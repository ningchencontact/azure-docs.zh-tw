...
+ [**適用于 Python 的 AZURE MACHINE LEARNING 主要 SDK**](https://aka.ms/aml-sdk)
...
+ [快速啟動](quickstart-run-cloud-notebook.md) 具有最新版 Azure Machine Learning SDK 和相關套件的預先設定筆記本 VM。
