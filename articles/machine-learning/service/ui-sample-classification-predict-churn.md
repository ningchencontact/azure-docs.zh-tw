...
我們使用這項實驗的資料是來自 KDD Cup 2009。 資料集有 50,000 個資料列和 230 特徵資料行。 工作是要預測客戶流失、 appetency，和向上銷售的客戶使用這些功能。 請參閱[KDD 網站](https://www.kdd.org/kdd-cup/view/kdd-cup-2009)如需詳細資訊的資料和工作。
