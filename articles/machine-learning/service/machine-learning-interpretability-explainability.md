...
description: 了解如何說明您的模型執行預測使用 Azure Machine Learning Interpretability SDK 的原因。 它可以用於定型和推斷期間了解您的模型如何進行預測。
...
Machine learning interpretability 來說很重要的機器學習開發週期的兩個階段： 
