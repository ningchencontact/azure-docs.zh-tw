...
具有 Azure Machine Learning 服務的 MLflow 追蹤可讓您將記錄的計量和成品從本機執行儲存至 Azure Machine Learning 工作區。
...
具有 Azure Machine Learning 服務的 MLflow 追蹤可讓您將已記錄的計量和成品從遠端執行儲存至 Azure Machine Learning 工作區。
