...
此資料集包含14個特徵和一個標籤資料行。 有多種類型的功能，包括數值和類別。 下圖顯示資料集的摘錄： ![資料](media/how-to-designer-sample-classification-predict-income/data.png)
...
![評估結果](media/how-to-designer-sample-classification-predict-income/evaluate-result.png)
