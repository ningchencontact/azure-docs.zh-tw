---
title: 使用 T-SQL 和 Python 在 SQL 資料倉儲上執行分析 - Team Data Science Process
...
[使用 SQL 資料倉儲逐步解說](sqldw-walkthrough.md)會示範如何使用 SQL 資料倉儲 (SQL DW)，針對公開使用的 NYC 計程車車程和車資資料集建置和部署機器學習服務的分類和迴歸模型。
