...
ms.locfileid: "53134279"
---
# <a name="creating-continous-integration-pipeline-on-azure-using-docker-kubernetes-and-python-flask-application"></a>使用 Docker、Kubernetes 及 Python Flask 應用程式在 Azure 上建立持續整合管線
