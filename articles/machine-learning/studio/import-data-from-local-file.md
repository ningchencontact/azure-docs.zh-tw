---
標題：從檔案匯入資料 titleSuffix: Azure Machine Learning Studio description:了解如何將訓練資料檔案從硬碟上傳到 Azure Machine Learning Studio。 這樣會在工作區中建立資料集模組。
...
![上傳新的資料集](./media/import-data-from-local-file/upload-dataset.png)
