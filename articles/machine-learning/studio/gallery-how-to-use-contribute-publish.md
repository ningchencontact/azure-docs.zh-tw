...
若要從傳統版本的 Studio 中下載資源：

1. 在傳統版本的 Studio 中，選取 [**新增**]。
...
當資源在您的工作區中時，您可以自訂並使用它，就像您在傳統版本的 Studio 中建立的任何專案一樣。
