---
標題：適用於初學者的資料科學標題字尾：Azure Machine Learning Studio 說明：「適用於初學者的資料科學」會運用 5 支短片教導基本概念，首先為「資料科學可以回答的 5 個問題」。 來自 Azure Machine Learning。
...
## <a name="question-1-is-this-a-or-b-uses-classification-algorithms"></a>「問題 1：這是 A 或 B？」會使用分類演算法
讓我們從此問題著手：這是 A 或 B 嗎？
...
## <a name="question-2-is-this-weird-uses-anomaly-detection-algorithms"></a>「問題 2：這很奇怪嗎？」會使用異常偵測演算法
...
* 如果您的車輛配有壓力計，您可能想知道：這個壓力計的讀數正常嗎？
* 如果您正在監視網際網路，您會想要知道：這則來自網際網路的訊息是典型的嗎？

異常偵測會標記未預期或異常的事件或行為。 它提供在何處尋找問題的線索。

## <a name="question-3-how-much-or-how-many-uses-regression-algorithms"></a>「問題 3：多少？或有多少？」會使用迴歸演算法
...
## <a name="question-4-how-is-this-organized-uses-clustering-algorithms"></a>「問題 4：這是如何組織的？」會使用叢集演算法
現在，最後這兩個問題屬於更進階的問題。
...
## <a name="question-5-what-should-i-do-now-uses-reinforcement-learning-algorithms"></a>「問題 5：我現在該怎麼辦？」會使用增強式學習演算法
...
* 如果我是一個房屋的溫度控制系統：要調整溫度，還是保持原來的溫度？  
* 如果我是一台自動駕駛的汽車：遇到黃燈時，要煞車還是加速？  
* 如果是機器人吸塵器：要繼續打掃，還是返回充電站？
