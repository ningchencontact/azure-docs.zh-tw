---
標題：在 Machine Learning Studio 中使用線性迴歸標題字尾： Azure Machine Learning Studio 說明：在 Excel 與 Azure Machine Learning Studio 服務中的線性迴歸模型比較: machine-learning ms.service: machine-learning ms.component: studio ms.topic: article
