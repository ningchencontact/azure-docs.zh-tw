...
![搜尋叢集實驗](./media/data-science-for-beginners-copy-other-peoples-work-to-do-data-science/search-for-clustering-experiments.png)

以下是有人在資源庫中提供的有趣實驗。

![叢集實驗](./media/data-science-for-beginners-copy-other-peoples-work-to-do-data-science/clustering-experiment.png)
...
![[在 Studio 中開啟] 按鈕](./media/data-science-for-beginners-copy-other-peoples-work-to-do-data-science/open-in-studio.png)

我可以在該處按一下，然後被帶往 **Azure Machine Learning Studio**。 其會建立一份實驗副本，並放在我自己的工作區中。 這包括參與者的資料集、他們所做的所有程序、他們使用的所有演算法，以及他們儲存結果的方式。

![在 Machine Learning Studio 中開啟一個資源庫實驗 - 叢集演算法範例](./media/data-science-for-beginners-copy-other-peoples-work-to-do-data-science/cluster-experiment-open-in-studio.png)
