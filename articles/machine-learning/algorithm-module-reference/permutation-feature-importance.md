...
本文概述排列功能、理論基礎，以及其在機器學習中的應用程式：[排列功能重要性](http://blogs.technet.com/b/machinelearning/archive/2015/04/14/permutation-feature-importance.aspx)。  
