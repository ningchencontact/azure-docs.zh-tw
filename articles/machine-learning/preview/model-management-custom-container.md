...
1. depenencies.yml 檔案：若要管理可從 [PyPi]( https://pypi.python.org/pypi) 安裝的相依性，您可以使用 Workbench 專案的 conda_dependencies.yml 檔案，或建立您自己的檔案。 這是用來安裝可透過 pip 安裝之 Python 相依性的建議方法。
