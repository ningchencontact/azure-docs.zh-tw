...
* 已安裝 [Azure Machine Learning Workbench](./overview-what-is-azure-ml.md)。 請依照[快速入門安裝指南](./quickstart-installation.md)來安裝程式及建立工作區。
...
* [深入學習預測性維護](https://docs.microsoft.com/en-us/azure/machine-learning/preview/scenario-deep-learning-for-predictive-maintenance)
