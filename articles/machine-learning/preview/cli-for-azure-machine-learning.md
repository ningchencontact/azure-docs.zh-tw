---
title: 為常用的 Azure Machine Learning 工作安裝及使用機器學習 CLI
...
>[!NOTE]
>Azure Machine Learning 服務所提供的 CLI 與 [Azure CLI](https://docs.microsoft.com/en-us/cli/azure/?view=azure-cli-latest) 不同，後者是用來管理 Azure 資源。
