...
如需詳細資訊, 請參閱[Machine Learning Studio 中的 R 套件](/azure/machine-learning/studio-module-reference/r-packages-supported-by-azure-machine-learning.md)。
