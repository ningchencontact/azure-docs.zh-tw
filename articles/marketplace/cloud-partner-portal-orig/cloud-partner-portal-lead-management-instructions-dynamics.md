...
16. 在 [新使用者] 中，提供要與此連線一起使用的名稱和電子郵件。 在 Azure 入口網站中，貼上您所建立之應用程式的**應用程式識別碼**。
     ...
     ![設定新使用者](./media/cloud-partner-portal-lead-management-instructions-dynamics/leadgencreateuser.PNG)
...
4.  在 [安全性] 中，選取 [安全性角色] 並尋找 Microsoft Marketplace 潛在客戶寫入器的角色。
    ...
    ![設定安全性潛在客戶寫入器](./media/cloud-partner-portal-lead-management-instructions-dynamics/crmonline10.jpg)\
