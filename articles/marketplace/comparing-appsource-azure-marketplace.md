...
| **在內容裡呈現給客戶** | 透過 Microsoft 產品 (例如 Dynamics 365、Power BI 和 Office 365) 的應用程式內體驗，來觸及更多客戶。 | 在內容相關式搜尋的 Azure 入口網站內體驗中提供您的解決方案。 使用虛擬機器和 Azure 應用程式：解決方案範本發佈選項。 |
