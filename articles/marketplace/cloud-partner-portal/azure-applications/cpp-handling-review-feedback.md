---
title: 處理 Azure 應用程式審查意見反應 |Azure Marketplace
...
![使用 Azure DevOps 意見反應發佈步驟](./media/pub-flow-vsts-access.png)
...
1. 收集下列資訊：
    ...
    - 提取要求連結，例如： `https://solutiontemplates.visualstudio.com/marketplacesolutions/_git/contoso/pullrequest/<number>` 可以從通知訊息或401回應頁面的位址抓取此 URL。
...
2. 選擇性在視窗右側的 [**原則**] 區段中，按一下問題訊息（在此範例中為「**原則驗證失敗**」）來調查問題的低層級詳細資料，包括相關聯的記錄檔。  錯誤通常會顯示在記錄檔的底部。
