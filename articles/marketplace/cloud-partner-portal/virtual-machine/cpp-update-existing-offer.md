---
title: 更新 Azure Marketplace 的現有虛擬機器供應項目 | Microsoft Docs
...
發佈預付型的供應項目後，就無法直接提高 SKU 的價格。  (不過，您可在相同的供應項目下建立新 SKU 並刪除舊的 SKU，然後再為新客戶重新發佈供應項目。)相對地，若要降低已發佈的供應項目價格，可採取以下步驟：
