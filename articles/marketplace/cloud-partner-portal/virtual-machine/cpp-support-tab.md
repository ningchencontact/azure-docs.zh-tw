---
title: 在 Azure Marketplace 的 Cloud Partner 入口網站中的虛擬機器支援 索引標籤
description: 說明用來建立 Microsoft Azure Marketplace 虛擬機器供應項目的支援索引標籤。
...
如果您還沒有 doen 因此，完成接下來您[虛擬機器的技術資產](./cpp-create-technical-assets.md)。
