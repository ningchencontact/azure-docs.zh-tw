---
title: Azure IoT Edge 模組供應項目發佈概觀 | Microsoft Docs
...
ms.locfileid: "49432371"
---
# <a name="iot-edge-module-offer-publishing-overview"></a>IoT Edge 模組供應項目發佈概觀

本文說明發佈程序和 IoT Edge 模組供應項目的關鍵部分。 請將這篇文章當作發佈供應項目至 [Microsoft Azure Marketplace](https://azuremarketplace.microsoft.com) 的第一步。
