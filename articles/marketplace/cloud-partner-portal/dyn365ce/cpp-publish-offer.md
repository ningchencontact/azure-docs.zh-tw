---
title: 發行 Dynamics 365 Customer Engagement 應用程式供應項目 |Azure Marketplace
description: 描述在 AppSource Marketplace 上發行 Dynamics 365 for Customer Engagement 應用程式供應項目的程序和步驟。
...
|  發行者登出             |  -        | 供應項目上線前發行者最終檢閱與確認。 您可以在所選訂用帳戶 (於供應項目資訊步驟) 部署供應項目，以確認它符合您的所有需求。  選取 [Go Live]  讓供應項目進行下一個步驟。 |
...
完成發佈程序並推出供應項目最多需要 10 個工作天。 完成發佈程序之後，您的供應項目將會列在 [Microsoft AppSource Marketplace](https://appsource.microsoft.com/marketplace/apps/) 中。
