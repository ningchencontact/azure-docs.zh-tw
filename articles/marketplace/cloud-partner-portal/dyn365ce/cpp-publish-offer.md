---
title: 為 Customer Engagement 應用程式供應專案發佈 Dynamics 365 |Azure Marketplace
description: 已取代的 .CPP 文章，連結至電腦文章;was 「描述在 AppSource Marketplace 上發佈 Dynamics 365 for Customer Engagement 應用程式供應專案的流程和步驟」。
