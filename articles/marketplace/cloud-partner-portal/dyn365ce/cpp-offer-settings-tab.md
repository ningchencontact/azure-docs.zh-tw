---
title: Dynamics 365 for Customer Engagement 供應專案的 [設定] 索引標籤 |Azure Marketplace
description: 已取代的 .CPP 文章，連結至電腦文章;was 「在 AppSource Marketplace 上設定 Dynamics 365 for Customer Engagement 應用程式供應專案的供應專案設定」。
