---
title: 建立 Dynamics 365 for Customer Engagement 應用程式供應專案 |Azure Marketplace
description: 已淘汰此 CPP 文章，並指向電腦文章;was 「如何在 AppSource Marketplace 上建立新的 Dynamics 365 for Customer Engagement 應用程式供應專案」。
