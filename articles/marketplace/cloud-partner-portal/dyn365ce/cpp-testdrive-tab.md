---
title: Dynamics 365 for Customer Engagement 應用程式供應專案試用產品索引標籤 |Azure Marketplace
description: 已取代的 .CPP 文章，連結至電腦文章;was 「如何在 AppSource Marketplace 上設定 Dynamics 365 for Customer Engagement 應用程式供應專案的試用產品」。
