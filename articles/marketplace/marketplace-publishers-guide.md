...
Azure Marketplace 和 AppSource 是聯合 Go-To-Market 活動與 Microsoft 的跳板，也是 Co-sell Ready 合作關係機會的門戶。 利用上市推廣、創造需求及聯合銷售與行銷，您可以使市集清單成為雲端商務引擎的中心及業務成長的飛輪。 參與市集無需任何費用。 我們的目標是要連接 Microsoft 客戶與合作夥伴生態系統所提供的最佳解決方案和服務。
...
每個店面都提供專屬的發行選項，有助於讓發行投資發揮最大效用。 下表摘要說明這些選項：
...
## <a name="how-to-publish-on-cloud-marketplace"></a>如何在雲端市集上發行

要成為雲端市集發行者，只需要簡單的三個步驟：
1.  決定適合您供應項目的清單類型
2.  註冊成為雲端市集發行者
3.  完成供應項目與清單類型所需的技術和內容必要條件


**1.  決定適合您供應項目的清單類型**

每個店面都支援多種發行選項與供應項目類型。 選擇最能呈現應用程式與服務詳細資料的供應項目類型。 所有發行選項可讓協力廠商存取潛在客戶共用。

|**發行選項**  | **供應項目類型** | **店面**  |
|---------|---------|---------|
|**清單**    |    與我連絡、諮詢服務     |  Azure Marketplace、AppSource       |
|**試用版**   |     免費試用、SaaS 試用版、互動式示範、試用產品    |  Azure Marketplace、AppSource       |
|**交易**     |   虛擬機器、解決方案範本、受控應用程式、容器、SaaS 訂用帳戶      |    Azure Marketplace     |



**2.  成為雲端合作夥伴發行者**

請按照下列步驟，註冊成為我們的雲端市集的發行者。 根據您與 Microsoft 間的現有約定及您選取的清單類型，可能不需要某些步驟： 
...
技術與行銷內容需求會因店面、供應項目類型和清單類型而異。 請檢閱以下規格，確保您能符合下列條件：
-   店面需求：Azure Marketplace 與 AppSource
-   清單類型需求：清單、試用版與交易
-   供應項目類型需求： 
 -  應用程式 – 虛擬機器、容器或 SaaS
 -  諮詢供應項目
...
Azure Marketplace 與 AppSource 可讓發行者對數百萬個客戶展示其解決方案。 針對市集中的新刊登，會自動提供一組免費的 Go-To-Market 權益，以協助促進客戶生態系統知曉您的供應項目。

在市集店面中刊登您的供應項目是聯合 Go-To-Market 活動與 Microsoft 的跳板，也是 Co-sell Ready 合作關係機會的門戶。 針對所有新的刊登，會自動提供一組免費的 Go-To-Market 權益，以協助促進客戶生態系統知曉您的供應項目。 GTM 權益提供各種不同的共同行銷與共同銷售活動，其設計目的是為了利用我們的品牌、管道和生態系統，以協助合作夥伴促進其解決方案的知曉度並創造銷售量。 合作夥伴不需要採取任何動作。 一旦發行供應項目，我們的 GTM 小組會連絡合作夥伴開始交付。
如需 GTM 權益及如何在市集上擴展業務的詳細資訊，請前往 [MPN 網站上的 GTM 權益](https://partner.microsoft.com/en-US/reach-customers/gtm) (英文)。
...
|**需求**  |**詳細資料**  |**必要或建議**  |
|---------|---------|---------|
|**Azure Active Directory (AAD)**    |  您的應用程式必須允許 Azure Active Directory 同盟單一登入 (AAD 同盟 SSO) 並同意啟用。 這裡有如何啟用 AAD 同盟 SSO 的資訊     |    必要   |
|**與 Microsoft Cloud 服務整合**    |  您的應用程式應與 Microsoft Power BI、Cortana Intelligence、Microsoft Azure 服務 (如物聯網) 等其他 Microsoft Cloud 服務整合       |    建議    |
|**目標對象**    |  AppSource 供應項目必須以企業營運使用者與企業擁有者為目標     |    必要   |
|**商用軟體即服務 (SaaS) 應用程式**    |  您的應用程式必須符合以下條件： <ul><li>企業營運 SaaS 應用程式</li><li>著重於業務流程</li><li>以商務客戶為目標</li><li>讓使用者能夠透過其公司認證 (使用者名稱與密碼) 登入</li></ul>       |    必要    |
|**免費試用期與試用版體驗**    |  客戶必須能在限時內免費使用您的應用程式。 免費試用可以採取兩種形式： <ul><li>提供「試用」選項，讓客戶可以從 AppSource 內啟動試用版</li><li>讓客戶從 AppSource 內「要求試用」</li></ul> 無論是哪一種方法，免費試用版都必須讓客戶能以最短的時間試用應用程式，無須支付額外費用。      |    必要    |
|**可輕鬆設定的周全解決方案**    |  應用程式的安裝與設定必須簡單快速 (無須自訂)     |    必要   |
|**潛在客戶管理**    |  若要獲得來自 Marketplace 的潛在客戶，您必須啟用 CRM (Marketo、Microsoft Dynamics 或 Salesforce)，以接受潛在客戶資料。       |    必要    |
|**隱私權原則及使用規定**    |  您的隱私權原則必須可透過公用 URL 取得。 您的使用條款必須在發行期間以文字形式輸入。     |    必要   |
|**支援**    |  供應項目必須包括可公開取得的支援 URL，讓客戶得以尋求協助。 採用試用版時，試用期間必須完全免費提供支援。     |    必要   |

**Azure Marketplace：發行選項的必要條件**
...
|**需求**  | **詳細資料**  |**發行選項**  |
|---------|---------|---------|
|**免費試用期與試用版體驗**     |  客戶必須能在限時內免費使用您的應用程式。<br><br>這表示，客戶不需要支付產品的授權或訂用帳戶費用或基礎的 Microsoft 第一方產品或服務成本。 由於所有試用版選項都部署在發行者的 Microsoft 產品訂用帳戶，因此試用版成本最佳化與管理完全由發行者掌控。<br><br>您可以選擇免費試用版、互動式示範或試用產品。 無論您的選擇為何，免費試用版都必須讓客戶能以最短的時間試用應用程式，無須支付額外費用。<br><br>若要開始建立試用產品的程序，請與 amp-testdrive@microsoft.com 聯繫。 <br><br>請注意，Azure Marketplace SaaS 試用版體驗必須允許使用者以其 Active Directory 工作認證登入。 [深入了解](https://docs.microsoft.com/azure/active-directory/develop/active-directory-devhowto-appsource-certified#appsource-trial-experiences)。 |   試用版      | 
...
#### <a name="prerequisites-specific-to-transaction-publishing-for-containers"></a>容器的交易發行特有的必要條件
...
|**諮詢服務的合作夥伴需求**    |  *僅限 Azure Marketplace*： <br>合作夥伴也必須具備其服務相關領域的**銀級或金級專長認證**。 以下列出符合資格的專長認證：</br><br><ul><li> **專長認證：** 雲端平台與基礎結構。 <br>**解決方案領域：** 雲端平台、資料中心</li><br><li>**專長認證：** 應用程式開發與 ISV <br>**解決方案領域：** 應用程式開發、應用程式整合、DevOps</li><br><li>**專長認證：** 資料管理與分析 <br>**解決方案領域：** 資料分析、資料平台 </li></br></ul>如需詳細資訊，請參閱[透過 Microsoft 合作夥伴網路了解專長認證](https://partner.microsoft.com/en-US/membership/competencies) (英文)。</br><br>如需清單的詳細資訊，請參閱 [Azure Marketplace 諮詢服務](https://docs.microsoft.com/en-us/azure/marketplace/consulting-services) (英文) |    列出     | 
...
|需要此發行構件  |此供應項目類型  |
|---------|---------|
|**標題 (最多 50 個字元)**    |  交易：虛擬機器、Azure 應用程式 (解決方案範本與受控應用程式)、容器、SaaS 訂用帳戶       |
|**摘要 (最多 200 個字元)**    |  交易：虛擬機器、Azure 應用程式 (解決方案範本與受控應用程式)、容器、SaaS 訂用帳戶       |
|**詳細摘要 (最多 256 個字元)**     |   交易：虛擬機器、Azure 應用程式 (解決方案範本與受控應用程式)、容器、SaaS 訂用帳戶      |
|**以 HTML 為基礎的描述 (最多 3,000 個字元)**    |  交易：虛擬機器、Azure 應用程式 (解決方案範本與受控應用程式)、容器、SaaS 訂用帳戶      |
|**公司標誌 (40x40、90x90、115x115、255x115、815x290)**    |  交易：虛擬機器、Azure 應用程式 (解決方案範本與受控應用程式)、容器、SaaS 訂用帳戶     |
...
|**Azure Container Registry (ACR) 映像存放庫詳細資料，包括訂用帳戶 ID、資源群組名稱、登錄名稱、使用者名稱、密碼及映像標記 (選擇性)** | 交易：容器 |
...
**認證您的 Azure AD 與 Marketplace 的整合：多租用戶應用程式**
...
**認證您的 Azure AD 與 Marketplace 的整合：單一租用戶應用程式**
...
在本節中，我們將解說下列作業的步驟： <ul><li>成為 Azure Marketplace 和 AppSource 中的發行者。</li><li>取得 Cloud Partner 入口網站的存取權。 您將使用該入口網站來建置、發行和維護您的供應項目。</li></ul>
...
**建立 Microsoft ID 以管理 Azure Marketplace 帳戶的指導方針**
...
3. 在您使用此帳戶建立 Microsoft ID 之後，請登入帳戶[信箱](https://outlook.live.com/owa/)。 [建立電子郵件轉寄規則](https://support.office.com/en-us/article/Use-rules-in-Outlook-Web-App-to-automatically-forward-messages-to-another-account-1433e3a0-7fb0-4999-b536-50e05cb67fed)，以將此信箱的所有電子郵件移至您在自己的網域中建立的電子郵件地址，來管理該 Azure Marketplace 帳戶。
...
如果您想要發佈商業供應項目供採購，則還需要新增付款和稅務資訊，然後在開發人員中心中提交以供驗證。 如果您只要發行免費或自備授權的供應項目，則不需要新增這項資訊。 您可以稍後再新增，但請花一些時間驗證稅務資訊。 如果您知道將會提供商業供應項目供採購，建議您儘快新增。
...
使用預付型方案交易作為發行選項時，依使用量計費的軟體授權營收會由您與 Microsoft 依 80%/20% 的比例分成。 單一供應項目可分別以預付型方案和自備授權帳務模型定價，並作為個別的 SKU 同時存在於供應項目層級。 您可以在 Cloud Partner 入口網站的供應項目中進行此設定。
...
### <a name="azure-marketplace-vs-appsource"></a>Azure Marketplace 與AppSource
...
選擇店面的第一步，是找出您的供應項目適用於哪些對象。 如果兩者都是您銷售解決方案的對象，您只需發行一次，即可同時陳列在這兩個店面。
 
請考量各個商店的其他優點：

|店面優點  |Azure Marketplace  |AppSource   |
|---------|---------|---------|
|**計費有彈性**    | 虛擬機器的「預付型方案」計費選項採用 Microsoft Enterprise 合約 (EA) 或 Web Direct 銷售模型。 定價選項也包含供應項目永久免費的免費層訂用帳戶。 此外也包含限時推廣期間內免費、之後轉換成付費訂用帳戶的立即試用訂用帳戶。 「自備授權」啟用也是支援發行者的選項之一。 <br><br>對於這兩種計費選項，在透過 Azure 應用程式 (例如，解決方案範本或受控應用程式) 部署虛擬機器的情況下，所有佈建的 Azure 資源都會直接向客戶收費。 | AppSource 目前提供試用體驗的佈建，但不提供商務用發行選項。 您可以使用目前的訂購和計費基礎架構，而無需其他投資或變更。        |
|**促進與其他合作夥伴的往來**     |Azure Marketplace 目前不允許發行者將服務提供者或交貨合作夥伴連結至供應項目，但將在 2018 年啟動此功能。         |  您可以連結獨立軟體廠商、系統整合商及受控服務提供者，以用於特定實作案例。 這項功能可支援對新客戶的共同銷售。      |
|**自動化**     |    Azure Marketplace 目前不允許發行者將服務提供者或交貨合作夥伴連結至供應項目。     | 使用自動化 SaaS 進行增益集佈建。 使用解決方案範本將 SaaS 式資料收集和部署案例自動化。        |您可以連結獨立軟體廠商、系統整合商及受控服務提供者以用於特定實作案例，支援對新客戶的共同銷售。
|**多種雲端類型**     |   透過 Azure Stack 發行公用雲端與內部部署解決方案，或發行至 Azure Government 與區域雲端，包括中國與德國。      |    AppSource 目前不支援 Azure Stack、Azure Government 或區域雲端。     |
