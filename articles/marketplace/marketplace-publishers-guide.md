---
title: Azure Marketplace 和 AppSource 發行者指南 | Azure
...
2.  瀏覽[成為市集中店面的發行者](./become-publisher.md)頁面。  
3.  瀏覽[依清單類型的需求](./listing-type-requirements.md)頁面。  

---   

## <a name="publishing-checklists"></a>發行檢查清單  
*   瀏覽[發行適用於 AppSource 的檢查清單](publishing-checklist-appsource.md)頁面。  
*   瀏覽 [Cloud Partner 入口網站上的 Azure Marketplace 發行檢查清單](./publishing-checklist-azure-marketplace.md)頁面。  
...
## <a name="guides"></a>手冊  
*   瀏覽 [Azure Marketplace 諮詢服務](consulting-services.md)頁面。  
*   瀏覽 [Azure Marketplace SaaS 應用程式技術發行指南](marketplace-saas-applications-technical-publishing-guide.md)頁面。  
...
*   瀏覽[使用 Azure AD 啟用試用版](./enable-trial-using-azure-ad.md)頁面。  
*   瀏覽[適用於 Azure Marketplace 的計費選項](./billing-options-azure-marketplace.md)頁面。  
