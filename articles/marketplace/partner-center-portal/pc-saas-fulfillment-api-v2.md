...
description: 說明如何建立和管理 SaaS 供應項目上使用相關聯的 「 履行 」 的 Azure Marketplace 與 AppSource v2 Api。
...
|  authorization     |  [取得 JSON web 權杖 (JWT) 持有人權杖](https://docs.microsoft.com/azure/marketplace/partner-center-portal/pc-saas-registration#get-a-token-based-on-the-azure-ad-app) |
