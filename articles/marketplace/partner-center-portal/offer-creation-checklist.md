...
| **欄位名稱**    | **注意事項**   | 
| :---------------- | :-----------|  
| 類別與子類別 | 必要1和最大值3。 預設值：未選取。 |
| 產業和 subindustries | 選擇性。 每個 L1 產業內最多2個 L1 產業和最多2個 subindustries，預設值：未選取 |
| 應用程式版本  | 選擇性。 預設值：無。 |
| 使用標準合約  | 選擇性。 預設值：未選取。  | |
| 使用規定  | 如果未選取標準合約，則為必要。  |
...
| :---------------- | :-----------| 
| 市場可用性  | 必要，最小1和最大值141。 |
| 計價模式  | 必要。 預設值：一般費率。 選項：每位使用者的平面費率。 |
