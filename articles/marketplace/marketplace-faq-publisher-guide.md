...
**Azure Marketplace 中的虛擬機器供應專案之成本結構中  的*價格*、*軟體價格*和總價有何差異？**
...
Azure Marketplace 提供了可讓 Microsoft 合作夥伴將產品與服務推廣並銷售給 Azure 客戶的市場。 發行者, 可以立即取得140全球市場、我們的 300000 + 合作夥伴和 Azure 的企業客戶網路的存取權。  Marketplace 包含超過 90% 的「財富500」公司, 以及許多全球領先的開發人員。 Azure Marketplace 中的新合作夥伴會自動提供一組[無成本的進入市場優勢](gtm-your-marketplace-benefits.md#go-to-market-gtm-benefits-in-the-marketplace), 協助您在 Azure Marketplace 中提高其供應專案的認知。
