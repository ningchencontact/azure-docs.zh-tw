...
Azure Marketplace 是適用於 Microsoft Azure 客戶中所列的國家/地區[參與原則](https://docs.microsoft.com/legal/marketplace/participation-policy)。
...
您可以在 [https://azure.microsoft.com/pricing/](https://azure.microsoft.com/pricing/) 或 [Microsoft Azure 管理入口網站](https://portal.azure.com/)的解決方案詳細資料頁面上，找到特定的定價詳細資料。
...
Azure Marketplace 可供在下列國家/地區的 Microsoft Azure 客戶：
...
1.  使用所有可用國家/地區來販售給清單就會出現。  按一下您想要提供此 SKU 的每個國家/地區旁邊的核取方塊。 按一下 [確定]。
...
「 發行者 」 可以編輯現有供應項目，選取新的國家/地區，並使用試算表下載/上傳函式設定價格。
...
您可以在 [https://azure.microsoft.com/pricing/](https://azure.microsoft.com/pricing/) 或 Microsoft Azure 管理入口網站的解決方案詳細資料頁面上，找到定價詳細資料。
