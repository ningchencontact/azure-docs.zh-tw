...
**我可以選擇哪個的 Microsoft Azure 地區部署我的 Azure Marketplace 購買嗎？**

客戶可以選擇部署到它們可讓任何 Azure 資料中心區域。 建議您選取最靠近服務的資料中心位置，以達到最佳效能並控管預算。

**如果不小心刪除的 Azure Marketplace 購買，可以 「 復原 」 動作嗎？**

否，刪除無法改變。 如果不小心刪除訂閱，可以重新購買。 任何未使用的功能或預付的服務都將遺失。

**我要收到警告，如果我嘗試刪除正在使用中的 Azure Marketplace 購買的其中一個應用程式嗎？**

否，Azure 在您刪除而購買項目時不會提供警告，即使該項目正在使用中或是有相依的應用程式。

**如果我的 Azure Marketplace 購買會對其他資產，例如 Azure 網站中的任何相依性，我沒有管理它們？**
...
**支援哪些國家/地區購買的應用程式和銷售/佈建服務透過 Azure Marketplace？**
...
**我已部署 Azure Marketplace 虛擬機器 (VM) 至訂用帳戶，而我現在想要從一個 Azure 帳戶移轉訂用帳戶之間。 目前支援這樣做嗎？**

若要移轉 Azure 訂用帳戶 (包括 Azure Marketplace VM 和服務)，請先刪除或取消任何既有的 Azure 訂用帳戶，再關聯至新的 Azure 帳戶。 移轉完成之後，產生的使用費用會依新註冊帳戶的付款方法來計費。

**我想要將 Azure Marketplace 虛擬機器 (VM) 訂閱移轉到我的 Enterprise 合約。 目前支援這樣做嗎？**
...
**如何應該提供我的 BYOL marketplace 解決方案的軟體授權金鑰和 Azure Marketplace 扮演什麼角色？**
...
**'免費試用' 和 '免費試用軟體' 之間的差異為何？**

「免費試用」訂用帳戶供應項目是永久免費的。  「免費軟體試用」(「立即試用」) 供應項目是付費供應項目，但可在限定期間內免費試用。

**我需要付款方式 （例如信用卡） 檔案，部署免費層或自備授權 (BYOL) 供應項目嗎？**
...
**如果他們有關於 Azure Marketplace 上販售之產品定價的問題時，沒有 Enterprise 合約 (EA) 間接客戶連絡誰？**

間接 Enterprise 合約 (EA) 客戶如有任何有關 Azure Marketplace 定價的問題，必須連絡其授權方案提供者 (LSP)。

**我可以控制我的員工存取 Azure Marketplace 及其購買權限嗎？**
...
**可以適用於 Azure 訂用帳戶點數或預付金都在我的帳戶 Azure marketplace 中的提供？**
...
**我如何支付這些訂閱？ 就我的 Azure Marketplace 購買會出現在 Azure 的帳單，或是否有另外的帳單？**
...
**頻率是否需要付費的 Azure Marketplace 購買？**
...
**我如何將 Azure Marketplace 購買從 MOSP 訂閱移至直接 Enterprise 合約 (EA) 訂閱？**
...
**什麼是虛擬機器的成本結構 「 價格 」、 「 軟體價格 」 和 「 總價 」 之間的差異，提供在 Azure Marketplace？**
...
**可以在 Azure 產品和執行 Azure Marketplace 供應項目所需的服務帳戶上套用 Azure 訂用帳戶點數或預付金嗎？**
...
**如有 Azure Marketplace 的一般支援問題，該連絡誰？**
...
**該連絡誰如有帳單支援/問題對於從 Marketplace 購買的協力廠商解決方案？**
...
**為什麼應該發佈我的應用程式，Azure Marketplace 上以及沒有它優點我嗎？**
...
**什麼是 Azure Marketplace 和 AppSource 之間的區別係數？**
...
**在 Azure Marketplace 中發行是否有任何費用？**

透過 Azure Marketplace 上傳清單、試用版或 BYOL (自備授權) 時，不需要發佈費用。

**透過 Azure Marketplace 購買是否有任何交易費用？**
...
**哪裡找到整合應用程式與 Azure Active Directory (AAD) 的指導方針？**
...
**什麼是潛在客戶 」 和 「 為什麼它們為 「 發行者 」 在 Marketplace 中對我至關重要？**
...
**我必須設定發佈供應項目在 Marketplace 上的潛在客戶目的地？**
...
**如果不小心刪除 Azure Marketplace 購買，可以「復原」動作嗎？**

否，刪除無法改變。 如果您不慎刪除訂用帳戶，您只需重新購買即可加以重新啟動。  不過，任何未使用的功能或預付的服務都會遺失，因此在刪除訂用帳戶時請務必多加留意。

**有警告，如果我嘗試刪除正由其中一個應用程式的 Azure Marketplace 購買嗎？**

否，刪除應用程式所依存的購買項目時，Azure 將不會警告您。

**如果我的 Azure Marketplace 購買會對其他資產，例如 Azure 網站中的任何相依性，然後我必須管理它們？**
...
**我已部署 Azure Marketplace 虛擬機器 (VM) 至訂用帳戶，而我現在想要移轉該訂用帳戶從一個 Azure 帳戶之間。 目前支援這樣做嗎？**
...
**我可以運用帳戶上的 Azure 訂閱額度或承諾使用量資金來購買 Azure Marketplace 產品嗎？**
...
**我如何支付這些訂閱？ 就我的 Azure Marketplace 購買會出現在 Azure 的帳單，還是沒有另外的帳單？**
...
**我要如何取消 Azure VM 的 Azure Marketplace 附加元件？**
...
**可以將套用 Azure 訂用帳戶點數或預付金都在我的帳戶向 Azure 產品和服務，才能執行 Azure Marketplace 供應項目？**
...
**對於從 Marketplace 購買的協力廠商解決方案，如需帳單支援/問題，該連絡誰？**
