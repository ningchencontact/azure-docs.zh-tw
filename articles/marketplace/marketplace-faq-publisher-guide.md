...
發行者可以選擇部署到他們所啟用的任何 Azure 資料中心區域。 建議您選取最靠近服務的資料中心位置，以達到最佳效能並控管預算。
...
目前，Azure CSP 與 Open 客戶僅可使用免費與自備授權 (BYOL) Marketplace 供應項目。
...
客戶可以選擇部署到發行者啟用的任何 Azure 資料中心區域。 您可以選取最靠近其服務的資料中心位置，以達到最佳效能並控管預算。
...
**我可以向 Azure 雲端解決方案提供者 (CSP) 購買 Azure Marketplace 解決方案嗎？**
