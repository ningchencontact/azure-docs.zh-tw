---
title: 適用於 Azure Marketplace 的支援 | Azure
description: Azure Marketplace 的支援資訊和連結。
...
## <a name="general-inquiries"></a>一般查詢  

| 支援通道 | 說明 |  
|:--- |:--- |  
| 電子郵件：[cloudmarketplace@microsoft.com](mailto:cloudmarketplace@microsoft.com) | 上架支援的通訊群組清單。<br />用於上架要求、設定探索工作階段及架構設計工作階段。 |  

## <a name="publishing"></a>發佈  

| 支援通道 | 說明 | 可用性 |  
|:--- |:--- |:--- |  
| 電子郵件：[azurecertified@microsoft.com](mailto:azurecertified@microsoft.com) | 為您支援 Azure Marketplace 發佈應用程式。 | 上班時間採用美國太平洋時區。 |  
| 電子郵件：[azuremarketonboard@microsoft.com](mailto:azuremarketonboard@microsoft.com) | 支援 Azure Marketplace 解決方案提名表單和程序。 | 上班時間採用美國太平洋時區。 |  
| 電子郵件：[amp-testdrive@microsoft.com](mailto:amp-testdrive@microsoft.com) | 試用產品的上架存取權。 | 上班時間採用美國太平洋時區。 |  
