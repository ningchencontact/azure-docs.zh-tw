...
Azure Analysis Services 支援 1200 和 1400 相容性層級的表格式模型。 最新的相容性層級是 1400。 此層級與 SQL Server 2017 Analysis Services 一致。 1400 相容性層級中的主要功能包括：
...
> [!NOTE]
> 在 SSMS 中，連接到 Azure Analysis Services 伺服器，當**支援的相容性層級**屬性會顯示**1200年**。 這是已知的問題，並且會解決在即將推出的 SSMS 中更新。 當問題解決之後，此屬性會顯示最高支援的相容性層級。
