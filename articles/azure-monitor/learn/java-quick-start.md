...
5. 設定 Application Insights 外掛程式之後，您需要再次[發佈/重新發佈](https://docs.microsoft.com/azure/app-service/app-service-web-get-started-java#deploy-the-app)您的應用程式，它才能開始傳送遙測資料。
