...
ms.locfileid: "72899168"
---
#<a name="productsa"></a>產品「></a>
                <ul id="products">
                    <li>
...
"> Config.xml</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-Java">開放原始碼 JAVA SDK GitHub</a>存放庫
                                                        </p>
                                                        <br><br>
                                                        <h3>.NET 應用程式</h3>
                                                        <p>
                                                            ...
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-dotnet">開放原始碼 .NET SDK GitHub</a>存放庫
                                                        </p>
                                                        <br><br>
                                                          <h3>.NET Core 應用程式</h3>
                                                        <p>
                                                            ...
                                                            <a href="./app/api-custom-events-metrics.md">自訂事件和計量</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-aspnetcore">開放原始碼 .NET Core SDK GitHub</a>存放庫
                                                        </p>
                                                        <br><br>
                                                          <h3>Node.js 應用程式</h3>
                                                        <p>
                                                            ...
                                                            <a href="./app/api-custom-events-metrics.md">自訂事件和計量</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-node.js">開放原始碼 NODE.JS SDK GitHub</a>存放庫
                                                        </p>
                                                        <br><br>
                                                        <h3>用戶端/瀏覽器端監視</h3>
                                                        <p>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="./app/usage-flows.md">消費者流程</a>
                                                        </p>
                                                        <br><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="https://docs.microsoft.com/azure/monitoring-and-diagnostics/monitoring-metric-charts">調查</a>
                                                         的計量</p>
                                                        <br><br>
