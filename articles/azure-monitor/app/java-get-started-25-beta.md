---
title: 使用 Azure 應用程式 Insights 的 JAVA web 應用程式分析 (2.5.0-搶鮮版 (BETA)) |Microsoft Docs
description: '使用 Application Insights (2.5.0-BETA) 之 JAVA web 應用程式的應用程式效能監視。 '
...
ms.locfileid: "68967833"
---
# <a name="get-started-with-application-insights-in-a-java-web-project-250-beta"></a>開始使用 JAVA Web 專案中的 Application Insights (2.5.0-BETA)
...
[安裝 JAVA 代理程式](java-agent-25-beta.md)來捕捉傳出的 HTTP 呼叫、JDBC 查詢、應用程式記錄, 以及更好的作業命名。
