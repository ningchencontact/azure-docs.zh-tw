...
如果您需要比 `DisableIpMasking` 更有彈性的替代方案，以記錄所有或部分的 IP 位址，您可以使用[遙測初始化運算式](https://docs.microsoft.com/azure/azure-monitor/app/api-filtering-sampling#addmodify-properties-itelemetryinitializer)，將所有或部分 ip 複製到自訂欄位。 
