...
找出必要的測試控管。 啟動**Visual Studio 安裝程式** > **個別元件** > **的調試和測試** **Web 效能和負載測試工具。**  > 
...
1. 建立 Web 效能和負載測試專案。 **[檔案**] [**新增** > **專案** **] 視覺效果C#** 測試 >   >   > 
...
1. 在 [可用性] 窗格的 Application Insights 入口網站中, 選取 [**建立測試** > **測試類型** > ] [**多重步驟 web 測試**]。
...
| 生效時間 | 在過去建立之權杖的時間範圍將會有效 (以處理時間扭曲)。  預設值為 (負) 5 分鐘。 |
