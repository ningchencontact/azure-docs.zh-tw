...
## <a name="limits"></a>限制
* 目前，查詢結果受限於僅只過去一週的資料。
* 我們測試的瀏覽器︰最新版本的 Chrome、Microsoft Edge 及 Internet Explorer。
...
![403 ... 確認安全性區域](media/analytics-troubleshooting/030.png)
...
5. 當不支援信任的區域設定時，Microsoft Edge 和 Internet Explorer 的使用者也會收到此錯誤。
   ...
   * 在 Internet Explorer 中，開啟 [網際網路選項]、[安全性]、[信任的網站]、[網站]：
     ...
     ![[網際網路選項] 對話方塊，將網站新增到信任的網站](media/analytics-troubleshooting/033.png)
...
![404 ... 找不到資源](media/analytics-troubleshooting/040.png)

應用程式資源已從 Application Insights 中刪除，且不再提供。 這可能會在您將 URL 儲存到 [分析] 頁面時發生。

## <a name="e-e"></a>403 ...沒有授權
![403 ... 未獲授權](media/analytics-troubleshooting/050.png)

您沒有權限可在分析中開啟此應用程式。

* 您的連結是由其他人所提供嗎？ 要求他們確認您是 [這個資源群組的讀取者或參與者](../../azure-monitor/app/resources-roles-access-control.md)。
...
![403 ... 嘗試啟用 HTML5 儲存體](media/analytics-troubleshooting/060.png)

## <a name="e-g"></a>404 ...找不到訂用帳戶
![404 ...找不到訂用帳戶](media/analytics-troubleshooting/070.png)
...
![404 ...頁面不存在](media/analytics-troubleshooting/080.png)
...
## <a name="cookies"></a>啟用協力廠商 cookie
  請參閱 [如何停用協力廠商 Cookie](https://www.digitalcitizen.life/how-disable-third-party-cookies-all-major-browsers)，但請注意，我們需要 **啟用** 它們。
