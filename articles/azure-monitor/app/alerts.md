...
![在 [警示規則] 刀鋒視窗中，按一下 [新增警示]。 將您的應用程式設定為要測量的資源，提供警示的名稱，然後選擇計量。](./media/alerts/01-set-metric.png)
...
![在 [概觀] 刀鋒視窗中，按一下 [設定]、[稽核記錄檔]](./media/alerts/09-alerts.png)
