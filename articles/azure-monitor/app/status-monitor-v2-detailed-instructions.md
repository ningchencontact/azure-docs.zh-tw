...
2. 安裝 NuGet 套件提供者。
    ...
    - 選擇性參數：
        - `-Proxy`答案中所述步驟，工作帳戶即會啟用。 指定要求的 proxy 伺服器。
        - `-Force`答案中所述步驟，工作帳戶即會啟用。 略過確認提示。
...
3. 將 PowerShell 資源庫設定為受信任的存放庫。
    ...
    您可以藉由執行 `Get-PSRepository` 命令來確認這項變更並審核所有 Psrepository。
...
4. 安裝最新版的 PowerShellGet。
    ...
    - 選擇性參數：
        - `-Proxy`答案中所述步驟，工作帳戶即會啟用。 指定要求的 proxy 伺服器。
        - `-Force`答案中所述步驟，工作帳戶即會啟用。 略過「已安裝」警告並安裝最新版本。
...
3. 安裝 Az ApplicationMonitor 模組。
    ...
    - 選擇性參數：
        - `-Proxy`答案中所述步驟，工作帳戶即會啟用。 指定要求的 proxy 伺服器。
        - `-AllowPrerelease`答案中所述步驟，工作帳戶即會啟用。 允許安裝 Alpha 和 Beta 版。
        - `-AcceptLicense`答案中所述步驟，工作帳戶即會啟用。 略過 [接受授權] 提示
        - `-Force`答案中所述步驟，工作帳戶即會啟用。 略過「不受信任的存放庫」警告。
