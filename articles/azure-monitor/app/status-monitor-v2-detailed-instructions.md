...
- Optional parameter:
    - `-Force`答案中所述步驟，工作帳戶即會啟用。 Bypasses the confirmation prompt.
...
2. Install the NuGet package provider.
    ...
    - Optional parameters:
        - `-Proxy`答案中所述步驟，工作帳戶即會啟用。 Specifies a proxy server for the request.
        - `-Force`答案中所述步驟，工作帳戶即會啟用。 Bypasses the confirmation prompt.
...
4. Install the newest version of PowerShellGet.
    ...
    - Optional parameters:
        - `-Proxy`答案中所述步驟，工作帳戶即會啟用。 Specifies a proxy server for the request.
        - `-Force`答案中所述步驟，工作帳戶即會啟用。 Bypasses the "already installed" warning and installs the latest version.
...
3. Install the Az.ApplicationMonitor module.
    ...
    - Optional parameters:
        - `-Proxy`答案中所述步驟，工作帳戶即會啟用。 Specifies a proxy server for the request.
        - `-AllowPrerelease`答案中所述步驟，工作帳戶即會啟用。 Allows installation of alpha and beta releases.
        - `-AcceptLicense`答案中所述步驟，工作帳戶即會啟用。 Bypasses the "Accept License" prompt
        - `-Force`答案中所述步驟，工作帳戶即會啟用。 Bypasses the "Untrusted Repository" warning.
