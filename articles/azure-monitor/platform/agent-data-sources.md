...
1. 在 Azure 入口網站中，選取 [工作區] > 您的工作區 > [進階設定]。
2. 選取 [資料] 。
3. 按一下要設定的資料來源。
