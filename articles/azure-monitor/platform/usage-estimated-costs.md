...
下列指令碼需要 Azure PowerShell 模組。 若要檢查是否有最新版，請參閱[安裝 Azure PowerShell 模組](https://docs.microsoft.com/powershell/azure/azurerm/install-azurerm-ps?view=azurermps-6.1.0)。
