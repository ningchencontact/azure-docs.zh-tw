...
8. 無法再透過 PowerShell 建立傳統的警示規則。 若要建立新的警示規則，您需要使用[「Add-azurermmetricalertrule」](https://docs.microsoft.com/powershell/module/azurerm.insights/add-azurermmetricalertrule?view=azurermps-6.13.0)命令。
