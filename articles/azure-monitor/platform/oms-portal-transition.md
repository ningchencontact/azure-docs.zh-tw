...
**Azure 公用雲端的 OMS 入口網站已正式淘汰。於 2019 5 月 15 日正式淘汰 Azure 美國政府雲端的 OMS 入口網站。** 我們很高興移至 Azure 入口網站，並預期此次轉換將會很簡單。 但我們了解任何變更均有其難度，而且可能會對您造成困擾。 本文其餘部分將介紹關鍵案例和此次轉換的藍圖。
...
此情況下，Application Insights Connector 是已被取代，而且移除從 Azure Marketplace，以及 OMS 入口網站淘汰於 2019 年 3 月 30 日。 現有的連線將繼續運作，直到 2019 年 6 月 30 日為止。 隨著 OMS 入口網站被淘汰，將無法從入口網站設定及移除現有連線。 於 2019 年 1 月提供的 REST API 將會支援此作業，通知將會張貼在 [Azure 更新](https://azure.microsoft.com/updates/)上。 
