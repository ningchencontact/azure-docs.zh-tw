...
| System Center Operations Manager|[整合 Operations Manager 與 Log Analytics](../../azure-monitor/platform/om-agents.md) | 設定 Operations Manager 與 Log Analytics 之間的整合，以將收集的資料從 Linux 與 Windows 電腦報告轉送到管理群組。|  
