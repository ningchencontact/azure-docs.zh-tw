...
| 擷取 | 存取計量的值，從命令列使用[PowerShell cmdlet](https://docs.microsoft.com/powershell/module/azurerm.insights/?view=azurermps-6.7.0)<br>從自訂應用程式使用存取度量值[REST API](rest-api-walkthrough.md)。<br>存取計量的值，從命令列使用[CLI](/azure/monitor/metrics)。 |
