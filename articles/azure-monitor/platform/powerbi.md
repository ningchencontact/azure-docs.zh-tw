...
ms.locfileid: "58110166"
---
# <a name="import-azure-monitor-log-data-into-power-bi"></a>Azure 監視器記錄資料匯入至 Power BI


[Power BI](https://powerbi.microsoft.com/documentation/powerbi-service-get-started/) 是 Microsoft 的雲端架構商務分析服務，能提供豐富的視覺效果和不同資料集的分析報告。  您可以至 Power BI 資料集匯 Azure 監視器記錄檔查詢的結果，因此您可以利用其功能，例如合併來自不同來源的資料，以及共用上的 web 和行動裝置。
...
Power BI Desktop 是桌面應用程式，可讓您建立可發行至 Power BI 的資料集和報表。  您也可以使用它來建立查詢，使用 Azure 監視器中匯出的 Power Query 語言。 
...
* 深入了解[Power BI](https://powerbi.microsoft.com) Azure 監視器記錄檔匯出為基礎的視覺效果。