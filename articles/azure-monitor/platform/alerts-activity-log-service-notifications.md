...
了解如何[設定現有問題管理系統的 Webhook 通知](../../service-health/service-health-alert-webhook-guide.md)。 如需活動記錄警示之 Webhook 結構描述的資訊，請參閱 [Azure 活動記錄警示的 Webhook](../../azure-monitor/platform/activity-log-alerts-webhook.md)。
