...
| Azure Kubernetes Service | 可直接存取入口網站中的 Azure Kubernetes Service （AKS）容器記錄（stdout/stderror）、事件和 pod 計量。 | [如何即時查看 Kubernetes 記錄、事件和 pod 計量](../insights/container-insights-livedata-overview.md) |
