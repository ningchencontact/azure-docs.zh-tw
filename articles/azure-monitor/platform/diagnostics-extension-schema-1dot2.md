---
title: Azure 診斷擴充功能 1.2 版設定結構描述
...
|**WindowsEventLog**|啟用收集 Windows 事件記錄。 選用屬性：<br /><br /> **scheduledTransferPeriod** - 排程傳輸至儲存體之間的間隔，無條件進位到最接近的分鐘數。 值是 [XML「持續時間資料類型」(英文)](https://www.w3schools.com/xml/schema_dtypes_date.asp)。|  
