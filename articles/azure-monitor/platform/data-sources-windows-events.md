...
從 [Log Analytics [設定] 中的 [資料] 功能表](agent-data-sources.md#configuring-data-sources)來設定 Windows 事件記錄檔。
...
* 使用 [自訂欄位](../../log-analytics/log-analytics-custom-fields.md) ，以將事件記錄剖析至個別欄位。
