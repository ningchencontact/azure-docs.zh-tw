...
- [Windows](../../log-analytics/log-analytics-windows-agent.md) 和 [Linux](../../log-analytics/log-analytics-quick-collect-linux-computer.md) 虛擬機器上的代理程式會根據您設定的[資料來源](../../azure-monitor/platform/agent-data-sources.md)，將遙測從客體作業系統和應用程式傳送到 Log Analytics。
...
![Log Analytics 元件](media/data-collection/logs-overview.png)
...
- 使用 [Logic Apps](~/articles/logic-apps/index.yml)，根據 Log Analytics 中的資料建置工作流程。
