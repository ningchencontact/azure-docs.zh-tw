...
![簡易結構描述範例](./media/create-pipeline-datacollector-api/example-simple-schema-01.png)
...
![資料收集管線架構](./media/create-pipeline-datacollector-api/data-pipeline-dataflow-architecture.png)
...
![邏輯應用程式的工作流程範例](./media/create-pipeline-datacollector-api/logic-apps-workflow-example-01.png)
...
![在搜尋結果中使兩個分開資料相互關聯的範例](./media/create-pipeline-datacollector-api/correlating-disjoined-data-example-01.png)
