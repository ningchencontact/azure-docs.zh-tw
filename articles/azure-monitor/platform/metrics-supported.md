...
|TotalRequests|閘道要求總數|Count|總計|指定期間內的閘道要求總數。 此度量已被取代，建議使用新的 `Requests` 計量。 |位置，主機名稱|
|SuccessfulRequests|成功的閘道要求|Count|總計|給定期間內成功的閘道要求總數。 此度量已被取代，建議使用新的 `Requests` 計量。|位置，主機名稱|
|UnauthorizedRequests|未經授權閘道器要求|Count|總計| 給定期間內未授權閘道要求的總數。 此度量已被取代，建議使用新的 `Requests` 計量。|位置，主機名稱|
|FailedRequests|失敗的閘道要求|Count|總計|指定期間內失敗的閘道要求總數。 此度量已被取代，建議使用新的 `Requests` 計量。|位置，主機名稱|
|OtherRequests|其他閘道器要求|Count|總計|在指定期間內，不屬於成功、未經授權或失敗類別的閘道要求總數。 此度量已被取代，建議使用新的 `Requests` 計量。 |位置，主機名稱|
|持續時間|閘道要求的整體持續期間|毫秒|平均值|當 API 管理收到來自用戶端的要求，以及將回應傳回給用戶端時的間隔時間。|位置，主機名稱|
|容量|容量|百分比|平均值|API 管理實例上的負載指標，以做出明智的決策，決定是否要調整實例以容納更多負載。|位置|
|EventHubTotalEvents|EventHub 事件總數|Count|總計|在指定期間內，從 API 管理傳送至 EventHub 的事件總數。|位置|
|EventHubSuccessfulEvents|成功的 EventHub 事件|Count|總計|指定期間內成功的 EventHub 事件總數。|位置|
|EventHubTotalFailedEvents|失敗的 EventHub 事件|Count|總計|在指定期間內失敗的 EventHub 事件總數。|位置|
|EventHubRejectedEvents|已拒絕 EventHub 事件|Count|總計|在指定期間內拒絕的 EventHub 事件（錯誤設定或未經授權）總數。|位置|
|EventHubThrottledEvents|已節流的 EventHub 事件|Count|總計|指定期間內的節流事件數總計。|位置|
|EventHubTimedoutEvents|已超時的 EventHub 事件|Count|總計|給定期間內已超時的 EventHub 事件總數。|位置|
|EventHubDroppedEvents|已卸載 EventHub 事件|Count|總計|因為在指定期間內到達佇列大小限制而略過的事件總數。|位置|
|EventHubTotalBytesSent|EventHub 事件的大小|位元組|總計|在指定期間內，EventHub 事件的總大小（以位元組為單位）。|位置|
...
|錯誤|錯誤數|Count|最大值||ShardId、ErrorType|
...
|Latency|Latency|毫秒|平均值|延遲，以毫秒為單位。|ApiName、OperationName、Region|
...
|每一磁碟 QD|資料磁片 QD （已淘汰）|Count|平均值|資料磁碟佇列深度 (或佇列長度)|SlotId|
...
|OS 每一磁碟 QD|OS 磁片 QD （已淘汰）|Count|平均值|OS 磁碟佇列深度 (或佇列長度)|無維度|
...
|資料磁片佇列深度|資料磁片佇列深度（預覽）|Count|平均值|資料磁碟佇列深度 (或佇列長度)|LUN|
...
|OS 磁片佇列深度|OS 磁片佇列深度（預覽）|Count|平均值|OS 磁碟佇列深度 (或佇列長度)|無維度|
|輸入流量|輸入流量（預覽）|Count|平均值|輸入流量是傳入方向的目前流量數（進入 VM 的流量）|無維度|
|輸出流程|輸出流程（預覽）|Count|平均值|輸出流程是輸出方向的目前流量數（從 VM 傳出的流量）|無維度|
...
|資料磁片佇列深度|資料磁片佇列深度（預覽）|Count|平均值|資料磁碟佇列深度 (或佇列長度)|LUN，VMName|
...
|OS 磁片佇列深度|OS 磁片佇列深度（預覽）|Count|平均值|OS 磁碟佇列深度 (或佇列長度)|VMName|
|輸入流量|輸入流量（預覽）|Count|平均值|輸入流量是傳入方向的目前流量數（進入 VM 的流量）|VMName|
|輸出流程|輸出流程（預覽）|Count|平均值|輸出流程是輸出方向的目前流量數（從 VM 傳出的流量）|VMName|
...
|度量|計量顯示名稱|單位|彙總類型|描述|維度|
|---|---|---|---|---|---|
|TotalPullCount|總提取計數|Count|平均值|總映射提取次數|無維度|
|SuccessfulPullCount|成功的提取計數|Count|平均值|成功的映射提取次數|無維度|
|TotalPushCount|總推送計數|Count|平均值|映射推播總數總計|無維度|
|SuccessfulPushCount|成功推送計數|Count|平均值|成功的映射推送數目|無維度|
...
|cpu_percent|CPU 百分比|百分比|平均值|CPU 百分比|無維度|
|memory_percent|記憶體百分比|百分比|平均值|記憶體百分比|無維度|
|功耗|IOPS|Count|平均值|每秒的 IO 作業數|無維度|
|storage_percent|儲存體百分比|百分比|平均值|儲存體百分比|無維度|
|storage_used|已使用儲存體|位元組|平均值|已使用儲存體|無維度|
|active_connections|作用中的連線|Count|平均值|作用中的連線|無維度|
|network_bytes_egress|Network Out|位元組|總計|跨作用中連線的網路輸出|無維度|
...
|d2c.endpoints.egress.builtIn.events|路由：傳遞至訊息/事件的訊息|Count|總計|IoT 中樞路由成功將訊息傳遞至內建端點 (訊息/事件) 的次數。 只有在啟用路由（IoT 中樞的 https://aka.ms/iotrouting) 時，此計量才會開始運作。|無維度|
...
|EventGridDeliveries|事件方格傳遞（預覽）|Count|總計|已發佈至事件方格的 IoT 中樞事件數目。 使用 [結果] 維度來取得成功和失敗的要求數目。 [事件種類] 維度會顯示事件的類型（ https://aka.ms/ioteventgrid)。|結果，事件|
...
|ActiveConnections|ActiveConnections|Count|平均值|Microsoft.EventHub 的使用中連線總數。|無維度|
|ConnectionsOpened|已開啟的連線。|Count|平均值|Microsoft.EventHub 的已開啟連線。|EntityName|
|ConnectionsClosed|已關閉的連線。|Count|平均值|Microsoft.EventHub 的已關閉連線。|EntityName|
...
|availabilityResults/計數|可用性測試|Count|Count|可用性測試計數|availabilityResult/name、availabilityResult/location、availabilityResult/success|
...
|度量|計量顯示名稱|單位|彙總類型|描述|維度|
|---|---|---|---|---|---|
|CacheUtilization|快取使用率|百分比|平均值|在叢集範圍的使用率等級|無|
|QueryDuration|查詢持續時間|毫秒|平均值|查詢持續時間 (以秒為單位)|查詢狀態|
|IngestionUtilization|擷取使用率|百分比|平均值|在叢集中使用的擷取位置的比率|無|
|保|保持運作|Count|平均值|例行性檢查指出對查詢的叢集回應|無|
|IngestionVolumeInMB|擷取量 (以 MB 為單位)|Count|總計|擷取到叢集的資料總量 (以 MB 為單位)|資料庫|
|IngestionLatencyInSeconds|擷取延遲 (以秒為單位)|秒|平均值|從來源 (例如，訊息位於 EventHub 中) 擷取到叢集的擷取時間，以秒為單位|無|
|EventProcessedForEventHubs|已處理的事件 (針對事件中樞)|Count|總計|從事件中樞擷取時，由叢集處理的事件數目|無|
|IngestionResult|擷取結果|Count|Count|擷取作業數|Status|
|CPU|CPU|百分比|平均值|CPU 使用率等級|無|
| ContinuousExportNumOfRecordsExported | 連續匯出中匯出的記錄數目 | Count | 總計 | 匯出作業期間寫入的每個儲存體成品所匯出的記錄數目  | 無 |
| ExportUtilization | 匯出使用率 | 百分比 | 最大值 | 匯出使用率 | 無 |
| ContinuousExportPendingCount | 連續匯出暫止計數 | Count | 最大值 | 準備好執行的暫止連續匯出作業數 | 無 |
| ContinuousExportMaxLatenessMinutes | 連續匯出最大延遲分鐘數 | Count | 最大值 | 所有連續匯出的最大時間（以分鐘為單位），這些會擱置並準備好執行 | 無 |

## <a name="microsoftlocationbasedservicesaccounts"></a>Microsoft.LocationBasedServices/accounts

|度量|計量顯示名稱|單位|彙總類型|描述|維度|
|---|---|---|---|---|---|
|使用方式|使用方式|Count|Count|API 呼叫的計數|ApiCategory、ApiName|
...
|RunSuccessLatency|執行成功的延遲|秒|平均值|已成功的工作流程執行延遲。|無維度|
|RunThrottledEvents|執行節流的事件|Count|總計|工作流程動作或觸發節流的事件數目。|無維度|
|RunStartThrottledEvents|執行啟動節流事件|Count|總計|工作流程執行開始節流事件的數目。|無維度|
|RunFailurePercentage|執行失敗百分比|百分比|總計|已失敗的工作流程執行百分比。|無維度|
|ActionsStarted|啟動的動作 |Count|總計|已啟動的工作流程動作數目。|無維度|
|ActionsCompleted|完成的動作 |Count|總計|已完成的工作流程動作數目。|無維度|
|ActionsSucceeded|成功的動作 |Count|總計|已成功的工作流程動作數目。|無維度|
...
|度量|計量顯示名稱|單位|彙總類型|描述|維度|
|---|---|---|---|---|---|
|已完成的執行|已完成的執行|Count|總計|已成功完成此工作區的執行數目|案例|
|開始執行|開始執行|Count|總計|此工作區已開始執行的數目|案例|
|失敗的執行|失敗的執行|Count|總計|此工作區的執行失敗次數|案例|

## <a name="microsoftmapsaccounts"></a>Microsoft.Maps/accounts

|度量|計量顯示名稱|單位|彙總類型|描述|維度|
|---|---|---|---|---|---|
|使用方式|使用方式|Count|Count|API 呼叫的計數|ApiCategory、ApiName、ResultType、ResponseCode|
...
|CapacityUnits|目前的容量單位|Count|平均值|耗用的容量單位|無維度|
...
|DeadletteredMessages|佇列/主題中的無效字母訊息計數。 (預覽)|Count|平均值|佇列/主題中的無效字母訊息計數。 (預覽)|EntityName|
|ScheduledMessages|佇列/主題中已排程的訊息計數。 (預覽)|Count|平均值|佇列/主題中已排程的訊息計數。 (預覽)|EntityName|
...
|度量|計量顯示名稱|單位|彙總類型|描述|維度|
|---|---|---|---|---|---|
|AllocatedCpu|AllocatedCpu|Count|平均值|在 millicore 中配置給此容器的 Cpu|ApplicationName、ServiceName、CodePackageName、ServiceReplicaName|
|AllocatedMemory|AllocatedMemory|位元組|平均值|配置給此容器的記憶體（MB）|ApplicationName、ServiceName、CodePackageName、ServiceReplicaName|
|ActualCpu|ActualCpu|Count|平均值|Millicore 中的實際 CPU 使用量|ApplicationName、ServiceName、CodePackageName、ServiceReplicaName|
...
|ApplicationStatus|ApplicationStatus|Count|平均值|Service Fabric 網狀應用程式的狀態|ApplicationName，狀態|
|ServiceStatus|ServiceStatus|Count|平均值|Service Fabric 網狀應用程式中服務的健全狀況狀態|ApplicationName、Status、ServiceName|
|ServiceReplicaStatus|ServiceReplicaStatus|Count|平均值|Service Fabric 網狀應用程式中服務複本的健全狀況狀態|ApplicationName、Status、ServiceName、ServiceReplicaName|
|ContainerStatus|ContainerStatus|Count|平均值|Service Fabric 網狀應用程式中的容器狀態|ApplicationName、ServiceName、CodePackageName、ServiceReplicaName、Status|
|RestartCount|RestartCount|Count|平均值|Service Fabric 網狀應用程式中的容器重新開機計數|ApplicationName、Status、ServiceName、ServiceReplicaName、CodePackageName|

## <a name="microsoftsignalrservicesignalr"></a>Microsoft.SignalRService/SignalR

|度量|計量顯示名稱|單位|彙總類型|描述|維度|
|---|---|---|---|---|---|
|ConnectionCount|連線計數|Count|最大值|使用者連線數量。|Endpoint|
...
|app_cpu_billed|應用程式 CPU 計費|Count|總計|應用程式 CPU 計費。 適用于無伺服器資料庫。|無維度|
...
|cpu_percent|CPU 百分比|百分比|平均值|CPU 百分比|無維度|
|cpu_limit|CPU 限制|Count|平均值|CPU 限制。 適用于以 vCore 為基礎的資料庫。|無維度|
|cpu_used|使用的 CPU|Count|平均值|使用的 CPU。 適用于以 vCore 為基礎的資料庫。|無維度|
|死結|死結|Count|總計|發生. 不適用於資料倉儲。|無維度|
|diff_backup_size_bytes|差異備份儲存體大小|位元組|最大值|累計差異備份儲存體大小。 適用于以 vCore 為基礎的資料庫。 不適用於超大規模資料庫資料庫。|無維度|
|dtu_limit|DTU 限制|Count|平均值|DTU 限制。 適用于以 DTU 為基礎的資料庫。|無維度|
|dtu_consumption_percent|DTU 百分比|百分比|平均值|DTU 百分比。 適用于以 DTU 為基礎的資料庫。|無維度|
|dtu_used|已使用 DTU|Count|平均值|使用的 DTU。 適用于以 DTU 為基礎的資料庫。|無維度|
...
|full_backup_size_bytes|完整備份儲存體大小|位元組|最大值|累計完整備份儲存體大小。 適用于以 vCore 為基礎的資料庫。 不適用於超大規模資料庫資料庫。|無維度|
|local_tempdb_usage_percent|本機 tempdb 百分比|百分比|平均值|本機 tempdb 百分比。 僅適用于資料倉儲。|無維度|
|log_backup_size_bytes|記錄備份儲存體大小|位元組|最大值|累計記錄備份儲存體大小。 適用于以 vCore 為基礎的資料庫。 不適用於超大規模資料庫資料庫。|無維度|
...
|儲存體|使用的資料空間|位元組|最大值|資料庫大小總計。 不適用於資料倉儲。|無維度|
|storage_percent|使用的資料空間百分比|百分比|最大值|資料庫大小百分比。 不適用於資料倉儲或超大規模資料庫資料庫。|無維度|
|tempdb_data_size|Tempdb 資料檔案大小 Kb|Count|最大值|Tempdb 資料檔案大小（Kb）。 不適用於資料倉儲。 針對以 DTU 為基礎的購買模型，使用 vCore 購買模型或 100 DTU 和更新版本的資料庫，將可使用此計量。|無維度|
|tempdb_log_size|Tempdb 記錄檔大小 Kb|Count|最大值|Tempdb 記錄檔大小（Kb）。 不適用於資料倉儲。 針對以 DTU 為基礎的購買模型，使用 vCore 購買模型或 100 DTU 和更新版本的資料庫，將可使用此計量。|無維度|
...
|cpu_limit|CPU 限制|Count|平均值|CPU 限制。 適用于以 vCore 為基礎的彈性集區。|無維度|
|cpu_percent|CPU 百分比|百分比|平均值|CPU 百分比|無維度|
|cpu_used|使用的 CPU|Count|平均值|使用的 CPU。 適用于以 vCore 為基礎的彈性集區。|無維度|
|dtu_consumption_percent|DTU 百分比|百分比|平均值|DTU 百分比。 適用于以 DTU 為基礎的彈性集區。|無維度|
|eDTU_limit|eDTU 限制|Count|平均值|eDTU 限制。 適用于以 DTU 為基礎的彈性集區。|無維度|
|eDTU_used|已使用 eDTU|Count|平均值|使用的 eDTU。 適用于以 DTU 為基礎的彈性集區。|無維度|
...
|storage_used|使用的資料空間|位元組|平均值|已使用儲存體|無維度|
|sqlserver_process_core_percent|SQL Server 處理常式核心百分比|百分比|最大值|此計量是預留位置，此時不會填入。|無維度|
|sqlserver_process_memory_percent|SQL Server 處理常式記憶體百分比|百分比|最大值|此計量是預留位置，此時不會填入。|無維度|
|tempdb_data_size|Tempdb 資料檔案大小 Kb|Count|最大值|Tempdb 資料檔案大小（Kb）。 不適用於資料倉儲。 針對以 DTU 為基礎的購買模型，使用 vCore 購買模型或 100 DTU 和更新版本的資料庫，將可使用此計量。|無維度|
|tempdb_log_size|Tempdb 記錄檔大小 Kb|Count|最大值|Tempdb 記錄檔大小（Kb）。 不適用於資料倉儲。 針對以 DTU 為基礎的購買模型，使用 vCore 購買模型或 100 DTU 和更新版本的資料庫，將可使用此計量。|無維度|
...
|io_bytes_read|IO 位元組讀取|位元組|平均值|IO 位元組讀取|無維度|
...
|Ingress|Ingress|位元組|總計|輸入資料量 (位元組)。 此數目包括從外部用戶端輸入到 Azure 儲存體與 Azure 內的輸入。|GeoType、ApiName、Authentication|
|Egress|Egress|位元組|總計|輸出資料量 (位元組)。 此數目包括從外部用戶端輸出到 Azure 儲存體與 Azure 內的輸出。 因此，此數目未反映可收費的輸出。|GeoType、ApiName、Authentication|
...
|BlobCount|Blob 計數|Count|總計|儲存體帳戶之 Blob 服務中的 Blob 數目。|BlobType|       |BlobCount|Blob 計數|Count|平均值|儲存體帳戶之 Blob 服務中的 Blob 數目。|BlobType，層|
...
|度量|計量顯示名稱|單位|彙總類型|描述|維度|
|---|---|---|---|---|---|
|ServerSyncSessionResult|同步會話結果|Count|平均值|每次伺服器端點成功完成與雲端端點的同步會話時，會將值記錄為1的度量|SyncGroupName、ServerEndpointName、SyncDirection|
...
|錯誤數|執行階段錯誤|Count|總計|執行階段錯誤|LogicalName、PartitionId|
...
* [了解 Azure 監視器中的度量](data-platform.md)
* [建立度量警示](alerts-overview.md)
* [將度量匯出至儲存體、事件中樞或 Log Analytics](resource-logs-overview.md)
