...
|CurrentConnections|連線：目前的連線數|Count|平均值|目前已建立的用戶端連接數目。|ServerResourceType|
...
* [將計量匯出至儲存體、事件中樞或 Log Analytics](../../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md)
