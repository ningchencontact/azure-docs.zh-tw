...
| Azure 監視器診斷記錄檔 | 活動 | [請參閱此處的清單](tutorial-dashboards.md) | <ul><li>**儲存體 Blob 或事件中樞︰**[診斷設定](diagnostic-logs-overview.md#diagnostic-settings)</li></ul> |
