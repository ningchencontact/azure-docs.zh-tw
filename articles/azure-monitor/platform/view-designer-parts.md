...
點選瀏覽會定義當您按一下標頭或檢視中的清單項目時，要採取哪個動作。  這樣會在[記錄搜尋入口網站](../../log-analytics/log-analytics-log-search-portals.md)中開啟查詢，或啟動另一個檢視。
...
* 深入了解[記錄檔搜尋](../../log-analytics/log-analytics-queries.md)以支援在視覺效果組件中查詢。
