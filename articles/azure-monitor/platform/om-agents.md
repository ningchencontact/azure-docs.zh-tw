...
* 從套用到您管理群組的最新更新彙總。 針對 Operations Manager 2012, 源資料夾是`%ProgramFiles%\Microsoft System Center 2012\Operations Manager\Server\Management Packs for Update Rollups` , 而若是 2012 R2, 則`System Center 2012 R2\Operations Manager\Server\Management Packs for Update Rollups`位於。
