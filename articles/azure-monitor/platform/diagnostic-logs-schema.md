...
|Microsoft.ContainerRegistry/registries|ContainerRegistryRepositoryEvents|RepositoryEvent 記錄（預覽）|
|Microsoft.ContainerRegistry/registries|ContainerRegistryLoginEvents|登入事件（預覽）|
