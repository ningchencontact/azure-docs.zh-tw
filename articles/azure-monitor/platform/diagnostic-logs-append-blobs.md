...
Azure 監視器提供一項功能，可讓您將資源診斷資料和活動記錄資料傳送至 Azure 儲存體帳戶、事件中樞命名空間，或 Azure 監視器中的 Log Analytics 工作區。 為解決系統效能問題，用來將記錄資料傳送至 Blob 儲存體的格式將會在 **2018 年 11 月 1 日午夜 12:00 UTC** 變更。 如果您有工具會從 Blob 儲存體讀取資料，便需要更新工具才能了解新的資料格式。
