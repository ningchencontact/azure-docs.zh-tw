...
>
> 如需詳細資訊，請參考[詳細的診斷擴充功能結構描述文件](diagnostics-extension-schema-1dot3.md)。
...
已增加接收器元素以及將診斷資料傳送至 [Application Insights](../../azure-monitor/app/cloudservices.md) 的能力，因此可更容易在應用程式以及系統和基礎結構層級中診斷問題。
