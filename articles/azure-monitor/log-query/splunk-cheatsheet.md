...
Azure 監視器使用 `project-rename` 運算子來重新命名欄位。 `project-rename` 可讓查詢利用為欄位預先建立的任何索引。 Splunk 有 `rename` 運算子可以執行相同的動作。

| |  | |
|:---|:---|:---|
| Splunk | **rename** |  <code>Event.Rule=330009.2<br>&#124; rename Date.Exception as execption</code> |
| Azure Monitor | **專案-重新命名** | <code>Office_Hub_OHubBGTaskError<br>&#124; project-rename exception = Date_Exception</code> |
| | |
...
| Azure Monitor | **排序依據** | <code>Office_Hub_OHubBGTaskError<br>&#124; order by Data_Hresult,  desc</code> |
| | |
