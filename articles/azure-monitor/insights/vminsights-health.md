...
| 作業系統 Available Megabytes Memory | 5 | 10 | < | 2.5 MB | 危急 | Sev1 | Linux | 
| Disk Avg. Disk sec/Read | 5 | 25 | > | 0.05 秒 | 危急 | Sev1 | Linux | 
| Disk Avg. Disk sec/Transfer | 5 | 25 | > | 0.05 秒 | 危急 | Sev1 | Linux | 
| Disk Avg. Disk sec/Write | 5 | 25 | > | 0.05 秒 | 危急 | Sev1 | Linux | 
| 磁片狀態 | 5 | 25 | <> | 1（true） | 危急 | Sev1 | Linux | 
| 作業系統 Total Percent Processor Time | 5 | 10 | >= | 95% | 危急 | Sev1 | Linux | 
| CPU 使用率百分比總計 | 5 | 10 | >= | 95% | 危急 | Sev1 | Windows | 
| 檔案系統錯誤或損毀 | 60 | 60 | <> | 4 | 危急 | Sev1 | Windows | 
| 每次讀取的平均邏輯磁碟秒數 | 1 | 15 | > | 0.04 秒 | 警告 | Sev2 | Windows | 
| 每次傳輸的平均邏輯磁碟秒數 | 1 | 15 | > | 0.04 秒 | 警告 | Sev2 | Windows | 
| 每次邏輯磁片寫入的平均秒數（邏輯磁片） | 1 | 15 | > | 0.04 秒 | 警告 | Sev2 | Windows | 
...
| 可用系統分頁表項目 | 5 | 10 | <= | 5000 | 危急 | Sev1 | Windows | 
| 每秒記憶體分頁數 | 5 | 10 | >= | 5000/秒 | 警告 | Sev1 | Windows | 
| 使用中認可的記憶體百分比 | 5 | 10 | > | 80% | 危急 | Sev1 | Windows | 
| 每次傳輸的平均磁碟秒數 | 1 | 15 | > | 0.04 秒 | 警告 | Sev2 | Windows | 
| 每次磁碟寫入的平均秒數 | 1 | 15 | > | 0.04 秒 | 警告 | Sev2 | Windows | 
...
| |Unknown |因為有數個原因，所以無法計算狀態。 下一節提供其他詳細資料和可能的解決方案。 |
...
* **類型**。 有三種類型的健康情況準則可評估條件，並匯總受監視 VM 的整體健全狀況狀態：
