...
|S.No  |資源名稱  |Azure FarmBeats Component  |
|---------|---------|---------|
|1  |       Azure Cosmos DB   |  資料中樞       |
|2  |    Application Insights      |     Data hub/Accelerator     |
|3  |Azure Cache for Redis   |資料中樞   |
|4  |       Azure 金鑰保存庫    |  Data hub/ Accelerator        |
|5  |    Time Series Insights       |     資料中樞      |
|6 |      EventHub Namespace    |  資料中樞       |
|7  |    Azure Data Factory V2       |     Data hub/ Accelerator      |
|8  |批次帳戶    |資料中樞   |
|9  |       儲存體帳戶     |  Data hub/ Accelerator        |
|10  |    邏輯應用程式        |     資料中樞      |
|11  |    API connection        |     資料中樞      |
|12|      App Service      |  Data hub/Accelerator       |
|13 |    App Service 方案        |     Data hub/ Accelerator      |
|14 |Azure Maps account     |加速器    |
...
移至 https://scihub.copernicus.eu/dhus/#/self-registration 。 In the registration page, provide a first name, last name, username, password, and email.
...
4. First-time users will be prompted to select a subscription to create a storage account and Microsoft Azure Files share. 選取 [建立儲存體]。
...
The steps for upgrade are similar to the first-time installation. 請遵循下列步驟：
...
4. 選取資源群組名稱。 Type in the name again to double-check, and select Delete to remove the resource group, and all its underlying resources.
