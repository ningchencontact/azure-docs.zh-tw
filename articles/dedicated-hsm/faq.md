---
title: Azure 專用硬體安全模組 (HSM) 常見問題集 |Microsoft Docs
...
### <a name="q-what-is-azure-dedicated-hsm-offering"></a>問：Azure 專用硬體安全模組 (HSM) 的供應項目是什麼？
...
## <a name="what-hardware-is-used-for-dedicated-hsm"></a>專用 HSM 使用什麼硬體？
...
### <a name="q-how-do-i-get-access-to-dedicated-hsm-client-software-documentation-firmware-images"></a>問：如何取得專用 HSM 的用戶端軟體、文件、韌體映像？
