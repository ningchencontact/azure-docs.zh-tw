---
title: 移轉 Power BI 工作區集合內容的程式碼片段 | Microsoft Docs
...
ms.locfileid: "31407709"
---
# <a name="code-snippets-for-migrating-content-from-power-bi-workspace-collections"></a>移轉 Power BI 工作區集合內容的程式碼片段

本文提供內容移轉所需之基本作業的一些程式碼片段。 如需特定報表類型的相關流程，請參閱[如何將 Power BI Embedded 工作區集合內容移轉至 Power BI](migrate-from-power-bi-workspace-collections.md#content-migration)。

**移轉工具**可供協助將 Power BI 工作區集合的內容複製到 Power BI Embedded。 當您擁有許多內容時特別有用。 如需詳細資訊，請參閱 [Power BI Embedded 移轉工具](migrate-tool.md)。
...
## <a name="export-report-from-a-power-bi-workspace-collection-workspace"></a>從 Power BI 工作區集合工作區匯出報表
...
## <a name="import-report-to-power-bi-embedded"></a>將報表匯入 Power BI Embedded
...
## <a name="extract-directquery-connection-string-from-power-bi-workspace-collections"></a>從 Power BI 工作區集合擷取 DirectQuery 連接字串

這適用於在移轉至 Power BI Embedded 之後更新 PBIX。
...
## <a name="update-directquery-connection-string-in-power-bi-embedded"></a>在 Power BI Embedded 中更新 DirectQuery 連接字串
...
## <a name="set-directquery-credentials-in-power-bi-embedded"></a>在 Power BI Embedded 中設定 DirectQuery 認證
...
在此程式碼片段中，我們假設可推送的資料集已經位於 Power BI 中的應用程式工作區。 如需推送 API 的相關資訊，請參閱[將資料推送至 Power BI 資料集](https://powerbi.microsoft.com/documentation/powerbi-developer-walkthrough-push-data/)。
