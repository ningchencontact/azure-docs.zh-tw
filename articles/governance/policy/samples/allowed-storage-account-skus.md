---
title: 範例 - 允許的儲存體帳戶 SKU
description: 此原則定義範例會要求儲存體帳戶使用已核准的 SKU。
...
ms.locfileid: "57533302"
---
# <a name="sample---allowed-storage-account-skus"></a>範例 - 允許的儲存體帳戶 SKU

此原則會要求儲存體帳戶使用已核准的 SKU。 您需指定已核准的 SKU 陣列。
