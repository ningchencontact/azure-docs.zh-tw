---
title: 範例 - 針對 VM 網路介面使用已核准的子網路
description: 此原則定義範例會要求網路介面使用已核准的子網路。
...
ms.locfileid: "57541279"
---
# <a name="sample---use-approved-subnet-for-vm-network-interfaces"></a>範例 - 針對 VM 網路介面使用已核准的子網路
