---
title: 範例 - 稽核 DB 層級威脅偵測設定
description: 此原則定義範例會稽核 SQL 資料庫安全性警示原則是否未設定成指定的狀態。
...
ms.locfileid: "57542750"
---
# <a name="sample---audit-db-level-threat-detection-setting"></a>範例 - 稽核 DB 層級威脅偵測設定
