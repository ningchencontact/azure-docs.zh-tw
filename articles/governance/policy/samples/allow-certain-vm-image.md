---
title: 範例 - 只允許特定的 VM 平台映像
description: 此原則定義範例會要求虛擬機器使用特定版本的 UbuntuServer。
...
ms.locfileid: "57539797"
---
# <a name="sample---only-allow-a-certain-vm-platform-image"></a>範例 - 只允許特定的 VM 平台映像
