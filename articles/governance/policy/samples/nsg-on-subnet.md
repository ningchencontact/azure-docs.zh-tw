...
description: 此原則定義範例會要求搭配每個虛擬子網路使用特定的網路安全性群組。
...
ms.locfileid: "57548961"
---
# <a name="sample---network-security-group-x-on-every-subnet"></a>範例 - 每一個子網路上的網路安全性群組 x

此原則會要求搭配每個虛擬子網路使用特定的網路安全性群組。 您需指定要使用之網路安全性群組的識別碼。
