...
安裝來賓設定擴充功能時，' GuestConfiguration ' PowerShell 模組隨附于最新版的 DSC 資源模組。 您可以使用模組頁面[GuestConfiguration/](https://www.powershellgallery.com/packages/GuestConfiguration/)中的 [手動下載] 連結，從 PowerShell 資源庫下載此模組。
