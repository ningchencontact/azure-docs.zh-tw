---
title: NIST SP 800-53 R4 藍圖範例 - 控制項對應
description: NIST SP 800-53 R4 藍圖範例的控制項對應。 每個控制項都會對應至一或多個可協助評量的 Azure 原則。
author: DCtheGeek
ms.author: dacoulte
ms.date: 06/24/2019
ms.topic: sample
...
## <a name="ac-16-security-attributes"></a>AC-16 安全性屬性
