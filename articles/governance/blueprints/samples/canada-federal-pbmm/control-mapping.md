...
此藍圖會指派下列 Azure 原則定義，協助您將所有資源和資源群組的部署位置限制為「加拿大中部」和「加拿大東部」:

- 允許的位置 (已硬式編碼為「加拿大中部」和「加拿大東部」)
- 允許的資源群組位置 (已硬式編碼為「加拿大中部」和「加拿大東部」)
...
## <a name="sc-28-1-protection-of-information-at-rest"></a>SC-28 (1) 待用資訊的保護
