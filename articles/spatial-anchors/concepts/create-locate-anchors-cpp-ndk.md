---
title: 建立並找出錨點使用 Azure 空間的錨點，在 C + + /cli NDK |Microsoft Docs
...
ms.locfileid: "57857380"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-cndk"></a>建立並找出錨點使用 Azure 空間的錨點，在 C + + /cli NDK
...
Azure Spatial Anchors 可讓您在世界各地的不同裝置間共用錨點。 它支援數種開發環境。 在本文中，我們將探討如何在 C + + /cli NDK。
