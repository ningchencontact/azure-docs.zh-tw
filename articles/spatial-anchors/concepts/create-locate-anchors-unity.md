---
title: 建立並找出在 Unity 中使用 Azure 空間的錨點的錨點 |Microsoft Docs
...
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-unity"></a>建立並找出在 Unity 中使用 Azure 空間的錨點的錨點
...
Azure Spatial Anchors 可讓您在世界各地的不同裝置間共用錨點。 它支援數種開發環境。 在本文中，我們將探討如何在 Unity 中的作業。
