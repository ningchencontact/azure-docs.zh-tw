...
- [真實世界中保存虛擬內容](how-tos/create-locate-anchors-unity.md#create-a-cloud-spatial-anchor)。 應用程式可讓使用者在會議室的牆上掛置虛擬日曆，讓其他人可使用手機應用程式或 HoloLens 裝置查看日曆。 在產業設定中，使用者可藉由將支援的裝置相機指向某機器，以接收其相關內容資訊。
