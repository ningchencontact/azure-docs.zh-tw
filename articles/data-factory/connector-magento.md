---
title: 使用 Azure Data Factory (預覽) 複製 Magento 中的資料 | Microsoft Docs
...
如需可用來定義活動的區段和屬性完整清單，請參閱[Pipelines](concepts-pipelines-activities.md)一文。 本節提供 Magento 來源所支援的屬性清單。
