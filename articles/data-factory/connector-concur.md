---
title: "使用 Azure Data Factory 從 Concur 複製資料 (搶鮮版 (Beta)) | Microsoft Docs"
...
---
# <a name="copy-data-from-concur-using-azure-data-factory-beta"></a>使用 Azure Data Factory 從 Concur 複製資料 (搶鮮版 (Beta))
