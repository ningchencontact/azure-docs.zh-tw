...
以簡單的清單檢視介面監視管線和活動回合。 所有回合都會以本機瀏覽器的時區顯示。 您可以變更時區，這會將所有日期時間欄位調整至選取的時區。  
...
## <a name="monitoring-features"></a>監視功能
...
### <a name="addremove-columns-in-list-view"></a>在清單檢視中新增/移除資料行
