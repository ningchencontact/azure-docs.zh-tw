...
| osType                       | 作業系統的類型。 允許的值包括：Linux 和 Windows (僅適用於 HDInsight 3.3)。 預設值為 Linux | 否       |
...
| 屬性               | 描述                              | 必要項                                 |
| ---------------------- | ---------------------------------------- | ---------------------------------------- |
| Type                   | type 屬性應設為：**AzureMLService**。 | 是                                      |
...
| -------------------- | ---------------------------------------- | ---------------------------------------- |
| name                 | 連結服務的名稱               | 是   |
| 型別                 | type 屬性應設為：**AzureDatabricks**。 | 是                                      |
