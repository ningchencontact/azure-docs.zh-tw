---
title: 使用 Azure Data Factory 從 Oracle Eloqua 複製資料 (預覽) | Microsoft Docs
...
| 屬性 | 描述 | 必要項 |
|:--- |:--- |:--- |
| 型別 | 資料集的類型屬性必須設定為：**EloquaObject** | 是 |
...
| 屬性 | 描述 | 必要項 |
|:--- |:--- |:--- |
| 型別 | 複製活動來源的類型屬性必須設定為：**EloquaSource** | 是 |
