...
5. 若要建立資料處理站，執行下列**組 AzDataFactoryV2** cmdlet，並使用 Location 和 ResourceGroupName 屬性從 $ResGrp 變數： 
...
3. 執行**組 AzDataFactoryV2LinkedService** cmdlet 來建立連結的服務：**AzureSqlDatabaseLinkedService**。 
