...
ms.locfileid: "75982657"
---
# <a name="incrementally-load-data-from-an-azure-sql-database-to-azure-blob-storage-using-the-azure-portal"></a>使用 Azure 入口網站以累加方式將資料從 Azure SQL 資料庫載入到 Azure Blob 儲存體
