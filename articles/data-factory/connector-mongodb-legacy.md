...
Integration Runtime 提供內建的 MongoDB 驅動程式，因此從 MongoDB 複製資料時，您不需要手動安裝任何驅動程式。
...
| _id | 客戶名稱 | 發票 | 服務等級 | 評等 |
| --- | --- | --- | --- | --- |
| 1111 |ABC |[{invoice_id:"123", item:"toaster", price:"456", discount:"0.2"}, {invoice_id:"124", item:"oven", price:"1235", discount:"0.2"}] |銀 |[5,6] |
...
| _id | ExampleTable_Invoices_dim1_idx | invoice_id | item | 價格 | 折扣 |
| --- | --- | --- | --- | --- | --- |
