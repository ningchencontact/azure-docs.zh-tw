---
title: 使用 Azure Data Factory 從 Microsoft Access 來源複製資料
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | Type 屬性必須設定為： **MicrosoftAccess** | 是 |
...
| 認證 | 以驅動程式特定「屬性-值」格式指定之連接字串的存取認證部分。 請將此欄位標示為 SecureString。 | 否 |
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 資料集的類型屬性必須設定為： **MicrosoftAccessTable** | 是 |
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 複製活動來源的類型屬性必須設定為： **MicrosoftAccessSource** | 是 |
