...
| 屬性   | 說明                                                  | 必要項 |
| ---------- | ------------------------------------------------------------ | -------- |
| type       | Dataset 中 `location` 下的 type 屬性必須設定為**SftpLocation**。 | 是      |
...
| 屬性                 | 說明                                                  | 必要項                                      |
| ------------------------ | ------------------------------------------------------------ | --------------------------------------------- |
| type                     | `storeSettings` 下的 type 屬性必須設定為**SftpReadSetting**。 | 是                                           |
...
以下是以格式為基礎之複製接收中 `storeSettings` 設定下的 SFTP 支援的屬性：

| 屬性                 | 說明                                                  | 必要項 |
| ------------------------ | ------------------------------------------------------------ | -------- |
| type                     | `storeSettings` 下的 type 屬性必須設定為**SftpWriteSetting**。 | 是      |
