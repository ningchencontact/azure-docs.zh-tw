...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | Type 屬性必須設定為：**PayPal** | 是 |
| 主機 | PayPal 執行個體的 URL。 (也就是 api.sandbox.paypal.com)  | 是 |
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 資料集的類型屬性必須設定為： **PayPalObject** | 是 |
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 複製活動來源的 type 屬性必須設定為：**PayPalSource** | 是 |
