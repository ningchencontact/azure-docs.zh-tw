---
title: 使用 Azure Data Factory 從 Oracle Service Cloud 複製資料 (預覽)
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 類型屬性必須設定為：**OracleServiceCloud** | 是 |
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 資料集的類型屬性必須設定為： **OracleServiceCloudObject** | 是 |
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 複製活動來源的類型屬性必須設定為：**OracleServiceCloudSource** | 是 |
