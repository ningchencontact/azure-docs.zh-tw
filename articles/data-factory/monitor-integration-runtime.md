...
本節提供 Get AzDataFactoryV2IntegrationRuntime cmdlet 所傳回的屬性的描述。 
...
使用**Get AzDataFactoryV2IntegrationRuntimeMetric** cmdlet 來擷取包含詳細的 JSON 承載自我裝載整合執行階段屬性，和其快照集指令程式執行期間的值。
