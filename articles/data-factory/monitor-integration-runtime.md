...
| 可用記憶體 | 自我裝載整合執行階段節點上的可用記憶體。 這個值是近乎即時的快照集。 | 
...
| 整體狀態 | Description | 
| -------------- | ----------- | 
| 初始 | 您的 Azure SSIS 整合執行階段的節點尚未配置/備妥。 | 
