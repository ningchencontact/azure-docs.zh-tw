---
title: 使用 Azure Data Factory 從 Amazon Simple Storage Service （S3）複製資料
...
下列屬性支援以格式為基礎之資料集的 `location` 設定下的 Amazon S3：
...
在以格式為基礎的複製來源中，`storeSettings` 設定下的 Amazon S3 支援下列屬性：
