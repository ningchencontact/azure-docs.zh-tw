...
- 在 Integration Runtime 電腦上安裝 [PostgreSQL 的 Ngpsql 資料提供者](http://go.microsoft.com/fwlink/?linkid=282716)，版本為 2.0.12 和 3.1.9 之間的版本。
...
| username | 指定連線到 PostgreSQL 資料庫時所要使用的使用者名稱。 |yes |
