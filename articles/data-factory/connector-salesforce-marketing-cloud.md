---
title: 使用 Azure Data Factory 從 Salesforce Marketing Cloud 複製資料 | Microsoft Docs
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 類型屬性必須設為：**SalesforceMarketingCloud** | 是 |
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 資料集的類型屬性必須設定為： **SalesforceMarketingCloudObject** | 是 |
...
| 屬性 | 說明 | 必要 |
|:--- |:--- |:--- |
| 類型 | 複製活動來源的類型屬性必須設定為：**SalesforceMarketingCloudSource** | 是 |
