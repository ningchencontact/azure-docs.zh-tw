...
目前，在 Log Analytics 中只能使用已儲存的搜尋來建立警示。  如需詳細資訊，請參閱 [記錄檔搜尋 REST API](log-analytics-queries.md) 。
...
* 在 Log Analytics 中使用 [REST API 執行記錄檔搜尋](log-analytics-queries.md) 。
