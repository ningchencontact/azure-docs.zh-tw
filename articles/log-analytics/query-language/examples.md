...
ms.locfileid: "49070944"
---
# <a name="log-analytics-query-examples"></a>Log Analytics 查詢範例
本文包含多個[查詢](../log-analytics-queries.md)使用 [Kusto 語言](https://docs.microsoft.com/azure/kusto/query/)從 Log Analytics 擷取不同資料類型的範例。 您可以透過方法來合併和分析資料，以使用這些範例識別用於您的要求的不同策略。  
