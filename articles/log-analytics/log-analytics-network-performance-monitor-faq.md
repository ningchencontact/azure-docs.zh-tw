...
效能監控和服務連線能力監視的功能可支援[以直接代理程式連線](../azure-monitor/platform/agent-windows.md)的節點，也可[透過 Operations Manager 連線](log-analytics-om-agents.md)節點。
