...
description: 了解如何在 Azure 入口網站中為您的 Log Analytics 工作區變更定價方案及管理資料量和保留原則。
...
---
# <a name="manage-cost-by-controlling-data-volume-and-retention-with-your-log-analytics-workspace"></a>藉由控制您 Log Analytics 工作區的資料量和保留期來管理成本
