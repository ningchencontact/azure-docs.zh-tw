...
![篩選範例](media/log-analytics-view-designer-filters/filters-example-time.png)

按一下 **+** 以使用為檢視定義的自訂篩選器來新增篩選條件。 從下拉式清單中選取篩選條件的值或輸入一個值。 按一下 **+**，繼續新增篩選條件。 


![篩選範例](media/log-analytics-view-designer-filters/filters-example-custom.png)
...
![篩選設定](media/log-analytics-view-designer-filters/filters-settings.png)
