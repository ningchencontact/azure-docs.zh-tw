...
## [無伺服器](https://docs.microsoft.com/azure/azure-functions/functions-create-first-azure-function)
## 微服務
...
### [容器服務](https://docs.microsoft.com/azure/container-service/dcos-swarm/container-service-deployment) 
...
## [什麼是 App Service？](https://docs.microsoft.com/azure/app-service/app-service-web-overview)
## 虛擬機器
...
## [Service Fabric 概觀](https://docs.microsoft.com/azure/service-fabric/service-fabric-overview)

# 使用說明指南
## 規劃
### [Web 應用程式架構](https://docs.microsoft.com/azure/architecture/reference-architectures/managed-web-app/)
### [VM 架構](https://docs.microsoft.com/azure/architecture/reference-architectures/virtual-machines-windows/)
### [連線到內部部署網路](https://docs.microsoft.com/azure/architecture/reference-architectures/hybrid-networking/)
### [微服務模式/案例](https://docs.microsoft.com/azure/service-fabric/service-fabric-patterns-and-scenarios)
## 開發
...
## 調整
### [Web 和行動裝置應用程式](https://docs.microsoft.com/azure/app-service/web-sites-scale)
### [虛擬機器](https://docs.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-overview)
### [微服務應用程式](https://docs.microsoft.com/azure/service-fabric/service-fabric-concepts-scalability)
...
### [帳單警示](https://docs.microsoft.com/azure/billing/billing-set-up-alerts)

## 自動化
### [調整 Linux VM](https://docs.microsoft.com/azure/virtual-machines/linux/tutorial-create-vmss)
### [調整 Windows VM](https://docs.microsoft.com/azure/virtual-machines/windows/tutorial-create-vmss)
