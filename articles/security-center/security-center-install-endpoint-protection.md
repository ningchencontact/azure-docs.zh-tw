...
1. 選取 **計算及應用程式**下方 資訊安全中心主功能表或**概觀**。
...
2. 在 [計算]  下，選取 [端點保護問題]  。 [端點保護問題]  儀表板隨即開啟。
   ...
   - 受到攻擊的電腦 – 顯示 Vm 和，資訊安全中心時，會受到惡意程式碼報告攻擊的電腦的數目。
...
2. 在 [非 Azure 電腦上未安裝端點保護]  下，選取工作區。 該工作區篩選的 Azure 監視器的記錄檔搜尋查詢會開啟，並列出遺漏反惡意程式碼的電腦。 從清單中選取電腦以了解更多資訊。
