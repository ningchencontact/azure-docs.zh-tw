---
title: 在 Azure 資訊安全中心中保護您的機器和應用程式
...
如需計算和應用程式服務建議的完整清單，請參閱[建議](security-center-virtual-machine-protection.md#compute-and-app-recs)。
