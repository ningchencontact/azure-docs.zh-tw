...
2. 按一下 [監視] 選項來開啟 [監視] 頁面。 此頁面會將您所有的監視設定和資料結合成一個彙總檢視。 它會先開啟 [活動記錄檔]  區段。
...
13. 按一下 [新增度量警示]  建立警示。
    ...
    Azure 監視器現在也有[**近乎即時計量警示**](https://aka.ms/azuremonitor/near-real-time-alerts) (預覽)，能以極高的頻率 (小至 1 分鐘) 進行評估。
