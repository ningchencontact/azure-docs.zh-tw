...
|計量|計量顯示名稱|單位|彙總類型|說明|維度|
|---|---|---|---|---|---|
|TotalJob|工作總數|Count|總計|工作總數|RunbookName、Status|
...
|計量|計量顯示名稱|單位|彙總類型|說明|維度|
|---|---|---|---|---|---|
|SuccessfulRuns|成功的執行|Count|總計|成功的執行次數。|無維度|
|FailedRuns|失敗的執行|Count|總計|失敗的執行次數。|無維度|

## <a name="microsoftdatafactoryfactories"></a>Microsoft.DataFactory/factories

|計量|計量顯示名稱|單位|彙總類型|說明|維度|
|---|---|---|---|---|---|
|PipelineFailedRuns|失敗的管線執行計量|Count|總計||無維度|
|PipelineSucceededRuns|成功的管線執行計量|Count|總計||無維度|
|ActivityFailedRuns|失敗的活動執行計量|Count|總計||無維度|
|ActivitySucceededRuns|成功的活動執行計量|Count|總計||無維度|
|TriggerFailedRuns|失敗的觸發程序執行計量|Count|總計||無維度|
|TriggerSucceededRuns|成功的觸發程序執行計量|Count|總計||無維度|
...
|計量|計量顯示名稱|單位|彙總類型|說明|維度|
|---|---|---|---|---|---|
|elasticPool.requestedUsageRate|要求的使用率|百分比|平均值|要求的使用率|無維度|

## <a name="microsoftdeviceselasticpoolsiothubtenants"></a>Microsoft.Devices/ElasticPools/IotHubTenants

|計量|計量顯示名稱|單位|彙總類型|說明|維度|
|---|---|---|---|---|---|
|tenantHub.requestedUsageRate|要求的使用率|百分比|平均值|要求的使用率|無維度|
|deviceDataUsage|裝置資料使用量總計|Count|總計|傳輸至任何已連線至 IotHub 之裝置或從該裝置傳出的位元組數|無維度|
|d2c.telemetry.ingress.allProtocol|遙測訊息傳送嘗試|Count|總計|要嘗試傳送至您 IoT 中樞的裝置到雲端遙測訊息數目|無維度|
|d2c.telemetry.ingress.success|已傳送的遙測訊息|Count|總計|成功傳送至您 IoT 中樞的裝置到雲端遙測訊息數目|無維度|
|c2d.commands.egress.complete.success|完成的命令|Count|總計|裝置成功完成的雲端到裝置命令數目|無維度|
...
|計量|計量顯示名稱|單位|彙總類型|說明|維度|
|---|---|---|---|---|---|
|MetadataRequests|中繼資料要求|Count|Count|中繼資料要求計數。 Cosmos DB 會維護每個帳戶的系統中繼資料集合，可讓您免費列舉集合、資料庫等及其設定。|GlobalDatabaseAccountName、DatabaseName、CollectionName、Region、StatusCode|
|MongoRequestCharge|Mongo 要求收費|Count|總計|已使用的 Mongo 要求單位|GlobalDatabaseAccountName、DatabaseName、CollectionName、Region、CommandName、ErrorCode|
|MongoRequests|Mongo 要求|Count|Count|已提出的 Mongo 要求數目|GlobalDatabaseAccountName、DatabaseName、CollectionName、Region、CommandName、ErrorCode|
|TotalRequestUnits|要求單位總計|Count|總計|已使用的要求單位|GlobalDatabaseAccountName、DatabaseName、CollectionName、Region、StatusCode|
|TotalRequests|要求總數|Count|Count|進行的要求數目|GlobalDatabaseAccountName、DatabaseName、CollectionName、Region、StatusCode|
...
|ActiveConnections|ActiveConnections (預覽)|Count|總計|Microsoft.EventHub 的使用中連線總數。 (預覽)|EntityName|
|ConnectionsOpened|已開啟的連線。 (預覽)|Count|總計|Microsoft.EventHub 的已開啟連線。 (預覽)|EntityName|
|ConnectionsClosed|已關閉的連線。 (預覽)|Count|總計|Microsoft.EventHub 的已關閉連線。 (預覽)|EntityName|
...
|ActiveConnections|ActiveConnections (預覽)|Count|總計|Microsoft.ServiceBus 的使用中連線總數。 (預覽)|EntityName|
|ConnectionsOpened|已開啟的連線。 (預覽)|Count|總計|Microsoft.ServiceBus 的已開啟連線。 (預覽)|EntityName|
|ConnectionsClosed|已關閉的連線。 (預覽)|Count|總計|Microsoft.ServiceBus 的已關閉連線。 (預覽)|EntityName|
