---
title: 針對 Azure 活動記錄警示呼叫 Webhook (傳統)
...
* **權杖型授權**。 儲存的 Webhook URI 含有權杖識別碼。 例如：`https://mysamplealert/webcallback?tokenid=sometokenid&someparameter=somevalue`
