...
ms.locfileid: "45579084"
---
# <a name="supported-resources-for-newer-azure-monitor-metric-alerts"></a>新版 Azure 監視器計量警示所支援的資源
...
|Microsoft.OperationalInsights/workspaces (預覽) | 是|[Log Analytics 工作區](monitoring-supported-metrics.md#microsoftoperationalinsightsworkspaces)|
