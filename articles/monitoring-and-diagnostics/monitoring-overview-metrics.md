...
* 所有計量皆有**一分鐘頻率** (除非在計量定義中另有指定)。 您每分鐘會從您的資源收到度量值，讓您可幾乎即時地看到資源的狀態和健全狀況。
...
> [!NOTE]
> 本文章透過 Azure 資源的 [新度量 API](https://docs.microsoft.com/rest/api/monitor/) 涵蓋度量。 新計量定義和計量 API 的 API 版本為 2018-01-01。 可以使用 API 版本 2014-04-01 存取舊版的度量定義和度量。
>
>
