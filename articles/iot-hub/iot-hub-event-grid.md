...
| Microsoft.Devices.DeviceTelemetry | 在裝置遙測訊息傳送至 IoT 中樞時發佈 |
...
* [瞭解如何使用 IoT 遙測事件來執行使用 Azure 地圖服務 (和 IoT 中樞訊息路由) 的 IoT 空間分析](../azure-maps/tutorial-iot-hub-maps.md#filter-events-using-iot-hub-message-routing)
