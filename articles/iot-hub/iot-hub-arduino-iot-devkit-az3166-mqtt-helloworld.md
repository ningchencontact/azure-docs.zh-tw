...
3. 將 DevKit 連接到您的電腦。
    VS Code 會自動偵測您的 DevKit，並開啟下列頁面：
    * DevKit 簡介頁面。
...
> [!NOTE]
> 您可能會收到「錯誤：AZ3166：未知的套件」錯誤訊息。 未正確重新整理面板套件索引時，就會發生此錯誤。 若要解決此錯誤，請參閱此[常見問題集](https://microsoft.github.io/azure-iot-developer-kit/docs/faq/#development)。
...
* [將 IoT DevKit AZ3166 連線到雲端中的 Azure IoT 中樞]({{"/docs/getting-started/" | absolute_url }})
* [搖一搖以獲取推文]({{"/docs/projects/shake-shake/" | absolute_url }})
