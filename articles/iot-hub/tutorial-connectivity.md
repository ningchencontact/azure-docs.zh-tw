...
您在本教學課程中執行的 CLI 指令碼會使用 [Azure CLI 2.0 的 Microsoft Azure IoT 擴充功能](https://github.com/Azure/azure-iot-cli-extension/blob/master/README.md)。 若要安裝此擴充功能，請執行下列 CLI 命令：
