---
title: 開始使用/Azure IoT 中樞模組識別 & 模組對應項（.NET）
...
1. 在 Visual Studio 中 **，選取 [** 檔案 > **新增** > **專案**]，將新專案新增至方案。 在 [建立新專案] 中，選取 [**主控台應用程式（.NET Framework）** ]，然後選取 **[下一步]** 。
...
1. 在 Visual Studio 中，開啟 [**工具**] [ > **nuget 套件管理員**] > [**管理解決方案的 nuget 套件**]。 選取 [瀏覽] 索引標籤。
