...
1. 如何從您的裝置使用 .NET 裝置 SDK 更新模組對應項。
...
登入 [Azure 入口網站][lnk-portal]。 瀏覽至您的 IoT 中樞並按一下 IoT 裝置。 尋找 myFirstDevice 並加以開啟，您會看到已成功建立 myFirstModule。 複製模組連接字串。 在下一個步驟中需要用到它。
