...
> [!NOTE]
> 為了簡單起見，本教學課程不會實作任何重試原則。 在生產環境程式碼中，您應該如 MSDN 文章 [暫時性錯誤處理](https://msdn.microsoft.com/library/hh680901(v=pandp.50).aspx)所建議，實作重試原則 (例如指數型輪詢)。
> 
