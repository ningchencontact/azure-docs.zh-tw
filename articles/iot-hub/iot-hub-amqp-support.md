...
ms.locfileid: "67432604"
---
# <a name="communicate-with-your-iot-hub-by-using-the-amqp-protocol"></a>使用 AMQP 通訊協定與 IoT 中樞通訊

Azure IoT 中樞支援[OASIS 進階訊息佇列通訊協定 (AMQP) 1.0 版](https://docs.oasis-open.org/amqp/core/v1.0/os/amqp-core-complete-v1.0-os.pdf)來提供各種由透過面向裝置和服務面向端點的功能。 本文件說明 AMQP 用戶端連線至 IoT 中樞，以使用 IoT 中樞功能的使用。
...
若要深入了解 AMQP 通訊協定，請參閱[AMQP v1.0 規格](https://www.amqp.org/sites/amqp.org/files/amqp.pdf)。
