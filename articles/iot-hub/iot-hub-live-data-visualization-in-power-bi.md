...
您可了解如何藉由使用 Power BI 將 Azure IoT 中樞收到的即時感應器資料視覺化。 如果您想要嘗試 toe 視覺化您的 IoT 中樞與 web 應用程式中的資料，請參閱[使用 web 應用程式的 Azure IoT 中樞的即時感應器資料視覺化](iot-hub-live-data-visualization-in-web-apps.md)。
