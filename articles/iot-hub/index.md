        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>程式碼範例</h3>
                        <p><a href="https://azure.microsoft.com/resources/samples/?service=iot-hub">程式碼範例</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/javascript/api/azure-iot-device/?view=azure-iot-typescript-latest">Node.js (裝置)</a></p>
                        <p><a href="/javascript/api/azure-iothub/?view=azure-iot-typescript-latest">Node.js (服務)</a></p>
                    </div>
                </div>
            </div>
        </div>
