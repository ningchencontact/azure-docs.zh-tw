...
| 現場服務工程師 (僅限 StorSimple 8000 系列) <sup>3</sup>                                         | 無法使用                                                                   | 4 小時內                                                                 |
| StorSimple 虛擬陣列 <sup>5</sup>                                                                              | ✓                                                                               | ✓                                                                              |
| StorSimple 虛擬陣列 <sup>5</sup> 的執行個體                                                                 | 無限制                                                                        | 無限制                                                                       |
...
除了英文以外，當地語言支援會在上班時間提供下列語言：西班牙文、葡萄牙文、日文、韓文、繁體中文和繁體中文。

## <a name="support-scope"></a>支援範圍 
所有支援層均提供帳單及訂用帳戶管理相關的問題支援服務。 客戶若想取得 StorSimple 支援，必須主動註冊 StorSimple 標準版或進階版支援方案。 StorSimple 支援小組將負責解決影響 StorSimple 解決方案的所有問題。 客戶若想取得與 StorSimple 沒有直接關係的 Azure 相關問題支援，需註冊適當的 Azure 支援方案。 請參閱[此處](https://azure.microsoft.com/support/plans/)了解詳細資訊。 支援小組根據 Azure 支援的客戶權利，將非 StorSimple 支援案例提交給 Azure 團隊進行後續追蹤。 


| **嚴重性** |**客戶的狀況**                                                                                                                                | 預期的 MICROSOFT 回應 <sup>2                                                                                       | 預期的客戶回應                                                                                                                                                       |
|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A        | 嚴重影響業務： <ul> <br> <li> 客戶蒙受重大業務損失或服務效能降低。 <sup>1</sup> <br> <li> 需要立即獲得協助。                          | 初步回應：<sup>1</sup> <ul><br> <li>對於進階版，1 小時或 1 小時以內。 <br> <li> 對於標準版，2 小時或 2 小時以內。 <br> <li> 每天提供全天候持續協助。 | <ul><li> 每天配置適當資源以勝任全天候持續性協助工作。 <br> <li> 正確的案主連絡資訊。                                                |
| B        | 中度影響業務： <ul><br> <li> 客戶蒙受中等業務損失或服務效能降低，但仍能在受損情況下適度繼續工作。 | 初步回應：<sup>1</sup><ul><br> <li> 對於進階版，2 小時或 2 小時以內。 <br> <li> 對於標準版，4 小時或 4 小時以內。                                      | <ul><li> 配置適當資源以勝任營業時間的持續性協助工作，直到客戶要求終止全年無休的協助工作為止。 <br> <li> 正確的案主連絡資訊。 |
| C        | 輕度影響業務： <ul><br> <li> 客戶的業務大體上可以運作，僅對服務造成些微妨礙或是不造成妨礙。                                 | 初步回應：<sup>1</sup><ul> <br> <li> 對於進階版，4 小時以內。 <br> <li> 對於標準版，8 小時以內。                                      | <ul><li>正確的案主連絡資訊                                                                                                                                    |
...
*<text> * Premium 涵蓋範圍不適用於所有位置。在購買 StorSimple Premium 支援之前，請先洽詢 Microsoft at SSSupOps\@microsoft.com，以取得地理涵蓋範圍。*
