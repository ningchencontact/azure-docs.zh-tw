...
| 線上支援入口網站存取                                                                            | ✓                                                                               | ✓                                                                              |
| 警示佈建和管理                                                                       | ✓                                                                               | ✓                                                                              |
| 技術支援中心初始回應時間全天候支援票證提交 <br> 根據嚴重性的初始回應時間 <sup>2 | 嚴重性 A:2小時內 <br> 嚴重性 B:4 小時內 <br> 嚴重性 C:8小時內 | 嚴重性 A:60分鐘內 <br> 嚴重性 B:2小時內 <br> 嚴重性 C:4 小時內 |
| 電話支援 (回撥電話)                                                                               | ✓                                                                               | ✓                                                                              |
| 進階組件更換 (僅限 StorSimple 8000 系列) <sup>3</sup>                                              | 下一個工作天 <sup>4                                                              | 4 小時內                                                                 |
| 現場服務工程師 (僅限 StorSimple 8000 系列) <sup>3</sup>                                         | 無                                                                   | 4 小時內                                                                 |
...
* 嚴重性 B:仲裁遺失或效能降低, 但工作可以以受損的方式繼續進行


* 嚴重性 C:大幅配合系統功能的輕微或無阻礙運作
...
除了英文以外, 當地語言支援也會在上班時間提供下列語言:西班牙文、葡萄牙文、日文、韓文、繁體中文和繁體中文。
...
|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A        | 嚴重業務影響： <ul> <br> <li> 客戶蒙受重大業務損失或服務效能降低。 <sup>1</sup> <br> <li> 需要立即獲得協助。                          | 初始回應:<sup>1</sup> <ul><br> <li>對於進階版，1 小時或 1 小時以內。 <br> <li> 對於標準版，2 小時或 2 小時以內。 <br> <li> 每天提供全天候持續協助。 | <ul><li> 每天配置適當資源以勝任全天候持續性協助工作。 <br> <li> 正確的案主連絡資訊。                                                |
| B        | 中度業務影響： <ul><br> <li> 客戶蒙受中等業務損失或服務效能降低，但仍能在受損情況下適度繼續工作。 | 初始回應:<sup>1</sup><ul><br> <li> 對於進階版，2 小時或 2 小時以內。 <br> <li> 對於標準版，4 小時或 4 小時以內。                                      | <ul><li> 配置適當資源以勝任營業時間的持續性協助工作，直到客戶要求終止全年無休的協助工作為止。 <br> <li> 正確的案主連絡資訊。 |
| C        | 輕度業務影響： <ul><br> <li> 客戶的業務大體上可以運作，僅對服務造成些微妨礙或是不造成妨礙。                                 | 初始回應:<sup>1</sup><ul> <br> <li> 對於進階版，4 小時以內。 <br> <li> 對於標準版，8 小時以內。                                      | <ul><li>正確的案主連絡資訊                                                                                                                                    |
 
<sup>1 </sup> 如果客戶無法提供適當的資源或回應，導致 Microsoft 無法持續進行問題排除工作，Microsoft 可能會降低嚴重性 A 案例的嚴重性層級。

<sup>2</sup>預期的回應時間是以英文的全天候支援為依據, 嚴重性 a 和當地上班時間, 適用于嚴重性 B 和 C, 而當地上班時間支援剩餘的當地語言:日文、繁體中文、繁體中文和韓文。
...
*<text> * 進階版涵蓋範圍並非在所有地區皆適用。購買 StorSimple Premium 支援\@之前, 請先洽詢 Microsoft at SSSupOps microsoft.com, 以取得地理涵蓋範圍。*
