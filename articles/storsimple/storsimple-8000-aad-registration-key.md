---
title: 在 Azure 中使用 StorSimple 8000 Device Manager 服務的新驗證
...
| Update 5 或更新版本，且裝置已上線。| 不需執行任何動作。                                       |
...
1. 在**StorSimple Device Manager**中，移至 [**管理] &gt;** [**金鑰**]。 您也可以使用搜尋列搜尋_金鑰_。
