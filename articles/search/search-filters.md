...
下列範例說明適用於篩選條件案例的數個設計模式。 如需更多概念，請參閱 [OData 運算式語法 > 範例](https://docs.microsoft.com/rest/api/searchservice/odata-expression-syntax-for-azure-search#filter-examples) \(英文\) 。
