---
title: 使用搜尋服務 REST API 以程式碼上傳資料 - Azure 搜尋服務
description: 了解如何使用 HTTP 要求與 REST API，將資料上傳至 Azure 搜尋服務中全文檢索的可搜尋索引。
author: brjohnstmsft
manager: jlembicz
ms.author: brjohnst
services: search
