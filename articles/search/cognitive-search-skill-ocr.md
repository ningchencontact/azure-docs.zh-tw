...
description: 在 Azure 認知搜尋的擴充管線中，使用光學字元辨識（OCR）從影像檔案解壓縮文字。
manager: nitinme
author: luiscabrer
ms.author: luisca
...
ms.locfileid: "72791932"
---
# <a name="ocr-cognitive-skill"></a>OCR 認知技能

**光學字元辨識（OCR）** 技能可識別影像檔案中的列印和手寫文字。 這項技能會使用認知服務中[電腦視覺](https://docs.microsoft.com/azure/cognitive-services/computer-vision/home)所提供的機器學習模型。 **OCR** 技能對應至下列功能：
