...
1. 繼續進行下一個步驟,**新增擴充**。 如需入口網站中可用技能的描述, 請[參閱步驟 2:在認知搜尋](cognitive-search-quickstart-blob.md#create-the-enrichment-pipeline)快速入門中新增認知技能。
...
1. 展開 [**新增擴充**] 區段, 以選取您想要在資料上執行的特定認知技能。 完成嚮導的其餘部分。 如需入口網站中可用技能的描述, 請[參閱步驟 2:在認知搜尋](cognitive-search-quickstart-blob.md#create-the-enrichment-pipeline)快速入門中新增認知技能。
