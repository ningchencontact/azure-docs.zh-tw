...
2. **增加搜尋服務層︰** Azure 搜尋服務來自[層數](https://azure.microsoft.com/pricing/details/search/)，而這其中的每一層都會提供不同等級的效能。  在某些情況下，您可能會有這麼多查詢，因為您所在的階層無法提供足夠的低延遲速率，即使是在超量而複本時也一樣。在此情況下，您可能會想要考慮使用其中一個較高的搜尋層，例如 Azure 搜尋服務 S3 層，其適用于具有大量檔的案例，以及非常高的查詢工作負載。
