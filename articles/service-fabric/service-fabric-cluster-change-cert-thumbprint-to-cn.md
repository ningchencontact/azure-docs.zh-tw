...
如需其他資訊[，請參閱部署使用憑證一般名稱的 Service Fabric 叢集，而不是指紋。](https://docs.microsoft.com/azure/service-fabric/service-fabric-create-cluster-using-cert-cn)
