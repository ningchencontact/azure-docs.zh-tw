...
目前的版本如下︰
* Service Fabric SDK 和 Tools 3.1.274
* Service Fabric 執行階段 6.2.274
* Service Fabric Tools for Visual Studio 2015 2.1.20180510.2
* Visual Studio 2017 15.7 包含 Service Fabric Tools for Visual Studio 2.1.20180423.1 
