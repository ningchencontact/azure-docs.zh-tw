...
然後，您可以執行其他的 PowerShell 命令以使用此叢集。 例如，您可以執行 [Get-ServiceFabricNode](/powershell/module/servicefabric/get-servicefabricnode.md?view=azureservicefabricps) 以顯示此安全叢集上的節點清單。
