...
1) 使用[get-azresource](https://docs.microsoft.com/powershell/module/az.resources/get-azresource?view=azps-2.5.0)取得應用程式的資源識別碼：

    ```powershell
    Get-AzResource  -Name <String> | f1
    ```

2) 使用[get-azresource](https://docs.microsoft.com/powershell/module/az.resources/remove-azresource?view=azps-2.5.0)刪除應用程式資源：
