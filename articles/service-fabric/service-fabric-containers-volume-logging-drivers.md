...
> [!NOTE]
> 6.4.571.9494 版的 Azure 檔案服務磁碟區外掛程式為預覽版，只在此文件中提供。 因為是預覽版本，此版本並**不**支援在生產環境中使用。
>
