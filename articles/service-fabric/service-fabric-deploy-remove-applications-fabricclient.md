...
問題:[CopyApplicationPackage](/dotnet/api/system.fabric.fabricclient.applicationmanagementclient.copyapplicationpackage)適用于大型應用程式套件的 API 時間 (以 GB 為單位)。
請嘗試︰
...
問題:上傳封裝已順利完成, 但[ProvisionApplicationAsync](/dotnet/api/system.fabric.fabricclient.applicationmanagementclient.provisionapplicationasync) API 超時。請嘗試︰
...
問題:應用程式封裝的[ProvisionApplicationAsync](/dotnet/api/system.fabric.fabricclient.applicationmanagementclient.provisionapplicationasync)時間有許多檔案 (順序為千位)。
請嘗試︰
