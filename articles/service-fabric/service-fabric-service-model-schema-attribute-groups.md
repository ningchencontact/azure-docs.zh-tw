...
所參考服務資訊清單的名稱。 此名稱必須符合服務資訊清單的 ServiceManifest 元素中宣告的名稱。
...
所參考服務資訊清單的版本。 此版本必須符合服務資訊清單中宣告的版本。
