---
title: Azure Service Fabric 服務模型 XML 架構描述
description: 描述 Service Fabric 服務模型的 XML 架構，包括位置和元件的摘要。
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639185"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>服務模型 XML 結構描述文件
本文記載了隨 Service Fabric SDK 一起安裝的 ServiceFabricServiceModel.xsd 結構描述檔案。  根據預設，結構描述檔案會安裝到 C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd。

## <a name="namespace-bindings"></a>命名空間繫結

|首碼|命名空間 URI|
|---|---|
|xs|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>元件摘要 
以下元件會於 ServiceFabricServiceModel.xsd 中定義：
- [257 個元素](service-fabric-service-model-schema-elements.md)
- [112 個 complexTypes](service-fabric-service-model-schema-complex-types.md)
- [1 個 simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [3 個元素群組](service-fabric-service-model-schema-element-groups.md)
- [16 個屬性群組](service-fabric-service-model-schema-attribute-groups.md)
