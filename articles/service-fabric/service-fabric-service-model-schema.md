...
下列元件會定義於 ServiceFabricServiceModel.xsd 的 http://schemas.microsoft.com/2011/01/fabric 命名空間中：
- [244 個元素](service-fabric-service-model-schema-elements.md)
- [103 個 complexTypes](service-fabric-service-model-schema-complex-types.md)
