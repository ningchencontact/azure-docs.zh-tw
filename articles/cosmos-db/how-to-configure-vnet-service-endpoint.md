...
>   * 如果您的虛擬網路和 Azure Cosmos DB 帳戶位於不同訂用帳戶，請確定具有虛擬網路的訂用帳戶也有`Microsoft.DocumentDB`註冊資源提供者。 若要註冊資源提供者，請參閱[Azure 資源提供者和類型](../azure-resource-manager/resource-manager-supported-services.md)文章。 
