---
title: 建立 Azure Cosmos DB 的資料表 API 資料表
description: 建立 Azure Cosmos DB 的資料表 API 資料表
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "71275005"
---
# <a name="create-an-azure-cosmos-table-api-account-and-table-using-azure-cli"></a>使用 Azure CLI 建立 Azure Cosmos 資料表 API 帳戶和資料表
