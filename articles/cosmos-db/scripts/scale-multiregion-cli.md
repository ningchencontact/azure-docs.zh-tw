...
ms.locfileid: "69614756"
---
# <a name="replicate-an-azure-cosmos-database-account-in-multiple-regions-and-configure-failover-priorities-using-the-azure-cli"></a>使用 Azure CLI 複寫多個區域中的 Azure Cosmos 資料庫帳戶和設定容錯移轉優先順序

此範例會使用 Azure CLI 複寫多個區域中的任何一種 Azure Cosmos 資料庫帳戶，並設定容錯移轉優先順序。
