---
title: Azure PowerShell 指令碼-使用共用的輸送量，Azure Cosmos 帳戶中建立容器
description: Azure PowerShell 指令碼範例-使用共用的輸送量，Azure Cosmos 帳戶中建立容器
author: markjbrown
...
---
# <a name="create-a-container-with-shared-throughput-in-an-azure-cosmos-account-using-powershell"></a>使用共用的輸送量，以使用 PowerShell 的 Azure Cosmos 帳戶建立容器
