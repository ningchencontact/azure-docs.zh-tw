---
title: Azure PowerShell 指令碼-使用 Azure Cosmos 帳戶中的大型的資料分割索引鍵來建立容器
description: Azure PowerShell 指令碼範例-使用 Azure Cosmos 帳戶中的大型的資料分割索引鍵來建立容器
author: markjbrown
...
ms.locfileid: "67566800"
---
# <a name="create-a-container-with-a-large-partition-key-in-an-azure-cosmos-account-using-powershell"></a>使用大型的資料分割索引鍵中使用 PowerShell 的 Azure Cosmos 帳戶建立容器
