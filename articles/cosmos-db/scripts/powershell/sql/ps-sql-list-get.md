---
title: Azure PowerShell 指令碼 - Azure Cosmos DB 列出及取得 SQL (Core) API 的作業
description: Azure PowerShell 指令碼 - Azure Cosmos DB 列出及取得 SQL (Core) API 的作業
author: markjbrown
