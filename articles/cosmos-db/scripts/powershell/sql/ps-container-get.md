---
title: Azure PowerShell 指令碼-取得 Azure Cosmos 帳戶中的容器的屬性
description: Azure PowerShell 指令碼範例-取得 Azure Cosmos 帳戶中的容器的屬性
author: markjbrown
...
ms.locfileid: "65078201"
---
# <a name="get-the-properties-of-a-container-in-an-azure-cosmos-account-using-powershell"></a>取得容器的屬性中使用 PowerShell 的 Azure Cosmos 帳戶
