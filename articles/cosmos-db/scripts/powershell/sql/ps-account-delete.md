---
title: Azure PowerShell 指令碼-刪除 Azure Cosmos 帳戶
description: Azure PowerShell 指令碼範例-刪除 Azure Cosmos 帳戶
author: markjbrown
...
ms.locfileid: "65078411"
---
# <a name="delete-an-azure-cosmos-account-using-powershell"></a>刪除 Azure Cosmos 帳戶使用 PowerShell
