---
title: Azure PowerShell 指令碼-取得 Azure Cosmos 帳戶中的資料庫的屬性
description: Azure PowerShell 指令碼範例-取得 Azure Cosmos 帳戶中的資料庫的屬性
author: markjbrown
...
ms.locfileid: "65077661"
---
# <a name="get-the-properties-of-a-database-in-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 的 Azure Cosmos 帳戶中取得資料庫的屬性
