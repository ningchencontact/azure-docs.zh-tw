---
title: Azure PowerShell 指令碼-Azure Cosmos 帳戶中建立唯一索引鍵原則與 TTL 的容器
description: Azure PowerShell 指令碼範例-Azure Cosmos 帳戶中建立容器唯一索引鍵原則與 TTL
author: markjbrown
...
ms.locfileid: "65078246"
---
# <a name="create-a-container-with-unique-key-policy-and-ttl-in-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 的 Azure Cosmos 帳戶中，建立唯一索引鍵原則與 TTL 的容器
