---
title: Azure PowerShell 指令碼-Core (SQL) API 建立 Azure Cosmos 帳戶
description: Azure PowerShell 指令碼範例-建立 Azure Cosmos 帳戶的核心 (SQL) API
author: markjbrown
...
ms.locfileid: "65078426"
---
# <a name="create-an-azure-cosmos-account-for-core-sql-api-account-using-powershell"></a>建立 Azure Cosmos 帳戶使用 PowerShell （核心） 的 SQL API 帳戶
