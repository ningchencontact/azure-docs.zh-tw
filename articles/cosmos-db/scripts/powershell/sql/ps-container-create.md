---
title: Azure PowerShell 指令碼-建立 Azure Cosmos 帳戶中的容器
description: Azure PowerShell 指令碼範例-建立 Azure Cosmos 帳戶中的容器
author: markjbrown
...
ms.locfileid: "65078231"
---
# <a name="create-a-container-in-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 的 Azure Cosmos 帳戶中建立容器
