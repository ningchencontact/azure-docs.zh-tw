---
title: Azure PowerShell 指令碼-設定 IP 防火牆以允許 Azure Cosmos 帳戶
description: Azure PowerShell 指令碼範例-設定 IP 防火牆以允許 Azure Cosmos 帳戶
author: markjbrown
...
ms.locfileid: "65078366"
---
# <a name="configure-ip-firewall-for-an-azure-cosmos-account-using-powershell"></a>Azure Cosmos 帳戶使用 PowerShell 設定 IP 防火牆
