---
title: Azure PowerShell 指令碼-使用 Azure Cosmos 帳戶中的自訂索引原則來建立容器
description: Azure PowerShell 指令碼範例-使用 Azure Cosmos 帳戶中的自訂索引原則來建立容器
author: markjbrown
...
ms.locfileid: "65078291"
---
# <a name="create-a-container-with-custom-index-policy-in-an-azure-cosmos-account-using-powershell"></a>使用自訂索引原則中使用 PowerShell 的 Azure Cosmos 帳戶建立容器
