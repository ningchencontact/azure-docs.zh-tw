---
title: Azure PowerShell 指令碼-使用 Azure Cosmos 帳戶中的衝突解決原則建立容器
description: Azure PowerShell 指令碼範例-使用 Azure Cosmos 帳戶中的衝突解決原則建立容器
author: markjbrown
...
ms.locfileid: "65078321"
---
# <a name="create-a-container-with-conflict-resolution-policy-in-an-azure-cosmos-account-using-powershell"></a>使用 Azure Cosmos 帳戶使用 PowerShell 中的衝突解決原則建立容器
