---
title: Azure PowerShell 指令碼-取得 Azure Cosmos 帳戶
description: Azure PowerShell 指令碼範例-取得 Azure Cosmos 帳戶
author: markjbrown
...
ms.locfileid: "65078381"
---
# <a name="get-the-properties-for-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 的 Azure Cosmos 帳戶取得的屬性
