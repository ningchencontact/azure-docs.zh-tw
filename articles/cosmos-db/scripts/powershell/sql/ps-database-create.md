---
title: Azure PowerShell 指令碼-建立 Azure Cosmos 資料庫
description: Azure PowerShell 指令碼範例-建立 Azure Cosmos 資料庫
author: markjbrown
...
ms.locfileid: "65077811"
---
# <a name="create-an-azure-cosmos-database-using-powershell"></a>建立 Azure Cosmos 資料庫，使用 PowerShell
