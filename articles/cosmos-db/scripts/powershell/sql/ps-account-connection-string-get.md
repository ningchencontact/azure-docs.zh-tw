---
title: Azure PowerShell 指令碼-取得 Azure Cosmos 帳戶的連接字串
description: Azure PowerShell 指令碼範例-取得 Azure Cosmos 帳戶的連接字串
author: markjbrown
...
---
# <a name="get-connection-strings-for-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 的 Azure Cosmos 帳戶取得連接字串
