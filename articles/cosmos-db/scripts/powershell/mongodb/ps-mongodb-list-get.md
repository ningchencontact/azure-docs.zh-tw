---
title: Azure 的 PowerShell 指令碼-Azure Cosmos DB 清單，並取得適用於 MongoDB API 的作業
description: Azure 的 PowerShell 指令碼-Azure Cosmos DB 清單，並取得適用於 MongoDB API 的作業
author: markjbrown
...
ms.locfileid: "66247435"
---
# <a name="list-and-get-databases-and-graphs-for-azure-cosmos-db---mongodb-api"></a>清單，並取得適用於 Azure Cosmos DB MongoDB API 的資料庫和圖形
