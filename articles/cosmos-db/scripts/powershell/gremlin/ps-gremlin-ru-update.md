---
title: Azure PowerShell 指令碼-Gremlin API 的 Azure Cosmos DB Update RU/秒
description: Azure PowerShell 指令碼-Gremlin API 的 Azure Cosmos DB Update RU/秒
author: markjbrown
...
ms.locfileid: "66247465"
---
# <a name="update-rus-for-a-database-or-graph-for-azure-cosmos-db---gremlin-api"></a>適用於 Azure Cosmos DB Gremlin API 更新資料庫或圖形的 RU/秒
