---
title: Azure CLI 指令碼：建立 Azure Cosmos DB 資料表 API 帳戶、資料庫和資料表 | Microsoft Docs
...
ms.locfileid: "51019531"
---
# <a name="azure-cosmos-db-create-a-table-api-account-using-azure-cli"></a>Azure Cosmos DB：使用 Azure CLI 建立資料表 API 帳戶
