...
ms.locfileid: "53263223"
---
# <a name="optimize-the-cost-required-to-read-and-write-data-from-azure-cosmos-db"></a>最佳化從 Azure Cosmos DB 讀取和寫入資料所需的成本
...
* 深入了解 [Azure Cosmos DB 上的帳單](understand-your-bill.md)
