...
ms.locfileid: "39608965"
---
# <a name="_Toc395783175"></a>使用 Azure Cosmos DB 和 Node.js SDK 來建置 Node.js Web 應用程式 (預覽)
> [!div class="op_single_selector"]
> * [.NET](sql-api-dotnet-application.md)
> * [Node.js](sql-api-nodejs-application.md)
> * [Node.js - v2.0 預覽](sql-api-nodejs-application-preview.md)
...
本教學課程示範如何使用 Azure 入口網站來建立 Azure Cosmos DB SQL API 帳戶。 然後，您會建置和執行以 Node.js SDK 為基礎的 Web 應用程式，以建立資料庫、容器，並在容器中新增項目。 本教學課程使用 Node.js SDK 2.0 版，其目前為預覽狀態。
