...
> [!NOTE]
> 目前僅支援 Azure Cosmos DB SQL 和 MongoDB API 帳戶的 Azure Cosmos DB 與 Power BI 連接器連線。 若要使用 MongoDB API 將 Azure Cosmos DB 連線至 Power BI，您必須使用 [Simba MongoDB ODBC 驅動程式](http://www.simba.com/drivers/mongodb-odbc-jdbc/)。
