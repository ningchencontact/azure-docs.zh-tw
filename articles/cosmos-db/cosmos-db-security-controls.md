...
description: 評估 Azure Cosmos DB 的安全性控制檢查清單
services: cosmos-db
documentationcenter: ''
author: msmbaldwin
manager: rkarlin
...
| 安全性控制 | 是/否 | 注意 |
|---|---|--|
| 待用的伺服器端加密：Microsoft 管理的金鑰 | 是 | 預設會加密所有 Cosmos 的資料庫和備份;請參閱[Azure Cosmos DB 中的資料加密](database-encryption-at-rest.md)。 不支援使用客戶管理的金鑰進行伺服器端加密。 |
