...
* Azure Cosmos DB 會在幕後佈建為每秒 **T** 個要求提供服務所需的分割區。 如果 **T** 超過每一分割區的最大輸送量 **t**，Azure Cosmos DB 就會佈建 **N = T/t** 分割區。 每一分割區的最大輸送量值由 Azure Cosmos DB 所設定，此值會根據佈建的總輸送量和使用的硬體組態來指派。 
