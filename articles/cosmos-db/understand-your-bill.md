...
*我們也假設您輸出 100 GB 資料的每個月從美國西部容器的將資料複寫至美國東部、 北歐和東亞。 輸出資料傳輸費率根據所收費用。*
...
*價格可能因地區而異。 如需最新的定價，請參閱[定價頁面](https://azure.microsoft.com/pricing/details/cosmos-db/)。*
