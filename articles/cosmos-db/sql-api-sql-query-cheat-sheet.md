...
「Azure Cosmos DB SQL 查詢速查表」透過將常見的資料庫查詢、關鍵字、內建函式及運算子顯示成容易列印的 PDF 參考表，協助您快速撰寫適用於 SQL API 資料的查詢。 
...
* 如需相關參考文件，請參閱 [Azure Cosmos DB SQL API：SQL 語法參考](https://msdn.microsoft.com/library/azure/dn782250.aspx)。
