...
使用[官方 MongoDB Java 驅動程式](https://mongodb.github.io/mongo-java-driver/)時 (請參閱[本快速入門](create-mongodb-java.md)中有關於其使用方式的資訊)，可藉由對 `MongoDatabase` 物件呼叫 `runCommand` 方法來執行命令。
