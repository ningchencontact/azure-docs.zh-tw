---
title: 具有 Azure Cosmos DB 和 HDInsight (Apache Spark) 的 Lambda 架構
...
* [串流處理變更：Azure CosmosDB 變更摘要 + Apache Spark](https://azure.microsoft.com/blog/stream-processing-changes-azure-cosmosdb-change-feed-apache-spark/)
