...
> [!NOTE]
> 當加入複合索引時，與其他索引類型一樣，在更新索引時，查詢可能會傳回不一致的結果。
...
### <a name="queries-with-filters-on-multiple-properties"></a>具有多個屬性篩選的查詢
...
### <a name="queries-with-a-filter-as-well-as-an-order-by-clause"></a>具有篩選準則和 ORDER BY 子句的查詢
