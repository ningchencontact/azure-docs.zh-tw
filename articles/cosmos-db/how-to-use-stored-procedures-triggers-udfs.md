...
預存程序須以 JavaScript 撰寫。 這些程序可建立、更新、讀取、查詢和刪除 Azure Cosmos 容器內的項目。 如需關於如何在 Azure Cosmos DB 中撰寫預存程序的詳細資訊，請參閱[如何在 Azure Cosmos DB 中撰寫預存程序](how-to-write-stored-procedures-triggers-udfs.md#stored-procedures)一文。
