---
title: 從 Spark 對 Azure Cosmos DB Cassandra API 的讀取作業
description: 本文說明如何讀取 Cosmos DB Cassandra API 中的資料表
services: cosmos-db
...
ms.locfileid: "47224956"
---
# <a name="read-azure-cosmos-db-cassandra-api-tables-from-spark"></a>從 Spark 讀取 Azure Cosmos DB Cassandra API 資料表
