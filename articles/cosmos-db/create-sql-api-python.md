...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 Azure Cosmos 帳戶中，按一下左側導覽列中的 [金鑰]  。 在下一個步驟中，您將使用畫面右側的複製按鈕，將 **URI** 和**主要金鑰**複製到 `CosmosGetStarted.py` 檔案。
