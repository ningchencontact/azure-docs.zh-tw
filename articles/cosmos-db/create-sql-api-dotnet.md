...
ms.locfileid: "54040909"
---
# <a name="quickstart-build-a-net-web-app-with-azure-cosmos-db-using-the-sql-api-and-the-azure-portal"></a>快速入門：使用 SQL API 和 Azure 入口網站建置採用 Azure Cosmos DB 的 .NET Web 應用程式
