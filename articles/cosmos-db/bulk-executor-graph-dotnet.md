...
如需與大量執行程式程式庫的參數有關的詳細資訊，請參閱[對 Azure Cosmos DB 進行 BulkImportData 的主題](https://docs.microsoft.com/azure/cosmos-db/bulk-executor-dot-net#bulk-import-data-to-azure-cosmos-db)。
