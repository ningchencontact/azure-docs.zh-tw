...
### <a name="delete-rows-that-match-a-condition"></a>刪除符合條件的資料列
...
### <a name="delete-all-the-rows-in-the-table"></a>刪除資料表中的所有資料列
...
### <a name="delete-specific-columns"></a>刪除特定資料行
