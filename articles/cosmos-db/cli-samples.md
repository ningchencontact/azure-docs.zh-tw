...
| [建立 Gremlin API 帳戶](scripts/create-graph-database-account-cli.md?toc=%2fcli%2fazure%2ftoc.json) | 建立單一 Azure Cosmos DB Gremlin API 帳戶、資料庫和集合。 |
|**調整 Azure Cosmos DB**||
