...
ms.locfileid: "53793121"
---
# <a name="build-a-web-app-using-azure-cosmos-dbs-api-for-mongodb-and-java-sdk"></a>使用 Azure Cosmos DB 適用於 MongoDB 的 API 和 Java SDK 建置 Web 應用程式
