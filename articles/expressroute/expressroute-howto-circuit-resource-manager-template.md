...
description: 建立、 佈建、 刪除和取消佈建 ExpressRoute 線路。
...
了解如何使用 Azure PowerShell 部署 Azure Resource Manager 範本來建立 ExpressRoute 線路。 如需開發 Resource Manager 範本的詳細資訊，請參閱 [Resource Manager 文件](/azure/azure-resource-manager/)和[範本參考](/azure/templates/microsoft.network/expressroutecircuits)。
...
[Azure 快速入門範本](https://azure.microsoft.com/resources/templates/)有良好的 Resource Manager 範本集合。 您可以使用其中一種[現有的範本](https://azure.microsoft.com/resources/templates/101-expressroute-circuit-create/)建立 ExpressRoute 線路。

[!code-json[create-azure-expressroute-circuit](~/quickstart-templates/101-expressroute-circuit-create/azuredeploy.json)]

若要查看多個相關範本，請選取[此處](https://azure.microsoft.com/resources/templates/?term=expressroute)。

若要建立 ExpressRoute 線路，藉由部署範本：
