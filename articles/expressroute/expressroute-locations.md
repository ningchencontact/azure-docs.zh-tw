...
| **[British Telecom](https://www.globalservices.bt.com/en/solutions/products/bt-compute-for-microsoft-azure)** |支援 |支援 |阿姆斯特丹、 香港特別行政區、 約翰尼斯堡、 倫敦、 紐波特 （威爾斯）、 聖保羅、 矽谷、 新加坡、 雪梨、 東京、 華盛頓特區 |
| **C3ntro** |敬請期待 |敬請期待 |邁阿密 |
| **CDC** | 支援 | 支援 | 坎培拉、坎培拉 2 |
| **[CenturyLink Cloud Connect](https://www.centurylink.com/cloudconnect)** |支援 |支援 |Amsterdam2、 芝加哥、 香港、 拉斯維加斯、 紐約、 巴黎、 聖安東尼奧、 矽谷、 東京、 多倫多、 華盛頓特區 |
| **Chief Telecom** |支援 |支援 |香港特別行政區、 台北 |
| **China Telecom Global** |支援 |不支援 |香港特別行政區 |
| **[Cologix](https://www.cologix.com/hyperscale/microsoft-azure/)** |支援 |支援 |芝加哥、達拉斯、蒙特婁、多倫多、華盛頓特區 |
| **[Colt](https://www.colt.net/uk/en/news/colt-announces-dedicated-cloud-access-for-microsoft-azure-services-en.htm)** |支援 |支援 |阿姆斯特丹、 都柏林、 倫敦、 紐波特、 大阪、 巴黎、 新加坡 2、 東京 |
...
| **[DE-CIX](https://www.de-cix.net/en/de-cix-service-world/directcloud/find-a-cloud-service/detail/microsoft-azure)** | 支援 |支援 |Amsterdam2，法蘭克福，馬賽|
| **[Devoli](https://devoli.com/expressroute)** | 支援 |支援 | 奧克蘭，墨爾本雪梨 |
...
| **[InterCloud](https://www.intercloud.com/)** |支援 |支援 |阿姆斯特丹、 芝加哥、 倫敦、 紐約、 巴黎、 矽谷、 新加坡、 華盛頓特區、 蘇黎士 |
| **[Internet2](https://www.internet2.edu/products-services/cloud-services-applications/microsoft-azure/#service-cloud-connect)** |支援 |支援 |芝加哥、達拉斯、華盛頓特區 |
...
| **[Kordia](https://www.kordia.co.nz/cloudconnect)** | 支援 |支援 |奧克蘭雪梨 |
...
| **[Megaport](https://www.megaport.com/services/microsoft-expressroute/)** |支援 |支援 |阿姆斯特丹、 亞特蘭大、 奧克蘭、 芝加哥、 達拉斯、 丹佛、 都柏林、 香港特別行政區，內華達州拉斯維加斯、 倫敦、 洛杉磯、 墨爾本、 邁阿密、 紐約、 伯斯、 魁北克市、 聖安東尼奧、 西雅圖、 矽谷、 新加坡、 新加坡 2、 雪梨、 多倫多、 華盛頓特區 |
...
| **[Orange](https://www.orange-business.com/en/products/business-vpn-galerie)** |支援 |支援 |阿姆斯特丹、 香港特別行政區、 倫敦、 巴黎、 聖保羅、 矽谷、 新加坡、 雪梨、 東京、 華盛頓特區 |
...
| **[Telia Carrier](https://teliacarrier.com/our-services/connectivity/cloud-connect.html?title=Cloud%20Connect)** | 支援 | 支援 |阿姆斯特丹、 芝加哥、 達拉斯、 香港、 倫敦、 巴黎、 華盛頓特區 |
...
| **[Vodafone](https://www.vodafone.com/business/global-enterprise/global-connectivity/vodafone-ip-vpn-cloud-connect)** |支援 |支援 |Amsterdam2、 倫敦、 新加坡 |
| **Vodafone Idea** | 支援 | 支援 | 孟買、孟買 2 |
| **[Zayo](https://www.zayo.com/solutions/industries/cloud-connectivity/microsoft-expressroute)** |支援 |支援 |阿姆斯特丹、 芝加哥、 達拉斯、 丹佛、 倫敦、 洛杉磯、 蒙特婁、 紐約、 巴黎、 西雅圖、 矽谷、 多倫多、 華盛頓特區 |
...
| **[CenturyLink Cloud Connect](https://www.centurylink.com/cloudconnect)** |支援 |支援 |New York，Phoenix、 聖安東尼奧、 華盛頓特區 |
...
| **服務提供者** | **Microsoft Azure** | **Office 365** | **位置** |
| --- | --- | --- | --- |
| **China Telecom** |支援 |不支援 |北京、 上海，，Beijing2 Shanghai2 |
...
| **[皇冠 Castle](https://fiber.crowncastle.com/solutions/added/cloud-connect)**| Equinix | 亞特蘭大、 芝加哥、 達拉斯、 洛杉磯、 紐約、 華盛頓特區 |
...
| **[頻譜 Enterprise](https://enterprise.spectrum.com/services/cloud/cloud-connect.html)** | Equinix | 芝加哥、 達拉斯、 洛杉磯、 紐約、 矽谷 | 
...
| **[Digital Realty](https://www.digitalrealty.com/services/interconnection/service-exchange/)** | IX 觸達、 Megaport PacketFabric |
| **[EdgeConnex](https://www.edgeconnex.com/services/edge-data-centers-proximity-matters/)** | Megaport, PacketFabric |
| **[Flexential](https://www.flexential.com/connectivity/cloud-connect-microsoft-azure-expressroute)** | IX 觸達、 Megaport、 PacketFabric |
| **[QTS 資料中心](https://www.qtsdatacenters.com/hybrid-solutions/connectivity/azure-cloud )** | Megaport, PacketFabric |
| **[Stream 資料中心]( https://www.streamdatacenters.com/products-services/network-cloud/ )** | Megaport |
| **[RagingWire Data Centers](https://www.ragingwire.com/wholesale/wholesale-data-centers-worldwide-nexcenters)** | IX 觸達、 Megaport、 PacketFabric |
| **[vXchnge](https://www.vxchnge.com/colocation-services/interconnection)** | IX 觸達、 Megaport |
