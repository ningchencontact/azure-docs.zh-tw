...
如果您採用 Azure 虛擬 WAN，您可以遵循[下列步驟](../virtual-wan/vpn-over-expressroute.md)來加密端對端連線。 如果您有一般的 Azure VNET，您可以在 VNET 中部署協力廠商 VPN 閘道，並在其與您的內部部署 VPN 閘道之間建立 IPsec 通道。
