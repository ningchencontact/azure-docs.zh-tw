...
description: 本文說明如何在 Azure 媒體服務中管理 Azure CDN 快取原則。
...
2. Azure 媒體服務 REST API， [StreamingEndpoint](/rest/api/media/operations/streamingendpoint#StreamingEndpointCacheControl)。
