...
| 檔案類型 |包含的橫條圖顯示您的帳戶中已透過我們的 CDN 來要求的前 10 名檔案類型。 就此報告的目的而言，檔案類型是由資產的副檔名和網際網路媒體類型 (例如 .html \[text/html\]、.htm \[text/html\]、.aspx \[text/html\] 等) 所定義。 圖形下方提供前 100 名檔案類型的詳細資訊。 |
