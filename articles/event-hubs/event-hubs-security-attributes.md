---
title: Azure 事件中樞的一般安全性屬性
description: 常見的安全性屬性，來評估 Azure 事件中樞的檢查清單
services: event-hubs
...
ms.locfileid: "66247195"
---
# <a name="common-security-attributes-for-azure-event-hubs"></a>Azure 事件中樞的一般安全性屬性

這篇文章說明 Azure 事件中樞內建的一般安全性屬性。
