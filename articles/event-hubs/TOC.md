...
### [使用 Resource Manager 範本啟用事件中樞擷取](event-hubs-resource-manager-namespace-event-hub-enable-capture.md)
...
### [使用 PowerShell 佈建實體](event-hubs-manage-with-ps.md) 
...
# 參考
## [程式碼範例](https://azure.microsoft.com/resources/samples/?service=event-hubs)
## Java
