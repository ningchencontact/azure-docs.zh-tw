---
title: 快速入門：使用 C 傳送事件 - Azure 事件中樞
description: 快速入門：本文會逐步解說如何建立 C 應用程式，以將事件傳送至 Azure 事件中樞。
services: event-hubs
documentationcenter: ''
