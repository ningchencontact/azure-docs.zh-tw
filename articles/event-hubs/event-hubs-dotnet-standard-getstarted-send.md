...
在本快速入門中，您已使用 .NET Standard 將訊息傳送到事件中樞。 若要了解如何使用 .NET Standard 從事件中樞接收事件，請參閱[ - .NET Standard](event-hubs-dotnet-standard-getstarted-receive-eph.md)。
