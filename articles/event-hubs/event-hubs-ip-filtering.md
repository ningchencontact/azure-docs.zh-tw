---
title: Azure 事件中樞 IP 篩選器 | Microsoft Docs
...
以下是兩個重要的使用案例，非常適合封鎖特定 IP 位址的事件中樞：
...
### <a name="creating-an-ip-filter-rule-with-azure-resource-manager-templates"></a>利用 Azure Resource Manager 範本來建立 IP 篩選器規則
