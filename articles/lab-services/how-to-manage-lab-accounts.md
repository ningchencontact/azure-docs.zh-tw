...
---
# <a name="manage-lab-accounts-in-azure-lab-services-formerly-azure-devtest-labs"></a>在 Azure 實驗室服務 (先前稱為 Azure DevTest Labs) 中管理實驗室帳戶
本文說明如何建立實驗室帳戶、檢視所有實驗室帳戶，或刪除實驗室帳戶。
...
若要提供教育工作者為其班級建立實驗室的權限，請將他們新增到實驗室建立者角色：
