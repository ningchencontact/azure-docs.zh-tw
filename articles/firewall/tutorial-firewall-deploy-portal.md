...
6. 檢閱摘要，然後按一下 [建立] 來建立防火牆。
   ...
   這需要幾分鐘才能部署。
7. 部署完成之後，請前往 **Test-FW-RG** 資源群組，然後按一下 **Test-FW01** 防火牆。
...
12. 在 [子網路] 中，按一下 [Workload-SN]。 請確定您只為此路由選取 **Workload-SN** 子網路，否則您的防火牆將無法正常運作。
...
3. 開啟 Internet Explorer 並瀏覽至 https://msn.com。
4. 在安全性警示上按一下 [確定] > [關閉]。

   您應該會看到 MSN 首頁。

5. 瀏覽至 https://www.msn.com 。
