...
>[!div class="checklist"]
> * [在本機部署遠端監視所預先設定的解決方案](../iot-accelerators/iot-accelerators-remote-monitoring-deploy-local.md)
...
![Alive and Well 的 Postman訊息](media/iot-suite-microservices-example/postman-alive-well.png)
...
![成功的 Docker 映像](media/iot-suite-microservices-example/successful-docker-image.png)
...
![Docker Hub 中的 Docker 映像](media/iot-suite-microservices-example/docker-image-in-docker-hub.png)
...
![New Edits Made Here 的 Postman 訊息](media/iot-suite-microservices-example/new-postman-message.png)
...
下一個要嘗試的動作是[在遠端監視解決方案中自訂裝置模擬器微服務](iot-suite-remote-monitoring-test.md)
