...
[Azure 和物聯網](../iot-accelerators/iot-accelerators-what-is-azure-iot.md)一文會說明典型 IoT 解決方案架構與下列層級：
...
* [Azure IoT 解決方案加速器](index.md)是[解決方案加速器](../iot-accelerators/iot-accelerators-what-are-solution-accelerators.md)的企業級集合，建置於 Azure 平台即服務 (PaaS) 上，可讓您加速開發自訂的 IoT 解決方案。
...
* **Azure IoT 解決方案加速器**：[什麼是 Azure IoT 解決方案加速器？](../iot-accelerators/iot-accelerators-what-are-solution-accelerators.md)
