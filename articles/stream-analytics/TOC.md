...
## 調整
### [隨著串流單位縮放](stream-analytics-streaming-unit-consumption.md)
### [隨著平行化查詢縮放](stream-analytics-parallelization.md)
#### [增加輸送量](stream-analytics-scale-jobs.md)
### [隨著 ML 函式縮放](stream-analytics-scale-with-machine-learning-functions.md)
...
### [SELECT INTO 陳述式](stream-analytics-select-into.md)
### [事件中樞接收者](stream-analytics-event-hub-consumer-groups.md)

## 與 Machine Learning 整合
### [使用 ML 模型進行情感分析](stream-analytics-machine-learning-integration-tutorial.md)
