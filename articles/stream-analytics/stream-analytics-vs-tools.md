...
* [快速入門：建立使用 Visual Studio 的 Stream Analytics 作業](stream-analytics-quick-create-vs.md)
* [教學課程：部署 Azure Stream Analytics 作業搭配使用 Azure 管線的 CI/CD](stream-analytics-tools-visual-studio-cicd-vsts.md)
