...
| Azure Cosmos DB   | 請參閱[Azure Cosmos DB 限制](../azure-resource-manager/management/azure-subscription-service-limits.md#azure-cosmos-db-limits)。 | 批次大小和寫入頻率會根據 Azure Cosmos DB 回應動態調整。 <br /> 串流分析沒有預先決定的限制。 |
