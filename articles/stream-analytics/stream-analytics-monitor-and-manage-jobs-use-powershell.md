...
> [!NOTE]
> 以程式控制方式建立的串流分析工作預設不會啟用監視功能。  您可以在 Azure 入口網站中流覽至 [作業] [監視] 頁面，然後按一下 [啟用] 按鈕來手動啟用監視，也可以遵循[Azure 串流分析監視器串流分析作業以程式](stream-analytics-monitor-jobs.md)設計方式執行此動作。
> 
> 
...
### <a name="get-azurestreamanalyticsjob--get-azstreamanalyticsjob"></a>AzureStreamAnalyticsJob |AzStreamAnalyticsJob
...
### <a name="get-azurestreamanalyticsinput--get-azstreamanalyticsinput"></a>AzureStreamAnalyticsInput |AzStreamAnalyticsInput
...
### <a name="get-azurestreamanalyticsoutput--get-azstreamanalyticsoutput"></a>AzureStreamAnalyticsOutput |AzStreamAnalyticsOutput
...
### <a name="get-azurestreamanalyticsquota--get-azstreamanalyticsquota"></a>AzureStreamAnalyticsQuota |AzStreamAnalyticsQuota
...
### <a name="get-azurestreamanalyticstransformation--get-azstreamanalyticstransformation"></a>AzureStreamAnalyticsTransformation |AzStreamAnalyticsTransformation
...
### <a name="new-azurestreamanalyticsinput--new-azstreamanalyticsinput"></a>新增-AzureStreamAnalyticsInput |新增-AzStreamAnalyticsInput
在串流分析工作內建立新的輸入，或更新現有的指定輸入。

您可以在 .json 檔案中或命令列上指定輸入的名稱。 若兩者皆指定，命令列上的名稱必須與檔案中的名稱相同。

如果您指定已存在的輸入，且未指定 Force 參數，此 Cmdlet 會詢問是否要取代現有的輸入。

如果您指定 Force 參數並指定現有的輸入名稱，則會取代輸入而不進行確認。
...
### <a name="new-azurestreamanalyticsjob--new-azstreamanalyticsjob"></a>新增-AzureStreamAnalyticsJob |新增-AzStreamAnalyticsJob
在 Microsoft Azure 中建立新的串流分析工作，或更新現有指定工作的定義。

您可以在 .json 檔案中或命令列上指定工作的名稱。 若兩者皆指定，命令列上的名稱必須與檔案中的名稱相同。

如果您指定的作業名稱已經存在，而且未指定 Force 參數，此 Cmdlet 會詢問是否要取代現有的作業。

如果您指定 Force 參數並指定現有的作業名稱，則會取代作業定義而不進行確認。
...
### <a name="new-azurestreamanalyticsoutput--new-azstreamanalyticsoutput"></a>新增-AzureStreamAnalyticsOutput |新增-AzStreamAnalyticsOutput
在串流分析工作內建立新的輸出，或更新現有的輸出。  

您可以在 .json 檔案中或命令列上指定輸出的名稱。 若兩者皆指定，命令列上的名稱必須與檔案中的名稱相同。

如果您指定已存在的輸出，但未指定 Force 參數，此 Cmdlet 會詢問是否要取代現有的輸出。

如果您指定 Force 參數並指定現有的輸出名稱，則會取代輸出而不進行確認。
...
### <a name="new-azurestreamanalyticstransformation--new-azstreamanalyticstransformation"></a>新增-AzureStreamAnalyticsTransformation |新增-AzStreamAnalyticsTransformation
在串流分析工作內建立新的轉換，或更新現有的轉換。

您可以在 .json 檔案中或命令列上指定轉換的名稱。 若兩者皆指定，命令列上的名稱必須與檔案中的名稱相同。

如果您指定已存在的轉換，但未指定 Force 參數，此 Cmdlet 會詢問是否要取代現有的轉換。

如果您指定 Force 參數，並指定現有的轉換名稱，則不需確認就會取代轉換。
...
### <a name="remove-azurestreamanalyticsinput--remove-azstreamanalyticsinput"></a>移除-AzureStreamAnalyticsInput |移除-AzStreamAnalyticsInput
以非同步方式從 Microsoft Azure 中的 Stream Analytics 作業刪除特定的輸入。  
如果您指定 Force 參數，將會刪除輸入而不進行確認。
...
### <a name="remove-azurestreamanalyticsjob--remove-azstreamanalyticsjob"></a>移除-AzureStreamAnalyticsJob |移除-AzStreamAnalyticsJob
以非同步方式從 Microsoft Azure 中刪除特定的 Stream Analytics 作業。  
如果您指定 Force 參數，則不需確認就會刪除作業。
...
### <a name="remove-azurestreamanalyticsoutput--remove-azstreamanalyticsoutput"></a>移除-AzureStreamAnalyticsOutput |移除-AzStreamAnalyticsOutput
以非同步方式從 Microsoft Azure 中的 Stream Analytics 作業刪除特定的輸出。  
如果您指定 Force 參數，則不需確認就會刪除輸出。
...
### <a name="start-azurestreamanalyticsjob--start-azstreamanalyticsjob"></a>開始-AzureStreamAnalyticsJob |開始-AzStreamAnalyticsJob
...
### <a name="stop-azurestreamanalyticsjob--stop-azstreamanalyticsjob"></a>停止-AzureStreamAnalyticsJob |停止-AzStreamAnalyticsJob
...
### <a name="test-azurestreamanalyticsinput--test-azstreamanalyticsinput"></a>測試-AzureStreamAnalyticsInput |測試-AzStreamAnalyticsInput
