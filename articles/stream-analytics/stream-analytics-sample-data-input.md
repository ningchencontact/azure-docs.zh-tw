---
title: 在 Azure 串流分析中使用範例資料測試查詢
description: 本文說明如何在 Azure 串流分析中使用一些範例輸入來測試查詢。
...
ms.locfileid: "30961687"
---
# <a name="test-a-query-and-sample-input-in-azure-stream-analytics"></a>在 Azure 串流分析中測試查詢和範例輸入 
...
當您滿意結果之後，您可以儲存查詢、啟動作業，以及坐下來觀看神奇的串流分析。
