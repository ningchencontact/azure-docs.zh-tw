...
您可以直接[下載套件](https://www.npmjs.com/package/azure-streamanalytics-cicd)，或透過 `npm install -g azure-streamanalytics-cicd` 命令[全域](https://docs.npmjs.com/downloading-and-installing-packages-globally)安裝。 這是建議的方法，它也可以在**Azure DevOps 管線**中的組建管線的 PowerShell 或 Azure CLI 腳本工作中使用。
