...
若要使用 REST API 停止作業，請參閱 [Stop](https://docs.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-job#stop) 方法。 若要使用 REST API 刪除作業，請參閱 [Delete](https://docs.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-job#delete) 方法。