...
- [以雲端服務提供者身分管理 Azure Stack 的使用量和帳單](azure-stack-add-manage-billing-as-a-csp.md)
- [將用於使用量與帳單的租用戶新增至 Azure Stack](azure-stack-csp-howto-register-tenants.md)
