...
> [!IMPORTANT]
> 在部署 Azure App Service 1.5 之前，請先將 1901 更新 (或更新版本) 套用到您的 Azure Stack 整合系統，或部署最新的 Azure Stack 開發套件。 
...
> [!IMPORTANT]
> 在執行升級之前，請確定您已完成 [Azure App Service on Azure Stack 資源提供者的部署](azure-stack-app-service-deploy-offline.md)，並且已閱讀 1.5 版隨附的[版本資訊](azure-stack-app-service-release-notes-update-five.md)，以了解可能對部署產生影響的新功能、修正程式和任何已知問題。
