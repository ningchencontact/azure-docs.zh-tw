...
- 在 **CloudCapabilities** 資料夾中：<br>         `AzureRM.CloudCapabilities.psm1` 會建立一個代表 Azure Stack 雲端中服務和版本的雲端功能 JSON 檔案。
- 在 **TemplateValidator** 資料夾中：<br>
`AzureRM.TemplateValidator.psm1` 會使用雲端功能 JSON 檔案來測試將在 Azure Stack 中部署的範本。
