...
![部署輸出](media/azure-stack-key-vault-deploy-vm-with-secret/deployment-output.png)

## <a name="next-steps"></a>後續步驟

* [使用 Key Vault 部署範例應用程式](azure-stack-key-vault-sample-app.md)
