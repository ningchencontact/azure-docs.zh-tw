...
ms.locfileid: "59262290"
---
# <a name="deploy-a-template-to-azure-stack-using-powershell"></a>使用 PowerShell 將範本部署到 Azure Stack

*適用於：Azure Stack 整合式系統和 Azure Stack 開發套件*

您可以使用 PowerShell 將 Azure Resource Manager 範本部署到 Azure Stack。 此文章說明如何使用 PowerShell 來部署範本。
...
1. 瀏覽 [AzureStackGitHub 存放庫](https://aka.ms/AzureStackGitHub)並尋找 **101-simple-windows-vm** 範本。 將範本儲存至下列位置：`C:\templates\azuredeploy-101-simple-windows-vm.json`。
