...
身為 Azure Stack 客戶，您應預期有下列資料中心整合階段：
...
> [!IMPORTANT]
> 在這個階段中，務必先調查並決定好所有必要資訊，然後才訂購解決方案。 請注意，這個步驟相當耗時，需要與您組織中的多個專業領域協調，以及從中收集資料。 
...
- 檢查所有纜線和邊界連線能力，以確保解決方案正確地放在一起，並且符合您的需求
- 設定方案 HLH (硬體生命週期主機)
- 檢查並確定所有 BMC、BIOS 和網路設定皆正確。
- 確定所有元件韌體是解決方案所核准的最新版本
- 啟動部署

> [!NOTE]
> 由現場工程師進行的部署程序可能需要一個工作週來完成。

## <a name="post-integration-phase"></a>後置整合階段
