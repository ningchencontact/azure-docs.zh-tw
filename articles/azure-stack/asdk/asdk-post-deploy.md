...
### <a name="to-change-the-password-expiration-policy-from-powershell"></a>從 Powershell 變更密碼到期原則
...
### <a name="to-change-the-password-expiration-policy-manually"></a>手動變更密碼到期原則
