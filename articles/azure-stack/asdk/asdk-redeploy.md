...
若要移除註冊資源，請使用 **Remove-AzsRegistration** Cmdlet 來取消註冊 Azure Stack。 然後，使用 **Remove-AzureRMResourceGroup** Cmdlet，從您的 Azure 訂用帳戶中刪除 Azure Stack 資源群組：
