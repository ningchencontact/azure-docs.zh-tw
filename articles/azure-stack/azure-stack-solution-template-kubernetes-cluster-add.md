...
2. 建立一個方案作為基本方案。 如需指示，請參閱[在 Azure Stack 中建立方案](azure-stack-create-plan.md)。

3. 建立供應項目。 如需指示，請參閱[在 Azure Stack 中建立供應項目](azure-stack-create-offer.md)。

4. 選取 [供應項目]，並尋找您所建立的供應項目。

5. 在 [供應項目] 刀鋒視窗中選取 [概觀]。

6. 選取 [變更狀態]。 選取 [公用]。

7. 選取 [+ 新增] > [供應項目與方案] > [訂用帳戶] 來建立新的訂用帳戶。
...
4. 輸入 `Kubernetes Cluster`。

5. 選取 `Kubernetes Cluster`。
...
2. 使用 PowerShell 連線到 Azure Stack。

3. 使用以下 PowerShell Cmdlet 來移除項目：
