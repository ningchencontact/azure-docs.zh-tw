...
ms.locfileid: "42888992"
---
# <a name="prepare-for-extension-host-for-azure-stack"></a>Azure Stack 的延伸主機準備

您可以使用延伸主機來減少所需的 TCP/IP 通訊埠數目，從而協助保護 Azure Stack。 本文將探討如何準備 Azure Stack 以使用延伸主機，此功能會透過 1808 更新之後的 Azure Stack 更新套件自動啟用。
