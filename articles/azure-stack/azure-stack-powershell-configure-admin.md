...
從[開發套件](.\asdk\asdk-connect.md#connect-to-azure-stack-with-remote-desktop)，或從 Windows 型外部用戶端 (如果您[透過 VPN 連線至 ASDK](.\asdk\asdk-connect.md#connect-to-azure-stack-with-vpn))，執行下列先決條件。 
