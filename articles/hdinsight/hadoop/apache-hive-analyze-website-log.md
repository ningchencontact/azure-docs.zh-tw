---
title: 使用 Hive 和 Apache Hadoop 進行網站記錄分析 - Azure HDInsight
description: 了解如何使用 HDInsight 上的 Apache Hive 來分析網站記錄。 您將使用記錄檔做為 HDInsight 資料表的輸入，然後使用 HiveQL 來查詢資料。
services: hdinsight
