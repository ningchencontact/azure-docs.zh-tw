...
Hive 可讓您針對大部分的結構化資料來投影結構。 定義結構後，您不需具備 Jave 或 MapReduce 相關知識，即可使用 HiveQL來查詢資料。
...
* __HBase__： HiveQL 可以用來查詢儲存在 Apache HBase 中的資料。 如需詳細資訊，請參閱[開始使用 HDInsight 上的 Apache HBase](../hbase/apache-hbase-tutorial-get-started-linux.md) 文件。
