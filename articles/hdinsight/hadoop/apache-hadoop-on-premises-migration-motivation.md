...
- **輕鬆管理、管理和監視**-Azure HDInsight 與 [Azure 監視器記錄](../hdinsight-hadoop-oms-log-analytics-tutorial.md) 整合，以提供單一介面讓您監視所有叢集。
...
|監控|Graphite、collectd、statsd、Telegraf、InfluxDB|
