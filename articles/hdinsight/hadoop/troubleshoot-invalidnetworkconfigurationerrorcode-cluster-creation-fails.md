...
如果您看到錯誤碼 `InvalidNetworkConfigurationErrorCode`，說明「虛擬網路設定與 HDInsight 需求不相容」，通常表示叢集的[虛擬網路](../hdinsight-plan-virtual-network-deployment.md)設定發生問題。 根據其餘的錯誤描述，遵循下列各節來解決您的問題。
