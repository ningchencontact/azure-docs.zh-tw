---
title: 叢集建立因 Azure HDInsight 中的 InvalidNetworkConfigurationErrorCode 而失敗
...
1. 在 vNet 中部署 VM 之後, 請在此 VM 上設定 DNS 轉送規則。 將所有 Idn 名稱解析要求轉寄到 168.63.129.16, 並將其餘內容轉送至您的 DNS 伺服器。 [以下](../hdinsight-plan-virtual-network-deployment.md)是自訂 DNS 伺服器的這項設定的範例。
