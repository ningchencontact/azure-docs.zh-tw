...
* 對於[在 HDInsight 上使用 Apache Pig](hdinsight-use-pig.md) 有基本了解
...
>
> * 如果叢集使用 Azure Data Lake Store Gen2，請使用 `abfs://` 路徑。 例如： `register abfs://home/example/jars/datafu-pig-1.4.0.jar`。
>
> * 如果叢集使用 Azure Data Lake Store Gen1，請使用 `adl://` 路徑。 例如： `register adl://home/example/jars/datafu-pig-1.4.0.jar`。
