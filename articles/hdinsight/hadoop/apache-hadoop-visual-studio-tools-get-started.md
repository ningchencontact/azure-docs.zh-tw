...
了解如何使用 Data Lake Tools for Visual Studio (也稱為 Azure Data Lake and Stream Analytics Tools for Visual Studio) 來連線到 [Azure HDInsight](../hdinsight-hadoop-introduction.md) 中的 Apache Hadoop 叢集及提交 Hive 查詢。 
