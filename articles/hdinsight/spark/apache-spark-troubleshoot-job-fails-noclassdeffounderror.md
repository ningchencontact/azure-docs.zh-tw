---
title: 從 Apache Kafka 叢集讀取資料的 Apache Spark 串流作業失敗, 並出現 JAVA.lang.noclassdeffounderror, Azure HDInsight
...
例如, 如果您執行的是 Kafka 叢集版本 0.10.1, 下列命令將會導致錯誤:
