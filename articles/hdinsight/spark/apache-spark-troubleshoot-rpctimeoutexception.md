---
title: Azure HDInsight 中 Apache Spark thrift 伺服器的 RpcTimeoutException
...
`OutOfMemoryError`和`overhead limit exceeded`錯誤可能也會出現`sparkthriftdriver.log`在中, 如下列範例所示:
