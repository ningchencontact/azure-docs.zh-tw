...
在此版本中，客戶可以針對所有透過 TLS 1.2 的連線加入宣告 TLS 1.2 enformence。 新的屬性**minSupportedTlsVersion**是透過 Azure Resource Manager 範本引進，以建立叢集。 如果未設定屬性，叢集仍然支援1.0、1.1 和1.2，與現今的行為相同。 客戶可以將此屬性的值設定為 "1.2"，這表示叢集僅支援 TLS 1.2 和更新版本。 
