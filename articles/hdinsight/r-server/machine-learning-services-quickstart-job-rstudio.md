---
title: 快速入門：適用於 R 的 RStudio Server 和 ML 服務 - Azure HDInsight
...
![R Studio Web 主控台概觀](./media/ml-services-quickstart-job-rstudio/connect-to-r-studio1.png)
