...
當您在 HDInsight 中建立 Apache Hadoop 叢集時，可以指定 **Azure 儲存體**帳戶或 **Data Lake Storage**。 來自該帳戶的特定儲存體容器，會保留您所建立叢集的檔案系統 (例如，Hadoop 分散式檔案系統)。 如需詳細資訊與指導方針，請參閱：
