---
title: 教學課程：在 HDInsight 上搭配使用 Apache Kafka 與 Storm - Azure | Microsoft Docs
...
> [!IMPORTANT]
> 在本文件的步驟中，Azure 資源群組必須包含 HDInsight 上的 Storm 和 HDInsight 叢集上的 Kafka。 這兩個叢集都位於 Azure 虛擬網路中，可讓 Spark 叢集直接與 Kafka 叢集通訊。
> 
