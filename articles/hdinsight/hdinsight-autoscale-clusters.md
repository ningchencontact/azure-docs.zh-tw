...
1. 在 [**自訂**步驟 5 (叢集大小)] 上, 勾選 [背景**工作節點自動** **調整**] 核取方塊。
...
調整作業可能需要10到20分鐘的時間才能完成。 設定自訂排程時, 請為此延遲進行規劃。 例如, 如果您需要在上午9:00 的叢集大小為 20, 請將排程觸發程式設定為較早的時間, 例如 8:30 AM, 讓調整作業已完成 9:00 AM。
...
選取 [**監視**] 下的 [**計量**]。 然後按一下 [計量] 下拉式清單方塊中的 [ **新增**計量和作用中背景**工作的數目**]。 按一下右上方的按鈕以變更時間範圍。
