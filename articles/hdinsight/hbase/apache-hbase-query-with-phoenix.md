---
title: 快速入門：Apache HBase 與 Apache Phoenix - Azure HDInsight
description: 在本快速入門中，您學會如何在 HDInsight 中使用 Apache Phoenix。 也了解如何在電腦上安裝並設定 SQLLine，以連線到在 HDInsight 中的 HBase 叢集。
