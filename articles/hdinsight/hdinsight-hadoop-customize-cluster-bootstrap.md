...
> [!IMPORTANT]  
> 參數`Spark2Defaults`可能需要搭配[新增 AzHDInsightConfigValues](https://docs.microsoft.com/powershell/module/az.hdinsight/add-azhdinsightconfigvalues)。 您可以傳遞空的值給參數，如下列程式碼範例所示。
