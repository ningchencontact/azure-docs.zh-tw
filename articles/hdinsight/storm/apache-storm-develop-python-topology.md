...
> [!NOTE]
> 此命令需要本機 Storm 開發環境。 如需詳細資訊，請參閱[設定開發環境](http://storm.apache.org/releases/1.0.6/Setting-up-development-environment.html)。
...
* [如何在 Pig 和 Hive 中使用 Python 使用者定義函數 (UDF)](../hadoop/python-udf-hdinsight.md)
