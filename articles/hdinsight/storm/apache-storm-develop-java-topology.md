...
了解如何為 [Apache Storm](https://storm.apache.org/) 建立以 Java 為基礎的拓撲。 在這裡，您可以建立 Storm 拓撲可實作字數統計應用程式。 您會使用 [Apache Maven](https://maven.apache.org/) 來建置和封裝專案。 然後，了解如何定義使用拓樸[Apache Storm Flux](https://storm.apache.org/releases/2.0.0-SNAPSHOT/flux.html) framework。
