...
ms.locfileid: "68736985"
---
# <a name="what-is-azure-data-catalog"></a>什麼是 Azure 資料目錄？

Azure 資料目錄是完全受控的雲端服務。 它能讓其使用者探索其所需的資料來源，並了解他們所尋找的資料來源。 同時，資料目錄可協助組織從現有的投資中獲得更多價值。
...
* 建立資料來源的文件，通常是徒勞無功的。 讓文件與資料來源保持同步是持續性責任。 使用者可能對於即將過期的文件缺乏信任感。
...
* [開啟 Azure 資料目錄](https://www.azuredatacatalog.com)