...
> [!NOTE]
> 我們已撰寫使用 **Azure 資料目錄** API 的範例工具，來將 Excel 活頁簿移轉至資料目錄。 若要了解資料目錄 API 和範例工具，請[下載臨機操作的活頁簿程式碼範例](https://github.com/Azure-Samples/data-catalog-dotnet-excel-register-data-assets)，並查看 [Azure 資料目錄 REST API](/rest/api/datacatalog/) 文件。
