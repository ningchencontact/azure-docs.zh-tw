---
title: Azure Data Lake Storage Gen1 文件 - 教學課程和 API 參考 | Microsoft Docs
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Data Lake Storage Gen1 影片庫</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Azure 入口網站開始使用 Data Lake Storage Gen1</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 PowerShell 開始使用 Data Lake Storage Gen1</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Azure CLI 開始使用 Data Lake Storage Gen1</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 .NET 開始使用 Data Lake Storage Gen1</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Java 開始使用 Data Lake Storage Gen1</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Node.js 開始使用 Data Lake Storage Gen1</h3>
                    </div>
                </div>
            </div>
        </div>
...
<ul class="panelContent cardsW">
    ...
                        <p><a href="/python/api/azure-mgmt-datalake-store/">Python (帳戶管理)</a></p>
                        <p><a href="https://docs.microsoft.com/python/api/azure-datalake-store/azure.datalake.store.core">Python (檔案系統管理)</a></p>
                    </div>
                </div>
            </div>
        </div>
