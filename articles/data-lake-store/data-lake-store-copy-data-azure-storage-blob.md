...
Azure Data Lake Storage Gen1 提供命令列工具 [AdlCopy](https://aka.ms/downloadadlcopy)，以從下列來源複製資料：
...
* **AdlCopy 工具**。 從 [https://aka.ms/downloadadlcopy](https://aka.ms/downloadadlcopy) 安裝 AdlCopy 工具。
