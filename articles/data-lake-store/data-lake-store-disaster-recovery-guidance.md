...
* [災害復原和高可用性 Azure 應用程式](../resiliency/resiliency-disaster-recovery-high-availability-azure-applications.md)
...
* [開始使用 Azure Data Lake 儲存體 Gen1](data-lake-store-get-started-portal.md)
