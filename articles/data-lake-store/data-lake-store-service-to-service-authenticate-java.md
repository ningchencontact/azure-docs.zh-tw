---
title: 服務對服務驗證：使用 Azure Active Directory 與 Azure Data Lake 儲存體 Gen1 Java |Microsoft Docs
...
* [使用 Java SDK 在 Data Lake 儲存體 Gen1 上的資料作業](data-lake-store-get-started-java-sdk.md)
