...
## [從 Key Vault 讀取 - Node.js](quick-create-node.md)
# 教學課程
...
## Node.js
### [保存庫管理](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/)
### [保存庫用戶端程式庫](https://docs.microsoft.com/javascript/api/azure-keyvault/)
## 開發
