...
description: 使用適用於 Azure CLI 2.0 的 IoT 擴充功能來註冊新的 IoT Edge 裝置
author: kgremban
manager: timlt
ms.author: kgremban
ms.date: 05/30/2018
...
[Azure CLI 2.0](https://docs.microsoft.com/cli/azure?view=azure-cli-latest) 是一個開放原始碼跨平台命令列工具，用來管理 Azure 資源 (例如 IoT Edge)。 它可讓您管理 Azure IoT 中樞資源、裝置佈建服務執行個體，以及現成的連結中樞。 新的 IoT 擴充功能以裝置管理和完整 IoT Edge 功能來擴充 Azure CLI 2.0 的功能。
...
了解如何[使用 Azure CLI 2.0 將模組部署至裝置](how-to-deploy-modules-cli.md)