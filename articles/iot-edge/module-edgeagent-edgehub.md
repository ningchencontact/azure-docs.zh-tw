...
| systemModules.edgeHub.exitCode | 如果結束，IoT Edge 中樞容器報告的結束代碼 |
...
| storeAndForwardConfiguration.timeToLiveSecs | IoT Edge 中樞在與路由端點中斷連線時保留訊息的時間 (以秒為單位)，例如，與 IoT 中樞或本機模組中斷連線 | 是 |
