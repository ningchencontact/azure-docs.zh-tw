---
title: Azure 原則 JSON 範例 - 稽核透明資料加密狀態 | Microsoft Docs
description: 此 JSON 範例原則會稽核是否未啟用 SQL 資料庫透明資料加密。
...
ms.locfileid: "34602273"
---
# <a name="audit-transparent-data-encryption-status"></a>稽核透明資料加密狀態

此原則會稽核是否未啟用 SQL 資料庫透明資料加密。
