---
title: Azure 原則 JSON 範例 - 稽核 DB 層級威脅偵測設定 | Microsoft Docs
description: 此 JSON 範例原則會稽核 SQL 資料庫安全性警示原則是否未設定成指定的狀態。
...
ms.locfileid: "34601899"
---
# <a name="audit-db-level-threat-detection-setting"></a>稽核 DB 層級威脅偵測設定
