---
title: Azure 原則 JSON 範例 - 稽核 SQL DB 層級稽核設定 | Microsoft Docs
description: 此 JSON 範例原則會稽核 SQL 資料庫稽核設定是否與指定的設定不符。
...
ms.locfileid: "34601746"
---
# <a name="audit-sql-db-level-audit-setting"></a>稽核 SQL DB 層級稽核設定

此原則會稽核 SQL 資料庫稽核設定是否與指定的設定不符。 您需指定一個指出應啟用或停用稽核設定的值。
