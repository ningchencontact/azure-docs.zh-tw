---
title: Azuare 原則 JSON 範例 - 稽核是否未針對區域啟用網路監看員 | Microsoft Docs
description: 此 JSON 範例原則會稽核是否未針對指定的區域啟用網路監看員
...
ms.locfileid: "34602562"
---
# <a name="audit-if-network-watcher-is-not-enabled-for-region"></a>稽核是否未針對區域啟用網路監看員
