---
title: Azure 原則 JSON 範例 - 不允許的資源類型 | Microsoft Docs
description: 此 JSON 範例原則會禁止部署指定的資源類型。
...
ms.locfileid: "34602487"
---
# <a name="not-allowed-resource-types"></a>不允許的資源類型

此原則會禁止部署指定的資源類型。 您需指定要封鎖的資源類型陣列。
