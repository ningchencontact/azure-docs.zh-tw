---
title: Azure 原則 JSON 範例 - 拒絕 Hybrid Use Benefit | Microsoft Docs
description: 此 JSON 範例原則會禁止使用 Azure Hybrid Use Benefit (AHUB)。
...
ms.locfileid: "34602443"
---
# <a name="deny-hybrid-use-benefit"></a>拒絕 Hybrid Use Benefit

禁止使用 Azure Hybrid Use Benefit (AHUB)。 當您不想要允許使用內部部署授權時，請使用此範本。
