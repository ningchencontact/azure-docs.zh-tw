---
title: Azure 原則 JSON 範例 - 允許的儲存體帳戶 SKU | Microsoft Docs
description: 此 JSON 範例原則會要求儲存體帳戶使用已核准的 SKU。
...
ms.locfileid: "34602902"
---
# <a name="allowed-storage-account-skus"></a>允許的儲存體帳戶 SKU
