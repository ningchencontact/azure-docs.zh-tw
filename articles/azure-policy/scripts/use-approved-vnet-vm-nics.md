---
title: Azure 原則 JSON 範例 - 針對 VM 網路介面使用已核准的 vNet | Microsoft Docs
description: 此 JSON 範例原則會要求網路介面使用已核准的虛擬網路。
...
ms.locfileid: "34602341"
---
# <a name="use-approved-vnet-for-vm-network-interfaces"></a>針對 VM 網路介面使用已核准的 vNet

此原則會要求網路介面使用已核准的虛擬網路。 您需指定已核准之虛擬網路的識別碼。
