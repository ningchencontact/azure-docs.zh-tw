...
建立[整合服務環境 (ISE)](../logic-apps/connect-virtual-network-vnet-isolated-environment-overview.md)之後, 請新增邏輯應用程式、整合帳戶和自訂連接器等成品, 使其可以存取您 Azure 虛擬網路中的資源。
...
## <a name="create-logic-apps-in-an-ise"></a>在 ISE 中建立邏輯應用程式
...
## <a name="create-integration-accounts-in-an-ise"></a>在 ISE 中建立整合帳戶
...
## <a name="create-custom-connectors-in-an-ise"></a>在 ISE 中建立自訂連接器
