...
description: 在 Visual Studio Code (VS Code) 中建立及管理邏輯應用程式
services: logic-apps
...
* 邏輯應用程式[工作流程定義](../logic-apps/logic-apps-workflow-definition-language.md)與結構 (使用 JavaScript 物件標記法) 的基本知識
