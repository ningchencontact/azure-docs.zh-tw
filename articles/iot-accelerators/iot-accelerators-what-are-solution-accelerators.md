...
新版的遠端監視解決方案加速器會使用微服務架構。 此解決方案加速器結合多種微服務，例如 *IoT 中樞管理員*和*存放管理員*。 每個微服務的 Java 和 .NET 版本皆可下載，並隨附於相關的開發人員文件中。 如需有關微服務的詳細資訊，請參閱[遠端監視架構](iot-accelerators-remote-monitoring-sample-walkthrough.md)。
