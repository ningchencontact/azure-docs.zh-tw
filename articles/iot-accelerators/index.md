            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p>了解如何自訂解決方案加速器</p>
                        <ul>
                            <li><a href="/azure/iot-accelerators/iot-accelerators-remote-monitoring-deploy-local">在本機執行解決方案</a></li>
                            <li><a href="/azure/iot-accelerators/iot-accelerators-remote-monitoring-customize#presentation-and-visualization">自訂 UX</a></li>
                        </ul>
                    </div>
                </div>
            </div>
