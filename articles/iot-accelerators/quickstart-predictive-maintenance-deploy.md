...
ms.locfileid: "38972908"
---
# <a name="quickstart-deploy-a-cloud-based-solution-to-run-a-predictive-maintenance-analysis-on-my-connected-devices"></a>快速入門：部署雲端式解決方案對我的連線裝置執行預測性維護分析

本快速入門會說明如何部署 Azure IoT 預測性維護解決方案加速器，以作為 IoT 裝置的雲端式預測性維護解決方案。 在部署解決方案加速器之後，您要使用解決方案的 [儀表板] 頁面，使用飛機引擎資料執行模擬。
...
在 [建立預測性維護解決方案] 頁面上，輸入預測性維護解決方案加速器的唯一 [解決方案名稱]。
...
Azure 訂用帳戶部署完成時，您就可以登入預測性維護解決方案加速器儀表板。
