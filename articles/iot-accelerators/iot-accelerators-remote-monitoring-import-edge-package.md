...
1. 在 Azure 入口網站中，瀏覽至您用來開發和測試 IoT Edge 裝置的 IoT 中樞。 单击“IoT Edge”，然后单击“IoT Edge 部署”：![IoT Edge](media/iot-accelerators-remote-monitoring-import-edge-package/iotedge.png)

1. 按一下具有您想使用之部署組態的部署。 此时将显示“部署详细信息”页：![IoT Edge 部署详细信息](media/iot-accelerators-remote-monitoring-import-edge-package/deploymentdetails.png)
...
1. 按一下 [上傳] 將套件新增至遠端監視解決方案：![上传的包](media/iot-accelerators-remote-monitoring-import-edge-package/uploadedpackage.png)
