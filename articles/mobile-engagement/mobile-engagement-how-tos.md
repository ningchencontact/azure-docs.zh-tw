...
> [!WARNING]
> 如果未定義使用者的應用程式資訊標記，使用者將不會收到推送。

* 結果

![Personalize2][12]

### <a name="you-can-further-personalize-the-text-your-notification"></a>您可以進一步個人化通知的文字
![Personalize3][13]
...
### <a name="the-body-of-an-announcement-may-also-be-personalized-with"></a>公告的內文也可以個人化：
...
### <a name="plan-to-start-a-campaign"></a>計畫開始活動
![Shedule1][18]
...
### <a name="plan-to-end-a-campaign"></a>計畫結束活動
![Shedule2][19]
...
網頁檢視是具有網頁內容的快顯視窗。 使用者按下推播通知時，就會出現這個快顯視窗。
網頁檢視可讓您與使用者有更多互動。
