---
title: Azure Mobile Engagement 文件 - 教學課程和 API 參考 | Microsoft Docs
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始使用適用於 Android 應用程式的 Azure Mobile Engagement</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始使用 Azure Mobile Engagement for Cordova/Phonegap</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始使用適用於 iOS 應用程式 (Objective C) 的 Azure Mobile Engagement</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始使用適用於 iOS 應用程式 (Swift) 的 Azure Mobile Engagement</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始使用適用於 Unity Android 部署的 Azure Mobile Engagement</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始使用適用於 Unity iOS 部署的 Azure Mobile Engagement</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始使用適用於 Windows 通用 App 的 Azure Mobile Engagement</h3>
                    </div>
                </div>
            </div>
        </div>
