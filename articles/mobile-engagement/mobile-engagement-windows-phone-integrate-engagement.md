...
> [!NOTE]
> 如果您的目標是 Windows Phone 8.1 (非 Silverlight)，請參閱 [Windows 通用整合程序](mobile-engagement-windows-store-integrate-engagement.md)。
> 
> 
...
> [!WARNING]
> 我們強烈地建議您不要在應用程式的其他地方新增 Engagement 初始化。 不過請注意， `EngagementAgent.Instance.Init` 方法執行於專用的執行緒，而非 UI 執行緒。
> 
> 
