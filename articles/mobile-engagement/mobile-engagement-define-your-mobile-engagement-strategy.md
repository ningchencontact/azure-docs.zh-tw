...
## <a name="mobile-engagement-serves-your-objectives"></a>Mobile Engagement 為您的目標效勞
*我們曾討論過保留率、使用量，但目的為何？*
...
## <a name="why-do-you-need-analytics-to-engage"></a>吸引使用者為何需要分析？
...
### <a name="how-to-create-a-great-tag-plan"></a>如何建立絕佳的標記計劃？
...
2. 根據登入狀態區隔對象。 收集資料，以了解使用者是否連線，或是否建立帳戶。 協助鎖定尚未登入的使用者，並傳送推播通知以吸引使用者進行轉換。
   ![][2]
