...
| 備份伺服器 <br> *Required for deploying Veeam Backup & Replication components* | Backup Proxy  | TCP/UDP  | 135, 137 to 139 and 445 |
    | 備份伺服器   | DNS  | UDP  | 53  | 
    | 備份伺服器   | Veeam Update Notification Server  | TCP  | 80  | 
    | 備份伺服器   | Veeam License Update Server  | TCP  | 443  | 
