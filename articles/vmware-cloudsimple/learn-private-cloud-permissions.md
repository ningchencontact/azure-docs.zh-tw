...
| **密碼編譯作業** | 新增磁片 <br> 複製 <br> 解密 <br> 直接存取 <br> Encrypt <br> 加密新的 <br> 管理 KMS <br> 管理加密原則 <br> 管理金鑰 <br> 移轉 <br> Recrypt <br> 註冊 VM <br> 註冊主機 |
| **dvPort 群組** | Create <br> 刪除 <br> 修改 <br> 原則作業 <br> 範圍作業 |
...
| **副檔名** | 註冊延伸模組 <br> 取消註冊延伸模組 <br> 更新延伸模組 |
| **外部統計資料提供者**| 註冊 <br> Unregister <br> 更新 |
| **資料夾** | 建立資料夾 <br> 刪除資料夾 <br> 移動資料夾 <br> 重新命名資料夾 |
| **全域** | 取消工作 <br> 容量規劃 <br> 診斷程式 <br> 停用方法 <br> 啟用方法 <br> 全域標記 <br> 醫療業 <br> 授權 <br> 記錄事件 <br> 管理自訂屬性 <br> Proxy <br> 腳本動作 <br> 服務管理員 <br> 設定自訂屬性 <br> 系統標記 |
...
| **工作** | 建立工作 <br> 更新工作 |
| **傳送服務**| 管理 <br> 監視 |
| **vApp** | 新增虛擬機器 <br> 指派資源集區 <br> 指派 vApp <br> 複製 <br> Create <br> 刪除 <br> 匯出 <br> 匯入 <br> 移動 <br> 關閉電源 <br> 開啟電源 <br> 重新命名 <br> 暫止 <br> Unregister <br> View OVF 環境 <br> vApp 應用程式設定 <br> vApp 實例設定 <br> vApp managedBy 設定 <br> vApp 資源設定 |
