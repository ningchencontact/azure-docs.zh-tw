...
ms.locfileid: "69972443"
---
# <a name="cloudsimple-node-quota-limits"></a>CloudSimple 節點配額限制

當您的訂用帳戶已啟用 CloudSimple 服務時, 有四個節點是可用來購買的預設數量。  您可以從 Azure 入口網站購買任何[節點類型](cloudsimple-node.md)。  必須至少有三個相同 SKU 的節點, 才能建立私人雲端。  如果您已購買節點, 當您嘗試購買其他節點時, 可能會看到錯誤。
