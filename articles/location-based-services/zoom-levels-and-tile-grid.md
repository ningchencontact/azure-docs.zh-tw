---
title: Azure LBS 中的縮放層級和圖格格線 | Microsoft Docs
description: 了解 Azure LBS 中的縮放層級和圖格格線
...
---
# <a name="zoom-levels-and-tile-grid"></a>縮放層級和並排顯示格線
Azure LBS 使用麥卡托圓球投影座標系統 (EPSG：3857)。
...
縮放層級 1 使用 4 個圖格來呈現世界：2 x 2 個正方形
...
每個後續的縮放層級再將前一層級的圖格一分為四，建立 2<sup>縮放</sup> x 2<sup>縮放</sup> 的格線。 縮放層級 20 是 2<sup>20</sup> x 2<sup>20</sup> 的格線，等於 1,048,576 x 1,048,576 個圖格 (總計 109,951,162,778)。
