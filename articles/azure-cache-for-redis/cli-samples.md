...
|**Web 應用程式加上快取**||
| [將 Web 應用程式連線至 Azure Redis 快取](./../app-service/scripts/app-service-cli-app-service-redis.md) | 建立 Azure Web 應用程式和「Azure Redis 快取」，然後將 Redis 連線詳細資料新增至應用程式設定。 |
|**刪除快取**||
