---
title: Azure Cache for Redis 文件 - 教學課程和 API 參考
...
ms.locfileid: "74122551"
---
# <a name="azure-cache-for-redis-documentation"></a>Azure Cache for Redis 文件

了解如何使用安全的資料快取和訊息代理程式 Azure Cache for Redis，為應用程式提供高輸送量且低延遲的資料存取。 教學課程、API 參考和其他文件會示範如何從 Azure 上的任何應用程式使用 Azure Cache for Redis。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>了解 Azure Cache for Redis 進階層</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Cache for Redis 影片庫</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始透過 .NET 使用 Azure Cache for Redis</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始透過 ASP.NET MVC 使用 Azure Cache for Redis</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始透過 Node.js 使用 Azure Cache for Redis</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始透過 Java 使用 Azure Cache for Redis</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始透過 Python 使用 Azure Cache for Redis</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3> 使用 Redis 快取唯讀資料以最佳化 Web 應用程式</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Azure Cache for Redis 中的可變動和部分資料</h3>
                    </div>
                </div>
            </div>
        </div>
...
**[更多互動式學習...](/learn/browse?products=azure-redis-cache)**
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://redis.io/clients">Redis 用戶端</a></p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://docs.microsoft.com/rest/api/redis/">REST API 參考</a></p>
                    </div>
                </div>
            </div>
        </div>
