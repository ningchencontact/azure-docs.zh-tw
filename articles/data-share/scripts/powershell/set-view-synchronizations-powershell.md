...
| 命令 | 注意 |
|---|---|
| [新增-AzDataShareSynchronizationSetting](/powershell/module/az.resources/new-azdatasharesynchronizationsettings) | 建立共用同步處理。 |
| [AzDataShareSynchronizationSetting](/powershell/module/az.resources/get-azdatasharesynchronizationsetting) | 取得共用同步處理的同步處理設定。 |
|||
