...
若要列出角色指派，您必須具有範圍內的 `Microsoft.Authorization/roleAssignments/read` 作業存取權。 所有內建角色都會獲得這項作業的存取權。 如需有關角色指派和管理 Azure 資源存取權的詳細資訊，請參閱 [Azure 角色型存取控制](role-assignments-portal.md)。
...
若要取得角色指派的相關資訊，您必須具有 `Microsoft.Authorization/roleAssignments/read` 作業的存取權。 所有內建角色都會獲得這項作業的存取權。 如需有關角色指派和管理 Azure 資源存取權的詳細資訊，請參閱 [Azure 角色型存取控制](role-assignments-portal.md)。
...
若要建立角色指派，您必須具有 `Microsoft.Authorization/roleAssignments/write` 作業的存取權。 在內建角色中，只有「擁有者」和「使用者存取系統管理員」會獲得這項作業的存取權。 如需有關角色指派和管理 Azure 資源存取權的詳細資訊，請參閱 [Azure 角色型存取控制](role-assignments-portal.md)。
...
| 元素名稱 | 必要 | 類型 | 說明 |
| --- | --- | --- | --- |
| roleDefinitionId |yes |字串 |角色的識別碼。 此識別碼的格式是： `{scope}/providers/Microsoft.Authorization/roleDefinitions/{role-definition-id-guid}` |
| principalId |yes |字串 |做為角色指派對象之 Azure AD 主體的 objectId (使用者、群組或服務主體)。 |
...
若要刪除角色指派，您必須具有 `Microsoft.Authorization/roleAssignments/delete` 作業的存取權。 在內建角色中，只有「擁有者」和「使用者存取系統管理員」會獲得這項作業的存取權。 如需有關角色指派和管理 Azure 資源存取權的詳細資訊，請參閱 [Azure 角色型存取控制](role-assignments-portal.md)。
...
若要列出角色，您必須具有該範圍內 `Microsoft.Authorization/roleDefinitions/read` 作業的存取權。 所有內建角色都會獲得這項作業的存取權。 如需有關角色指派和管理 Azure 資源存取權的詳細資訊，請參閱 [Azure 角色型存取控制](role-assignments-portal.md)。
...
取得由角色定義識別碼所指定的單一角色相關資訊。 若要使用角色的顯示名稱來取得單一角色的相關資訊，請參閱 [列出所有角色](role-assignments-rest.md#list-all-roles)。

若要取得角色的相關資訊，您必須具有 `Microsoft.Authorization/roleDefinitions/read` 作業的存取權。 所有內建角色都會獲得這項作業的存取權。 如需有關角色指派和管理 Azure 資源存取權的詳細資訊，請參閱 [Azure 角色型存取控制](role-assignments-portal.md)。
...
若要建立自訂角色，您必須在所有 `AssignableScopes` 上都具有 `Microsoft.Authorization/roleDefinitions/write` 作業的存取權。 在內建角色中，只有「擁有者」和「使用者存取系統管理員」會獲得這項作業的存取權。 如需有關角色指派和管理 Azure 資源存取權的詳細資訊，請參閱 [Azure 角色型存取控制](role-assignments-portal.md)。
...
| 元素名稱 | 必要 | 類型 | 說明 |
| --- | --- | --- | --- |
| name |yes |字串 |自訂角色的 GUID 識別碼。 |
| properties.roleName |yes |字串 |自訂角色的顯示名稱。 大小上限為 128 個字元。 |
| properties.description |否 |字串 |自訂角色的說明。 大小上限為 1024 個字元。 |
| properties.type |yes |字串 |設定為 "CustomRole"。 |
...
| properties.assignableScopes |yes |String[] |範圍陣列，此陣列指定可在其中使用自訂角色的範圍。 |
...
若要修改自訂角色，您必須在所有 `AssignableScopes` 上都具有 `Microsoft.Authorization/roleDefinitions/write` 作業的存取權。 在內建角色中，只有「擁有者」和「使用者存取系統管理員」會獲得這項作業的存取權。 如需有關角色指派和管理 Azure 資源存取權的詳細資訊，請參閱 [Azure 角色型存取控制](role-assignments-portal.md)。
...
| --- | --- | --- | --- |
| name |yes |字串 |自訂角色的 GUID 識別碼。 |
| properties.roleName |yes |字串 |已更新的自訂角色顯示名稱。 |
...
| properties.assignableScopes |yes |String[] |範圍陣列，此陣列指定可在其中使用已更新之自訂角色的範圍。 |
...
若要刪除自訂角色，您必須在所有 `AssignableScopes` 上都具有 `Microsoft.Authorization/roleDefinitions/delete` 作業的存取權。 在內建角色中，只有「擁有者」和「使用者存取系統管理員」會獲得這項作業的存取權。 如需有關角色指派和管理 Azure 資源存取權的詳細資訊，請參閱 [Azure 角色型存取控制](role-assignments-portal.md)。
