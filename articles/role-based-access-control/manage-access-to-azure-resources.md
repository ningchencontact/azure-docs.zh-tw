...
|||
|---|---|
| [Azure AD 租用戶與訂用帳戶之間的關聯性](rbac-and-directory-admin-roles.md) | 了解 Azure AD 如何作為 Azure 訂用帳戶之使用者和群組的受信任來源。 |
| [角色型存取控制 (RBAC)](overview.md) | 透過指派給使用者、群組或服務主體的角色，提供更細緻的存取管理。 |
...
| [受控服務識別 (MSI)](../active-directory/pp/msi-overview.md) | 為 Azure 資源 (例如虛擬機器) 提供自己的識別身分，讓您不需要將認證放在程式碼中。 |
