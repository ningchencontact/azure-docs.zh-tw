...
取得 [使用角色指派來管理 Azure 訂用帳戶資源的存取權](role-assignments-portal.md)的詳細資訊。
...
2. 選取 [使用者和群組]，然後選取 [所有使用者]或 [所有群組]。 在此範例中，我們將重點放在個別使用者。
    ![在 Azure Active Directory 中管理使用者和群組 - 螢幕擷取畫面](./media/role-assignments-users/rbac_users_groups.png)
3. 依名稱或使用者名稱搜尋使用者。
...
2. 選取 [移除]然後選取 [是] 以確認。
    ![移除存取權指派 - 螢幕擷取畫面](./media/role-assignments-users/delete_assignment.png)

## <a name="next-steps"></a>後續步驟

* 取得 [使用角色指派來管理 Azure 訂用帳戶資源的存取權](role-assignments-portal.md)
