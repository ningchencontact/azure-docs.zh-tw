...
ms.locfileid: "34161204"
---
# <a name="azure-resource-manager-resource-provider-operations"></a>Azure Resource Manager 資源提供者作業

本文會列出每個 Azure Resource Manager 資源提供者可用的作業。 這些作業可用在[自訂角色](custom-roles.md)中，以對 Azure 中的資源提供細微的[角色型存取控制 (RBAC)](overview.md)。 作業字串的格式如下：`Microsoft.{ProviderName}/{ChildResourceType}/{action}`
...
> | 動作類型 | 作業 | 說明 |
> | --- | --- | --- |
> | 動作 | Microsoft.AAD/domainServices/delete | 刪除 Domain Services。 |
> | 動作 | Microsoft.AAD/domainServices/read | 讀取 Domain Services。 |
> | 動作 | Microsoft.AAD/domainServices/write | 寫入 Domain Services |
> | 動作 | Microsoft.AAD/locations/operationresults/read | 讀取非同步作業的狀態。 |
> | 動作 | Microsoft.AAD/Operations/read | 已針對作業當地語系化的易記描述，因為您應該向使用者顯示此描述。 |
...
> | 動作 | Microsoft.ApiManagement/service/apis/diagnostics/loggers/delete | 移除記錄器和診斷設定的對應 |
> | 動作 | Microsoft.ApiManagement/service/apis/diagnostics/loggers/read | 取得現有診斷記錄器的清單 |
> | 動作 | Microsoft.ApiManagement/service/apis/diagnostics/loggers/write | 將記錄器對應至診斷設定 |
...
> | 動作 | Microsoft.ApiManagement/service/diagnostics/loggers/delete | 移除記錄器和診斷設定的對應 |
> | 動作 | Microsoft.ApiManagement/service/diagnostics/loggers/read | 取得現有診斷記錄器的清單 |
> | 動作 | Microsoft.ApiManagement/service/diagnostics/loggers/write | 將記錄器對應至診斷設定 |
...
> | 動作 | Microsoft.Automation/automationAccounts/modules/delete | 刪除 Azure 自動化模組 |
> | 動作 | Microsoft.Automation/automationAccounts/modules/getCount/action | 取得自動化帳戶內的模組計數 |
> | 動作 | Microsoft.Automation/automationAccounts/modules/read | 取得 Azure 自動化模組 |
> | 動作 | Microsoft.Automation/automationAccounts/modules/write | 建立或更新 Azure 自動化模組 |
...
> | 動作 | Microsoft.Automation/automationAccounts/runbooks/draft/publish/action | 發佈 Azure 自動化 Runbook 草稿 |
...
> | 動作類型 | 作業 | 說明 |
> | --- | --- | --- |
> | 動作 | Microsoft.BatchAI/clusters/delete | 刪除 Batch AI 叢集 |
> | 動作 | Microsoft.BatchAI/clusters/read | 列出 Batch AI 叢集，或取得 Batch AI 叢集的屬性 |
> | 動作 | Microsoft.BatchAI/clusters/remoteLoginInformation/action | 列出 Batch AI 叢集的遠端登入資訊 |
> | 動作 | Microsoft.BatchAI/clusters/write | 建立新的 Batch AI 叢集，或更新現有的 Batch AI 叢集 |
> | 動作 | Microsoft.BatchAI/fileservers/delete | 刪除 Batch AI 檔案伺服器 |
> | 動作 | Microsoft.BatchAI/fileservers/read | 列出 Batch AI 檔案伺服器，或取得 Batch AI 檔案伺服器的屬性 |
> | 動作 | Microsoft.BatchAI/fileservers/resume/action | 繼續執行 Batch AI 檔案伺服器 |
> | 動作 | Microsoft.BatchAI/fileservers/suspend/action | 暫止 Batch AI 檔案伺服器 |
> | 動作 | Microsoft.BatchAI/fileservers/write | 建立新的 Batch AI 檔案伺服器，或更新現有的 Batch AI 檔案伺服器 |
> | 動作 | Microsoft.BatchAI/jobs/delete | 刪除 Batch AI 作業 |
> | 動作 | Microsoft.BatchAI/jobs/read | 列出 Batch AI 作業，或取得 Batch AI 作業的屬性 |
> | 動作 | Microsoft.BatchAI/jobs/remoteLoginInformation/action | 列出 Batch AI 作業的遠端登入資訊 |
> | 動作 | Microsoft.BatchAI/jobs/terminate/action | 終止 Batch AI 作業 |
> | 動作 | Microsoft.BatchAI/jobs/write | 建立新的 Batch AI 作業，或更新現有的 Batch AI 作業 |
...
> | 動作 | Microsoft.ClassicCompute/domainNames/loadBalancedEndpointSets/read | 顯示已負載平衡的端點集 |
...
> | 動作 | Microsoft.ClassicCompute/domainNames/slots/roles/roleInstances/operationStatuses/read | 讀取網域名稱位置角色之角色執行個體的作業狀態。 |
...
> | 動作 | Microsoft.ClassicStorage/storageAccounts/images/delete | 刪除給定的儲存體帳戶映像。 |
> | 動作 | Microsoft.ClassicStorage/storageAccounts/images/read | 傳回儲存體帳戶映像。 |
...
> | 動作類型 | 作業 | 說明 |
> | --- | --- | --- |
> | 動作 | Microsoft.Commerce/RateCard/read | 傳回給定訂用帳戶的優惠資料、資源/計量中繼資料和速率。 |
...
> | 動作 | Microsoft.Devices/checkProvisioningServiceNameAvailability/Action | 檢查 IotHub 名稱是否可供使用 |
...
> | 動作 | Microsoft.Devices/provisioningServices/ProvisioningServiceKeys/listkeys/Action | 取得金鑰名稱的 IotDps 金鑰 |
...
> | 動作 | Microsoft.Insights/ActionGroups/Write | 寫入動作群組 |
> | 動作 | Microsoft.Insights/ActivityLogAlerts/Activated/Action | 已觸發活動記錄警示 |
> | 動作 | Microsoft.Insights/ActivityLogAlerts/Delete | 刪除活動記錄警示 |
> | 動作 | Microsoft.Insights/ActivityLogAlerts/Read | 讀取活動記錄警示 |
> | 動作 | Microsoft.Insights/ActivityLogAlerts/Write | 讀取活動記錄警示 |
> | 動作 | Microsoft.Insights/AlertRules/Activated/Action | 警示規則已啟用 |
> | 動作 | Microsoft.Insights/AlertRules/Delete | 刪除警示規則組態 |
> | 動作 | Microsoft.Insights/AlertRules/Incidents/Read | 讀取警示規則事件組態 |
> | 動作 | Microsoft.Insights/AlertRules/Read | 讀取警示規則組態 |
> | 動作 | Microsoft.Insights/AlertRules/Resolved/Action | 警示規則已解析 |
> | 動作 | Microsoft.Insights/AlertRules/Throttled/Action | 警示規則已節流 |
> | 動作 | Microsoft.Insights/AlertRules/Write | 寫入到警示規則組態 |
> | 動作 | Microsoft.Insights/AutoscaleSettings/Delete | 刪除自動調整設定組態 |
> | 動作 | Microsoft.Insights/AutoscaleSettings/providers/Microsoft.Insights/MetricDefinitions/Read | 讀取計量定義 |
> | 動作 | Microsoft.Insights/AutoscaleSettings/Read | 讀取自動調整設定組態 |
> | 動作 | Microsoft.Insights/AutoscaleSettings/Scaledown/Action | 自動調整相應減少作業 |
> | 動作 | Microsoft.Insights/AutoscaleSettings/Scaleup/Action | 自動調整相應增加作業 |
> | 動作 | Microsoft.Insights/AutoscaleSettings/Write | 寫入到自動調整設定組態 |
...
> | 動作 | Microsoft.Insights/DiagnosticSettings/Delete | 刪除診斷設定組態 |
> | 動作 | Microsoft.Insights/DiagnosticSettings/Read | 讀取診斷設定組態 |
> | 動作 | Microsoft.Insights/DiagnosticSettings/Write | 寫入到診斷設定組態 |
> | 動作 | Microsoft.Insights/EventCategories/Read | 讀取事件類別 |
> | 動作 | Microsoft.Insights/eventtypes/digestevents/Read | 讀取管理事件類型摘要 |
> | 動作 | Microsoft.Insights/eventtypes/values/Read | 讀取管理事件類型值 |
> | 動作 | Microsoft.Insights/ExtendedDiagnosticSettings/Delete | 刪除延伸的診斷設定組態 |
> | 動作 | Microsoft.Insights/ExtendedDiagnosticSettings/Read | 讀取延伸的診斷設定組態 |
> | 動作 | Microsoft.Insights/ExtendedDiagnosticSettings/Write | 寫入到延伸的診斷設定組態 |
...
> | 動作 | Microsoft.Insights/LogProfiles/Delete | 刪除記錄設定檔組態 |
> | 動作 | Microsoft.Insights/LogProfiles/Read | 讀取記錄設定檔 |
> | 動作 | Microsoft.Insights/LogProfiles/Write | 寫入到記錄設定檔組態 |
...
> | 動作 | Microsoft.Insights/MetricAlerts/Write | 寫入計量警示 |
...
> | 動作 | Microsoft.Insights/Metrics/Write | 寫入計量 |
...
> | 動作 | Microsoft.KeyVault/hsmPools/joinVault/action | 將 Key Vault 加入至 HSM 集區 |
...
> | 動作 | Microsoft.KeyVault/vaults/providers/Microsoft.Insights/logDefinitions/read | 取得 Key Vault 的可用記錄 |
> | 動作 | Microsoft.KeyVault/vaults/providers/Microsoft.Insights/metricDefinitions/read | 取得 Key Vault 的可用計量 |
...
> | 動作 | Microsoft.LabServices/labAccounts/sizes/read | 讀取大小。 |
...
> | 動作 | Microsoft.Logic/integrationAccounts/listKeyVaultKeys/action | 取得 Key Vault 中的金鑰。 |
...
> | 動作類型 | 作業 | 說明 |
> | --- | --- | --- |
> | 動作 | Microsoft.Migrate/Operations/read | 讀取公開的作業 |
...
> | 動作 | Microsoft.Network/intendedPolicies/delete | 刪除預定原則 |
> | 動作 | Microsoft.Network/intendedPolicies/read | 取得預定原則描述 |
> | 動作 | Microsoft.Network/intendedPolicies/write | 建立預定原則或更新現有的預定原則 |
...
> | 動作 | Microsoft.Network/loadBalancers/outboundNatRules/read | 取得負載平衡器的輸出 NAT 規則定義 |
...
> | 動作 | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationvCenters/delete | 刪除任何作業 |
> | 動作 | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationvCenters/read | 讀取任何作業 |
> | 動作 | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationvCenters/write | 建立或更新任何作業 |
...
> | 動作 | Microsoft.Security/locations/jitNetworkAccessPolicies/initiate/action | 起始 Just-in-Time 網路存取原則 |
...
> | 動作 | Microsoft.Sql/locations/networkInterfaceAzureAsyncOperation/read | 傳回特定網路介面 Azure 非同步作業的詳細資料 |
> | 動作 | Microsoft.Sql/locations/networkInterfaceOperationResults/read | 傳回指定網路介面作業的詳細資料 |
...
> | 動作 | Microsoft.Sql/servers/databases/replicationLinks/read | 傳回為特定資料庫所建立之複寫連結的詳細資料 |
...
> | 動作 | Microsoft.Sql/servers/networkInterfaces/read | 傳回指定網路介面的屬性 |
> | 動作 | Microsoft.Sql/servers/networkInterfaces/write | 使用指定參數建立網路介面，或更新指定網路介面的屬性或標記 |
...
> | 動作 | Microsoft.Storage/storageAccounts/storageAccounts/queueServices/providers/Microsoft.Insights/diagnosticSettings/read | 取得資源的診斷設定。 |
...
> | 動作 | microsoft.storagesync/storageSyncServices/syncGroups/cloudEndpoints/operationresults/read | 適用於非同步備份呼叫的位置 API |
...
> | 動作 | Microsoft.StorSimple/managers/devices/installUpdates/action | 在裝置上安裝更新 |
...
> | 動作 | Microsoft.StorSimple/managers/devices/listFailoverSets/action | 列出現有裝置的容錯移轉集。 |
> | 動作 | Microsoft.StorSimple/managers/devices/listFailoverTargets/action | 列出裝置的容錯移轉目標 |
...
> | 動作 | Microsoft.StorSimple/managers/devices/volumeContainers/listEncryptionKeys/action | 列出磁碟區容器的加密金鑰 |
...
> | 動作 | Microsoft.StorSimple/managers/devices/volumeContainers/rolloverEncryptionKey/action | 變換磁碟區容器的加密金鑰 |
...
> | 動作 | Microsoft.StorSimple/managers/listPrivateEncryptionKey/action | 取得 StorSimple 裝置管理員的私密加密金鑰。 |
...
> | 動作 | Microsoft.StorSimple/managers/storageAccountCredentials/listAccessKey/action | 列出儲存體帳戶認證的存取金鑰 |
...
> | 動作 | microsoft.web/connectiongateways/liststatus/action | 列出狀態連線閘道。 |
...
> | 動作 | Microsoft.WorkloadMonitor/workloads/delete | 刪除工作負載資源 |
