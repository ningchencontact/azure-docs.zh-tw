...
![PowerShell Get-AzureRMAuthorizationChangeLog - 螢幕擷取畫面](./media/change-history-report/access-change-history.png)
...
![以試算表形式來檢視的變更記錄 - 螢幕擷取畫面](./media/change-history-report/change-history-spreadsheet.png)

## <a name="next-steps"></a>後續步驟
* 使用 [Azure RBAC 中的自訂角色](custom-roles.md)
