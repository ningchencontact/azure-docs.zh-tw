...
**SQL Server 2016** | 不支援 DPM 2012 R2。 支援 DPM SAC、更新彙總套件 2 (含) 以後版本的 DPM 2016。<br/><br/> 內部部署/Azure VM。| 備份 SQL Server 資料庫。<br/><br/> 不支援 SQL Server 叢集備份。<br/><br/>不支援儲存在 CSV 上的資料庫。
