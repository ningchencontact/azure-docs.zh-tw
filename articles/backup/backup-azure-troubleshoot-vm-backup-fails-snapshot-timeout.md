...
## <a name="usererrorunsupporteddisksize---currently-azure-backup-does-not-support-disk-sizes-greater-than-4095-gb"></a>UserErrorUnsupportedDiskSize-目前 Azure 備份不支援大於 4095 GB 的磁片大小

**錯誤碼**：UserErrorUnsupportedDiskSize <br>
**錯誤訊息**：目前 Azure 備份不支援大於 4095 GB 的磁片大小 <br>
