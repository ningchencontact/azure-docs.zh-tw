...
若要停用/解決作用中警示, 您可以按一下對應至您想要停用之警示的清單專案。 這會開啟一個畫面, 其中顯示有關警示的詳細資訊, 而頂端有 [停用] 按鈕。 按一下此按鈕會將警示的狀態變更為「非作用中」。 只要以滑鼠右鍵按一下對應于該警示的清單專案, 然後選取 [停用], 也可以停用警示。
