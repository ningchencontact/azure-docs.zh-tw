...
**案例** | **OS 支援**
--- | ---
使用 Azure VM 代理程式擴充功能進行備份 | Windows 用戶端：不支援<br/><br/> Windows Server 2019 (資料中心/Datacenter Core)、 Windows Server 2016 (資料中心/Datacenter Core);Windows Server 2012 R2 Datacenter;Windows Server 2008 R2 （RTM 和 SP1）
