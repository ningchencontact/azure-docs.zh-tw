...
1. 在 [還原設定] 中，選取還原選項：
    ...
    - **取代現有的**：如果您想要取代現有 VM 上的磁碟，請使用此選項。
        ![還原設定精靈](./media/backup-azure-arm-restore-vms/restore-configuration.png)
2. 為您所選的還原選項指定設定。
...
- [將還原的磁碟](https://docs.microsoft.com/azure/virtual-machines/windows/attach-managed-disk-portal#option-2-attach-an-existing-disk)連結至現有 VM。
- 使用 PowerShell，從還原的磁碟[建立新 VM](https://docs.microsoft.com/azure/backup/backup-azure-vms-automation#create-a-vm-from-restored-disks。
