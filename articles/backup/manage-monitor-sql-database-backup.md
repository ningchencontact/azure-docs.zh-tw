...
建議您小心; 使用此選項具有已狀況良好的擴充功能的 VM 上觸發，這項作業會取得重新啟動的延伸模組。 這可能會導致失敗的所有進行中工作。 請檢查一或多個[徵狀](backup-sql-server-azure-troubleshoot.md#re-registration-failures)觸發重新註冊作業之前。
