---
title: 使用 Azure 備份來還原 Azure VM 上已備份的 SQL Server 資料庫 |Microsoft Docs
...
2. 在 [**選取還原點**] 中, 選取要[還原到特定的時間點](#restore-to-a-specific-point-in-time), 還是要[還原到特定的復原點](#restore-to-a-specific-restore-point)。
