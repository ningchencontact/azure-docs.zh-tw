...
Azure 備份可讓您備份 Azure 虛擬機器，其中包含使用客戶管理的金鑰加密的磁片。 如需詳細資訊，請參閱[使用客戶管理的金鑰來加密受控磁片](https://docs.microsoft.com/azure/virtual-machines/windows/disk-encryption#customer-managed-keys)。
