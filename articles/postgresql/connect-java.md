---
title: 使用 Java 連線至適用於 PostgreSQL 的 Azure 資料庫
...
ms.locfileid: "53544646"
---
# <a name="azure-database-for-postgresql-use-java-to-connect-and-query-data"></a>適用於 PostgreSQL 的 Azure 資料庫：使用 Java 連線並查詢資料
