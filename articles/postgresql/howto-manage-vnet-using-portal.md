---
title: 建立和管理 VNet 服務端點和規則，在 Azure Database for PostgreSQL-使用 Azure 入口網站的單一伺服器
description: 建立和管理 VNet 服務端點和規則 Azure Database for PostgreSQL-使用 Azure 入口網站的單一伺服器
author: bolzmj
ms.author: mbolz
...
ms.locfileid: "65073165"
---
# <a name="create-and-manage-vnet-service-endpoints-and-vnet-rules-in-azure-database-for-postgresql---single-server-by-using-the-azure-portal"></a>建立和管理 VNet 服務端點和 VNet 規則，在 Azure Database for PostgreSQL-使用 Azure 入口網站的單一伺服器
...
> [!Important]
> 如果您離開控制項設為 ON 時，您的 Azure PostgreSQL 資料庫伺服器會接受來自任何子網路的通訊。 就安全性觀點而言，讓此控制項保持 [開啟] 可能使存取過多。 Microsoft Azure 虛擬網路服務端點功能搭配虛擬網路規則功能的 Azure Database for PostgreSQL，同時可以減少安全性曝露面。
