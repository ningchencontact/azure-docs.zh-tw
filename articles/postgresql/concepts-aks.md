---
title: 連接 Azure Kubernetes Service (AKS) 與適用於 PostgreSQL 的 Azure 資料庫
description: 了解如何連接 Azure Kubernetes Service 與適用於 PostgreSQL 的 Azure 資料庫
author: rachel-msft
ms.author: raagyema
