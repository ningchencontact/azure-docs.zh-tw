...
1. 前往[Azure 入口網站](https://portal.azure.com)以提交支援要求。 搜尋並選取 [說明 **+ 支援**]。

    ![搜尋 [說明及支援]，Microsoft Azure 入口網站](./media/pay-by-invoice/search-for-help-and-support.png)

2. 選取 [新增支援要求]。

    ![新的支援要求連結、[說明及支援] 畫面、Microsoft Azure 入口網站](./media/pay-by-invoice/help-and-support.png)
...
1. 移至 [ [Azure 入口網站](https://portal.azure.com)] 以帳戶管理員身分登入。 搜尋並選取 [**成本管理 + 帳單**]。

    ![搜尋成本管理和計費，Microsoft Azure 入口網站](./media/pay-by-invoice/search.png)
...
1. 前往[Azure 入口網站](https://portal.azure.com)查看您的帳單資訊。 搜尋並選取 [**成本管理 + 帳單**]。
1. 在功能表中，選擇 [**帳單設定檔**]。

    ![帳單設定檔功能表項目、成本管理和計費，Microsoft Azure 入口網站](./media/pay-by-invoice/billing-profile.png)

1. 選取帳單設定檔。
1. 在 [**帳單設定檔**] 功能表中，選取 [**付款條件**]。

   ![付款方法功能表項目、帳單設定檔、成本管理 Microsoft Azure 入口網站](./media/pay-by-invoice/billing-profile-payment-methods.png)

1. 選取橫幅，指出您有資格使用支票/有線轉移來付款。

    ![用來切換至支票/有線、付款條件、Microsoft Azure 入口網站的橫幅](./media/pay-by-invoice/customer-led-switch-to-invoice.png)
