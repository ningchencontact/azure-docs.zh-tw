...
| **類別目錄**  | **供應項目名稱** | **配額識別碼** | **供應項目號碼** | **可用的資料** |
| --- | --- | --- | --- | --- |
...
| **Azure Government** | Azure Government 隨用隨付 | PayAsYouGo_2014-09-01 | MS-AZR-0017P-USGOV-MS-AZR-0003P |
...
| Marketplace 供應專案使用量<sup>6</sup> | 稅金 - 如需詳細資訊，請參閱[發票條款說明](../understand/understand-invoice.md)。 |
