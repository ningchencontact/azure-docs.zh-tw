...
您可能需要變更要接收訂單狀態電子郵件的使用者。 例如，需要在裝置已送達或收取時通知的使用者。 另一位使用者可能需要讓他們可以確認資料位於 Azure 儲存體帳戶之前先刪除從來源資料複製程序完成時收到通知。 在這些情況下，您可以編輯通知詳細資料。
...
|完成       |已順利完成訂單。<br> 從伺服器刪除內部部署資料之前，請確認資料已位於 Azure 中。         |
