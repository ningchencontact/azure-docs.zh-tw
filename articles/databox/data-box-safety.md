...
| ![超重圖示](./media/data-box-safety/heavy_weight_hazard_icon.png) **重量** | |
| ![沒有使用者可自行維修零件圖示](./media/data-box-safety/no_user_serviceable_parts_icon.png) **沒有使用者可自行維修的零件** |除非受過適當訓練，否則請勿觸碰。 |
| ![閱讀安全性注意事項圖示](./media/data-box-safety/read_safety_and_health_information_icon.png) **請先閱讀所有指示** | |
| ![傾倒危險圖示](./media/data-box-safety/tip_hazard_icon.png) **傾倒危險** | |
...
* 完整設定的機箱重達 22.7 公斤 (50 磅)；請勿嘗試自己將其抬起。
* 移動機箱之前，請務必確定由兩人承受重量。 請注意，一個人嘗試抬起這個重量可能造成受傷。


![警告圖示](./media/data-box-safety/warning_icon.png) ![傾倒危險圖示](./media/data-box-safety/tip_hazard_icon.png) **警告！**
...
此節提供 Azure 資料箱 (法規型號 DB010) 的法規資訊。
...
* [連接資料箱的纜線並且連線](data-box-deploy-set-up.md)
