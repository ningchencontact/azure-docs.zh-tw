...
若要確認您已正確設定您的 CNAME，您可以在其中一個目標端點上使用 [nslookup](https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/nslookup)，例如 `expenses.adventure-works.com`。  您的回應應該包含已經提到的別名 (`<Id.tenant>.runtime.msappproxy.net`)。
...
- 內部 URL：
    ...
    ![內部 URL](./media/active-directory-application-proxy-wildcard\42.png)
...
- 內部應用程式 SPN： 
    ...
    ![SPN 設定](./media/active-directory-application-proxy-wildcard\44.png)
...
- 在 [內部 URL] 中，您設定 **finance** 而不是萬用字元。 
    ...
    ![內部 URL](./media/active-directory-application-proxy-wildcard\52.png)
...
- 在內部應用程式 SPN中，您設定 **finance** 而不是萬用字元。
    ...
    ![SPN 設定](./media/active-directory-application-proxy-wildcard\54.png)


設定會實作下列案例：

![案例](./media/active-directory-application-proxy-wildcard\09.png)
