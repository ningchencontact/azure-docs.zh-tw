...
4. 在搜尋方塊中，輸入 **Zwayam**，從結果面板中選取 [Zwayam]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 Zwayam](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_addfromgallery.png)
...
3. **[建立 Zwayam 測試使用者](#create-a-zwayam-test-user)** - 使 Zwayam 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_samlbase.png)

3. 在 [Zwayam 網域與 URL] 區段上，執行下列步驟：

    ![Zwayam 網域與 URL 單一登入資訊](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_url.png)
...
4. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。
    ...
    ![憑證下載連結](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_certificate.png) 

5. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/active-directory-saas-zwayam-tutorial/tutorial_general_400.png)

6. 在 [Zwayam 組態] 區段上，按一下 [設定 Zwayam] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段複製 [SAML 實體識別碼]，並在 [Zwayam 網域及 URL] 區段中的 [登入 URL] 文字方塊中，貼上 [SAML 實體識別碼] 值。

    ![Zwayam 組態](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_configure.png) 

7. 若要在 **Zwayam** 端設定單一登入，您必須將已下載的**中繼資料 XML** 傳送給 [Zwayam 支援小組](mailto:opendoors@zwayam.com)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-zwayam-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-zwayam-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-zwayam-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-zwayam-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [Zwayam]。

    ![應用程式清單中的 Zwayam 連結](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_app.png)  
