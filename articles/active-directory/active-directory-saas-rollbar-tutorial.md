...
4. 在搜尋方塊中，輸入 **Rollbar**，從結果面板中選取 [Rollbar]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 Rollbar](./media/active-directory-saas-rollbar-tutorial/tutorial_rollbar_addfromgallery.png)
...
3. 如果您想要以 **IDP** 起始模式設定應用程式，請在 [Rollbar 網域及 URL] 區段上執行下列步驟：
    ...
    ![Rollbar 網域及 URL 單一登入資訊](./media/active-directory-saas-rollbar-tutorial/tutorial_rollbar_url.png)
...
4. 如果您想要以 **SP** 起始模式設定應用程式，請勾選 [顯示進階 URL 設定]，然後執行下列步驟：
    ...
    ![Rollbar 網域及 URL 單一登入資訊](./media/active-directory-saas-rollbar-tutorial/tutorial_rollbar_url1.png)
