...
1. 請參閱下列 Azure VM 快速入門，完成必要的章節 （「 登入至 Azure 」，「 建立資源群組 」，「 建立網路群組 」，「 建立 VM 」） 的其中一個。
   ...
   - [建立使用 PowerShell 將 Windows 虛擬機器](../../virtual-machines/windows/quick-create-powershell.md)
   - [建立 Linux 虛擬機器，使用 PowerShell](../../virtual-machines/linux/quick-create-powershell.md)
...
- [受管理的身分識別的 Azure 資源的概觀](overview.md)
