...
4. 在搜尋方塊中，輸入 **Jamf Pro**，從結果面板中選取 [Jamf Pro]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 Jamf Pro](./media/active-directory-saas-jamfprosamlconnector-tutorial/tutorial_jamfprosamlconnector_addfromgallery.png)
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-jamfprosamlconnector-tutorial/tutorial_jamfprosamlconnector_samlbase.png)

3. 如果您想要以 **IDP** 起始模式設定應用程式，請在 [Jamf Pro 網域及 URL] 區段上執行下列步驟：

    ![Jamf Pro 網域及 URL 單一登入資訊](./media/active-directory-saas-jamfprosamlconnector-tutorial/tutorial_jamfprosamlconnector_url.png)
...
4. 如果您想要以 **SP** 起始模式設定應用程式，請勾選 [顯示進階 URL 設定]，然後執行下列步驟：
    ...
    ![Jamf Pro 網域及 URL 單一登入資訊](./media/active-directory-saas-jamfprosamlconnector-tutorial/tutorial_jamfprosamlconnector_url1.png)
...
7. 在不同的網頁瀏覽器視窗中，以系統管理員身分登入您的 Jamf Pro 公司網站。

8. 按一下頁面右上角的**設定圖示**。

    ![Jamf Pro 設定](./media/active-directory-saas-jamfprosamlconnector-tutorial/configure1.png)

9. 按一下 [單一登入]。

    ![Jamf Pro 設定](./media/active-directory-saas-jamfprosamlconnector-tutorial/configure2.png)

10. 向下捲動至 [單一登入] 區段下方的 [身分識別提供者]，然後執行下列步驟：

    ![Jamf Pro 設定](./media/active-directory-saas-jamfprosamlconnector-tutorial/configure3.png)
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-jamfprosamlconnector-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-jamfprosamlconnector-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-jamfprosamlconnector-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-jamfprosamlconnector-tutorial/create_aaduser_04.png)
...
2. 按一下頁面右上角的**設定圖示**。
    ...
    ![新增員工](./media/active-directory-saas-jamfprosamlconnector-tutorial/configure1.png)
...
5. 選取 [建立標準帳戶]。
    ...
    ![新增員工](./media/active-directory-saas-jamfprosamlconnector-tutorial/user3.png)

6. 在 [新增帳戶] 對話方塊上，執行下列步驟：

    ![新增員工](./media/active-directory-saas-jamfprosamlconnector-tutorial/user4.png)
...
2. 在應用程式清單中，選取 [Jamf Pro]。
    ...
    ![應用程式清單中的 Jamf Pro 連結](./media/active-directory-saas-jamfprosamlconnector-tutorial/tutorial_jamfprosamlconnector_app.png)  
