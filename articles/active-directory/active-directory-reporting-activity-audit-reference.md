...
- 報告，請參閱 [Azure Active Directory 報告](active-directory-reporting-azure-portal.md)。

- 稽核活動報告，請參閱 [Azure Active Directory 入口網站中的稽核活動報告](active-directory-reporting-activity-audit-logs.md)。 
