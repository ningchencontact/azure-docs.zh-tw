...
4. 在搜尋方塊中，輸入 **ContractWorks**，從結果面板中選取 [ContractWorks]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 ContractWorks](./media/active-directory-saas-contractworks-tutorial/tutorial_contractworks_addfromgallery.png)
...
3. **[建立 ContractWorks 測試使用者](#create-a-contractworks-test-user)** - 在 ContractWorks 中建立 Britta Simon 的對應項目，且該項目須與 Azure AD 中代表使用者的項目連結。
...
3. 如果您想要以 **IDP** 起始模式設定應用程式，請在 [ContractWorks 網域和 URL] 區段上執行下列步驟：
    ...
    ![ContractWorks 網域及 URL 單一登入資訊](./media/active-directory-saas-contractworks-tutorial/tutorial_contractworks_url.png)

    在 [識別碼] 文字方塊中，輸入 URL：`https://login.securedocs.com/saml/metadata`

4. 如果您想要以 **SP** 起始模式設定應用程式，請勾選 [顯示進階 URL 設定]，然後執行下列步驟：

    ![ContractWorks 網域及 URL 單一登入資訊](./media/active-directory-saas-contractworks-tutorial/tutorial_contractworks_url1.png)

    在 [登入 URL] 文字方塊中，輸入 URL：`https://login.securedocs.com/saml/hint`
     
5. ContractWorks 應用程式會預期要有特定格式的 SAML 判斷提示。 設定此應用程式的下列宣告。 您可以在應用程式整合頁面的 [使用者屬性] 區段中，管理這些屬性的值。 以下螢幕擷取畫面顯示上述的範例。
    
    ![設定單一登入](./media/active-directory-saas-contractworks-tutorial/tutorial_ContractWorks_attribute.png)
...
6. 在 [單一登入] 對話方塊的 [使用者屬性] 區段中，如上圖所示設定 SAML 權杖屬性，然後執行下列步驟：
    ...
    ![設定單一登入](./media/active-directory-saas-contractworks-tutorial/tutorial_attribute_04.png)

    ![設定單一登入](./media/active-directory-saas-contractworks-tutorial/tutorial_attribute_05.png)
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-contractworks-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-contractworks-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-contractworks-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-contractworks-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [ContractWorks]。

    ![應用程式清單中的 ContractWorks 連結](./media/active-directory-saas-contractworks-tutorial/tutorial_contractworks_app.png)  
