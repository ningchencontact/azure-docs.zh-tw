...
4. 在搜尋方塊中，輸入 **DATABASICS**，從結果面板中選取 [DATABASICS]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 DATABASICS](./media/active-directory-saas-databasics-tutorial/tutorial_databasics_addfromgallery.png)
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-databasics-tutorial/tutorial_databasics_samlbase.png)

3. 在 [DATABASICS 網域與 URL] 區段中，執行下列步驟：

    ![DATABASICS 網域及 URL 單一登入資訊](./media/active-directory-saas-databasics-tutorial/tutorial_databasics_url.png)
...
4. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。
    ...
    ![憑證下載連結](./media/active-directory-saas-databasics-tutorial/tutorial_databasics_certificate.png) 
...
3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。
    ...
    ![[新增] 按鈕](./media/active-directory-saas-databasics-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-databasics-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [DATABASICS]。
    ...
    ![應用程式清單中的 DATABASICS 連結](./media/active-directory-saas-databasics-tutorial/tutorial_databasics_app.png)  
