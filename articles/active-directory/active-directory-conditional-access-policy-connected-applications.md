...
此設定只適用於已加入內部部署 AD 的 Windows 10 裝置。 您只可以使用「加入混合式 Azure AD」向 Azure AD 註冊這些裝置，而這是註冊 Windows 10 裝置的[自動化程序](device-management-hybrid-azuread-joined-devices-setup.md)。 
