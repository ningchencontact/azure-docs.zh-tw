...
4. 在搜尋方塊中，輸入 **Trisotech Digital Enterprise Server**，從結果面板中選取 [Trisotech Digital Enterprise Server]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 Trisotech Digital Enterprise Server](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_addfromgallery.png)
...
3. **[建立 Trisotech Digital Enterprise Server測試使用者](#create-a-trisotech-digital-enterprise-server-test-user)** - 使 Trisotech Digital Enterprise Server 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_samlbase.png)

3. 在 [Trisotech Digital Enterprise Server 網域及 URL] 區段中，執行下列步驟：

    ![Trisotech Digital Enterprise Server 網域與 URL 單一登入資訊](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_url.png)
...
7. 按一下 [功能表圖示]，然後選取 [管理]。
    ...
    ![設定單一登入](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/user1.png)

8. 選取 [使用者提供者]。

    ![設定單一登入](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/user2.png)

9. 在 [使用者提供者組態] 區段中執行下列步驟：

    ![設定單一登入](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/user3.png)
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [Trisotech Digital Enterprise Server]。
    ...
    ![應用程式清單中的 Trisotech Digital Enterprise Server 連結](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_app.png)  
