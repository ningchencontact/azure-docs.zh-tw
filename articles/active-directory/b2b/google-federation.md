...
5. 捲動至 [授權的網域] 區段並輸入 microsoftonline.com。
   ...
   ![授權的網域區段](media/google-federation/google-oauth-authorized-domains.png)
