...
4. 在搜尋方塊中，輸入 **Versal**，從結果面板中選取 **Versal**，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 Versal](./media/active-directory-saas-versal-tutorial/tutorial_versal_addfromgallery.png)
...
3. **[建立 Versal 測試使用者](#create-a-versal-test-user)** - 讓 Versal 中對應的 Britta Simon 連結到使用者在 Azure AD 中的代表項目。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-versal-tutorial/tutorial_versal_samlbase.png)

3. 在 [Versal 網域與 URL] 區段中，執行下列步驟：

    ![Versal 網域與 URL 單一登入資訊](./media/active-directory-saas-versal-tutorial/tutorial_versal_url.png)
...
4. 應用程式需要特定格式的 SAML 判斷提示，需要您將自訂屬性對應新增到您的 SAML 權杖屬性設定。 以下螢幕擷取畫面顯示上述的範例。 [使用者識別碼] 的預設值是 **user.userprincipalname**，但是 **Versal** 預期它是與使用者電子郵件地址對應的值。 對此您可以使用清單中的 **user.mail** 屬性，或者根據組織組態使用適當的屬性值。
    
    ![使用者識別碼下拉式功能表](./media/active-directory-saas-versal-tutorial/tutorial_versal_attribute.png)

5. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。

    ![憑證下載連結](./media/active-directory-saas-versal-tutorial/tutorial_versal_certificate.png) 

6. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/active-directory-saas-versal-tutorial/tutorial_general_400.png)
    
7. 若要在 **Versal** 端設定單一登入，您必須將所下載的「中繼資料 XML」和「SAML 簽署憑證」傳送給 [ Versal 支援小組](https://support.versal.com/hc/)。 他們將設定 Versal 組織，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-versal-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-versal-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-versal-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-versal-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [Versal]。
    ...
    ![應用程式清單中的 Versal 連結](./media/active-directory-saas-versal-tutorial/tutorial_versal_app.png)  
