...
現，在您可以將 VM 存取權授與 Azure SQL 伺服器中的資料庫。  在這個步驟，您可以使用現有的 SQL 伺服器或建立新的。  若要使用 Azure 入口網站建立新的伺服器和資料庫，請遵循此 [Azure SQL 快速入門](~/articles/sql-database/sql-database-get-started-portal.md)的作法。 在 [Azure SQL 文件](~/articles/sql-database/index.yml)中也有使用 Azure CLI 和 Azure PowerShell 的快速入門作法。
...
- [SQL Database 和 SQL 資料倉儲的通用驗證 (MFA 的 SSMS 支援)](~/articles/sql-database/sql-database-ssms-mfa-authentication.md)
- [使用 SQL Database 或 SQL 資料倉儲設定和管理 Azure Active Directory 驗證](~/articles/sql-database/sql-database-aad-authentication-configure.md)
...
- 深入了解 [Azure AD 驗證的 Azure SQL 支援](~/articles/sql-database/sql-database-aad-authentication.md)。
- 深入了解[設定 Azure AD 驗證的 Azure SQL 支援](~/articles/sql-database/sql-database-aad-authentication-configure.md)。
