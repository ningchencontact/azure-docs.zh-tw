...
在本教學課程中，您將了解如何整合 BambooHR 與 Azure Active Directory (Azure AD)。
...
2. 在 [單一登入] 視窗的 [模式] 下拉式清單中，選取 [SAML 登入]。
    ...
    ![[單一登入] 視窗](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_samlbase.png)

3. 在 [BambooHR 網域及 URL] 底下，執行下列操作：

    ![[BambooHR 網域及 URL] 區段](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_url.png)
...
5. 選取 [ **儲存**]。
    ...
    ![[儲存] 按鈕](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_general_400.png)
...
8. 在首頁上，執行下列操作：
    ...
    ![BambooHR 單一登入頁面](./media/active-directory-saas-bamboo-hr-tutorial/ic796691.png "單一登入")   
...
9. 在 [SAML Single Sign-On] \(SAML 單一登入\) 窗格中，執行下列操作：
    ...
    ![[SAML Single Sign-On] \(SAML 單一登入\) 窗格](./media/active-directory-saas-bamboo-hr-tutorial/IC796692.png "SAML 單一登入")
...
4. 在 [使用者] 視窗中，執行下列操作：
    ...
    ![[使用者] 視窗](./media/active-directory-saas-bamboo-hr-tutorial/create_aaduser_04.png)
...
2. 在頂端的工具列中，選取 [Settings] \(設定\)。
    ...
    ![[Settings] \(設定\) 按鈕](./media/active-directory-saas-bamboo-hr-tutorial/IC796694.png "設定")
...
2. 在 [企業應用程式] 清單中，選取 [BambooHR]。
    ...
    ![[企業應用程式] 清單中的 [BambooHR] 連結](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_app.png)  
