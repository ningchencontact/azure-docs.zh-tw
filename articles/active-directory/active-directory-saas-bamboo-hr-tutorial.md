...
4. 在搜尋方塊中，輸入 **BambooHR**，從結果面板中選取 [BambooHR]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 BambooHR](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_addfromgallery.png)
...
3. **[建立 BambooHR 測試使用者](#create-a-bamboohr-test-user)** - 在 BambooHR 中建立一個與 Azure AD 中代表 Britta Simon 之項目連結的 Britta Simon 對應項目。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_samlbase.png)

3. 在 [BambooHR 網域及 URL] 區段上，執行下列步驟：

    ![BambooHR 網域及 URL 單一登入資訊](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_url.png)

    a. 在 [登入 URL] 文字方塊中，使用下列模式輸入 URL︰`https://<company>.bamboohr.com`

    b. 在 [識別碼] 文字方塊中，輸入一個值：`BambooHR-SAML`

    > [!NOTE] 
    > [登入 URL] 的值不是真正的值。 請使用實際的「登入 URL」來更新此值。 請連絡 [BambooHR 用戶端支援小組](https://www.bamboohr.com/contact.php)以取得此值。 
 
4. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。

    ![憑證下載連結](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_certificate.png) 

5. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_general_400.png)

6. 在 [BambooHR 組態] 區段上，按一下 [設定 BambooHR] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 單一登入服務 URL]。

    ![BambooHR 設定](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_configure.png) 
...
8. 在 [SAML 單一登入] 區段中，執行下列步驟：
    ...
    a. 在 [SSO 登入 URL] 文字方塊中，貼上您從 Azure 入口網站複製的 [SAML 單一登入服務 URL] 值。
      
    b. 在記事本中開啟從 Azure 入口網站下載的 Base-64 編碼憑證，將其內容複製到您的剪貼簿，然後貼到 [X.509 憑證] 文字方塊中
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-bamboo-hr-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-bamboo-hr-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-bamboo-hr-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-bamboo-hr-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [BambooHR]。
    ...
    ![應用程式清單中的 BambooHR 連結](./media/active-directory-saas-bamboo-hr-tutorial/tutorial_bamboohr_app.png)  
