...
Azure Active Directory Identity Protection 會分析您的組態，並偵測可能影響您使用者身份識別的弱點。 如需詳細資訊，請參閱 [Azure Active Directory Identity Protection 偵測到的弱點](identity-protection/vulnerabilities.md)。
...
您可以將調查活動繫結至 Azure Active Directory Protection 傳送的每封電子郵件 [通知](identity-protection/notifications.md) 。
...
* [有風險的登入復原](identity-protection/flows.md#risky-sign-in-recovery)
* [已封鎖有風險的登入](identity-protection/flows.md#risky-sign-in-blocked)  
* [使用 Azure AD Identity Protection 時的登入體驗](identity-protection/flows.md)  
...
* [遭到入侵的帳戶復原流程](identity-protection/flows.md#compromised-account-recovery)。  
* [遭到入侵的帳戶封鎖流程](identity-protection/flows.md#compromised-account-blocked)。  
...
* [Multi-Factor Authentication 註冊流程](identity-protection/flows.md#multi-factor-authentication-registration)。  
* [使用 Azure AD Identity Protection 時的登入體驗](identity-protection/flows.md)。  
...
* [Azure Active Directory Identity Protection 偵測到的弱點](identity-protection/vulnerabilities.md)

* [Azure Active Directory 風險事件](active-directory-identity-protection-risk-events.md)

* [Azure Active Directory Identity Protection 通知](identity-protection/notifications.md)

* [Azure Active Directory Identity Protection 腳本](identity-protection/playbook.md)

* [Azure Active Directory Identity Protection 詞彙](identity-protection/glossary.md)

* [使用 Azure AD Identity Protection 時的登入體驗](identity-protection/flows.md)

* [Azure Active Directory Identity Protection - 如何解鎖使用者](identity-protection/howto-unblock-user.md)

* [開始使用 Azure Active Directory Identity Protection 和 Microsoft Graph](identity-protection/graph-get-started.md)
