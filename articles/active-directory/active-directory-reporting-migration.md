...
Azure AD 異常活動安全性報告已經合併，可為您提供一個集中檢視。 此檢視顯示 Azure AD 可以偵測及作為報告依據的所有安全性相關風險事件。
...
![企業應用程式登入報表](./media/active-directory-reporting-migration/199.png)
