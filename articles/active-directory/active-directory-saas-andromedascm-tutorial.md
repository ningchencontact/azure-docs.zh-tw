...
4. 在搜尋方塊中，輸入 **Andromeda**，從結果面板中選取 [Andromeda]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 Andromeda](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_addfromgallery.png)
...
3. 如果您想要以 **IDP** 起始模式設定應用程式，請在 [Andromeda 網域和 URL] 區段上執行下列步驟：
    ...
    ![Andromeda 網域與 URL 單一登入資訊](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_url.png)
...
4. 如果您想要以 **SP** 起始模式設定應用程式，請勾選 [顯示進階 URL 設定]，然後執行下列步驟：
    ...
    ![Andromeda 網域與 URL 單一登入資訊](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_url1.png)
...
9. 在 [Andromeda 組態] 區段上，按一下 [設定 Andromeda] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 單一登入服務 URL]。
    ...
    ![Andromeda 組態](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_configure.png)

10. 以系統管理員身分登入您的 Andromeda 公司網站。

11. 在功能表列頂端按一下 [系統管理員]，並且瀏覽至 [系統管理]。

    ![Andromeda 系統管理](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_admin.png)
...
13. 在 [SAML 設定] 區段頁面上，執行下列步驟：
    ...
    ![Andromeda 設定](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_config.png)
    ...
    ![Andromeda 屬性對應](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_attbmap.png)
...
2. 在應用程式清單中，選取 [Andromeda]。
    ...
    ![應用程式清單中的 Andromeda 連結](./media/active-directory-saas-andromedascm-tutorial/tutorial_andromedascm_app.png)  
