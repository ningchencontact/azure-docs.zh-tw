...
針對 Chrome 支援**Windows 10 Creators Update （1703年版）** 或更新版本中，安裝[10 的 Windows 帳戶延伸模組](https://chrome.google.com/webstore/detail/windows-10-accounts/ppnbnpeolgkicgegkbkbjmhlideopiji)。 條件式存取原則會要求裝置特定詳細資料時，需要此延伸模組。
