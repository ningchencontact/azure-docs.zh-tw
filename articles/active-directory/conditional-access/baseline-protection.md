...
如果您有在指令碼中使用的特殊權限帳戶，則應以 [Azure 資源的受控識別](../managed-identities-azure-resources/overview.md)或[服務主體 (具有憑證)](../develop/howto-authenticate-service-principal-powershell.md) 取代這些帳戶。 您暫時可以在基準原則中排除特定使用者帳戶，來解決此問題。 
