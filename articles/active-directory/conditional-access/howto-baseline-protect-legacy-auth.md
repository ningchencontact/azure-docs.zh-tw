...
* 使用舊版的郵件通訊協定，例如 IMAP/SMPT/POP3 任何用戶端
...
SharePoint Online 啟用新式驗證的預設值。 對於在 2017 年 8 月 1 日之後建立的目錄預設會在 Exchange Online 啟用新式驗證。 不過，如果您先前已停用新式驗證，或您使用在此日期之前建立的目錄，請遵循下列文章中的步驟[Exchange online 啟用新式驗證](https://docs.microsoft.com/en-us/exchange/clients-and-mobile-in-exchange-online/enable-or-disable-modern-authentication-in-exchange-online)。
