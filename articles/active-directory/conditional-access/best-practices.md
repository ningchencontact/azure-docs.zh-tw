...
是，您可以使用一些條件式存取原則中的 Exchange ActiveSync[限制](https://docs.microsoft.com/azure/active-directory/conditional-access/conditional-access-for-exo-and-spo#exchange-activesync)。 
