...
## <a name="faq"></a>常見問題集
**问：我使用 Connect，但卻收到來自 Azure 團隊的電子郵件通知和/或來自 Office 365 訊息中心的訊息。**  
