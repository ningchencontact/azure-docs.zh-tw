...
| [添加新的联合域](how-to-connect-fed-management.md#addfeddomain) |新增要與 Azure AD 同盟的其他網域。 |
| [更新 SSL 证书](how-to-connect-fed-ssl-update.md)| 更新 AD FS 伺服器陣列的 SSL 憑證。 |
...
| [添加自定义公司徽标/插图](how-to-connect-fed-management.md#customlogo) |指定要顯示於 AD FS 登入頁面的自訂標誌來修改登入體驗。 |
| [添加登录说明](how-to-connect-fed-management.md#addsignindescription) |變更 AD FS 登入頁面上的登入說明。 |
| [修改 AD FS 声明规则](how-to-connect-fed-management.md#modclaims) |修改或新增對應至 Azure AD Connect 同步組態之 AD FS 中的宣告規則。 |
