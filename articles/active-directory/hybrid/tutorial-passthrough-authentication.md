...
## <a name="install-active-directory-prerequisites"></a>安裝 Active Directory 先決條件
...
11. 當安裝完成時，按一下 [結束]。
12. 安裝完成之後，請先登出並重新登入，再使用 Synchronization Service Manager 或「同步處理規則編輯器」。
