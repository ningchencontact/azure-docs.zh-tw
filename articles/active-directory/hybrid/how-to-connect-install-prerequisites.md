...
* 如果您使用個別的 SQL Server，這些需求適用於：
  * Azure AD Connect 支援各種 Microsoft SQL Server 版本，從 SQL Server 2008 (含最新的 Service Pack) 到 SQL Server 2017 都包含在內。 **不支援** 使用 Microsoft Azure SQL Database 作為資料庫。
