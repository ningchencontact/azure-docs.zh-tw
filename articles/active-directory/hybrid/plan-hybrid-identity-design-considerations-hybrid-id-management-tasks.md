...
在您的組織中散發管理工作，可以改善管理的精確度和效率，並改善組織的工作負載平衡。 以下是定義健全的身分識別管理系統的要點。
 ...
 ![身分識別管理考量](./media/plan-hybrid-identity-design-considerations/Identity_management_considerations.png)
...
![目錄同步作業](./media/plan-hybrid-identity-design-considerations/Directory_synchronization.png)要適當設計混合式身分識別解決方案的同步處理會確定會回答下列問題: • 適用於混合式身分識別解決方案的同步處理解決方案為何？
•    有哪些可用的單一登入功能？
