...
|WinRM  | 5985（TCP/UDP） |僅適用于使用 gMSA by Azure AD Connect Wizard 安裝 AD FS 時|
|AD DS Web 服務 | 9389（TCP/UDP） |僅適用于使用 gMSA by Azure AD Connect Wizard 安裝 AD FS 時 |
