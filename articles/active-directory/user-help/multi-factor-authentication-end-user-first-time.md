...
如果登入時未看到類似畫面，請遵循[管理您的雙步驟驗證設定](multi-factor-authentication-end-user-manage-settings.md#using-the-additional-security-verification-page)中的指示，以尋找您可以在其中管理驗證選項的設定頁面。
...
9. 建議您輸入您的行動電話號碼，以防萬一您無法存取行動裝置應用程式。 從下拉式清單中指定您的國家/地區, 然後在國家/地區名稱旁的方塊中輸入您的行動電話號碼。 選取 [下一步]。
