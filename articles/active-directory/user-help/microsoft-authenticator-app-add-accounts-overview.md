...
## <a name="what-account-types-can-i-add"></a>我可以新增哪些帳戶類型
您可以針對您每天使用的許多帳戶，開啟雙因素驗證，包括：
...
|文章 |說明 |
|------|------------|
|[新增公司或學校帳戶](microsoft-authenticator-app-add-work-account.md)|描述如何將公司和學校帳戶新增至 Microsoft Authenticator 應用程式以進行雙因素驗證。|
|[新增您的個人 Microsoft 帳戶](microsoft-authenticator-app-add-personal-account.md)|描述如何新增您的 Microsoft 個人帳戶以近行雙因素驗證和手機登入 (也稱為無密碼登入)。|
|[新增個人的非 Microsoft 帳戶](microsoft-authenticator-app-add-non-microsoft-account.md)|描述如何新增非 Microsoft 個人帳戶以進行雙因素驗證。|
|[手動新增帳戶](microsoft-authenticator-app-add-account-manual.md)|描述相機無法擷取 QR 代碼時，如何以手動方式將帳戶新增至 Microsoft Authenticator 應用程式。|
