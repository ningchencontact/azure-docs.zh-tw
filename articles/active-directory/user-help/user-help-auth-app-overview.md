...
- 在您以使用者名稱和密碼登入後，提供第二個驗證方法的提示。

- 使用您的使用者名稱和採用指紋、臉部或 PIN 的行動裝置提供登入，而無須輸入密碼。

>[!Important]
>本內容適用於使用者。 I如果您是系統管理員，可以在 [Azure Active Directory 文件](https://docs.microsoft.com/azure/active-directory)中找到更多關於如何設定和管理 Azure Active Directory (Azure AD) 環境的資訊。<br><br>如果您有登入帳戶方面的問題，請參閱[當您無法登入 Microsoft 帳戶時](https://support.microsoft.com/help/12429)以取得說明。  如果您在嘗試登入 Microsoft 帳戶時收到[「該 Microsoft 帳戶不存在」](https://support.microsoft.com/help/13811)訊息，請取得相關因應措施的詳細資訊。
...
- **驗證碼。** 在您要登入工作/學校帳戶或個人 Microsoft 帳戶的裝置中輸入您的使用者名稱和密碼，然後從 Microsoft Authenticator 應用程式的 [帳戶] 畫面中複製相關聯的驗證碼。
...
- **公司或學校帳戶。** 如果您使用公司或學校帳戶 (例如 alain@contoso.com)，則會由您的組織決定您是否必須使用雙因素驗證，以及特定的驗證方法。 如需多重要素驗證的詳細資訊，請參閱 [Azure Multi-Factor Authentication 對我有何意義](multi-factor-authentication-end-user.md)。 如需如何將安全性資訊設定為使用 Microsoft 驗證應用程式的詳細資訊，請參閱[將安全性資訊設定為使用驗證器應用程式 (預覽)](security-info-setup-auth-app.md)。

- **個人 Microsoft 帳戶。** 您可以選擇為個人 Microsoft 帳戶 (例如 alain@outlook.com) 設定雙因素驗證。

- **非 Microsoft 個人帳戶。** 您可以選擇為非 Microsoft 個人帳戶 (例如 alain@gmail.com) 設定雙因素驗證。 您的非 Microsoft 帳戶可能並非使用雙因素驗證一詞，但您應可在 [安全性] 或 [登入] 設定中找到這項功能。

## <a name="in-this-section"></a>本節內容

|文章 |說明 |
|------|------------|
|[下載並安裝應用程式](microsoft-authenticator-app-how-to.md)|說明應在何處及如何取得執行 Android、iOS 和 Windows Phone 的裝置所適用的 Microsoft Authenticator 應用程式，並加以安裝。|
|[新增公司或學校帳戶](microsoft-authenticator-app-add-work-account.md)|說明如何將不同的公司或學校帳戶和個人帳戶新增至 Microsoft Authenticator 應用程式。|
|[新增個人帳戶](microsoft-authenticator-app-add-personal-account.md)|說明如何將個人 Microsoft 和非 Microsoft 帳戶新增至 Microsoft Authenticator 應用程式。|
|[手動新增帳戶](microsoft-authenticator-app-add-account-manual.md)|說明您在無法掃描隨附的 QR 代碼時，如何以手動方式將帳戶新增至 Microsoft Authenticator 應用程式。|
|[使用應用程式登入](microsoft-authenticator-app-phone-signin-faq.md)|說明如何使用 Microsoft Authenticator 應用程式登入您不同的帳戶。|
|[備份及復原帳戶認證](microsoft-authenticator-app-backup-and-recovery.md)| 說明如何使用 Microsoft Authenticator 應用程式來備份和復原您的帳戶認證。|
