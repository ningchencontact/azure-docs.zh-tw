---
title: Microsoft Authenticator 手機登入 - Azure Active Directory | Microsoft Docs
description: 提供如何使用手機登入您的公司和學校帳戶及個人 Microsoft 帳戶 (而不是輸入密碼) 的詳細資訊與逐步指示。
...
如果您的組織使用 Azure Active Directory 進行身分識別管理和驗證，您就可以在 Microsoft Authenticator 應用程式中開啟手機登入之後加以使用。 

### <a name="to-turn-on-phone-sign-in-for-your-account"></a>為您的帳戶開啟手機登入

- **如果您的手機上有這個圖示![手機登入圖示](./media/microsoft-authenticator-app-phone-signin-faq/icon.png)。** 您已經設定手機登入。 系統可能會要求您升級帳戶來新增推播通知，如此您就可以在應用程式外部收到有關驗證要求的通知。
...
1.  如往常般登入您的公司或學校帳戶。
    ...
    ![登入頁面](./media/microsoft-authenticator-app-phone-signin-faq/microsoft-auth-app-sign-in.png)
...
3. 點選您在 [核准登入] 畫面上看到的相同號碼。 使用您手機的 PIN 或生物識別金鑰來完成驗證。
    ...
    ![核准手機頁面](./media/microsoft-authenticator-app-phone-signin-faq/microsoft-auth-app-sign-in-numbers.png)
...
|**為什麼不能使用多個公司或學校帳戶進行手機登入？**| 一支手機必須向單一公司或學校帳戶進行註冊。 如果您想要針對不同的公司或學校帳戶開啟手機登入，您必須先透過 [設定] 頁面取消註冊舊的帳戶。|
