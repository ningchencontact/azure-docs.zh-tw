...
您可以隨時停用任何已連線裝置。 如果您不熟悉裝置，或裝置遺失或遭竊，這點格外重要。 停用裝置之後，它不會再經過您的組織，並將無法存取任何您組織的資源。
...
- 檢視連接的裝置之後, 您可以選取要檢視或管理您[安全性資訊](user-help-security-info-overview.md)、 您[組織](myprofile-portal-organizations-page.md)，或檢視表如何組織[會使用您的資料](myprofile-portal-privacy-page.md)。