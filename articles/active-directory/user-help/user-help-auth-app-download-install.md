...
>[!Important]
>如果您不是目前在您的行動裝置上，您仍然可以取得 Microsoft Authenticator 應用程式所傳送的下載連結給自己[Microsoft 驗證器頁面](https://www.microsoft.com/en-us/account/authenticator)。

## <a name="next-steps"></a>後續步驟

- 下載並安裝應用程式之後，您必須新增各種帳戶。 如需詳細資訊，請參閱[新增帳戶](user-help-auth-app-add-account-overview.md)。
