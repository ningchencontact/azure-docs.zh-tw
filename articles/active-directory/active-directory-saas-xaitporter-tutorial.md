...
4. 在搜尋方塊中，輸入 **XaitPorter**，從結果面板中選取 [XaitPorter]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 XaitPorter](./media/active-directory-saas-xaitporter-tutorial/tutorial_xaitporter_addfromgallery.png)
...
3. **[建立 XaitPorter 測試使用者](#create-a-xaitporter-test-user)** - 在 XaitPorter 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表該使用者的項目連結。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-xaitporter-tutorial/tutorial_xaitporter_samlbase.png)

3. 在 [XaitPorter 網域及 URL] 區段上，執行下列步驟：

    ![XaitPorter 網域及 URL 單一登入資訊](./media/active-directory-saas-xaitporter-tutorial/tutorial_xaitporter_url.png)
...
8. 按一下 [管理員]。
    ...
    ![設定單一登入](./media/active-directory-saas-xaitporter-tutorial/user1.png)

9. 從 [系統安裝] 下拉式清單中，選取 [管理單一登入]。

    ![設定單一登入](./media/active-directory-saas-xaitporter-tutorial/user2.png)

10. 在 [管理單一登入] 區段中，執行下列步驟：

    ![設定單一登入](./media/active-directory-saas-xaitporter-tutorial/user3.png)
...
3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。
    ...
    ![[新增] 按鈕](./media/active-directory-saas-xaitporter-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-xaitporter-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [XaitPorter]。
    ...
    ![應用程式清單中的 XaitPorter 連結](./media/active-directory-saas-xaitporter-tutorial/tutorial_xaitporter_app.png)  
