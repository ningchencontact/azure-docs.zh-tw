---
title: 使用群組來管理 Azure AD 中的資源存取權 | Microsoft Docs
...
ms.locfileid: "37859620"
---
# <a name="manage-access-to-resources-with-azure-active-directory-groups"></a>使用 Azure Active Directory 群組來管理資源的存取權
Azure Active Directory (Azure AD) 是一個身分識別與存取管理的綜合性解決方案，提供許多強大的功能來管理內部部署和雲端應用程式和資源的存取權，包括如 Office 365 的 Microsoft 線上服務，以及非 Microsoft 的 SaaS 應用程式。 本文會提供概觀，但如果您要立即開始使用 Azure AD 群組，請遵循 [在 Azure AD 中管理安全性群組](active-directory-groups-create-azure-portal.md)的指示。 如果您想要看看如何使用 PowerShell 管理 Azure Active directory 中的群組，則可以在 [適用於群組管理的 Azure Active Directory Cmdlet](../users-groups-roles/groups-settings-v2-cmdlets.md)中深入了解。
...
* [提供可供一般使用者自助服務的群組](../users-groups-roles/groups-self-service-management.md)
* [使用 Azure AD Connect 將內部部署群組同步處理至 Azure](../connect/active-directory-aadconnect.md)
...
* [使用屬性來建立進階規則](../users-groups-roles/groups-dynamic-membership.md)
