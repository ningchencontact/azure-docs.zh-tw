...
您在 Azure 資源 ([例如 Azure VM](msi-qs-configure-portal-windows-vm.md) 或 [Azure VMSS](msi-qs-configure-portal-windows-vmss.md)) 上啟用 MSI 之後：
...
- 若要在 Azure 虛擬機器上啟用 MSI，請參閱[使用 Azure 入口網站設定 Azure VM 受控服務身分識別 (MSI)](msi-qs-configure-portal-windows-vm.md)。
