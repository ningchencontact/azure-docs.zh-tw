...
> [!IMPORTANT]
> 若要使用管理單位，管理單位範圍內的管理員須具有 Azure Active Directory Premium 授權，而管理單位中的所有使用者要有 Azure Active Directory Basic 授權。 如需詳細資訊，請參閱〈 [開始使用 Azure AD Premium](active-directory-get-started-premium.md)〉。
>
