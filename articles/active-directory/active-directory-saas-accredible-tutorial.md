...
4. 在搜尋方塊中，輸入 **Accredible**，從結果面板中選取 [Accredible]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 Accredible](./media/active-directory-saas-accredible-tutorial/tutorial_accredible_addfromgallery.png)
...
3. 在 [Accredible 網域及 URL] 區段上，執行下列步驟：
    ...
    ![Accredible 網域及 URL 單一登入資訊](./media/active-directory-saas-accredible-tutorial/tutorial_accredible_url.png)
