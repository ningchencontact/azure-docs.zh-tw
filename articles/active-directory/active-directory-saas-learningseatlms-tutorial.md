...
在存取面板中按一下 [Learning Seat LMS] 圖格，系統會將您自動登入 Learning Seat LMS 應用程式。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://msdn.microsoft.com/library/dn308586)。
