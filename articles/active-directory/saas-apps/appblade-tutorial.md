...
若要設定 Azure AD 與 AppBlade 的整合，您需要下列項目：
...
當您在「存取面板」中按一下 [AppBlade] 圖格時，應該會自動登入您已設定 SSO 的 AppBlade。 如需有關「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
