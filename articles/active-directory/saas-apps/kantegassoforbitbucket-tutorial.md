...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Kantega SSO for Bitbucket (單一登入)。
...
* 已啟用 Kantega SSO for Bitbucket 單一登入的訂用帳戶

## <a name="scenario-description"></a>案例描述

在本教學課程中，您會在測試環境中設定和測試 Azure AD 單一登入。

* Kantega SSO for Bitbucket 支援由 **SP 和 IDP** 起始的 SSO
...
4. 在搜尋方塊中，輸入 **Kantega SSO for Bitbucket**，從結果面板中選取 [Kantega SSO for Bitbucket]  ，然後按一下 [新增]  按鈕以新增應用程式。

    ![結果清單中的 Kantega SSO for Bitbucket](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>設定和測試 Azure AD 單一登入

在本節中，您會以名為 **Britta Simon** 的測試使用者為基礎，使用 Kantega SSO for Bitbucket 來設定和測試 Azure AD 單一登入。
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 Kantega SSO for Bitbucket 中相關使用者之間的連結關聯性。

若要設定及測試與 Kantega SSO for Bitbucket 搭配運作的 Azure AD 單一登入，您需要完成下列建置組塊：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[設定 Kantega SSO for Bitbucket 單一登入](#configure-kantega-sso-for-bitbucket-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Kantega SSO for Bitbucket 測試使用者](#create-kantega-sso-for-bitbucket-test-user)** - 在 Kantega SSO for Bitbucket 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Kantega SSO for Bitbucket]  應用程式整合頁面上，選取 [單一登入]  。
...
7. 在 [設定 Kantega SSO for Bitbucket]  區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-kantega-sso-for-bitbucket-single-sign-on"></a>設定 Kantega SSO for Bitbucket 單一登入
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]  、[所有應用程式]  及 [Kantega SSO for Bitbucket]  。

    ![企業應用程式刀鋒視窗](common/enterprise-applications.png)

2. 在應用程式清單中，選取 [Kantega SSO for Bitbucket]  。

    ![應用程式清單中的 Kantega SSO for Bitbucket 連結](common/all-applications.png)
...
### <a name="create-kantega-sso-for-bitbucket-test-user"></a>建立 Kantega SSO for Bitbucket 測試使用者

若要讓 Azure AD 使用者能夠登入 Bitbucket，必須將他們佈建到 Bitbucket。 在 Kantega SSO for Bitbucket 的案例中，佈建是手動工作。
...
當您在存取面板中按一下 [Kantega SSO for Bitbucket] 圖格時，應該會自動登入您已設定 SSO 的 Kantega SSO for Bitbucket。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
