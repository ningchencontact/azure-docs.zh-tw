...
1. 在搜尋方塊中，輸入 **LiquidFiles**。

    ![建立 Azure AD 測試使用者](./media/liquidfiles-tutorial/tutorial_liquidfiles_search.png)

1. 在結果面板中，選取 [LiquidFiles]，然後按一下 [新增] 按鈕以新增應用程式。

    ![建立 Azure AD 測試使用者](./media/liquidfiles-tutorial/tutorial_liquidfiles_addfromgallery.png)
...
1. **[建立 LiquidFiles 測試使用者](#creating-a-liquidfiles-test-user)** - 使用 LiquidFiles 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/liquidfiles-tutorial/tutorial_liquidfiles_samlbase.png)

1. 在 [LiquidFiles 網域及 URL] 區段中，執行下列步驟：

    ![設定單一登入](./media/liquidfiles-tutorial/tutorial_liquidfiles_url.png)

    a. 在 [登入 URL] 文字方塊中，使用下列模式輸入 URL︰ `https://<YOUR_SERVER_URL>/saml/init`

    b. 在 [識別碼] 文字方塊中，使用下列模式輸入 URL： `https://<YOUR_SERVER_URL>`

    c. b. 在 **[回覆 URL]** 文字方塊中，以下列模式輸入 URL：`https://<YOUR_SERVER_URL>/saml/consume`
...
1. 在 [SAML 簽署憑證] 區段上，複製憑證的 [指紋] 值。
    ...
    ![設定單一登入](./media/liquidfiles-tutorial/tutorial_liquidfiles_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入](./media/liquidfiles-tutorial/tutorial_general_400.png)

1. 在 [LiquidFiles 組態] 區段上，按一下 [設定 LiquidFiles] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登入 URL] 和 [SAML 單一登入服務 URL]。

    ![設定單一登入](./media/liquidfiles-tutorial/tutorial_liquidfiles_configure.png)
...
1. 在 [單一登入設定] 頁面上，執行下列步驟：
    ...
    b. 在 [IDP 登入 URL] 文字方塊中，貼上您從 Azure 入口網站複製的 [SAML 單一登入服務 URL] 值。
...
1. 在 **Azure 入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/liquidfiles-tutorial/create_aaduser_01.png) 

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。
    
    ![建立 Azure AD 測試使用者](./media/liquidfiles-tutorial/create_aaduser_02.png) 

1. 若要開啟 [使用者] 對話方塊，按一下對話方塊頂端的 [新增]。
 
    ![建立 Azure AD 測試使用者](./media/liquidfiles-tutorial/create_aaduser_03.png) 

1. 在 [使用者]  對話頁面上，執行下列步驟：
 
    ![建立 Azure AD 測試使用者](./media/liquidfiles-tutorial/create_aaduser_04.png) 
...
1. 在應用程式清單中，選取 [LiquidFiles]。

    ![設定單一登入](./media/liquidfiles-tutorial/tutorial_liquidfiles_app.png) 
