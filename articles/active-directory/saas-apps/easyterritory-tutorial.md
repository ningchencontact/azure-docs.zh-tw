...
3. **[建立 EasyTerritory 測試使用者](#create-a-easyterritory-test-user)** - 在 EasyTerritory 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
7. 若要在 **EasyTerritory** 端設定單一登入，您必須將已下載的**中繼資料 XML** 傳送給 [EasyTerritory 支援小組](mailto:sales@easyterritory.com)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
