...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    ![Samanage 網域與 URL 單一登入資訊](common/sp-identifier.png)

    a. 在 [登入 URL] 文字方塊中，使用下列模式輸入 URL：`https://<Company Name>.samanage.com/saml_login/<Company Name>`

    b. 在 [識別碼 (實體識別碼)] 文字方塊中，使用下列模式輸入 URL：`https://<Company Name>.samanage.com`

    > [!NOTE] 
    > 這些都不是真正的值。 請使用實際的「登入 URL」及「識別碼」來更新這些值 (本教學課程稍後會說明)。 如需詳細資料，請連絡 [Samanage 客戶支援小組](https://www.samanage.com/support)。 您也可以參考 Azure 入口網站中**基本 SAML 組態**區段所示的模式。
