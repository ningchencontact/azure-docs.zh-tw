...
1. 在搜尋方塊中，輸入 **Zscaler Beta**。

    ![建立 Azure AD 測試使用者](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_search.png)

1. 在結果窗格中，選取 [Zscaler Beta]，然後按一下 [新增] 按鈕以新增應用程式。

    ![建立 Azure AD 測試使用者](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_addfromgallery.png)
...
1. **[建立 Zscaler Beta 測試使用者](#creating-a-zscaler-beta-test-user)** - 使 Zscaler Beta 中 Britta Simon 的對應使用者連結到該使用者在 Azure AD 中的代表身分。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_samlbase.png)

1. 在 [Zscaler Beta 網域與 URL] 區段上，執行下列步驟：

    ![設定單一登入](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_url.png)
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。
    ...
    ![設定單一登入](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入](./media/zscaler-beta-tutorial/tutorial_general_400.png)

1. 在 [Zscaler Beta 設定] 區段中，按一下 [設定 Zscaler Beta] 開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 單一登入服務 URL]。

    ![設定單一登入](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_configure.png) 
...
1. 在 [管理系統管理員和角色] 下按一下 [管理使用者和驗證]。   
    ...
    ![管理使用者和驗證](./media/zscaler-beta-tutorial/ic800207.png "管理使用者和驗證")

1. 在 [選擇您的組織的驗證選項]  區段中，執行下列步驟：   
                
    ![驗證](./media/zscaler-beta-tutorial/ic800208.png "驗證")
...
1. 在 [設定 SAML 單一登入參數] 對話方塊頁面上，執行下列步驟，然後按一下 [完成]
    ...
    ![單一登入](./media/zscaler-beta-tutorial/ic800209.png "單一登入")
...
1. 在 [設定使用者驗證]  對話方塊頁面上執行下列步驟：
    ...
    ![管理](./media/zscaler-beta-tutorial/ic800210.png "管理")
...
1. 在 **Azure 入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/zscaler-beta-tutorial/create_aaduser_01.png) 

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。
    
    ![建立 Azure AD 測試使用者](./media/zscaler-beta-tutorial/create_aaduser_02.png) 

1. 若要開啟 [使用者] 對話方塊，按一下對話方塊頂端的 [新增]。
 
    ![建立 Azure AD 測試使用者](./media/zscaler-beta-tutorial/create_aaduser_03.png) 

1. 在 [使用者]  對話頁面上，執行下列步驟：
 
    ![建立 Azure AD 測試使用者](./media/zscaler-beta-tutorial/create_aaduser_04.png) 
...
1. 按一下 [系統管理] 。   
    ...
    ![管理](./media/zscaler-beta-tutorial/ic781035.png "管理")

1. 按一下 [使用者管理] 。   
        
     ![新增](./media/zscaler-beta-tutorial/ic781036.png "新增")

1. 在 [使用者] 索引標籤中，按一下 [新增]。
      
    ![新增](./media/zscaler-beta-tutorial/ic781037.png "新增")

1. 在 [新增使用者] 區段中，執行下列步驟：
        
    ![新增使用者](./media/zscaler-beta-tutorial/ic781038.png "新增使用者")
...
1. 在應用程式清單中，選取 [Zscaler Beta]。

    ![設定單一登入](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_app.png) 
