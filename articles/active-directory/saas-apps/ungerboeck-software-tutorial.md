---
title: 教學課程：Azure Active Directory 與 Ungerboeck Software 整合 | Microsoft Docs
description: 了解如何設定 Azure Active Directory 與 Ungerboeck Software 之間的單一登入。
...
在此教學課程中，您將了解如何整合 Ungerboeck Software 與 Azure Active Directory (Azure AD)。 在整合 Ungerboeck Software 與 Azure AD 時，您可以：

* 在 Azure AD 中控制可存取 Ungerboeck Software 的人員。
...
* 已啟用 Ungerboeck Software 單一登入 (SSO) 的訂用帳戶。

## <a name="scenario-description"></a>案例描述

在本教學課程中，您會在測試環境中設定和測試 Azure AD SSO。 Ungerboeck Software 支援由 **SP** 起始的 SSO。

## <a name="adding-ungerboeck-software-from-the-gallery"></a>從資源庫新增 Ungerboeck Software

若要設定 Ungerboeck Software 與 Azure AD 整合，您需要從資源庫將 Ungerboeck Software 新增至受控 SaaS 應用程式的清單。
...
以名為 **B.Simon** 的測試使用者，設定及測試與 Ungerboeck Software 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 Ungerboeck Software 中相關使用者之間的連結關聯性。

若要使用 Ungerboeck Software 設定並測試 Azure AD SSO，請完成下列構成要素：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** ，讓您的使用者能夠使用此功能。
2. **[設定 Ungerboeck Software SSO](#configure-ungerboeck-software-sso)** 以在應用程式端設定 SSO 設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** 以使用 B.Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** 以讓 B.Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Ungerboeck Software 測試使用者](#create-ungerboeck-software-test-user)** 以在 Ungerboeck Software 中建立 B.Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Ungerboeck Software]  應用程式整合頁面上，尋找 [管理]  區段並選取 [單一登入]  。
...
1. 在 [基本 SAML 設定]  頁面上，輸入下列欄位的值：
    ...
    1. 在 [登入 URL]  文字方塊中，使用下列模式輸入 URL：`https://<SUBDOMAIN>.ungerboeck.com/prod`
...
1. 在 [設定 Ungerboeck Software]  區段上，依據您的需求複製適當的 URL。
...
在本節中，您會將 Ungerboeck Software 的存取權授與 B.Simon，讓其能夠使用 Azure 單一登入。

1. 在 Azure 入口網站中，選取 [企業應用程式]  ，然後選取 [所有應用程式]  。
1. 在應用程式清單中，選取 [Ungerboeck Software]  。
