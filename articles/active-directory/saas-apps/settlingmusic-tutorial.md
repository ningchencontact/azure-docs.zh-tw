...
3. **[建立 Settling music 測試使用者](#create-a-settling-music-test-user)** - 讓 Settling music 中的 Britta Simon 對應項目得以連結至 Azure AD 中代表該使用者的項目。
...
3. 在 [Settling music 網域及 URL] 區段上，執行下列步驟：
