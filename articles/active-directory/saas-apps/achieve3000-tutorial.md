...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Achieve3000 (單一登入)。
...
4. 在搜尋方塊中，輸入 **Achieve3000**，從結果面板中選取 [Achieve3000]，然後按一下 [新增] 按鈕以新增應用程式。
     ...
     ![結果清單中的 Achieve3000](common/search-new-app.png)
...
5. **[建立 Achieve3000 測試使用者](#create-achieve3000-test-user)** - 在 Achieve3000 中建立一個與 Azure AD 使用者代表 Britta Simon 連結的對應使用者。
...
若要設定與 Achieve3000 搭配運作的 Azure AD 單一登入，請執行下列步驟：

1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Achieve3000] 應用程式整合頁面上，選取 [單一登入]。
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    b. 在 [識別碼 (實體識別碼)] 文字方塊中，輸入下列值：`achieve3000-saml`
...
8. 在 [設定 Achieve3000] 區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-achieve3000-single-sign-on"></a>設定 Achieve3000 單一登入
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [Achieve3000]。
