...
4. 在搜尋方塊中，輸入 **OfficeSpace Software**，從結果面板中選取 [OfficeSpace Software]，然後按一下 [新增] 按鈕以新增應用程式。
...
3. **[建立 OfficeSpace Software 測試使用者](#create-a-officespace-software-test-user)** - 使 OfficeSpace Software 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
8. 在 [OfficeSpace Software 組態] 區段上，按一下 [設定 OfficeSpace Software] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登入 URL] 和 [SAML 單一登入服務 URL]。
