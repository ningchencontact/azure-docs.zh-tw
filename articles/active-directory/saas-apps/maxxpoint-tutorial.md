...
3. **[建立 MaxxPoint 測試使用者](#creating-a-maxxpoint-test-user)** - 使 MaxxPoint 中 Britta Simon 的對應使用者能夠連結到代表她在 Azure AD 中的項目。
...
3. 在 [MaxxPoint 網域和 URL] 區段中，如果您想要在 [IDP 起始模式] 中設定應用程式，則不需要執行任何步驟。

    ![設定單一登入](./media/maxxpoint-tutorial/tutorial_maxxpoint_02.png)
    
4. 在 [MaxxPoint 網域和 URL] 區段中，如果您想要在 [SP 起始模式] 中設定應用程式，請執行下列步驟：
...
2. 移至 [使用者和群組]，然後按一下 [所有使用者] 以顯示使用者清單。
    ...
    ![建立 Azure AD 測試使用者](./media/maxxpoint-tutorial/create_aaduser_02.png) 
