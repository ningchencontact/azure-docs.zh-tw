...
4. 在搜尋方塊中，輸入 **ClearCompany**，從結果面板中選取 [ClearCompany]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 ClearCompany](./media/clearcompany-tutorial/tutorial_clearcompany_addfromgallery.png)
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/clearcompany-tutorial/tutorial_clearcompany_samlbase.png)

3. 如果您想要以 IDP 起始模式設定應用程式，請在 [ClearCompany 網域和 URL] 區段上執行下列步驟：

    ![ClearCompany 網域及 URL 單一登入資訊](./media/clearcompany-tutorial/tutorial_clearcompany_url1.png)

    在 [識別碼] 文字方塊中，輸入 URL：`https://api.clearcompany.com`

4. 如果您想要以 **SP** 起始模式設定應用程式，請勾選 [顯示進階 URL 設定]，然後執行下列步驟：

    ![ClearCompany 網域及 URL 單一登入資訊](./media/clearcompany-tutorial/tutorial_clearcompany_url2.png)

    在 [登入 URL] 文字方塊中，使用下列模式輸入 URL︰ `https://<companyname>.clearcompany.com`
    
    > [!NOTE] 
    > 登入 URL 的值不是真正的值。 請使用實際的登入 URL 來更新此值。 請連絡 [ClearCompany 用戶端支援小組](https://www.clearcompany.com/support)以取得此值。 

5. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。

    ![憑證下載連結](./media/clearcompany-tutorial/tutorial_clearcompany_certificate.png) 

6. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/clearcompany-tutorial/tutorial_general_400.png)
    
7. 在 [ClearCompany 組態] 區段上，按一下 [設定 ClearCompany] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 單一登入服務 URL]。

    ![ClearCompany 組態](./media/clearcompany-tutorial/tutorial_clearcompany_configure.png) 

8. 若要在 **ClearCompany** 端設定單一登入，您必須將已下載的「憑證 (Base64)」和「SAML 單一登入服務 URL」傳送給 [ClearCompany 支援小組](https://www.clearcompany.com/support)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/clearcompany-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/clearcompany-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/clearcompany-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/clearcompany-tutorial/create_aaduser_04.png)
...
在本節中，您要在 ClearCompany 中建立名為 Britta Simon 的使用者。 配合  [ClearCompany 支援小組](https://www.clearcompany.com/support) 在 ClearCompany 平台中新增使用者。 您必須先建立和啟動使用者，然後才能使用單一登入。
...
2. 在應用程式清單中，選取 [ClearCompany]。
    ...
    ![應用程式清單中的 ClearCompany 連結](./media/clearcompany-tutorial/tutorial_clearcompany_app.png)  
