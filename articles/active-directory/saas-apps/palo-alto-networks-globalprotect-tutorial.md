...
## <a name="configure-and-test-azure-ad-single-sign-on-for-palo-alto-networks---globalprotect"></a>設定及測試 Palo Alto Networks - GlobalProtect 的 Azure AD 單一登入
...
若要使用 Palo Alto Networks - GlobalProtect 來設定及測試 Azure AD SSO，請完成下列構成要素：
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 **Palo Alto Networks - GlobalProtect** 應用程式整合頁面上，找到 [管理]  區段並選取 [單一登入]  。
...
- [嘗試搭配 Azure AD 使用 Palo Alto Networks - GlobalProtect](https://aad.portal.azure.com/)