...
4. **[建立 Zscaler One 測試使用者](#creating-a-zscaler-one-test-user)** - 使 Zscaler One 中 Britta Simon 的對應使用者連結到該使用者在 Azure AD 中的代表身分。
...
3. 在 [Zscaler One 網域與 URL] 區段上，執行下列步驟：
...
6. 在 [Zscaler One 設定] 區段中，按一下 [設定 Zscaler One] 開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 單一登入服務 URL]。

    ![設定單一登入](./media/zscaler-one-tutorial/tutorial_zscalerone_configure.png) 

7. 在不同的 Web 瀏覽器視窗中，以系統管理員身分登入您的 Zscaler One 公司網站。
