...
* IMPAC Risk Manager 支援由 **SP** 起始的 SSO
...
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 Small Improvements 中相關使用者之間的連結關聯性。

若要設定及測試與 Small Improvements 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[設定 Small Improvements 單一登入](#configure-small-improvements-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Small Improvements 測試使用者](#create-small-improvements-test-user)** - 在 Small Improvements 中建立一個與 Azure AD 中代表 Britta Simon 之使用者連結的 Britta Simon 對應項目。
...
若要設定與 Small Improvements 搭配運作的 Azure AD 單一登入，請執行下列步驟：

1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Small Improvements] 應用程式整合頁面上，選取 [單一登入]。
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    ![Small Improvements 網域及 URL 單一登入資訊](common/sp-identifier.png)
...
6. 在 [安裝 Small Improvements] 區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-small-improvements-single-sign-on"></a>設定 Small Improvements 單一登入
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [Small Improvements]。

    ![企業應用程式刀鋒視窗](common/enterprise-applications.png)

2. 在應用程式清單中，選取 [Small Improvements] 。

    ![應用程式清單中的 [Small Improvements] 連結](common/all-applications.png)
...
### <a name="create-small-improvements-test-user"></a>建立 Small Improvements 測試使用者
...
當您在存取面板中按一下 [Small Improvements] 圖格時，應該會自動登入您已設定 SSO 的 Small Improvements。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
