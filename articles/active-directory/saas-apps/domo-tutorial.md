...
1. 在搜尋方塊中，輸入 **Domo**。
    ...
    ![建立 Azure AD 測試使用者](./media/domo-tutorial/tutorial_domo_search.png)

1. 在結果窗格中，選取 [Domo]，然後按一下 [新增] 按鈕以新增應用程式。

    ![建立 Azure AD 測試使用者](./media/domo-tutorial/tutorial_domo_addfromgallery.png)
...
1. **[建立 Domo 測試使用者](#creating-a-domo-test-user)** - 在 Domo 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/domo-tutorial/tutorial_domo_samlbase.png)

1. 在 [Domo 網域與 URL] 區段中，執行下列步驟：

    ![設定單一登入](./media/domo-tutorial/tutorial_domo_url.png)
...
1. Domo 應用程式需要特定格式的 SAML 判斷提示。 設定此應用程式的下列宣告。 您可以在應用程式整合頁面的 [使用者屬性] 區段中管理這些屬性的值。 以下螢幕擷取畫面顯示此設定的範例。 

    ![設定單一登入](./media/domo-tutorial/tutorial_domo_attributes.png)
...
1. 在 [單一登入] 對話方塊的 [使用者屬性] 區段中，如圖所示設定 SAML 權杖屬性，然後執行下列步驟：
    ...
    ![設定單一登入](./media/domo-tutorial/tutorial_attribute_04.png)

    ![設定單一登入](./media/domo-tutorial/tutorial_attribute_05.png)
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。
    ...
    ![設定單一登入](./media/domo-tutorial/tutorial_domo_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入](./media/domo-tutorial/tutorial_general_400.png)


1. 在 [Domo 組態] 區段上，按一下 [設定 Domo] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。   

   ![設定單一登入](./media/domo-tutorial/tutorial_domo_configure.png) 

1. 若要在 **Domo** 端設定單一登入，請瀏覽至 Domo 知識庫文章 (可在[這裡](http://knowledge.domo.com?cid=azuread)找到)，然後依照指示進行操作。
...
1. 在 **Azure 入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/domo-tutorial/create_aaduser_01.png) 

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。
    
    ![建立 Azure AD 測試使用者](./media/domo-tutorial/create_aaduser_02.png) 

1. 若要開啟 [使用者] 對話方塊，按一下對話方塊頂端的 [新增]。
 
    ![建立 Azure AD 測試使用者](./media/domo-tutorial/create_aaduser_03.png) 

1. 在 [使用者]  對話頁面上，執行下列步驟：
 
    ![建立 Azure AD 測試使用者](./media/domo-tutorial/create_aaduser_04.png) 
...
1. 在應用程式清單中，選取 [Domo] 。
    ...
    ![設定單一登入](./media/domo-tutorial/tutorial_domo_app.png) 
