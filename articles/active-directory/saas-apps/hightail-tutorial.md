...
若要設定及測試與 Hightail 搭配運作的 Azure AD SSO，請完成下列構成要素：
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Hightail]  應用程式整合頁面上，尋找 [管理]  區段並選取 [單一登入]  。
...
- [嘗試搭配 Azure AD 使用 Hightail](https://aad.portal.azure.com/)