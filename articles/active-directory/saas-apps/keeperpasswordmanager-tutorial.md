...
3. **[建立 Keeper Password Manager & Digital Vault 測試使用者](#creating-a-keeperpasswordmanager-test-user)** - 使 Learnconnect 中 Britta Simon 的對應使用者連結到該使用者在 Azure AD 中的代表身分。
...
3. 在 **Keeper Password Manager & Digital Vault 網域及 URL** 區段中，執行下列步驟：
...
6. 在 [Keeper Password Manager & Digital Vault 設定] 區段中，按一下 [設定 Keeper Password Manager & Digital Vault] 開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。
