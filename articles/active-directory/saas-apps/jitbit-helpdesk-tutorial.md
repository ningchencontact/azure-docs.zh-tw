...
3. **[建立 Jitbit Helpdesk 測試使用者](#creating-a-jitbit-helpdesk-test-user)** - 使 Jitbit Helpdesk 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
3. 在 [Jitbit Helpdesk 網域與 URL] 區段中，執行下列步驟：
...
6. 在 [Jitbit Helpdesk 設定] 區段中，按一下 [設定 Jitbit Helpdesk] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 單一登入服務 URL]。
...
5. 在 [建立] 區段中，輸入您想要佈建的 Azure AD 帳戶資料，如下所示：
