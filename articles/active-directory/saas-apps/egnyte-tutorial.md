...
4. 在搜尋方塊中，輸入 **Egnyte**，從結果面板中選取 [Egnyte]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 Egnyte](./media/egnyte-tutorial/tutorial_egnyte_addfromgallery.png)
...
3. **[建立 Egnyte 測試使用者](#creating-an-egnyte-test-user)** - 在 Egnyte 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    ![Egnyte 網域與 URL 單一登入資訊](./media/egnyte-tutorial/tutorial_egnyte_url.png)
...
5. 在 [SAML 簽署憑證] 頁面上的 [SAML 簽署憑證] 區段中，按一下 [下載] 以下載**憑證 (Base64)**，然後將憑證檔案儲存在電腦上。
    ...
    ![憑證下載連結](./media/egnyte-tutorial/tutorial_egnyte_certificate.png) 

6. 在 [安裝 Egnyte] 區段上，依據您的需求複製適當的 URL。
    ...
    ![Egnyte 組態](common/configuresection.png)

7. 在不同的 Web 瀏覽器視窗中，以系統管理員身分登入您的 Egnyte 公司網站。
