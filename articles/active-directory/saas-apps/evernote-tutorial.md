---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 Evernote 整合 | Microsoft Docs
...
在本教學課程中，您將了解如何整合 Evernote 與 Azure Active Directory (Azure AD)。 在整合 Evernote 與 Azure AD 時，您可以︰

* 在 Azure AD 中控制可存取 Evernote 的人員。
...
以名為 **B.Simon** 的測試使用者，設定及測試與 Evernote 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 Evernote 中相關使用者之間的連結關聯性。

若要設定及測試與 Evernote 搭配運作的 Azure AD SSO，請完成下列建置組塊：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 Evernote SSO](#configure-evernote-sso)** - 在應用程式端設定單一登入設定。
    1. **[建立 Evernote 測試使用者](#create-evernote-test-user)** - 在 Evernote 中建立一個與 Azure AD 中代表使用者之項目連結的 B.Simon 對應項目。
...
1. 在 [設定 Evernote]  區段上，根據您的需求複製適當的 URL。
...
在本節中，您會將 Evernote 的存取權授與 B.Simon，讓她能夠使用 Azure 單一登入。
...
## <a name="configure-evernote-sso"></a>設定 Evernote SSO

1. 若要自動執行 Evernote 內的設定，您必須按一下 [安裝擴充功能]  來安裝「我的應用程式安全登入瀏覽器擴充功能」  。

    ![我的應用程式擴充功能](common/install-myappssecure-extension.png)

2. 將擴充功能新增至瀏覽器之後，按一下 [設定 Evernote]  便會將您導向到 Evernote 應用程式。 請從該處提供用以登入 Evernote 的管理員認證。 瀏覽器擴充功能會自動為您設定應用程式，並自動執行步驟 3 到 6。

    ![設定組態](common/setup-sso.png)

3. 如果您想要手動設定 Evernote，請開啟新的網頁瀏覽器視窗，並以系統管理員身分登入 Evernote 公司網站，然後執行下列步驟：

4. 移至 [管理主控台] 

    ![管理主控台](./media/evernote-tutorial/tutorial_evernote_adminconsole.png)

5. 從 [管理主控台]  ，移至 [安全性]  ，然後選取 [單一登入] 
