...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Teamphoria (單一登入)。
...
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 Teamphoria 中相關使用者之間的連結關聯性。

若要設定及測試與 Teamphoria 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[設定 Teamphoria 單一登入](#configure-teamphoria-single-sign-on)** - 在應用程式端設定單一登入設定。
...
### <a name="configure-teamphoria-single-sign-on"></a>設定 Teamphoria 單一登入
