...
4. 在搜尋方塊中，輸入 **Netsuite**。
    ...
    ![建立 Azure AD 測試使用者](./media/netsuite-tutorial/tutorial_netsuite_search.png)

5. 在結果面板中，選取 [Netsuite]，然後按一下 [新增] 按鈕以新增應用程式。

    ![建立 Azure AD 測試使用者](./media/netsuite-tutorial/tutorial_netsuite_addfromgallery.png)
...
11. 在 [SAML 設定]  頁面上，執行下列步驟：
    ...
    ![設定單一登入](./media/netsuite-tutorial/ns-sso-setup.png)
