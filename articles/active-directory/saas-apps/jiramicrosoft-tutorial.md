...
3. **[建立 JIRA SAML SSO by Microsoft 測試使用者](#creating-jira-saml-sso-by-microsoft-test-user)** - 使 JIRA SAML SSO by Microsoft 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
### <a name="creating-jira-saml-sso-by-microsoft-test-user"></a>建立 JIRA SAML SSO by Microsoft 測試使用者
...
2. 在應用程式清單中，選取 [JIRA SAML SSO by Microsoft]。
    ...
    ![設定單一登入](./media/jiramicrosoft-tutorial/tutorial_singlesign-onforjira_app.png)
