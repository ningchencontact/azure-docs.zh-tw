...
3. **[建立 Wingspan eTMF 測試使用者](#creating-a-wingspan-etmf-test-user)** - 使 Wingspan eTMF 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
3. 在 [Wingspan eTMF 網域與 URL] 區段上，執行下列步驟：
...
6. 若要在 **Wingspan eTMF** 端設定單一登入，您必須將已下載的**中繼資料 XML** 傳送給 [Wingspan eTMF 支援](http://www.wingspan.com/contact-us/)。 他們將會設定妥當，讓兩端的 SAML SSO 連線都設定正確。
