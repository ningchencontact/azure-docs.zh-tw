...
若要設定 SkyDesk Email 與 Azure AD 整合，您需要從資源庫將 SkyDesk Email 加入受控 SaaS 應用程式清單中。
...
1. 在搜尋方塊中，輸入 **SkyDesk Email**。

    ![建立 Azure AD 測試使用者](./media/skydeskemail-tutorial/tutorial_skydeskemail_search.png)

1. 在結果窗格中，選取 [SkyDesk Email]，然後按一下 [新增] 按鈕以新增應用程式。

    ![建立 Azure AD 測試使用者](./media/skydeskemail-tutorial/tutorial_skydeskemail_addfromgallery.png)
...
1. **[建立 SkyDesk Email 測試使用者](#creating-a-skydesk-email-test-user)** - 使 SkyDesk Email 中 Britta Simon 的對應使用者連結到該使用者在 Azure AD 中的代表身分。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/skydeskemail-tutorial/tutorial_skydeskemail_samlbase.png)

1. 在 [SkyDesk Email 網域與 URL] 區段中，執行下列步驟：

    ![設定單一登入](./media/skydeskemail-tutorial/tutorial_skydeskemail_url.png)
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。
    ...
    ![設定單一登入](./media/skydeskemail-tutorial/tutorial_skydeskemail_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入](./media/skydeskemail-tutorial/tutorial_general_400.png)

1. 在 [SkyDesk Email 組態] 區段上，按一下 [設定 SkyDesk Email] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登入 URL] 和 [SAML 單一登入服務 URL]。

    ![設定單一登入](./media/skydeskemail-tutorial/tutorial_skydeskemail_configure.png) 

1. 若要在 **SkyDesk Email**中啟用 SSO，請執行下列步驟：
...
1. 在 **Azure 入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/skydeskemail-tutorial/create_aaduser_01.png) 

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。
    
    ![建立 Azure AD 測試使用者](./media/skydeskemail-tutorial/create_aaduser_02.png) 

1. 若要開啟 [使用者] 對話方塊，按一下對話方塊頂端的 [新增]。
 
    ![建立 Azure AD 測試使用者](./media/skydeskemail-tutorial/create_aaduser_03.png) 

1. 在 [使用者]  對話頁面上，執行下列步驟：
 
    ![建立 Azure AD 測試使用者](./media/skydeskemail-tutorial/create_aaduser_04.png) 
...
1. 在應用程式清單中，選取 [SkyDesk Email] 。

    ![設定單一登入](./media/skydeskemail-tutorial/tutorial_skydeskemail_app.png) 
