...
在本節中，您會以名為 **Britta Simon** 的測試使用者為基礎，設定及測試與 SkyDesk Email 搭配運作的 Azure AD 單一登入。
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 SkyDesk Email 中相關使用者之間的連結關聯性。

若要設定及測試與 SkyDesk Email 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[設定 SkyDesk Email 單一登入](#configure-skydesk-email-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 SkyDesk Email 測試使用者](#create-skydesk-email-test-user)** - 在 SkyDesk Email 中建立一個與 Azure AD 中代表 Britta Simon 之使用者連結的 Britta Simon 對應項目。
...
若要設定與 SkyDesk Email 搭配運作的 Azure AD 單一登入，請執行下列步驟：

1. 在 [Azure 入口網站](https://portal.azure.com/)的 [SkyDesk Email] 應用程式整合頁面上，選取 [單一登入]。
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    ![SkyDesk Email 網域及 URL 單一登入資訊](common/sp-signonurl.png)
...
6. 在 [安裝 SkyDesk Email] 區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-skydesk-email-single-sign-on"></a>設定 SkyDesk Email 單一登入

1. 在不同的網頁瀏覽器視窗中，以系統管理員身分登入 SkyDesk Email 帳戶。
...
1. 在 [SAML 驗證]  對話方塊頁面上執行下列步驟：
    ...
    b. 在 [Logout URL] \(登出 URL\) 文字方塊中，貼上您從 Azure 入口網站複製的 [登出 URL] 值。
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [SkyDesk Email]。

    ![企業應用程式刀鋒視窗](common/enterprise-applications.png)

2. 在應用程式清單中，選取 [SkyDesk Email] 。

    ![應用程式清單中的 [SkyDesk Email] 連結](common/all-applications.png)
...
### <a name="create-skydesk-email-test-user"></a>建立 SkyDesk Email 測試使用者

在本節中，您會在 SkyDesk Email 中建立名為 Britta Simon 的使用者。
