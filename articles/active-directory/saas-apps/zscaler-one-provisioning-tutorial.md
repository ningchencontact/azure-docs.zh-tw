...
3. 若要新增 Zscaler One，請按一下**新的應用程式**對話方塊頂端的按鈕。

    ![新增應用程式按鈕][3]

4. 在搜尋方塊中，輸入 **Zscaler One**。

    ![Zscaler One 佈建](./media/zscaler-one-provisioning-tutorial/app-search.png)

5. 在結果窗格中，選取**Zscaler One**，然後按一下**新增**按鈕以新增至您的 SaaS 應用程式清單的 Zscaler One。

    ![Zscaler One 佈建](./media/zscaler-one-provisioning-tutorial/app-search-results.png)

    ![Zscaler One 佈建](./media/zscaler-one-provisioning-tutorial/app-creation.png)
...
2. Zscaler One 從清單中選取您的 SaaS 應用程式。

    ![Zscaler One 佈建](./media/zscaler-one-provisioning-tutorial/app-instance-search.png)
