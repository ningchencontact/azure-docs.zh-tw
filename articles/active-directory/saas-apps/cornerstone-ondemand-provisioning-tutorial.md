...
**若要從 Azure AD 應用程式資源庫新增 Cornerstone OnDemand，請執行下列步驟：**
...
1. 登入[Azure 入口網站](https://portal.azure.com)，然後選取**企業應用程式**，選取**所有應用程式**，然後選取**Cornerstone OnDemand**.
