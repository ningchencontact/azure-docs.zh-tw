...
1. 在搜尋方塊中，輸入 **Collaborative Innovation**。

    ![建立 Azure AD 測試使用者](./media/collaborativeinnovation-tutorial/tutorial_collaborativeinnovation_search.png)

1. 在結果窗格中，選取 [Collaborative Innovation]，然後按一下 [新增] 按鈕以新增應用程式。

    ![建立 Azure AD 測試使用者](./media/collaborativeinnovation-tutorial/tutorial_collaborativeinnovation_addfromgallery.png)
...
1. **[建立 Collaborative Innovation 測試使用者](#creating-a-collaborative-innovation-test-user)** - 在 Collaborative Innovation 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/collaborativeinnovation-tutorial/tutorial_collaborativeinnovation_samlbase.png)

1. 在 [Collaborative Innovation 網域及 URL] 區段上，執行下列步驟：

    ![設定單一登入](./media/collaborativeinnovation-tutorial/tutorial_collaborativeinnovation_url.png)
...
1. Collaborative Innovation 應用程式需要特定格式的 SAML 判斷提示。 請設定此應用程式的下列宣告。 您可以在應用程式整合頁面的 [使用者屬性] 區段中管理這些屬性的值。 以下螢幕擷取畫面顯示上述的範例。
    
    ![設定單一登入](./media/collaborativeinnovation-tutorial/attribute.png)
...
1. 在 [使用者屬性] 區段中，按一下 [檢視及編輯所有其他使用者屬性] 核取方塊，可展開屬性。 在每個顯示的屬性上執行下列步驟-
    ...
    ![設定單一登入](./media/collaborativeinnovation-tutorial/url_update.png)
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。
    ...
    ![設定單一登入](./media/collaborativeinnovation-tutorial/tutorial_collaborativeinnovation_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入](./media/collaborativeinnovation-tutorial/tutorial_general_400.png)

1. 若要在 **Collaborative Innovation** 端設定單一登入，您必須將已下載的**中繼資料 XML** 傳送給 [Collaborative Innovation 支援小組](https://www.unilever.com/contact/)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 **Azure 入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/collaborativeinnovation-tutorial/create_aaduser_01.png) 

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。
    
    ![建立 Azure AD 測試使用者](./media/collaborativeinnovation-tutorial/create_aaduser_02.png) 

1. 若要開啟 [使用者] 對話方塊，按一下對話方塊頂端的 [新增]。
 
    ![建立 Azure AD 測試使用者](./media/collaborativeinnovation-tutorial/create_aaduser_03.png) 

1. 在 [使用者]  對話頁面上，執行下列步驟：
 
    ![建立 Azure AD 測試使用者](./media/collaborativeinnovation-tutorial/create_aaduser_04.png) 
...
1. 在應用程式清單中，選取 **Collaborative Innovation**。
    ...
    ![設定單一登入](./media/collaborativeinnovation-tutorial/tutorial_collaborativeinnovation_app.png) 
