...
在本節中，您會以名為 **Britta Simon** 的測試使用者為基礎，設定及測試與 KnowBe4 Security Awareness Training 搭配運作的 Azure AD 單一登入。
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 KnowBe4 Security Awareness Training 中相關使用者之間的連結關聯性。

若要設定及測試與 KnowBe4 Security Awareness Training 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[設定 KnowBe4 Security Awareness Training 單一登入](#configure-knowbe4-security-awareness-training-single-sign-on)** - 在應用程式端設定單一登入設定。
...
當您在存取面板中按一下 [KnowBe4 Security Awareness Training] 圖格時，應該會自動登入您已設定 SSO 的 KnowBe4 Security Awareness Training。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
