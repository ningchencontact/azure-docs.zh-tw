...
3. **[建立 Greenhouse 測試使用者](#create-a-greenhouse-test-user)** - 在 Greenhouse 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
1. 在 Azure 入口網站的 [Greenhouse] 應用程式整合頁面上，按一下 [單一登入]。
...
3. 在 [Springer Link 網域與 URL] 區段上，執行下列步驟：
...
6. 若要在 **Greenhouse** 端設定單一登入，您必須將已下載的**中繼資料 XML** 傳送給 [Greenhouse 支援小組](http://www.greenhouse.io/contact)。
...
3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。
    ...
    ![[新增] 按鈕](./media/greenhouse-tutorial/create_aaduser_03.png)
