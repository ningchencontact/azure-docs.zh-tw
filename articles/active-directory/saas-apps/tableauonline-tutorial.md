...
1. 在搜尋方塊中，輸入 **Tableau Online**。

    ![建立 Azure AD 測試使用者](./media/tableauonline-tutorial/tutorial_tableauonline_search.png)

1. 在結果窗格中，選取 [Tableau Online]，然後按一下 [新增] 按鈕以新增應用程式。

    ![建立 Azure AD 測試使用者](./media/tableauonline-tutorial/tutorial_tableauonline_addfromgallery.png)
...
1. **[建立 Tableau Online 測試使用者](#creating-a-tableau-online-test-user)** - 使 Tableau Online 中 Britta Simon 的對應使用者連結到該使用者在 Azure AD 中的代表身分。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/tableauonline-tutorial/tutorial_tableauonline_samlbase.png)

1. 在 [Tableau Online 網域及 URL] 區段中，執行下列步驟：
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。
    ...
    ![設定單一登入](./media/tableauonline-tutorial/tutorial_tableauonline_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入](./media/tableauonline-tutorial/tutorial_general_400.png)

1. 在不同的瀏覽器視窗中，登入您的 Tableau Online 應用程式。 依序前往 [設定] 和 [驗證]。
   
    ![設定單一登入](./media/tableauonline-tutorial/tutorial_tableauonline_09.png)
    
1. 若要在 [驗證類型] 區段下啟用 SAML，請 勾選 [使用 SAML 的單一登入] 核取方塊。
   
    ![設定單一登入](./media/tableauonline-tutorial/tutorial_tableauonline_12.png)

1. 向下捲動到 [將中繼資料檔匯入到 Tableau Online]  區段。  按一下 [瀏覽]，然後匯入您從 Azure AD 下載的中繼資料檔案。 然後，按一下 [套用] 。
   
   ![設定單一登入](./media/tableauonline-tutorial/tutorial_tableauonline_13.png)

1. 在 [比對判斷提示] 區段中，針對 [電子郵件地址]、[名字] 和 [姓氏] 插入對應的識別提供者判斷提示名稱。 若要從 Azure AD 取得這項資訊︰ 
...
1. 在 **Azure 入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/tableauonline-tutorial/create_aaduser_01.png) 

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。
    
    ![建立 Azure AD 測試使用者](./media/tableauonline-tutorial/create_aaduser_02.png) 

1. 若要開啟 [使用者] 對話方塊，按一下對話方塊頂端的 [新增]。
 
    ![建立 Azure AD 測試使用者](./media/tableauonline-tutorial/create_aaduser_03.png) 

1. 在 [使用者]  對話頁面上，執行下列步驟：
 
    ![建立 Azure AD 測試使用者](./media/tableauonline-tutorial/create_aaduser_04.png) 
...
1. 選取 [新增單一登入 (SSO) 驗證的使用者] 。 在 [輸入電子郵件地址] 文字方塊中，新增 britta.simon@contoso.com
...
1. 在應用程式清單中，選取 [Tableau Online] 。
    ...
    ![設定單一登入](./media/tableauonline-tutorial/tutorial_tableauonline_app.png) 
