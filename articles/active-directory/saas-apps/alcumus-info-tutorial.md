...
4. 在搜尋方塊中，輸入 **Alcumus Info Exchange**。
    ...
    ![建立 Azure AD 測試使用者](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_search.png)

5. 在結果面板中，選取 [Alcumus Info Exchange]，然後按一下 [新增] 按鈕以新增該應用程式。

    ![建立 Azure AD 測試使用者](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_addfromgallery.png)
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_samlbase.png)

3. 在 [Alcumus Info Exchange 網域及 URL] 區段上，執行下列步驟：

    ![設定單一登入](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_url.png)
...
4. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。
    ...
    ![設定單一登入](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_certificate.png) 

5. 按一下 [儲存]  按鈕。

    ![設定單一登入](./media/alcumus-info-tutorial/tutorial_general_400.png)
...
1. 在 **Azure 入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/alcumus-info-tutorial/create_aaduser_01.png) 

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。
    
    ![建立 Azure AD 測試使用者](./media/alcumus-info-tutorial/create_aaduser_02.png) 

3. 若要開啟 [使用者] 對話方塊，按一下對話方塊頂端的 [新增]。
 
    ![建立 Azure AD 測試使用者](./media/alcumus-info-tutorial/create_aaduser_03.png) 

4. 在 [使用者]  對話頁面上，執行下列步驟：
 
    ![建立 Azure AD 測試使用者](./media/alcumus-info-tutorial/create_aaduser_04.png) 
...
2. 在應用程式清單中，選取 [Alcumus Info Exchange]。
    ...
    ![設定單一登入](./media/alcumus-info-tutorial/tutorial_alcumusinfoexchange_app.png) 
