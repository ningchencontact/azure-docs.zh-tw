...
3. 在 [以 SAML 設定單一登入] 頁面上，按一下 [編輯] 按鈕以開啟 [基本 SAML 設定] 對話方塊。
...
在本節中，您要在 Shuccho Navi 中建立名為 Britta Simon 的使用者。 請與 [Shuccho Navi 支援小組](mailto:sys_ntabtm@nta.co.jp)合作，以在 Shuccho Navi 平台中新增使用者。 您必須先建立和啟動使用者，然後才能使用單一登入。
