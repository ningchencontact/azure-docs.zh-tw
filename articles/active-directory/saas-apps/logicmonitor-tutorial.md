...
3. **[建立 LogicMonitor 測試使用者](#creating-a-logicmonitor-test-user)** - 使 LogicMonitor 中 Britta Simon 的對應使用者連結到該使用者在 Azure AD 中的代表身分。
...
3. 在 [LogicMonitor 網域及 URL] 區段中，執行下列步驟：
...
6. 以系統管理員身分登入您的 **LogicMonitor** 公司網站。
