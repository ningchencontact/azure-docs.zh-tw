...
3. 若要新增 Zscaler，請按一下**新的應用程式**對話方塊頂端的按鈕。

    ![新增應用程式按鈕][3]

4. 在搜尋方塊中，輸入 **Zscaler**。

    ![Zscaler 佈建](./media/zscaler-provisioning-tutorial/app-search.png)

5. 在結果窗格中，選取**Zscaler**，然後按一下**新增**按鈕將 Zscaler 新增到您的 SaaS 應用程式的清單。

    ![Zscaler 佈建](./media/zscaler-provisioning-tutorial/app-search-results.png)

    ![Zscaler 佈建](./media/zscaler-provisioning-tutorial/app-creation.png)
...
2. 您可以選取 Zscaler 從您的 SaaS 應用程式清單。

    ![Zscaler 佈建](./media/zscaler-provisioning-tutorial/app-instance-search.png)
