...
4. 在搜尋方塊中，輸入 **Fuse**，從結果面板中選取 [Fuse]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 Fuse](./media/fuse-tutorial/tutorial_fuse_addfromgallery.png)
...
在 Fuse 中，將 Azure AD 中**使用者名稱**的值指派為 **Username** 的值，以建立連結關聯性。

若要設定及測試與 Fuse 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
3. **[建立 Fuse 測試使用者](#create-a-fuse-test-user)** - 使 Fuse 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[測試單一登入](#test-single-sign-on)**，驗證組態是否能運作。

### <a name="configure-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您會於 Azure 入口網站啟用 Azure AD 單一登入，然後在您的 Fuse 應用程式中設定單一登入。

**若要設定與 Fuse 搭配運作的 Azure AD 單一登入，請執行下列步驟：**

1. 在 Azure 入口網站的 [Fuse] 應用程式整合頁面上，按一下 [單一登入]。

    ![設定單一登入連結][4]

2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
 
    ![單一登入對話方塊](./media/fuse-tutorial/tutorial_fuse_samlbase.png)

3. 在 [Fuse 網域與 URL] 區段中，執行下列步驟：

    ![Fuse 網域與 URL 單一登入資訊](./media/fuse-tutorial/tutorial_fuse_url.png)
    
    在 [登入 URL] 文字方塊中，使用下列模式輸入 URL︰ `https://<tenant name>.fusionuniversal.com/`

    > [!NOTE] 
    > 這不是真實的值。 請使用實際的登入 URL 來更新此值。 請連絡 [Fuse 用戶端支援小組](mailto:support@fusion-universal.com)以取得此值。 
 
4. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (原始)]，然後將憑證檔案儲存在您的電腦上。

    ![憑證下載連結](./media/fuse-tutorial/tutorial_fuse_certificate.png) 

5. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/fuse-tutorial/tutorial_general_400.png)

6. 在 [Fuse 組態] 區段上，按一下 [設定 Fuse] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。

    ![Fuse 設定](./media/fuse-tutorial/tutorial_fuse_configure.png) 

7. 若要為您的應用程式設定 SSO，請聯絡 [Fuse 支援小組](mailto:support@fusion-universal.com)，並提供下列資訊：
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/fuse-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/fuse-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/fuse-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/fuse-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [Fuse] 。
    ...
    ![應用程式清單中的 Fuse 連結](./media/fuse-tutorial/tutorial_fuse_app.png)  
