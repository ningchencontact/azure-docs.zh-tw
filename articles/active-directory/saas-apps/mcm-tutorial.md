...
1. 在結果窗格中，選取 [MCM]，然後按一下 [新增] 按鈕以新增應用程式。
...
1. **[建立 MCM 測試使用者](#creating-a-mcm-test-user)** - 使 MCM 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
