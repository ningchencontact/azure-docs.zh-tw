---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 Comm100 Live Chat 整合 | Microsoft Docs
...
在本教學課程中，您將了解如何整合 Comm100 Live Chat 與 Azure Active Directory (Azure AD)。 在整合 Comm100 Live Chat 與 Azure AD 時，您可以︰

* 在 Azure AD 中控制可存取 Comm100 Live Chat 的人員。
...
* 已啟用 Comm100 Live Chat 單一登入 (SSO) 的訂用帳戶。
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-comm100-live-chat"></a>設定及測試適用於 Comm100 Live Chat 的 Azure AD 單一登入

以名為 **B.Simon** 的測試使用者，設定及測試與 Comm100 Live Chat 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 Comm100 Live Chat 中相關使用者之間的連結關聯性。

若要設定及測試與 Comm100 Live Chat 搭配運作的 Azure AD SSO，請完成下列構成要素：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 Comm100 Live Chat SSO](#configure-comm100-live-chat-sso)** - 在應用程式端設定單一登入設定。
    1. **[建立 Comm100 Live Chat 測試使用者](#create-comm100-live-chat-test-user)** - 使 Comm100 Live Chatr 中對應的 B.Simon 連結到使用者在 Azure AD 中的代表項目。
...
1. Comm100 Live Chat 應用程式需要特定格式的 SAML 判斷提示，需要您將自訂屬性對應新增到您的 SAML 權杖屬性設定。 以下螢幕擷取畫面顯示預設屬性清單。

    ![image](common/edit-attribute.png)

1. 除了上述屬性外，Comm100 Live Chat 應用程式還需要在 SAML 回應中多傳回幾個屬性，如下所示。 這些屬性也會預先填入，但您可以根據您的需求來檢閱這些屬性。
...
1. 在 [設定 Comm100 Live Chat]  區段上，依據您的需求複製適當的 URL。
...
在本節中，您會將 Comm100 Live Chat 的存取權授與 B.Simon，讓其能夠使用 Azure 單一登入。

1. 在 Azure 入口網站中，選取 [企業應用程式]  ，然後選取 [所有應用程式]  。
1. 在應用程式清單中，選取 [Comm100 Live Chat]  。
...
## <a name="configure-comm100-live-chat-sso"></a>設定 Comm100 Live Chat SSO
...
### <a name="create-comm100-live-chat-test-user"></a>建立 Comm100 Live Chat 測試使用者

若要讓 Azure AD 使用者能夠登入 Comm100 Live Chat，您必須將這些使用者佈建到 Comm100 Live Chat。 在 Comm100 Live Chat 中，需以手動方式佈建。
