...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Comm100 Live Chat (單一登入)。
...
4. 在搜尋方塊中，輸入 **Comm100 Live Chat**，從結果面板中選取 [Comm100 Live Chat]  ，然後按一下 [新增]  按鈕以新增應用程式。
     ...
     ![結果清單中的 Comm100 Live Chat](common/search-new-app.png)
...
2. **[設定 Comm100 Live Chat 單一登入](#configure-comm100-live-chat-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Comm100 Live Chat 測試使用者](#create-comm100-live-chat-test-user)** - 在 Comm100 Live Chat 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Comm100 Live Chat]  應用程式整合頁面上，選取 [單一登入]  。
...
5. Comm100 Live Chat 應用程式需要特定格式的 SAML 判斷提示。 設定此應用程式的下列宣告。 您可以在應用程式整合頁面的 [使用者屬性]  區段中，管理這些屬性的值。 在 [以 SAML 設定單一登入]  頁面上，按一下 [編輯]  按鈕以開啟 [使用者屬性]  對話方塊。
...
6. 在 [設定 Comm100 Live Chat]  區段上，依據您的需求複製適當的 URL。
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]  、[所有應用程式]  及 [Comm100 Live Chat]  。
...
4. 在 [新增代理程式]  頁面上，執行下列步驟：
    ...
    a. a. 在 [電子郵件]  文字方塊中，輸入使用者的電子郵件地址，例如 **Brittasimon\@contoso.com**。
