...
4. 在 [基本 SAML 組態]  區段上，執行下列步驟：
    ...
    > [!NOTE]
    > 這不是真正的值。 請使用實際的「登入 URL」來更新此值。 請連絡 [HRworks Single Sign-On 客戶支援小組](https://www.hrworks.de/dienstleistungen/support/)以取得此值。 您也可以參考 Azure 入口網站中**基本 SAML 組態**區段所示的模式。
