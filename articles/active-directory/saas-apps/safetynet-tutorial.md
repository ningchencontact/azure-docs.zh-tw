...
ms.locfileid: "68880189"
---
# <a name="tutorial-integrate-safetynet-with-azure-active-directory"></a>教學課程：整合 SafetyNet 與 Azure Active Directory

在本教學課程中，您將了解如何整合 SafetyNet 與 Azure Active Directory (Azure AD)。 在整合 SafetyNet 與 Azure AD 時，您可以︰

* 在 Azure AD 中控制可存取 SafetyNet 的人員。
...
以名為 **B. Simon** 的測試使用者，設定及測試與 SafetyNet 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 SafetyNet 中相關使用者之間的連結關聯性。

若要設定及測試與 SafetyNet 搭配運作的 Azure AD SSO，請完成下列建構元素：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
2. **[設定 SafetyNet SSO](#configure-safetynet-sso)** - 在應用程式端設定單一登入設定。
...
5. **[建立 SafetyNet 測試使用者](#create-safetynet-test-user)** - 在 SafetyNet 中建立一個與 Azure AD 中代表 Britta Simon 之使用者連結的 B.Simon 對應項目。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [SafetyNet]  應用程式整合頁面上，尋找 [管理]  區段並選取 [單一登入]  。
...
1. 在 [基本 SAML 設定]  區段上，如果您想要以 **IDP** 起始模式設定應用程式，請輸入下列欄位的值：
    ...
    a. 在 [識別碼]  文字方塊中，使用下列模式來輸入 URL：`https://<subdomain>.predictivesolutions.com/sp`

    b. 在 [回覆 URL]  文字方塊中，使用下列模式來輸入 URL：`https://<subdomain>.predictivesolutions.com/CRMApp/saml/SSO`
...
在本節中，您會將 SafetyNet 的存取權授與 B.Simon，讓其能夠使用 Azure 單一登入。
...
### <a name="create-safetynet-test-user"></a>建立 SafetyNet 測試使用者
