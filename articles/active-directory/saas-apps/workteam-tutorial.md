---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 Workteam 整合 | Microsoft Docs
...
在本教學課程中，您將了解如何整合 Workteam 與 Azure Active Directory (Azure AD)。 在整合 Workteam 與 Azure AD 時，您可以︰

* 在 Azure AD 中控制可存取 Workteam 的人員。
...
* 已啟用 Workteam 單一登入 (SSO) 的訂用帳戶。

## <a name="scenario-description"></a>案例描述

在本教學課程中，您會在測試環境中設定和測試 Azure AD SSO。

* Workteam 支援由 **SP 和 IDP** 起始的 SSO
...
以名為 **B.Simon** 的測試使用者，設定及測試與 Workteam 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 Workteam 中相關使用者之間的連結關聯性。

若要設定及測試與 Workteam 搭配運作的 Azure AD SSO，請完成下列建置組塊：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 Workteam SSO](#configure-workteam-sso)** - 在應用程式端設定單一登入設定。
    1. **[建立 Workteam 測試使用者](#create-workteam-test-user)** - 使 Workteam 中對應的 B.Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [設定 Workteam]  區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-workteam-sso"></a>設定 Workteam SSO

1. 若要自動執行 Workteam 內的設定，您必須按一下 [安裝擴充功能]  來安裝「我的應用程式安全登入瀏覽器擴充功能」  。

    ![我的應用程式擴充功能](common/install-myappssecure-extension.png)

2. 將延伸模組新增至瀏覽器之後，按一下 [安裝 Workteam]  便會將您導向到 Workteam 應用程式。 請從該處提供用以登入 Workteam 的管理員認證。 瀏覽器擴充功能會自動為您設定應用程式，並自動執行步驟 3 到 6。
...
### <a name="create-workteam-test-user"></a>建立 Workteam 測試使用者
