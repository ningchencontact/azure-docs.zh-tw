...
* 已啟用 15Five 單一登入的訂用帳戶

## <a name="scenario-description"></a>案例描述

在本教學課程中，您會在測試環境中設定和測試 Azure AD 單一登入。

* 15Five 支援 **SP** 起始的 SSO
...
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 15Five 中相關使用者之間的連結關聯性。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [15Five]  應用程式整合頁面上，選取 [單一登入]  。
...
6. 在 [設定 15Five]  區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-15five-single-sign-on"></a>設定 15Five 單一登入

若要在 **15Five** 端設定單一登入，您必須將從 Azure 入口網站下載的 [同盟中繼資料 XML]  和所複製的適當 URL 傳送給 [15Five 支援小組](https://www.15five.com/contact/)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]  、[所有應用程式]  及 [15Five]  。
...
### <a name="create-15five-test-user"></a>建立 15Five 測試使用者
...
3. 移至 [人員]\>[新增人員]  。
    ...
    ![人員](./media/15five-tutorial/ic784676.png "人員")
