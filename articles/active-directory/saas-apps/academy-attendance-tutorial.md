...
若要設定將 Academy Attendance 整合到 Azure AD 中，您需要從資源庫將 Academy Attendance 新增到受控 SaaS 應用程式清單中。
...
1. 在 [基本 SAML 組態]  區段上，輸入下列欄位的值：
    ...
    a. 在 [登入 URL]  文字方塊中，使用下列模式輸入 URL：`https://<SUBDOMAIN>.aattendance.com/sso/saml2/login?idp=<IDP_NAME>`

    b. 在 [識別碼 (實體識別碼)]  文字方塊中，使用下列模式輸入 URL：`https://<SUBDOMAIN>.aattendance.com/sso/saml2/metadata?idp=<IDP_NAME>`
