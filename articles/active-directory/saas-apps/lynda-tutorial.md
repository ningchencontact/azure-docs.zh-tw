...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Lynda.com (單一登入)。
...
* Lynda.com 支援 **SP** 起始的 SSO
* Lynda.com 支援 **Just In Time** 使用者佈建
...
4. 在搜尋方塊中，輸入 **Lynda.com**，從結果面板中選取 [Lynda.com]  ，然後按一下 [新增]  按鈕以新增應用程式。

     ![結果清單中的 Lynda.com](common/search-new-app.png)
...
5. **[建立 Lynda.com 測試使用者](#create-lyndacom-test-user)** - 使 Lynda.com 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Lynda.com]  應用程式整合頁面上，選取 [單一登入]  。
...
4. 在 [基本 SAML 組態]  區段上，執行下列步驟：
    ...
    > [!NOTE]
    > 這不是真正的值。 請使用實際的「登入 URL」來更新此值。 請連絡 [Lynda.com 用戶端支援小組](https://www.linkedin.com/help/lynda/ask)以取得此值。 您也可以參考 Azure 入口網站中**基本 SAML 組態**區段所示的模式。

5. 在 [以 SAML 設定單一登入]  頁面的 [SAML 簽署憑證]  區段中按一下 [下載]  ，以依據您的需求從指定選項下載**同盟中繼資料 XML**，並儲存在您的電腦上。

    ![憑證下載連結](common/metadataxml.png)

6. 在 [設定 Lynda.com]  區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-lyndacom-single-sign-on"></a>設定 Lynda.com 單一登入

若要在 **Lynda.com** 端設定單一登入，您必須將從 Azure 入口網站下載的 [同盟中繼資料 XML]  和所複製的適當 URL 傳送給 [Lynda.com 支援小組](https://www.linkedin.com/help/lynda/ask)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
### <a name="create-lyndacom-test-user"></a>建立 Lynda.com 測試使用者
...
當您在存取面板中按一下 Lynda.com 圖格時，應該會自動登入您已設定 SSO 的 Lynda.com。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
