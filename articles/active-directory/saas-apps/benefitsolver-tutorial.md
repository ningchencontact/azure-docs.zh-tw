...
1. 在搜尋方塊中，輸入 **Benefitsolver**，從結果面板中選取 [Benefitsolver]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 Benefitsolver](./media/benefitsolver-tutorial/tutorial_benefitsolver_addfromgallery.png)
...
1. **[建立 Benefitsolver 測試使用者](#create-a-benefitsolver-test-user)** - 使 Benefitsolver 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/benefitsolver-tutorial/tutorial_benefitsolver_samlbase.png)

1. 在 [Benefitsolver 網域與 URL] 區段上，執行下列步驟：

    ![Benefitsolver 網域及 URL 單一登入資訊](./media/benefitsolver-tutorial/tutorial_benefitsolver_url.png)
...
1. Benefitsolver 應用程式需要特定格式的 SAML 判斷提示，因此您必須將自訂屬性對應加入 **SAML Token 屬性** 組態。

    ![Benefitsolver 屬性區段](./media/benefitsolver-tutorial/tutorial_attribute.png)
...
1. 在 [單一登入] 對話方塊的 [使用者屬性] 區段中，如圖所示設定 SAML 權杖屬性，然後執行下列步驟：
    ...
    ![Benefitsolver 屬性區段](./media/benefitsolver-tutorial/tutorial_attribute_04.png)
    
    ![Benefitsolver 屬性區段](./media/benefitsolver-tutorial/tutorial_attribute_05.png)
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。
    ...
    ![憑證下載連結](./media/benefitsolver-tutorial/tutorial_benefitsolver_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/benefitsolver-tutorial/tutorial_general_400.png)

1. 若要在 **Benefitsolver** 端設定單一登入，您必須將已下載的**中繼資料 XML** 傳送給 [Benefitsolver 支援小組](https://www.businessolver.com/contact)。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/benefitsolver-tutorial/create_aaduser_01.png)

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/benefitsolver-tutorial/create_aaduser_02.png)

1. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/benefitsolver-tutorial/create_aaduser_03.png)

1. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/benefitsolver-tutorial/create_aaduser_04.png)
...
1. 在應用程式清單中，選取 [Benefitsolver] 。

    ![應用程式清單中的 Benefitsolver 連結](./media/benefitsolver-tutorial/tutorial_benefitsolver_app.png)  
