...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Klue (單一登入)。
...
4. 在搜尋方塊中，輸入 **Klue**，從結果面板中選取 [Klue]，然後按一下 [新增] 按鈕以新增應用程式。

     ![結果清單中的 Klue](common/search-new-app.png)
...
5. **[建立 Klue 測試使用者](#create-klue-test-user)** - 使 Klue 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [Azure 入口網站](https://portal.azure.com/) 的 [Klue] 應用程式整合頁面上，選取 [單一登入]。
...
9. 在 [設定 Klue] 區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-klue-single-sign-on"></a>設定 Klue 單一登入
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [Klue]。
