...
3. 若要新增三個 Zscaler，請按一下**新的應用程式**對話方塊頂端的按鈕。

    ![新增應用程式按鈕][3]

4. 在 [搜尋] 方塊中，輸入**Zscaler 三個**。

    ![Zscaler 三佈建](./media/zscaler-three-provisioning-tutorial/app-search.png)

5. 在結果窗格中，選取**Zscaler 三**，然後按一下**新增**按鈕以新增至您的 SaaS 應用程式清單的 Zscaler 三個。

    ![Zscaler 三佈建](./media/zscaler-three-provisioning-tutorial/app-search-results.png)

    ![Zscaler 三佈建](./media/zscaler-three-provisioning-tutorial/app-creation.png)
...
2. Zscaler 三個從清單中選取您的 SaaS 應用程式。

    ![Zscaler 三佈建](./media/zscaler-three-provisioning-tutorial/app-instance-search.png)
