---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 Coralogix 整合 | Microsoft Docs
...
在本教學課程中，您將了解如何整合 Coralogix 與 Azure Active Directory (Azure AD)。 在整合 Coralogix 與 Azure AD 時，您可以︰

* 在 Azure AD 中控制可存取 Coralogix 的人員。
...
以名為 **B.Simon** 的測試使用者，設定及測試與 Coralogix 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 Coralogix 中相關使用者之間的連結關聯性。

若要設定及測試與 Coralogix 搭配運作的 Azure AD SSO，請完成下列建置組塊：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 Coralogix SSO](#configure-coralogix-sso)** - 在應用程式端設定單一登入設定。
    1. **[建立 Coralogix 測試使用者](#create-coralogix-test-user)** - 使 Coralogix 中對應的 B.Simon 連結到該使用者在 Azure AD 中的代表項目。
