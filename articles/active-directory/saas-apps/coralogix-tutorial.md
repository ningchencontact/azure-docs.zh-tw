...
* Coralogix 支援 **SP** 起始的 SSO

## <a name="adding-coralogix-from-the-gallery"></a>從資源庫新增 Coralogix

若要設定將 Coralogix 整合到 Azure AD 中，您需要從資源庫將 Coralogix 新增到受控 SaaS 應用程式清單。
...
4. 在搜尋方塊中，輸入 **Coralogix**，從結果面板中選取 [Coralogix]，然後按一下 [新增] 按鈕以新增應用程式。
...
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 Coralogix 中相關使用者之間的連結關聯性。

若要設定及測試與 Coralogix 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[設定 Coralogix 單一登入](#configure-coralogix-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Coralogix 測試使用者](#create-coralogix-test-user)** - 使 Coralogix 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
若要使用 Coralogix 設定 Azure AD 單一登入，請執行下列步驟：
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    a. 在 [登入 URL] 文字方塊中，使用下列模式輸入 URL：`https://<SUBDOMAIN>.coralogix.com`
    ...
    > [!NOTE]
    > [登入 URL] 的值不是真正的值。 使用實際的登入 URL 來更新此值。 請連絡 [Coralogix 客戶支援小組](mailto:info@coralogix.com)以取得此值。 您也可以參考 Azure 入口網站中**基本 SAML 組態**區段所示的模式。

5. Coralogix 應用程式需要特定格式的 SAML 判斷提示。 設定此應用程式的下列宣告。 您可以在應用程式整合頁面的 [使用者屬性] 區段中，管理這些屬性的值。 在 [以 SAML 設定單一登入] 頁面上，按一下 [編輯] 按鈕以開啟 [使用者屬性] 對話方塊。
...
6. 在 [使用者屬性] 對話方塊的 [使用者宣告] 區段中，使用 [編輯] 圖示來編輯宣告或使用 [新增宣告] 來新增宣告，如上圖所示設定 SAML 權杖屬性，然後執行下列步驟：
    ...
    ![映像](./media/coralogix-tutorial/tutorial_usermail.png)

    ![映像](./media/coralogix-tutorial/tutorial_usermailedit.png)
...
8. 在 [安裝 Coralogix] 區段上，依據您的需求複製適當的 URL。
