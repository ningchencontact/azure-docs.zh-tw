...
1. **[建立 Kantega SSO for Bamboo 測試使用者](#creating-a-kantega-sso-for-bamboo-test-user)** - 使 Kantega SSO for Bamboo 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 **IDP** 起始模式下，在 [Kantega SSO for Bamboo 網域及 URL] 區段中執行下列步驟：
...
1. 在應用程式清單中，選取 [Kantega SSO for Bamboo]。
