...
4. 在 [基本 SAML 設定]  區段上，如果您想要以 **IDP** 起始模式設定應用程式，請執行下列步驟：
    ...
    ![Kantega SSO for Bamboo 網域及 URL 單一登入資訊](common/idp-intiated.png)
...
5. 如果您想要以 **SP** 起始模式設定應用程式，請按一下 [設定其他 URL]  ，然後執行下列步驟：
    ...
    ![Kantega SSO for Bamboo 網域及 URL 單一登入資訊](common/metadata-upload-additional-signon.png)
...
當您在存取面板中按一下 [Kantega SSO for Bamboo] 圖格時，應該會自動登入您已設定 SSO 的 Kantega SSO for Bamboo。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
