...
4. 在搜尋方塊中，輸入 **Seismic**，從結果面板中選取 [Seismic]，然後按一下 [新增] 按鈕以新增應用程式。

     ![結果清單中的 Seismic](common/search-new-app.png)
...
2. **[設定 Seismic 單一登入](#configure-seismic-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Seismic 測試使用者](#create-seismic-test-user)** - 使 Seismic 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    > [!NOTE]
    > 這些都不是真正的值。 請使用實際的「登入 URL」及「識別碼」來更新這些值。 請連絡 [Seismic 用戶端支援小組](mailto:support@seismic.com)以取得這些值。 您也可以上傳**服務提供者中繼資料**以自動填入識別碼值，如需**服務提供者中繼資料**的詳細資訊，請連絡 [Seismic 用戶端支援小組](mailto:support@seismic.com)。
...
在本節中，您會將 Seismic 的存取權授與 Britta Simon，讓她能夠使用 Azure 單一登入。

1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [Seismic]。
