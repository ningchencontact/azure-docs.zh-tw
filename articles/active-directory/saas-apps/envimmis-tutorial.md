...
* 已啟用 Envi MMIS 單一登入的訂用帳戶

## <a name="scenario-description"></a>案例描述

在本教學課程中，您會在測試環境中設定和測試 Azure AD 單一登入。

* Envi MMIS 支援由 **SP** 和 **IDP** 起始的 SSO
...
7. 在 [設定 Envi MMIS]  區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-envi-mmis-single-sign-on"></a>設定 Envi MMIS 單一登入
...
7. 上傳已下載的中繼資料檔案後，欄位會自動填入。 按一下 [更新] 
...
### <a name="create-envi-mmis-test-user"></a>建立 Envi MMIS 測試使用者

若要讓 Azure AD 使用者可以登入 Envi MMIS，必須將他們佈建到 Envi MMIS。 Envi MMIS 需以手動的方式佈建。
