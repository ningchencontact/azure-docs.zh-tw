...
5. 本節的目標是要在 Azure 入口網站中啟用 Azure AD 單一登入，並在 Pluralsight 應用程式中設定 SSO。
    ...
    ![設定單一登入](./media/pluralsight-tutorial/tutorial_pluralsight_attribute.png)
...
6. 若要加入必要的 [SAML Token 屬性] ，請對下表顯示的每一列執行下列步驟：
   ...
   a. 按一下 [加入使用者屬性] 來開啟 [加入使用者屬性] 對話方塊。
     ...
     ![設定單一登入](./media/pluralsight-tutorial/tutorial_pluralsight_addattribute.png)
