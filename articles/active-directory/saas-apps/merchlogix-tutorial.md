...
1. 在搜尋方塊中，輸入 **Merchlogix**，從結果面板中選取 [Merchlogix]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 Merchlogix](./media/merchlogix-tutorial/tutorial_merchlogix_addfromgallery.png)
...
1. **[建立 Merchlogix 測試使用者](#create-a-merchlogix-test-user)** - 使 Merchlogix 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/merchlogix-tutorial/tutorial_merchlogix_samlbase.png)

1. 在 [Merchlogix 網域與 URL] 區段中，執行下列步驟：
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。
    ...
    ![憑證下載連結](./media/merchlogix-tutorial/tutorial_merchlogix_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/merchlogix-tutorial/tutorial_general_400.png)

1. 在 [Merchlogix 設定] 區段上，按一下 [設定 Merchlogix] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段複製 [登出 URL]、[SAML 實體識別碼] 和 [SAML 單一登入服務 URL]。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/merchlogix-tutorial/create_aaduser_01.png)

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/merchlogix-tutorial/create_aaduser_02.png)

1. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/merchlogix-tutorial/create_aaduser_03.png)

1. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/merchlogix-tutorial/create_aaduser_04.png)
...
1. 在應用程式清單中，選取 [Merchlogix]。

    ![應用程式清單中的 Merchlogix 連結](./media/merchlogix-tutorial/tutorial_merchlogix_app.png)  
