...
- 您可以讓使用者使用他們的 Azure AD 帳戶自動登入 XaitPorter (單一登入)。
...
1. 在搜尋方塊中，輸入 **XaitPorter**，從結果面板中選取 [XaitPorter]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 XaitPorter](./media/xaitporter-tutorial/tutorial_xaitporter_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>設定和測試 Azure AD 單一登入

在本節中，您會以名為 "Britta Simon" 的測試使用者身分，設定及測試與 XaitPorter 搭配運作的 Azure AD 單一登入。

若要讓單一登入能夠運作，Azure AD 必須知道 XaitPorter 與 Azure AD 中互相對應的使用者。 換句話說，必須建立 Azure AD 使用者和 XaitPorter 中相關使用者之間的連結關聯性。

在 XaitPorter 中，將 Azure AD 中**使用者名稱**的值，指派為 [使用者名稱] 的值，以建立連結關聯性。

若要設定及測試與 XaitPorter 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
1. **[建立 XaitPorter 測試使用者](#create-a-xaitporter-test-user)** - 在 XaitPorter 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表該使用者的項目連結。
1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
1. **[測試單一登入](#test-single-sign-on)**，驗證組態是否能運作。

### <a name="configure-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您會在 Azure 入口網站中啟用 Azure AD 單一登入，然後在您的 XaitPorter 應用程式中設定單一登入。

**若要設定與 XaitPorter 搭配運作的 Azure AD 單一登入，請執行下列步驟：**

1. 在 Azure 入口網站的 [XaitPorter] 應用程式整合頁面上，按一下 [單一登入]。

    ![設定單一登入連結][4]

1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
 
    ![單一登入對話方塊](./media/xaitporter-tutorial/tutorial_xaitporter_samlbase.png)

1. 在 [XaitPorter 網域及 URL] 區段上，執行下列步驟：

    ![XaitPorter 網域及 URL 單一登入資訊](./media/xaitporter-tutorial/tutorial_xaitporter_url.png)
...
1. 在 [SAML 簽署憑證] 區段中，按一下「複製」按鈕複製「應用程式同盟中繼資料 URL」，並將它貼到 [記事本]。 
    ...
    ![憑證下載連結](./media/xaitporter-tutorial/tutorial_xaitporter_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/xaitporter-tutorial/tutorial_general_400.png)

1. 將 **IP 位址**或**應用程式同盟中繼資料 Url** 提供給 [SmartRecruiters 支援小組](https://www.smartrecruiters.com/about-us/contact-us/)，讓 XaitPorter 自行設定允許清單，以確保可以從您 XaitPorter 執行個體可觸達 IP 位址。 

1. 在不同的網頁瀏覽器視窗中，以系統管理員身分登入您的 XaitPorter 公司網站。

1. 按一下 [管理員]。

    ![設定單一登入](./media/xaitporter-tutorial/user1.png)

1. 從 [系統安裝] 下拉式清單中，選取 [管理單一登入]。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/xaitporter-tutorial/create_aaduser_01.png)

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/xaitporter-tutorial/create_aaduser_02.png)

1. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/xaitporter-tutorial/create_aaduser_03.png)

1. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/xaitporter-tutorial/create_aaduser_04.png)
...
**若要將 Britta Simon 指派給 XaitPorter，請執行下列步驟：**

1. 在 Azure 入口網站中，開啟應用程式檢視，接著瀏覽至目錄檢視並移至 [企業應用程式]，然後按一下 [所有應用程式]。

    ![指派使用者][201] 

1. 在應用程式清單中，選取 [XaitPorter]。

    ![應用程式清單中的 XaitPorter 連結](./media/xaitporter-tutorial/tutorial_xaitporter_app.png)  
...
當您在存取面板中按一下 XaitPorter 磚時，應該會自動登入您的 XaitPorter 應用程式。
