...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Certify (單一登入)。
...
* Certify 支援由 **IDP** 起始的 SSO
* Certify 支援 **Just In Time** 使用者佈建
...
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 Certify 中相關使用者之間的連結關聯性。

若要設定及測試與 Certify 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[設定 Certify 單一登入](#configure-certify-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Certify 測試使用者](#create-certify-test-user)** - 在 Certify 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表 Britta Simon 的項目連結。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Certify] 應用程式整合頁面上，選取 [單一登入]。
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    ![Certify 網域及 URL 單一登入資訊](common/idp-identifier.png)
...
6. 在 [設定 Certify] 區段上，依據您的需求複製適當的 URL。
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [Certify]。
