...
3. **[建立 SCC LifeCycle 測試使用者](#creating-an-scc-lifecycle-test-user)** - 在 SCC LifeCycle 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
3. 在 [SCC LifeCycle 網域與 URL] 區段中，執行下列步驟：
