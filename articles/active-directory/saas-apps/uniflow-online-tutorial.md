...
* 讓使用者使用其 Azure AD 帳戶自動登入 uniFLOW Online。
...
* 已啟用 uniFLOW Online 單一登入 (SSO) 的訂用帳戶。
...
1. **[設定 uniFLOW Online SSO](#configure-uniflow-online-sso)** - 在應用程式端設定單一登入設定。
    * **[建立 uniFLOW Online 測試使用者](#create-uniflow-online-test-user)** - 使 uniFLOW Online 中對應的 B.Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [基本 SAML 組態]  區段上，輸入下列欄位的值：
    ...
    > [!NOTE]
    > 這些都不是真正的值。 請使用實際的「登入 URL」及「識別碼」來更新這些值。 請連絡 [uniFLOW Online 用戶端支援小組](mailto:support@nt-ware.com)以取得這些值。 您也可以參考 Azure 入口網站中**基本 SAML 組態**區段所示的模式。
...
1. 在左側導覽面板中，選取 [使用者]  索引標籤。
    ...
    ![uniFLOW Online 設定](./media/uniflow-online-tutorial/configure1.png)

1. 按一下 [識別提供者]  。

    ![uniFLOW Online 設定](./media/uniflow-online-tutorial/configure2.png)

1. 按一下 [新增識別提供者]  。

    ![uniFLOW Online 設定](./media/uniflow-online-tutorial/configure3.png)

1. 在 [新增識別提供者]  區段上，執行下列步驟：


    ![uniFLOW Online 設定](./media/uniflow-online-tutorial/configure4.png)
...
1. 在 [一般]  索引標籤上，執行下列步驟：
    ...
    ![uniFLOW Online 設定](./media/uniflow-online-tutorial/configure5.png)

    a. 輸入顯示名稱，例如：*AzureAD SSO*。

    b. 針對 [ADGS 同盟中繼資料]  ，選取 [從 URL]  選項。
...
### <a name="create-uniflow-online-test-user"></a>建立 uniFLOW Online 測試使用者
...
1. 按一下 [新增使用者]  。
    ...
    ![uniFLOW Online 設定](./media/uniflow-online-tutorial/user1.png)

1. 按一下 [手動建立使用者]  。

    ![uniFLOW Online 設定](./media/uniflow-online-tutorial/user2.png)

1. 在 [手動建立使用者]  索引標籤上，依據您的組織需求提供必要的值。

    ![uniFLOW Online 設定](./media/uniflow-online-tutorial/user3.png)

## <a name="test-sso"></a>測試 SSO

在本節中，您會使用存取面板來測試您的 Azure AD 單一登入設定。

當您在存取面板中按一下 [uniFLOW Online] 圖格時，應該會自動登入您已設定 SSO 的 uniFLOW Online。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
