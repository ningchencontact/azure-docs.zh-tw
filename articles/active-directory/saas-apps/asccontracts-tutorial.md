...
1. **[建立 ASC Contracts 測試使用者](#creating-an-asc-contracts-test-user)** - 在 ASC Contracts 中建立一個與 Azure AD 中代表 Britta Simon 的項目連結的 Britta Simon 對應項目。
...
1. 在 [ASC Contracts 網域與 URL] 區段中，執行下列步驟：
