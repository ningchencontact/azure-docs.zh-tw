...
## <a name="configure-and-test-azure-ad-single-sign-on-for-clever"></a>設定及測試 Clever 的 Azure AD 單一登入
...
1. 在 [基本 SAML 組態]  區段上，輸入下列欄位的值：
    ...
    b. 在 [識別碼 (實體識別碼)]  文字方塊中，使用下列模式輸入 URL：`https://clever.com/oauth/saml/metadata.xml`
