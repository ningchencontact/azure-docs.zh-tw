...
若要設定將 FileCloud 整合到 Azure AD 中，您需要從資源庫將 FileCloud 新增到受控 SaaS 應用程式清單。
...
1. 在搜尋方塊中，輸入 **FileCloud**，從結果面板中選取 **FileCloud**，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 FileCloud](./media/filecloud-tutorial/tutorial_filecloud_addfromgallery.png)
...
在 FileCloud 中，將 Azure AD 中 [使用者名稱] 的值指派為 [使用者名稱] 的值，以建立連結關聯性。

若要使用 FileCloud 設定及測試 Azure AD 單一登入功能，您需要完成下列建置組塊：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
1. **[建立 FileCloud 測試使用者](#create-a-filecloud-test-user)** - 在 FileCloud 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
1. **[測試單一登入](#test-single-sign-on)**，驗證組態是否能運作。

### <a name="configure-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您會在 Azure 入口網站中啟用 Azure AD 單一登入，然後在您的 FileCloud 應用程式中設定單一登入。

**若要使用 FileCloud 設定 Azure AD 單一登入，請執行下列步驟：**

1. 在 Azure 入口網站的 [FileCloud] 應用程式整合頁面上，按一下 [單一登入]。

    ![設定單一登入連結][4]

1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
 
    ![單一登入對話方塊](./media/filecloud-tutorial/tutorial_filecloud_samlbase.png)

1. 在 [FileCloud 網域與 URL] 區段上，執行下列步驟：
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。
    ...
    ![憑證下載連結](./media/filecloud-tutorial/tutorial_filecloud_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/filecloud-tutorial/tutorial_general_400.png)

1. 在 [FileCloud 設定] 區段上，按一下 [設定 FileCloud] 可開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 實體識別碼]。

    ![FileCloud 設定](./media/filecloud-tutorial/tutorial_filecloud_configure.png) 

1. 在不同的網頁瀏覽器視窗中，以管理員身分登入您的 FileCloud 租用戶。

1. 在左側的導覽窗格上，按一下 [設定] 。 
   
    ![在應用程式端設定單一登入](./media/filecloud-tutorial/tutorial_filecloud_000.png)

1. 按一下 [設定] 區段上的 [SSO] 索引標籤。 
   
    ![在應用程式端設定單一登入](./media/filecloud-tutorial/tutorial_filecloud_001.png)

1. 在 **Single Sign On (SSO) Settings** (單一登入 (SSO) 設定) 面板上，選取 **SAML** 作為 **Default SSO Type** (預設 SSO 類型)。
   
    ![在應用程式端設定單一登入](./media/filecloud-tutorial/tutorial_filecloud_002.png)

1. 在 [IdP 端點 URL] 文字方塊中，貼上您從 Azure 入口網站複製的 [SAML 實體識別碼] 值。

    ![在應用程式端設定單一登入](./media/filecloud-tutorial/tutorial_filecloud_003.png)

1. 在記事本中開啟您下載的中繼資料，將其內容複製到剪貼簿上，然後貼到 **SAML Settings** (SAML 設定) 面板的 **IdP Meta Data** (IdP 中繼資料) 文字方塊中。

    ![在應用程式端設定單一登入](./media/filecloud-tutorial/tutorial_filecloud_004.png)
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/filecloud-tutorial/create_aaduser_01.png)

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/filecloud-tutorial/create_aaduser_02.png)

1. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/filecloud-tutorial/create_aaduser_03.png)

1. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/filecloud-tutorial/create_aaduser_04.png)
...
在本節中，您會將 FileCloud 的存取權授與 Britta Simon，讓她能夠使用 Azure 單一登入。

![指派使用者角色][200] 

**若要將 Britta Simon 指派給 FileCloud，請執行下列步驟：**

1. 在 Azure 入口網站中，開啟應用程式檢視，接著瀏覽至目錄檢視並移至 [企業應用程式]，然後按一下 [所有應用程式]。

    ![指派使用者][201] 

1. 在應用程式清單中，選取 [FileCloud] 。

    ![應用程式清單中的 FileCloud 連結](./media/filecloud-tutorial/tutorial_filecloud_app.png)  
