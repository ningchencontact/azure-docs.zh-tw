...
3. **[建立 FileCloud 測試使用者](#create-a-filecloud-test-user)** - 在 FileCloud 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
3. 在 [FileCloud 網域與 URL] 區段上，執行下列步驟：
...
6. 在 [FileCloud 設定] 區段上，按一下 [設定 FileCloud] 可開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 實體識別碼]。

    ![FileCloud 設定](./media/filecloud-tutorial/tutorial_filecloud_configure.png) 

7. 在不同的網頁瀏覽器視窗中，以管理員身分登入您的 FileCloud 租用戶。
