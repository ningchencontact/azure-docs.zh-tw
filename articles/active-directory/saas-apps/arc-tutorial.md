---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 Arc Publishing - SSO 整合 | Microsoft Docs
...
在本教學課程中，您將了解如何整合 Arc Publishing - SSO 與 Azure Active Directory (Azure AD)。 在整合 Arc Publishing - SSO 與 Azure AD 時，您可以︰

* 在 Azure AD 中控制可存取 Arc Publishing - SSO 的人員。
...
* 已啟用 Arc Publishing - SSO 單一登入 (SSO) 的訂用帳戶。
...
* Arc Publishing - SSO 支援由 **SP 和 IDP** 起始的 SSO
* Arc Publishing - SSO 支援 **Just In Time** 使用者佈建
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-arc-publishing---sso"></a>設定及測試 Arc Publishing - SSO 的 Azure AD 單一登入

以名為 **B.Simon** 的測試使用者，設定及測試與 Arc Publishing - SSO 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 Arc Publishing - SSO 中相關使用者之間的連結關聯性。

若要設定及測試與 Arc Publishing - SSO 搭配運作的 Azure AD SSO，請完成下列建置組塊：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 Arc Publishing - SSO 單一登入](#configure-arc-publishing---sso-sso)** - 在應用程式端設定單一登入設定。
    1. **[建立 Arc Publishing - SSO 測試使用者](#create-arc-publishing---sso-test-user)** - 使 Arc Publishing - SSO 中對應的 B.Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [基本 SAML 設定]  區段上，如果您想要以 **IDP** 起始模式設定應用程式，請輸入下列欄位的值：
    ...
    a. 在 [識別碼]  文字方塊中，使用下列模式來輸入 URL：`https://www.okta.com/saml2/service-provider/<Unique ID>`

    b. 在 [回覆 URL]  文字方塊中，使用下列模式來輸入 URL：`https://arcpublishing-<Customer>.okta.com/sso/saml2/<Unique ID>`
...
1. 除了上述屬性外，Arc Publishing - SSO 應用程式還需要在 SAML 回應中多傳回幾個屬性，如下所示。 這些屬性也會預先填入，但您可以根據您的需求來檢閱這些屬性。
...
在本節中，您會將 Arc Publishing - SSO 的存取權授與 B.Simon，使其能夠使用 Azure 單一登入。
...
## <a name="configure-arc-publishing---sso-sso"></a>設定 Arc Publishing - SSO 單一登入
