...
1. 在搜尋方塊中，輸入 **YouEarnedt**，從結果面板中選取 [YouEarnedt]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 YouEarnedIt](./media/youearnedit-tutorial/tutorial_youearnedit_addfromgallery.png)
...
1. **[建立 YouEarnedIt 測試使用者](#create-a-youearnedit-test-user)** - 在 YouEarnedIt 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/youearnedit-tutorial/tutorial_youearnedit_samlbase.png)

1. 在 [YouEarnedIt 網域與 URL] 區段上，執行下列步驟：

    ![YouEarnedIt 網域與 URL 單一登入資訊](./media/youearnedit-tutorial/tutorial_youearnedit_url.png)
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。
    ...
    ![憑證下載連結](./media/youearnedit-tutorial/tutorial_youearnedit_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/youearnedit-tutorial/tutorial_general_400.png)

1. 在 [YouEarnedIt 組態] 區段上，按一下 [設定 YouEarnedIt] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 單一登入服務 URL]。

    ![YouEarnedIt 組態](./media/youearnedit-tutorial/tutorial_youearnedit_configure.png) 

1. 若要在 **YouEarnedIt** 端設定單一登入，您必須將已下載的「憑證 (Base64)」和「SAML 單一登入服務 URL」傳送給 [YouEarnedIt 支援小組](https://youearnedit.freshdesk.com/support/tickets/new)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/youearnedit-tutorial/create_aaduser_01.png)

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/youearnedit-tutorial/create_aaduser_02.png)

1. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/youearnedit-tutorial/create_aaduser_03.png)

1. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/youearnedit-tutorial/create_aaduser_04.png)
...
1. 在應用程式清單中，選取 [YouEarnedIt] 。

    ![應用程式清單中的 YouEarnedIt 連結](./media/youearnedit-tutorial/tutorial_youearnedit_app.png)  
