...
* TargetProcess 支援 **SP** 起始的 SSO
* TargetProcess 支援 **Just In Time** 使用者佈建

## <a name="adding-targetprocess-from-the-gallery"></a>從資源庫新增 TargetProcess
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [TargetProcess] 應用程式整合頁面上，選取 [單一登入]。
...
6. 在 [安裝 TargetProcess] 區段上，依據您的需求複製適當的 URL。
