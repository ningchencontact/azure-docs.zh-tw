...
4. 在搜尋方塊中，輸入 **Lecorpio**，從結果面板中選取 [Lecorpio]，然後按一下 [新增] 按鈕以新增應用程式。

     ![結果清單中的 Lecorpio](common/search-new-app.png)
...
5. **[建立 Lecorpio 測試使用者](#create-lecorpio-test-user)** - 使 Lecorpio 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Lecorpio] 應用程式整合頁面上，按一下 [單一登入]。
...
6. 在 [設定 Lecorpio] 區段上，依據您的需求複製適當的 URL。
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [Lecorpio]。
