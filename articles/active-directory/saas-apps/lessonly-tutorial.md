...
若要設定 Lesson.ly 與 Azure AD 的整合作業，您需要從資源庫將 Lesson.ly 加入到受控 SaaS 應用程式清單。
...
1. 在搜尋方塊中，輸入 **Lesson.ly**。

    ![建立 Azure AD 測試使用者](./media/lessonly-tutorial/tutorial_lesson.ly_search.png)

1. 在結果窗格中，選取 [Lesson.ly]，然後按一下 [新增] 按鈕以新增應用程式。

    ![建立 Azure AD 測試使用者](./media/lessonly-tutorial/tutorial_lesson.ly_addfromgallery.png)
...
1. **[建立 Lesson.ly 測試使用者](#creating-a-lessonly-test-user)** - 使 Lesson.ly 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/lessonly-tutorial/tutorial_lesson.ly_samlbase.png)

1. 在 [Lesson.ly 網域與 URL] 區段上，執行下列步驟：

    ![設定單一登入](./media/lessonly-tutorial/tutorial_lesson.ly_url.png)
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。
    ...
    ![設定單一登入](./media/lessonly-tutorial/tutorial_lesson.ly_certificate.png)

1. Lesson.ly 應用程式需要特定格式的 SAML 判斷提示，需要您加入自訂屬性對應到您的 **SAML Token 屬性** 設定。以下螢幕擷取畫面顯示上述的範例。
...
1. 在 [Lesson.ly 組態] 區段上，按一下 [設定 Lesson.ly] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。

    ![設定單一登入](./media/lessonly-tutorial/tutorial_lesson.ly_configure.png)

1. 若要在 **Lesson.ly** 端設定單一登入，您必須將已下載的「憑證 (Base64)」、「登出 URL、SAML實體辨識碼和 SAML 單一登入服務 URL」 傳送給 [Lesson.ly 支援小組](mailto:dev@lessonly.com)。
...
1. 在應用程式清單中，選取 [Lesson.ly] 。

    ![設定單一登入](./media/lessonly-tutorial/tutorial_lesson.ly_app.png) 
