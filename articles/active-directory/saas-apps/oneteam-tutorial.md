...
5. 在結果窗格中，選取 [Oneteam]，然後按一下 [新增] 按鈕以新增應用程式。
...
3. **[建立 Oneteam 測試使用者](#creating-a-oneteam-test-user)** - 使 Oneteam 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
3. 如果您想要以「IDP 起始模式」設定應用程式，請在 [Oneteam 網域和 URL] 區段上執行下列步驟：
...
7. 若要設定您應用程式的 SSO，您可以向 [Oneteam 支援小組](https://support.one-team.com/hc/requests/new)提出支援票證，並向他們提供下載的**中繼資料**。 
