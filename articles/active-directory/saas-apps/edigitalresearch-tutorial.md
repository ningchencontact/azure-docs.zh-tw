...
4. 在搜尋方塊中，輸入 **eDigitalResearch**，從結果面板中選取 [eDigitalResearch]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 eDigitalResearch](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_addfromgallery.png)
...
在 eDigitalResearch 中，將 Azure AD 中**使用者名稱**的值，指派為 **Username** 的值，以建立連結關聯性。

若要設定及測試與 eDigitalResearch 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
3. **[建立 eDigitalResearch 測試使用者](#create-a-edigitalresearch-test-user)** - 在 eDigitalResearch 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_samlbase.png)

3. 在 [eDigitalResearch 網域與 URL] 區段中，執行下列步驟：
    ...
    > [!NOTE] 
    > 這些都不是真正的值。 請使用實際的識別碼和回覆 URL 更新這些值。 請連絡 [eDigitalResearch 支援小組](http://www.maruedr.com/contact)以取得這些值。
 


4. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。

    !![憑證下載連結](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_certificate.png) 

5. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/edigitalresearch-tutorial/tutorial_general_400.png)

6. 在 [eDigitalResearch 設定] 區段上，按一下 [設定 eDigitalResearch] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL] 和 [SAML 實體識別碼]。

    ![eDigitalResearch 組態](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_configure.png) 

7. 若要在 **eDigitalResearch** 端設定單一登入，您必須將已下載的「憑證 (Base64) 檔案」、「SAML 實體識別碼」及「登出 URL」傳送給 [eDigitalResearch 支援小組](http://www.maruedr.com/contact)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/edigitalresearch-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/edigitalresearch-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/edigitalresearch-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/edigitalresearch-tutorial/create_aaduser_04.png)
...
請與 [eDigitalResearch 支援小組](http://www.maruedr.com/contact)合作以建立此使用者。     
...
2. 在應用程式清單中，選取 [eDigitalResearch] 。
    ...
    ![應用程式清單中的 [eDigitalResearch] 連結](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_app.png)  
