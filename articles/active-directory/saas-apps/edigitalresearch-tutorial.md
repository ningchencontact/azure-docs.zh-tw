...
1. 若要在 **eDigitalResearch** 端設定單一登入，您必須將已下載的「憑證 (Base64) 檔案」、「SAML 實體識別碼」及「登出 URL」傳送給 [eDigitalResearch 支援小組](https://www.maruedr.com/contact)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
請與 [eDigitalResearch 支援小組](https://www.maruedr.com/contact)合作以建立此使用者。        
