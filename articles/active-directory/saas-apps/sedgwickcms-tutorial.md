...
1. 在搜尋方塊中，輸入 **Sedgwick CMS**，從結果面板中選取 [Sedgwick CMS]，然後按一下 [新增] 按鈕以新增應用程式。
...
1. **[建立 Sedgwick CMS 測試使用者](#create-a-sedgwick-cms-test-user)** - 在 Sedgwick CMS 中建立一個與 Azure AD 中代表 Britta Simon 之使用者連結的 Britta Simon 對應項目。
...
1. 在 [Sedgwick CMS 網域及 URL] 區段上，執行下列步驟：
