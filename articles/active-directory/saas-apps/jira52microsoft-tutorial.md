...
* JIRA 核心和軟體：5.2
* JIRA 也支援 6.0 和 7.12。 如需詳細資料，請按一下 [JIRA SAML SSO by Microsoft](jiramicrosoft-tutorial.md)
...
3. **[建立 JIRA SAML SSO by Microsoft (V5.2) 測試使用者](#creating-jira-saml-sso-by-microsoft-v52-test-user)** - 讓 JIRA SAML SSO by Microsoft (V5.2) 中的 Britta Simon 對應項目得以連結至 Azure AD 中代表該使用者的項目。
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    ![JIRA SAML SSO by Microsoft (V5.2) 網域及 URL 單一登入資訊](./media/jira52microsoft-tutorial/tutorial_singlesign-onforjira5.2_url.png)
...
5. 在 [SAML 簽署憑證] 區段的 [SAML 簽署憑證] 頁面上，按一下 [複製] 按鈕以複製**應用程式同盟中繼資料 URL** 並貼到記事本。
    ...
    ![憑證下載連結](./media/jira52microsoft-tutorial/tutorial_metadataurl.png) 
...
### <a name="creating-jira-saml-sso-by-microsoft-v52-test-user"></a>建立 JIRA SAML SSO by Microsoft (V5.2) 測試使用者
...
2. 在應用程式清單中，選取 [JIRA SAML SSO by Microsoft (V5.2)]。
    ...
    ![設定單一登入](./media/jira52microsoft-tutorial/tutorial_singlesign-onforjira5.2_app.png)
