...
3. **[建立 ClickTime 測試使用者](#create-a-clicktime-test-user)** - 在 ClickTime 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
3. 在 [ClickTime 網域及 URL] 區段上，執行下列步驟：
...
6. 在 [ClickTime 組態] 區段上，按一下 [設定 ClickTime] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 單一登入服務 URL]。
