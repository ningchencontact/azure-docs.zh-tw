...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 ClickTime (單一登入)。
...
2. **[設定 ClickTime 單一登入](#configure-clicktime-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 ClickTime 測試使用者](#create-clicktime-test-user)** - 在 ClickTime 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [ClickTime] 應用程式整合頁面上，選取 [單一登入]。
...
6. 在 [設定 ClickTime] 區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-clicktime-single-sign-on"></a>設定 ClickTime 單一登入
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [ClickTime]。
...
### <a name="create-clicktime-test-user"></a>建立 ClickTime 測試使用者
