---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 SD Elements 整合 | Microsoft Docs
...
在本教學課程中，您將了解如何整合 SD Elements 與 Azure Active Directory (Azure AD)。 在整合 SD Elements 與 Azure AD 時，您可以︰

* 在 Azure AD 中控制可存取 SD Elements 的人員。
...
* 已啟用 SD Elements 單一登入 (SSO) 的訂用帳戶。

## <a name="scenario-description"></a>案例描述

在本教學課程中，您會在測試環境中設定和測試 Azure AD SSO。

* SD Elements 支援由 **IDP** 起始的 SSO
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-sd-elements"></a>設定及測試 SD Elements 的 Azure AD 單一登入

以名為 **B.Simon** 的測試使用者，設定及測試與 SD Elements 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 SD Elements 中相關使用者之間的連結關聯性。

若要設定及測試與 SD Elements 搭配運作的 Azure AD SSO，請完成下列構成要素：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    * **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    * **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 SD Elements SSO](#configure-sd-elements-sso)** - 在應用程式端設定單一登入設定。
    * **[建立 SD Elements 測試使用者](#create-sd-elements-test-user)** - 使 SD Elements 中 B.Simon 的對應使用者連結到該使用者在 Azure AD 中的代表身分。
...
1. 除了上述屬性外，SD Elements 應用程式還需要在 SAML 回應中多傳回幾個屬性，如下所示。 這些屬性也會預先填入，但您可以根據您的需求來檢閱這些屬性。
...
1. 在 [設定 SD Elements]  區段上，依據您的需求複製適當的 URL。
...
在本節中，您會將 SD Elements 的存取權授與 B.Simon，讓她能夠使用 Azure 單一登入。
...
## <a name="configure-sd-elements-sso"></a>設定 SD Elements SSO
...
1. 在 [單一登入設定]  對話方塊上，執行下列步驟：
    ...
    c. 在 [識別提供者單一登入服務]  文字方塊中，貼上您從 Azure 入口網站複製的 [登入 URL]  值。

    d. 按一下 [檔案]  。

### <a name="create-sd-elements-test-user"></a>建立 SD Elements 測試使用者

本節目標是在 SD Elements 中建立名為 B.Simon 的使用者。 在 SD Elements 的案例中，以手動工作建立 SD Elements 使用者。

**若要在 SD Elements 中建立 B.Simon，請執行下列步驟：**
