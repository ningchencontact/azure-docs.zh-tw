...
1. 登入 [Azure 入口網站](https://portal.azure.com)，依序選取 [企業應用程式]  、[所有應用程式]  及 [Cisco Spark]  。
...
6. 使用您的系統管理員帳戶登入 [Cisco Spark 開發人員網站](https://developer.webex.com/)，即可找到您 Cisco Spark 帳戶的 [租用戶識別碼]  和 [祕密權杖]  。 登入之後 -
   ...
   * 向下捲動至[驗證區段](https://developer.webex.com/getting-started.html#authentication)
