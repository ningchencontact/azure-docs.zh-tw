---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 SmartDraw 整合 | Microsoft Docs
...
在本教學課程中，您會了解如何整合 SmartDraw 與 Azure Active Directory (Azure AD)。 在整合 SmartDraw 與 Azure AD 時，您可以︰

* 在 Azure AD 中控制可存取 SmartDraw 的人員。
* 讓使用者使用其 Azure AD 帳戶自動登入 SmartDraw。
...
在本節中，您會將 SmartDraw 的存取權授與 B.Simon，讓其能夠使用 Azure 單一登入。

1. 在 Azure 入口網站中，選取 [企業應用程式]  ，然後選取 [所有應用程式]  。
1. 在應用程式清單中，選取 [SmartDraw]  。
