...
* 已啟用 Autotask Endpoint Backup 單一登入的訂用帳戶

## <a name="scenario-description"></a>案例描述

在本教學課程中，您會在測試環境中設定和測試 Azure AD 單一登入。

* Autotask Endpoint Backup 支援由 **IDP** 起始的 SSO
...
5. **[建立 Autotask Endpoint Backup 測試使用者](#create-autotask-endpoint-backup-test-user)** - 在 Autotask Endpoint Backup 中建立一個與 Azure AD 中代表 Britta Simon 之使用者連結的 Britta Simon 對應項目。
...
若要設定與 Autotask Endpoint Backup 搭配運作的 Azure AD 單一登入，請執行下列步驟：

1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Autotask Endpoint Backup]  應用程式整合頁面上，選取 [單一登入]  。
...
6. 在 [設定 Autotask Endpoint Backup]  區段上，依據您的需求複製適當的 URL。
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]  、[所有應用程式]  及 [Autotask Endpoint Backup]  。
