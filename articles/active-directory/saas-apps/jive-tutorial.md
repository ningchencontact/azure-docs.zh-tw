...
5. 在結果面板中，選取 [Jive]，然後按一下 [新增] 按鈕以新增應用程式。
...
3. **[建立 Jive 測試使用者](#creating-a-jive-test-user)** - 使 Jive 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
6. 若要在 **Jive** 端設定單一登入，請以系統管理員身分登入您的 Jive 租用戶。
