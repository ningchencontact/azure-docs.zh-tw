---
title: 教學課程：Azure Active Directory 與 Brandfolder 整合 | Microsoft Docs
description: 了解如何設定 Azure Active Directory 與 Brandfolder 之間的單一登入。
...
ms.locfileid: "56190155"
---
# <a name="tutorial-azure-active-directory-integration-with-brandfolder"></a>教學課程：Azure Active Directory 與 Brandfolder 整合

在本教學課程中，您會了解如何將 Brandfolder 與 Azure Active Directory (Azure AD) 整合。
Brandfolder 與 Azure AD 整合提供下列優點：

* 您可以在 Azure AD 中控制可存取 Brandfolder 的人員。
...
若要設定 Azure AD 與 Brandfolder 整合，您需要下列項目：

* Azure AD 訂用帳戶。 如果您沒有 Azure AD 環境，您可以在[這裡](https://azure.microsoft.com/pricing/free-trial/)取得一個月的試用帳戶
* 已啟用 Brandfolder 單一登入的訂用帳戶

## <a name="scenario-description"></a>案例描述

在本教學課程中，您會在測試環境中設定和測試 Azure AD 單一登入。

* Brandfolder 支援由 **IDP** 起始的 SSO

* Brandfolder 支援 **Just In Time** 使用者佈建

## <a name="adding-brandfolder-from-the-gallery"></a>從資源庫新增 Brandfolder

若要設定將 Brandfolder 整合到 Azure AD 中，您需要從資源庫將 Brandfolder 新增到受控 SaaS 應用程式清單中。

**若要從資源庫新增 Brandfolder，請執行下列步驟：**
...
2. **[設定 Brandfolder 單一登入](#configure-brandfolder-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Brandfolder 測試使用者](#create-brandfolder-test-user)** - 使 Brandfolder 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
若要使用 Brandfolder 設定 Azure AD 單一登入功能，請執行下列步驟：

1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Brandfolder] 應用程式整合頁面上，選取 [單一登入]。
...
4. 在 [以 SAML 設定單一登入] 頁面上，執行下列步驟：
    ...
    ![Brandfolder 網域及 URL 單一登入資訊](common/idp-intiated.png)

    a. 在 [識別碼] 文字方塊中，使用下列模式來輸入 URL：`https://brandfolder.com/organizations/<ORG_SLUG>/saml/metadata`
...
在本節中，您會將 Brandfolder 的存取權授與 Britta Simon，讓其能夠使用 Azure 單一登入。

1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [Brandfolder]。

    ![企業應用程式刀鋒視窗](common/enterprise-applications.png)

2. 在應用程式清單中，選取 [Brandfolder]。

    ![應用程式清單中的 Brandfolder 連結](common/all-applications.png)
