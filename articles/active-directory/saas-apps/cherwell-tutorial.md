...
若要設定將 Cherwell 整合到 Azure AD 中，您需要從資源庫將 Cherwell 新增到受控 SaaS 應用程式清單。
...
1. 在搜尋方塊中，輸入 **Cherwell**。

    ![建立 Azure AD 測試使用者](./media/cherwell-tutorial/tutorial_cherwell_search.png)

1. 在結果面板中，選取 [Cherwell]，然後按一下 [新增] 按鈕以新增該應用程式。

    ![建立 Azure AD 測試使用者](./media/cherwell-tutorial/tutorial_cherwell_addfromgallery.png)
...
1. **[建立 Cherwell 測試使用者](#creating-a-cherwell-test-user)** - 在 Cherwell 中建立一個與 Azure AD 中代表 Britta Simon 之項目連結的 Britta Simon 對應項目。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/cherwell-tutorial/tutorial_cherwell_samlbase.png)

1. 在 [Cherwell 網域及 URL] 區段上，執行下列步驟：

    ![設定單一登入](./media/cherwell-tutorial/tutorial_cherwell_url.png)

    在 [登入 URL] 文字方塊中，使用下列模式輸入 URL︰ `https://<companyname>.cherwellondemand.com/cherwellclient`

    > [!NOTE] 
    > 這不是真實的值。 使用實際的「登入 URL」來更新此值。 請連絡 [Cherwell 支援小組](https://csm.cherwell.com/contact)以取得此值。
 
1. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。

    ![設定單一登入](./media/cherwell-tutorial/tutorial_cherwell_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入](./media/cherwell-tutorial/tutorial_general_400.png)

1. 在 [Cherwell 組態] 區段上，按一下 [設定 Cherwell] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製「SAML 實體識別碼」和「SAML 單一登入服務 URL」。

    ![設定單一登入](./media/cherwell-tutorial/tutorial_cherwell_configure.png) 

1. 若要在 **Cherwell** 端設定單一登入，您必須將已下載的「憑證 (Base64)」、「SAML 單一登入服務 URL」及「SAML 實體識別碼」傳送給 [Cherwell 支援小組](https://csm.cherwell.com/contact)。 
...
1. 在 **Azure 入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/cherwell-tutorial/create_aaduser_01.png) 

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。
    
    ![建立 Azure AD 測試使用者](./media/cherwell-tutorial/create_aaduser_02.png) 

1. 若要開啟 [使用者] 對話方塊，按一下對話方塊頂端的 [新增]。
 
    ![建立 Azure AD 測試使用者](./media/cherwell-tutorial/create_aaduser_03.png) 

1. 在 [使用者]  對話頁面上，執行下列步驟：
 
    ![建立 Azure AD 測試使用者](./media/cherwell-tutorial/create_aaduser_04.png) 
...
1. 在應用程式清單中，選取 [Cherwell]。

    ![設定單一登入](./media/cherwell-tutorial/tutorial_cherwell_app.png) 
