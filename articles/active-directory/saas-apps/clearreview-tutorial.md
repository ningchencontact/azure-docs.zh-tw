...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Clear Review (單一登入)。
...
* Clear Review 支援由 **SP 和 IDP** 起始的 SSO
...
4. 在搜尋方塊中，輸入 **Clear Review**，從結果面板中選取 [Clear Review]，然後按一下 [新增] 按鈕以新增應用程式。
     ...
     ![結果清單中的 Clear Review](common/search-new-app.png)
...
2. **[設定 Clear Review 單一登入](#configure-clear-review-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Clear Review 測試使用者](#create-clear-review-test-user)** - 使 Clear Review 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Clear Review] 應用程式整合頁面上，選取 [單一登入]。
...
9. 在 [設定 Clear Review] 區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-clear-review-single-sign-on"></a>設定 Clear Review 單一登入
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [Clear Review]。
...
### <a name="create-clear-review-test-user"></a>建立 Clear Review 測試使用者
