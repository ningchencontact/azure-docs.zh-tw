...
3. **[建立 Reward Gateway 測試使用者](#creating-a-reward-gateway-test-user)** - 使 Reward Gateway 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
3. 在 [Reward Gateway 網域與 URL] 區段上，執行下列步驟：
