...
3. **[建立 Kindling 測試使用者](#creating-a-kindling-test-user)** - 使 Kintone 中 Britta Simon 的對應使用者連結到該使用者在 Azure AD 中的代表身分。
...
3. 在 [Kindling 網域及 URL] 區段中，執行下列步驟：
...
6. 在 [Kindling 組態] 區段上，按一下 [設定 Kindling] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。

    ![設定單一登入](./media/kindling-tutorial/tutorial_kindling_configure.png) 

7. 若要在 **Kindling** 端設定單一登入，您必須將已下載的**憑證 (Base64)**、**登出 URL、SAML實體辨識碼和 SAML 單一登入服務 URL** 傳送至 [Kindling 支援小組](mailto:support@kindlingapp.com)。
