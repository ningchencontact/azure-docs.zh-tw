...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Kindling (單一登入)。
...
4. 在搜尋方塊中，輸入 **Kindling**，從結果面板中選取 [Kindling]  ，然後按一下 [新增]  按鈕以新增應用程式。

     ![結果清單中的 Kindling](common/search-new-app.png)
...
5. **[建立 Kindling 測試使用者](#create-kindling-test-user)** - 使 Kintone 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
6. 在 [設定 Kindling]  區段上，依據您的需求複製適當的 URL。
