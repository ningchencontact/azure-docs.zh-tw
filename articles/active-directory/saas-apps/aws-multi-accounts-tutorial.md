...
1. 在 [Attach Permissions Policies] \(附加權限原則\) 對話方塊上，按一下 [Next: Review] \(下一步：檢閱\)。  
...
1. 執行步驟 9 到步驟 17，以建立您要為此帳戶設定的多個角色。 如果您有兩個以上的帳戶，請為所有帳戶執行相同的步驟，以建立其角色。
