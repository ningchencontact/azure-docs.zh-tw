...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 OneTrust Privacy Management Software (單一登入)。
...
5. **[建立 OneTrust Privacy Management Software 測試使用者](#create-onetrust-privacy-management-software-test-user)** - 在 OneTrust Privacy Management Software 中建立一個與 Azure AD 中代表 Britta Simon 之使用者連結的 Britta Simon 對應項目。
...
若要設定與 OneTrust Privacy Management Software 搭配運作的 Azure AD 單一登入，請執行下列步驟：

1. 在 [Azure 入口網站](https://portal.azure.com/)的 [OneTrust Privacy Management Software]  應用程式整合頁面上，選取 [單一登入]  。
...
### <a name="configure-onetrust-privacy-management-software-single-sign-on"></a>設定 OneTrust Privacy Management Software 單一登入
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]  、[所有應用程式]  及 [OneTrust Privacy Management Software]  。

    ![企業應用程式刀鋒視窗](common/enterprise-applications.png)

2. 在應用程式清單中，選取 [OneTrust Privacy Management Software]  。

    ![應用程式清單中的 [OneTrust Privacy Management Software] 連結](common/all-applications.png)
...
當您在存取面板中按一下 [OneTrust Privacy Management Software] 圖格時，應該會自動登入您已設定 SSO 的 OneTrust Privacy Management Software。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
