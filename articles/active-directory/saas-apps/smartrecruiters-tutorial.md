...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 SmartRecruiters (單一登入)。
...
* SmartRecruiters 支援由 **SP 和 IDP** 起始的 SSO
...
在本節中，您會以名為 **Britta Simon** 的測試使用者為基礎，設定及測試與 SmartRecruiters 搭配運作的 Azure AD 單一登入。
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 SmartRecruiters 中相關使用者之間的連結關聯性。

若要設定及測試與 SmartRecruiters 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[設定 SmartRecruiters 單一登入](#configure-smartrecruiters-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 SmartRecruiters 測試使用者](#create-smartrecruiters-test-user)** - 在 SmartRecruiters 中建立一個與 Azure AD 中代表 Britta Simon 之使用者連結的 Britta Simon 對應項目。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [SmartRecruiters]  應用程式整合頁面上，選取 [單一登入]  。
...
7. 在 [安裝 SmartRecruiters]  區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-smartrecruiters-single-sign-on"></a>設定 SmartRecruiters 單一登入
...
1. 在 Azure 入口網站中，依序選取 [企業應用程式]  、[所有應用程式]  及 [SmartRecruiters]  。
...
### <a name="create-smartrecruiters-test-user"></a>建立 SmartRecruiters 測試使用者

在本節中，您會在 SmartRecruiters 中建立名為 Britta Simon 的使用者。 請與 [SmartRecruiters 支援小組](https://www.smartrecruiters.com/about-us/contact-us/)合作，在 SmartRecruiters 平台中新增使用者。 您必須先建立和啟動使用者，然後才能使用單一登入。

### <a name="test-single-sign-on"></a>測試單一登入 

在本節中，您會使用存取面板來測試您的 Azure AD 單一登入設定。

當您在存取面板中按一下 [SmartRecruiters] 圖格時，應該會自動登入您已設定 SSO 的 SmartRecruiters。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
