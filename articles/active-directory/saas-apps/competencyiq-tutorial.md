...
4. 在搜尋方塊中，輸入 **CompetencyIQ**，從結果面板中選取 [CompetencyIQ]，然後按一下 [新增] 按鈕以新增應用程式。

     ![結果清單中的 CompetencyIQ](common/search-new-app.png)
...
2. **[設定 CompetencyIQ 單一登入](#configure-competencyiq-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 CompetencyIQ 測試使用者](#create-competencyiq-test-user)** - 使 CompetencyIQ 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    b. 在 [識別碼 (實體識別碼)] 文字方塊中，輸入 URL：`https://www.competencyiq.com/`

    > [!NOTE]
    > [登入 URL] 的值不是真正的值。 使用實際的登入 URL 來更新此值。 請連絡 [CompetencyIQ 用戶端支援小組](https://www.competencyiq.com/)以取得此值。 您也可以參考 Azure 入口網站中**基本 SAML 組態**區段所示的模式。

5. 在 [以 SAML 設定單一登入] 頁面的 [SAML 簽署憑證] 區段中按一下 [下載]，以依據您的需求從指定選項下載**同盟中繼資料 XML**，並儲存在您的電腦上。

    ![憑證下載連結](common/metadataxml.png)

6. 在 [設定 CompetencyIQ] 區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-competencyiq-single-sign-on"></a>設定 CompetencyIQ 單一登入

若要在 **CompetencyIQ** 端設定單一登入，您必須將從 Azure 入口網站下載的 [同盟中繼資料 XML] 和複製的適當 URL 傳送給 [CompetencyIQ 支援小組](https://www.competencyiq.com/)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
