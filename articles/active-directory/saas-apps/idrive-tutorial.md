---
title: 教學課程：Azure Active Directory 與 IDrive 整合 | Microsoft Docs
description: 了解如何設定 Azure Active Directory 與 IDrive 之間的單一登入。
...
ms.locfileid: "67100561"
---
# <a name="tutorial-azure-active-directory-integration-with-idrive"></a>教學課程：Azure Active Directory 與 IDrive 整合

在本教學課程中，您將了解如何整合 IDrive 與 Azure Active Directory (Azure AD)。
IDrive 與 Azure AD 整合提供下列優點：

* 您可以在 Azure AD 中控制可存取 IDrive 的人員。
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 IDrive (單一登入)。
...
若要設定 Azure AD 與 IDrive 整合，您需要下列項目：

* Azure AD 訂用帳戶。 如果您沒有 Azure AD 環境，您可以在[這裡](https://azure.microsoft.com/pricing/free-trial/)取得一個月的試用帳戶
* 已啟用 IDrive 單一登入的訂用帳戶

## <a name="scenario-description"></a>案例描述

在本教學課程中，您會在測試環境中設定和測試 Azure AD 單一登入。

* IDrive 支援由 **SP 和 IDP** 起始的 SSO

## <a name="adding-idrive-from-the-gallery"></a>從資源庫新增 IDrive

若要設定將 IDrive 整合到 Azure AD 中，您需要從資源庫將 IDrive 新增到受控 SaaS 應用程式清單。

**若要從資源庫新增 IDrive，請執行下列步驟：**
...
4. 在搜尋方塊中，輸入 **IDrive**，從結果面板中選取 [IDrive]  ，然後按一下 [新增]  按鈕以新增應用程式。

     ![結果清單中的 IDrive](common/search-new-app.png)
...
2. **[設定 IDrive 單一登入](#configure-idrive-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 IDrive 測試使用者](#create-idrive-test-user)** - 使 IDrive 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
7. 在 [安裝 IDrive]  區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-idrive-single-sign-on"></a>設定 IDrive 單一登入

若要設定 **IDrive** 端的單一登入，您必須將從 Azure 入口網站下載的 [憑證 (原始)]  和複製的適當 URL 傳送給 [IDrive 支援小組](https://www.idrive.com/support)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
