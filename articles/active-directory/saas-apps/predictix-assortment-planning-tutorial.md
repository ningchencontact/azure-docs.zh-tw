...
1. 在搜尋方塊中，輸入 **Predictix Assortment Planning**，從結果面板中選取 [Predictix Assortment Planning]，然後按一下 [新增] 按鈕以新增應用程式。
...
1. **[建立 Predictix Assortment Planning 測試使用者](#create-a-predictix-assortment-planning-test-user)** - 在 Predictix Assortment Planning 中建立 Britta Simon 的對應項目，且該項目必須與 Azure AD 中代表 Britta Simon 的項目連結。
...
1. 在 [Predictix Assortment Planning 網域及 URL] 區段上，執行下列步驟：
...
1. 在 [Predictix Assortment Planning 設定] 區段中，按一下 [設定 Predictix Assortment Planning] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。
...
1. 在應用程式清單中，選取 [Predictix Assortment Planning] 。
