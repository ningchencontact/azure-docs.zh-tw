...
在本節中，您會以名為 **Britta Simon** 的測試使用者為基礎，設定及測試與 Uberflip 搭配運作的 Azure AD 單一登入。 若要讓單一登入能夠運作，您必須建立 Azure AD 使用者與 Uberflip 中相關使用者之間的連結。
...
1. **[建立 Uberflip 測試使用者](#create-an-uberflip-test-user)**，Uberflip 中便有名為 Britta Simon 的使用者，其已連結至名為 Britta Simon 的 Azure AD 使用者。
...
Uberflip 中現在會建立名為 Britta Simon 的使用者。 您不需要採取任何動作來建立此使用者。 Uberflip 支援依預設啟用的 Just-In-Time 使用者佈建。 如果 Uberflip 中還沒有名為 Britta Simon 的使用者存在，在驗證之後就會建立新的使用者。
