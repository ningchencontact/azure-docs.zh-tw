...
3. **[建立 Skytap 測試使用者](#create-a-skytap-test-user)** - 讓 Skytap 中的 Britta Simon 對應項目得以連結至 Azure AD 中代表該使用者的項目。
...
3. 若想要以 **IDP** 起始模式設定應用程式，請在 [Skytap 網域及 URL] 區段上執行以下步驟：
...
7. 若要在 **Skytap** 端設定單一登入，您需要將下載的**中繼資料 XML** 傳送給 [Skytap 支援小組](mailto:support@skytap.com)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
4. 在 [使用者] 對話方塊中，執行下列步驟：
    ...
    ![[使用者] 對話方塊](./media/skytap-tutorial/create_aaduser_04.png)
