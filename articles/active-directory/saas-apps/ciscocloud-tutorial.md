...
1. 在搜尋方塊中，輸入 **Cisco Cloud**，從結果面板中選取 [Cisco Cloud]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 Cisco Cloud](./media/ciscocloud-tutorial/tutorial_ciscocloud_addfromgallery.png)
...
1. **[建立 Cisco Cloud 測試使用者](#create-a-cisco-cloud-test-user)** - 在 Cisco Cloud 中建立一個與 Azure AD 中代表 Britta Simon 之使用者連結的 Britta Simon 對應項目。
...
1. 如果您想要以 **IDP** 起始模式設定應用程式，請在 [Cisco Cloud 網域和 URL] 區段上執行下列步驟：
...
1. Cisco Cloud 應用程式需要特定格式的 SAML 判斷提示。 設定此應用程式的下列宣告。 您可以在應用程式整合頁面的 [使用者屬性] 區段中，管理這些屬性的值。
 以下螢幕擷取畫面顯示其相關範例。
...
1. 若要在 **Cisco Cloud** 端設定單一登入，您必須將**應用程式同盟中繼資料 Url** 傳送給 [Cisco Cloud 支援小組](mailto:cpr-ops@cisco.com)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/ciscocloud-tutorial/create_aaduser_01.png)

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/ciscocloud-tutorial/create_aaduser_02.png)

1. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/ciscocloud-tutorial/create_aaduser_03.png)

1. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/ciscocloud-tutorial/create_aaduser_04.png)
...
1. 在應用程式清單中，選取 [Cisco Cloud]。

    ![應用程式清單中的 Cisco Cloud 連結](./media/ciscocloud-tutorial/tutorial_ciscocloud_app.png)  
