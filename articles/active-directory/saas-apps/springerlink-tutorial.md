...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Springer Link (單一登入)。
...
4. 在搜尋方塊中，鍵入 **Springer Link**，從結果面板中選取 [Springer Link]，然後按一下 [新增] 按鈕以新增應用程式。
     ...
     ![結果清單中的 Springer Link](common/search-new-app.png)
...
4. 在 [基本 SAML 組態] 區段上，若您想要以 **IDP** 起始模式設定應用程式，請執行下列步驟：
    ...
    d. 在 [轉送狀態] 文字方塊中，輸入 URL： `https://link.springer.com`
...
當您在存取面板中按一下 [Springer Link] 圖格時，應該會自動登入您設定 SSO 的 Springer Link。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
