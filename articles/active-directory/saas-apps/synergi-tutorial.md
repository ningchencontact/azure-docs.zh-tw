...
1. 在搜尋方塊中，輸入 **Synergi**，從結果面板中選取 [Synergi]，然後按一下 [新增] 按鈕以新增應用程式。

    ![結果清單中的 Synergi](./media/synergi-tutorial/tutorial_synergi_addfromgallery.png)
...
在 Synergi 中，將 Azure AD 中 [使用者名稱]的值指派為 [使用者名稱] 的值，以建立連結關聯性。

若要設定及測試對 Synergi 的 Azure AD 單一登入，您需要完成下列建置組塊：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
1. **[建立 Synergi 測試使用者](#create-a-synergi-test-user)** - 在 Synergi 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表 Britta Simon 的項目連結。
1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
1. **[測試單一登入](#test-single-sign-on)**，驗證組態是否能運作。

### <a name="configure-azure-ad-single-sign-on"></a>設定 Azure AD 單一登入

在本節中，您會在 Azure 入口網站中啟用 Azure AD 單一登入，並在 Synergi 應用程式中設定單一登入。

**若要使用 Synergi 設定 Azure AD 單一登入功能，請執行下列步驟：**

1. 在 Azure 入口網站的 [Synergi] 應用程式整合頁面上，按一下 [單一登入]。

    ![設定單一登入連結][4]

1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
 
    ![單一登入對話方塊](./media/synergi-tutorial/tutorial_synergi_samlbase.png)

1. 在 [Synergi 網域與 URL] 區段上，執行下列步驟：
    ...
    > [!NOTE] 
    > 這些都不是真正的值。 請使用實際的識別碼和回覆 URL 更新這些值。 請連絡 [Synergi 支援小組](https://www.irmsecurity.com/contact/)以取得這些值。

1. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。

    ![憑證下載連結](./media/synergi-tutorial/tutorial_synergi_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/synergi-tutorial/tutorial_general_400.png)

1. 在 [Synergi 設定] 區段上，按一下 [設定 Synergi] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段複製 [登出 URL] 和 [SAML 實體識別碼]。

    ![Synergi 設定](./media/synergi-tutorial/tutorial_synergi_configure.png) 

1. 若要在 **Synergi** 端設定單一登入，您需要將已下載的 [憑證 (Base64)]、[登出 URL] 和 [SAML 實體識別碼] 傳送給 [Synergi 支援小組](https://www.irmsecurity.com/contact/)。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/synergi-tutorial/create_aaduser_01.png)

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/synergi-tutorial/create_aaduser_02.png)

1. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/synergi-tutorial/create_aaduser_03.png)

1. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/synergi-tutorial/create_aaduser_04.png)
...
1. 在應用程式清單中，選取 [Synergi] 。

    ![應用程式清單中的 Synergi 連結](./media/synergi-tutorial/tutorial_synergi_app.png)  
