...
3. **[建立 Synergi 測試使用者](#create-a-synergi-test-user)** - 在 Synergi 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表 Britta Simon 的項目連結。
...
3. 在 [Synergi 網域與 URL] 區段上，執行下列步驟：
...
6. 在 [Synergi 設定] 區段上，按一下 [設定 Synergi] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段複製 [登出 URL] 和 [SAML 實體識別碼]。

    ![Synergi 設定](./media/synergi-tutorial/tutorial_synergi_configure.png) 

7. 若要在 **Synergi** 端設定單一登入，您需要將已下載的 [憑證 (Base64)]、[登出 URL] 和 [SAML 實體識別碼] 傳送給 [Synergi 支援小組](https://www.irmsecurity.com/contact/)。
