...
3. **[建立 Convercent 測試使用者](#creating-a-convercent-test-user)** - 在 Convercent 中建立 Britta Simon 的對應項目，且該項目與 Azure AD 中代表使用者的項目連結。
...
7. 若要為您的應用程式設定 SSO，請連絡 [Convercent 支援小組](mailto:support@convercent.com)並提供下載的**中繼資料 XML**。
