...
1. 在搜尋方塊中，輸入 **LINE WORKS**，從結果面板中選取 [LINE WORKS]，然後按一下 [新增] 按鈕以新增應用程式。
...
在 LINE WORKS 中，指派 Azure AD 中的**使用者名稱**值作為 [Username] \(使用者名稱\) 的值，以建立連結關聯性。

若要設定及測試與 LINE WORKS 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
1. **[建立 LINE WORKS 測試使用者](#create-a-line-works-test-user)** - 在 LINE WORKS 中建立一個與 Azure AD 中代表 Britta Simon 之項目連結的對應項目。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/worksmobile-tutorial/tutorial_lineworks_samlbase.png)

1. 在 [LINE WORKS 網域及 URL] 區段上，執行下列步驟：
    ...
    > [!NOTE] 
    > 這不是真實的值。 請使用實際的登入 URL 來更新此值。 請連絡 [LINE WORKS 用戶端支援小組](mailto:dl_ssoinfo@worksmobile.com)以取得此值。
...
1. 按一下 [儲存]  按鈕。
    ...
    ![設定單一登入儲存按鈕](./media/worksmobile-tutorial/tutorial_general_400.png)

1. 在 [LINE WORKS 設定] 區段上，按一下 [設定 LINE WORKS] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。

    ![LINE WORKS 設定](./media/worksmobile-tutorial/tutorial_lineworks_configure.png) 

1. 若要在 **LINE WORKS** 端設定單一登入，您必須將已下載的**憑證檔案、登出 URL、SAML 實體識別碼及 SAML 單一登入服務 URL**傳送給 [LINE WORKS 支援小組](mailto:dl_ssoinfo@worksmobile.com)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/worksmobile-tutorial/create_aaduser_01.png)

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/worksmobile-tutorial/create_aaduser_02.png)

1. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/worksmobile-tutorial/create_aaduser_03.png)

1. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/worksmobile-tutorial/create_aaduser_04.png)
...
### <a name="create-a-line-works-test-user"></a>建立 LINE WORKS 測試使用者

在本節中，您會在 LINE WORKS 中建立名為 Britta Simon 的使用者。 請與 [LINE WORKS 支援小組](mailto:dl_ssoinfo@worksmobile.com)合作，在 LINE WORKS 平台中新增使用者。
...
**若要將 Britta Simon 指派給 LINE WORKS，請執行下列步驟：**

1. 在 Azure 入口網站中，開啟應用程式檢視，接著瀏覽至目錄檢視並移至 [企業應用程式]，然後按一下 [所有應用程式]。

    ![指派使用者][201] 

1. 在應用程式清單中，選取 [LINE WORKS]。

    ![應用程式清單中的 [LINE WORKS] 連結](./media/worksmobile-tutorial/tutorial_lineworks_app.png)  
