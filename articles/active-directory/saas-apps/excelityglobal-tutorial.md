...
若要在 **ExcelityGlobal** 端設定單一登入，您必須將從 Azure 入口網站複製的 [指紋值]  和適當 URL 傳送給 [ExcelityGlobal 支援小組](https://www.excelityglobal.com/contact-us)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
