...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/myworkdrive-tutorial/tutorial_myworkdrive_samlbase.png)

3. 如果您想要以 **IDP** 起始模式設定應用程式，請在 [MyWorkDrive 網域和 URL] 區段上執行下列步驟：
...
4. 如果您想要以 **SP** 起始模式設定應用程式，請勾選 [顯示進階 URL 設定]，然後執行下列步驟：
    ...
    > [!NOTE] 
    > 這些都不是真正的值。 使用實際的回覆 URL 與登入 URL 更新這些值。 請連絡 [ 用戶端支援小組](mailto:support@myworkdrive.com)以取得這些值。 
...
6. 按一下 [儲存]  按鈕。
    ...
    ![設定單一登入儲存按鈕](./media/myworkdrive-tutorial/tutorial_general_400.png)
    
7. 在 [MyWorkDrive 組態] 區段上，按一下 [設定 MyWorkDrive] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。

    ![MyWorkDrive 組態](./media/myworkdrive-tutorial/tutorial_myworkdrive_configure.png) 

8. 若要在 **MyWorkDrive** 端設定單一登入，您必須將下載的「憑證 (Base64)」、「登出 URL」、「SAML 實體識別碼」，以及「SAML 單一登入服務 URL」傳送至 [MyWorkDrive 支援小組](mailto:support@myworkdrive.com)。 他們會進行此設定，讓兩端的 SAML SSO 連線都設定正確。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/myworkdrive-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/myworkdrive-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/myworkdrive-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/myworkdrive-tutorial/create_aaduser_04.png)
...
**若要將 Britta Simon 指派給 MyWorkDrive，請執行下列步驟：**
...
2. 在應用程式清單中，選取 [MyWorkDrive] 。
    ...
    ![應用程式清單中的 MyWorkDrive 連結](./media/myworkdrive-tutorial/tutorial_myworkdrive_app.png)  
