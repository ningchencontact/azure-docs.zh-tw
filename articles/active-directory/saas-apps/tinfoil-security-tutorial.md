---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 TINFOIL SECURITY 整合 | Microsoft Docs
...
在本教學課程中，您將了解如何整合 TINFOIL SECURITY 與 Azure Active Directory (Azure AD)。 在整合 TINFOIL SECURITY 與 Azure AD 時，您可以：

* 在 Azure AD 中控制可存取 TINFOIL SECURITY 的人員。
* 讓使用者使用其 Azure AD 帳戶自動登入 TINFOIL SECURITY。
...
* 已啟用 TINFOIL SECURITY 單一登入 (SSO) 的訂用帳戶。
...
1. 在 [從資源庫新增]  區段的搜尋方塊中，輸入 **TINFOIL SECURITY**。
1. 從結果面板中選取 [TINFOIL SECURITY]  ，然後新增應用程式。 當應用程式新增至您的租用戶時，請等候幾秒鐘。

## <a name="configure-and-test-azure-ad-single-sign-on-for-tinfoil-security"></a>設定及測試 TINFOIL SECURITY 的 Azure AD 單一登入

以名為 **B.Simon** 的測試使用者，設定及測試與 TINFOIL SECURITY 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 TINFOIL SECURITY 中相關使用者之間的連結關聯性。

若要設定及測試與 TINFOIL SECURITY 搭配運作的 Azure AD SSO，請完成下列建置組塊：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    * **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    * **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 TINFOIL SECURITY SSO](#configure-tinfoil-security-sso)** - 在應用程式端設定單一登入設定。
    * **[建立 TINFOIL SECURITY 測試使用者](#create-tinfoil-security-test-user)** - 使 TINFOIL SECURITY 中對應的 B.Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [TINFOIL SECURITY]  應用程式整合頁面上，尋找 [管理]  區段並選取 [單一登入]  。
...
1. 在 [設定 TINFOIL SECURITY]  區段上，依據您的需求複製適當的 URL。
...
在本節中，您會將 TINFOIL SECURITY 的存取權授與 B.Simon，讓她能夠使用 Azure 單一登入。
...
## <a name="configure-tinfoil-security-sso"></a>設定 TINFOIL SECURITY SSO
...
1. 在 [單一登入]  組態頁面上，執行下列步驟：
    ...
    e. 複製 [您的帳戶識別碼]  值，並將該值貼到 Azure 入口網站中的 [使用者屬性與宣告]  區段底下的 [來源屬性]  文字方塊中。
...
- [嘗試搭配 Azure AD 使用 TINFOIL SECURITY](https://aad.portal.azure.com/)