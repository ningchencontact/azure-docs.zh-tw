...
1. 在搜尋方塊中，輸入 **Ariba**。
    ...
    ![建立 Azure AD 測試使用者](./media/ariba-tutorial/tutorial_ariba_search.png)

1. 在結果面板中，選取 [Ariba]，然後按一下 [新增] 按鈕以新增該應用程式。

    ![建立 Azure AD 測試使用者](./media/ariba-tutorial/tutorial_ariba_addfromgallery.png)
...
1. **[建立 Ariba 測試使用者](#creating-an-ariba-test-user)** - 在 Ariba 中建立一個與 Azure AD 中代表 Britta Simon 之項目連結的 Britta Simon 對應項目。
...
1. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![設定單一登入](./media/ariba-tutorial/tutorial_ariba_samlbase.png)

1. 在 [Ariba 網域及 URL] 區段上，執行下列步驟：

    ![設定單一登入](./media/ariba-tutorial/tutorial_ariba_url.png)

    a. 在 [登入 URL] 文字方塊中，使用下列模式來輸入 URL：`https://<subdomain>.sourcing.ariba.com` 或 `https://<subdomain>.supplier.ariba.com`

    b. 在 [識別碼] 文字方塊中，使用下列模式輸入 URL： `http://<subdomain>.procurement-2.ariba.com`
...
1. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (Base64)]，然後將憑證檔案儲存在您的電腦上。
    ...
    ![設定單一登入](./media/ariba-tutorial/tutorial_ariba_certificate.png) 

1. 按一下 [儲存]  按鈕。

    ![設定單一登入](./media/ariba-tutorial/tutorial_general_400.png)

1. 若要為您的應用程式設定 SSO，請撥打電話 (**1-866-218-2155**) 給 Ariba 支援小組，他們將會進一步協助您將所下載的「憑證 (Base64)」檔案提供給他們。  
...
1. 在 **Azure 入口網站**的左方瀏覽窗格中，按一下 [Azure Active Directory] 圖示。
    ...
    ![建立 Azure AD 測試使用者](./media/ariba-tutorial/create_aaduser_01.png) 

1. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。
    
    ![建立 Azure AD 測試使用者](./media/ariba-tutorial/create_aaduser_02.png) 

1. 若要開啟 [使用者] 對話方塊，按一下對話方塊頂端的 [新增]。
 
    ![建立 Azure AD 測試使用者](./media/ariba-tutorial/create_aaduser_03.png) 

1. 在 [使用者]  對話頁面上，執行下列步驟：
 
    ![建立 Azure AD 測試使用者](./media/ariba-tutorial/create_aaduser_04.png) 
...
1. 在應用程式清單中，選取 [Ariba]。
    ...
    ![設定單一登入](./media/ariba-tutorial/tutorial_ariba_app.png) 
