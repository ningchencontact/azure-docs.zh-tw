...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/4me-tutorial/tutorial_4me_samlbase.png)
...
7. 按一下 [儲存]  按鈕。
    ...
    ![設定單一登入儲存按鈕](./media/4me-tutorial/tutorial_general_400.png)
...
### <a name="create-a-4me-test-user"></a>建立 4me 測試使用者
