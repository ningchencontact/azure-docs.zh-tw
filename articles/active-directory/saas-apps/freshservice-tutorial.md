...
* 您可以讓使用者使用其 Azure AD 帳戶自動登入 Freshservice (單一登入)。
...
若要設定 Azure AD 與 Freshservice 的整合，您需要下列項目：
...
4. 在搜尋方塊中，輸入 **TOPdesk - Secure**，從結果面板中選取 **TOPdesk - Secure**，然後按一下 [新增] 按鈕以新增應用程式。
     ...
     ![結果清單中的 Freshservice](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>設定和測試 Azure AD 單一登入

在本節中，您會以名為 **Britta Simon** 的測試使用者為基礎，設定及測試與 Freshservice 搭配運作的 Azure AD 單一登入。
若要讓單一登入能夠運作，必須建立 Azure AD 使用者與 Freshservice 中相關使用者之間的連結關聯性。

若要設定及測試與 Freshservice 搭配運作的 Azure AD 單一登入，您需要完成下列構成要素：

1. **[設定 Azure AD 單一登入](#configure-azure-ad-single-sign-on)** - 讓您的使用者能夠使用此功能。
2. **[設定 Freshservice 單一登入](#configure-freshservice-single-sign-on)** - 在應用程式端設定單一登入設定。
3. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 Britta Simon 測試 Azure AD 單一登入。
4. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 Britta Simon 能夠使用 Azure AD 單一登入。
5. **[建立 Freshservice 測試使用者](#create-freshservice-test-user)** - 使 Freshservice 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
若要設定與 Freshservice 搭配運作的 Azure AD 單一登入，請執行下列步驟：

1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Freshservice] 應用程式整合頁面上，選取 [單一登入]。
...
4. 在 [基本 SAML 組態] 區段上，執行下列步驟：
    ...
    ![Freshservice 網域及 URL 單一登入資訊](common/sp-identifier.png)
...
7. 在 [設定 Freshservice] 區段上，依據您的需求複製適當的 URL。
...
### <a name="configure-freshservice-single-sign-on"></a>設定 FreshService 單一登入

1. 在不同的網頁瀏覽器視窗中，以系統管理員身分登入您的 Freshservice 公司網站。

2. 在頂端的功能表中，按一下 [系統管理員] 。

    ![管理](./media/freshservice-tutorial/ic790814.png "管理")

3. 在 [客戶入口網站] 中，按一下 [安全性]。

    ![安全性](./media/freshservice-tutorial/ic790815.png "安全性")

4. 在 [安全性] 區段中，執行下列步驟：

    ![單一登入](./media/freshservice-tutorial/ic790816.png "單一登入")
...
在本節中，您會將 Freshservice 的存取權授與 Britta Simon，讓她能夠使用 Azure 單一登入。

1. 在 Azure 入口網站中，依序選取 [企業應用程式]、[所有應用程式] 及 [Freshservice]。

    ![企業應用程式刀鋒視窗](common/enterprise-applications.png)

2. 在應用程式清單中，選取 [Freshservice]。

    ![應用程式清單中的 [Freshservice] 連結](common/all-applications.png)
...
4. 按一下 [新要求者] 。
    ...
    ![新要求者](./media/freshservice-tutorial/ic790819.png "新要求者")

5. 在 [新要求者]  區段中，執行下列步驟：

    ![新要求者](./media/freshservice-tutorial/ic790820.png "新要求者")  
...
當您在存取面板中按一下 Freshservice 圖格時，應該會自動登入您已設定 SSO 的 Freshservice。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
