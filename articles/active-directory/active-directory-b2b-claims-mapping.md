...
![在 UI 中顯示 SAML 權杖屬性](media/active-directory-b2b-claims-mapping/view-claims-in-saml-token.png)
...
- 如需 B2B 共同作業使用者屬性的相關資訊，請參閱 [Azure Active Directory B2B 共同作業使用者的屬性](active-directory-b2b-user-properties.md)。
- 如需 B2B 共同作業使用者的使用者權杖相關資訊，請參閱[了解 Azure AD B2B 共同作業中的使用者權杖](active-directory-b2b-user-token.md)。
