...
| `displayName` | String | 應用程式的顯示名稱。 <br><br> _注意：這是僅適用於應用程式 （舊版） 的註冊體驗。被取代`name`中[應用程式註冊](https://go.microsoft.com/fwlink/?linkid=2083908)體驗。_ | `"MyRegisteredApp"` |
| `errorUrl` | String | 不支援。 | |
...
| `homepage` | String | 應用程式的首頁的 URL。 <br><br> _注意：這是僅適用於應用程式 （舊版） 的註冊體驗。被取代`signInUrl`中[應用程式註冊](https://go.microsoft.com/fwlink/?linkid=2083908)體驗。_ | `"https://MyRegisteredApp"` |
| `objectId` | String | 目錄中應用程式的唯一識別碼。 <br><br> _注意：這是僅適用於應用程式 （舊版） 的註冊體驗。被取代`id`中[應用程式註冊](https://go.microsoft.com/fwlink/?linkid=2083908)體驗。_ | `"f7f9acfc-ae0c-4d6c-b489-0a81dc1652dd"` |
