---
title: 開始使用 Azure Active Directory v2.0 Windows 桌面 | Microsoft Docs
description: Windows Desktop .NET (XAML) 應用程式如何取得存取權杖，以及呼叫受 Azure Active Directory v2.0 端點保護的 API。
