...
- 具現化 MSAL 的機密用戶端應用程式。
- 呼叫 `AcquireTokenOnBehalf`，將用戶端為 Web API 取得的持有人權杖，與相同使用者的持有者權杖交換，但針對我們的 API 呼叫下游 API。
...
您也可以在[NodeJS 和 Azure Functions](https://github.com/Azure-Samples/ms-identity-nodejs-webapi-onbehalfof-azurefunctions/blob/master/MiddleTierAPI/MyHttpTrigger/index.js#L61)查看代表流程執行的範例。
