---
title: "開始使用 Azure Active Directory v2 Windows desktop |Microsoft 文件"
description: "如何在 Windows 桌面.NET (XAML) 應用程式可以取得存取權杖和呼叫由 Azure Active Directory v2 端點保護應用程式開發介面。"
