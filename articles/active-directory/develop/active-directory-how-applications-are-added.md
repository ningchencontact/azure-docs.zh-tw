...
## <a name="what-services-does-azure-ad-provide-to-applications"></a>Azure AD 對應用程式提供哪些服務？
...
## <a name="how-are-applications-represented-in-the-directory"></a>目錄中呈現應用程式的方式？
...
* 從 [Azure Active Directory 應用程式庫](https://azure.microsoft.com/updates/azure-active-directory-over-1000-apps/)
...
* 在「Azure 管理入口網站」中新增您正在開發的應用程式，請參閱：https://msdn.microsoft.com/library/azure/dn132599.aspx
