...
在 iOS 上，將 `com.microsoft.adalcache` keychain 群組新增至您的應用程式在 XCode 中的權利，其位於 **專案設定** > **功能** > **keychain**

### <a name="macos"></a>macOS

MSAL on macOS 預設會使用 `com.microsoft.identity.universalstorage` 存取群組。
