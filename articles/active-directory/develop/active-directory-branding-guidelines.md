...
[取得應用程式] 連結必須將使用者重新導向到 Azure AD 授與存取權 (授權) 頁面，讓組織的系統管理員可授權您的應用程式來存取由 Microsoft 代管的組織資料。 [整合應用程式與 Azure Active Directory](active-directory-integrating-applications.md) 一文中詳細討論存取權的要求方式。
...
| 資產                                | PNG 格式 | SVG 格式 |
| ------------------------------------ | ---------- | ---------- |
| Microsoft 標誌  | ![Microsoft 標誌 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.png) | ![Microsoft 標誌 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.svg) |
...
![「使用 Microsoft 登入」紅線](./media/active-directory-branding-guidelines/Sign-in-with-Microsoft-redlines.png)

若要下載官方影像並在您的應用程式中使用，請以滑鼠右鍵按一下您要使用的影像，然後將其儲存到您的電腦。

| 資產                                | PNG 格式 | SVG 格式 |
| ------------------------------------ | ---------- | ---------- |
| 使用 Microsoft 登入 (深色佈景主題)  | ![[登入] 按鈕深色佈景主題 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.png) | ![[使用 Microsoft 登入] 按鈕深色佈景主題 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.svg) |
| 使用 Microsoft 登入 (淺色佈景主題) | ![[登入] 按鈕淺色佈景主題 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.png) | ![[使用 Microsoft 登入] 按鈕淺色佈景主題 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.svg) |
| 登入 (深色佈景主題)                 | ![[登入] 簡短按鈕深色佈景主題 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.png) | ![[登入] 簡短按鈕深色佈景主題 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.svg) |
| 登入 (淺色佈景主題)                | ![[登入] 簡短按鈕淺色佈景主題 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.png) | ![[登入] 簡短按鈕淺色佈景主題 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.svg) |
