...
* [Azure AD v2.0 權杖參考](v2-id-and-access-tokens.md)
* [Azure AD v2.0 驗證程式庫參考](reference-v2-libraries.md)
* [Azure AD v2.0 端點的範圍和同意](v2-permissions-and-consent.md)
* [Microsoft Graph API](https://graph.microsoft.io)

> [!NOTE]
> 如果您只需要從 Azure Active directory 登入公司及學校帳戶，請先閱讀 [Azure AD 開發人員指南](azure-ad-developers-guide.md)。 Azure AD v2.0 端點的適用對象是明確需要登入 Microsoft 個人帳戶的開發人員。
