...
ms.locfileid: "73905494"
---
# <a name="custom-token-cache-serialization-in-msal-for-java-msal4j"></a>MSAL for JAVA 中的自訂權杖快取序列化（MSAL4J）

若要擁有持續性權杖快取應用程式，您將需要自訂序列化。 與權杖快取序列化相關的 JAVA 類別和介面如下所示：
