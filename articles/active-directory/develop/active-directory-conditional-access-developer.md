...
它假設對於[單一](quickstart-v1-integrate-apps-with-azure-ad.md)和[多租用戶](active-directory-devhowto-multi-tenant-overview.md)應用程式以及[常見驗證模式](authentication-scenarios.md)的認知。
