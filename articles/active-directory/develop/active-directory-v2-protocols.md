---
title: 瞭解 Microsoft 身分識別平臺所支援的授權通訊協定 |Azure
...
> [!NOTE]
> Microsoft 身分識別平臺端點並非支援所有的 Azure AD 案例和功能。 若要判斷您是否應該使用 Microsoft 身分識別平臺端點, 請參閱[microsoft 身分識別平臺限制](active-directory-v2-limitations.md)。
