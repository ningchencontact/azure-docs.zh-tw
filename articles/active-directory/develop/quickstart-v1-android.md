---
title: 從 Android 應用程式 (v1.0) 登入使用者並呼叫 Microsoft Graph API | Microsoft Docs
...
ms.locfileid: "73150288"
---
# <a name="quickstart-sign-in-users-and-call-the-microsoft-graph-api-from-an-android-app-v10"></a>快速入門：從 Android 應用程式 (v1.0) 登入使用者並呼叫 Microsoft Graph API
...
對於新的 Android 應用程式，建議您使用 Microsoft 身分識別平台 (v2.0) 和 MSAL 來取得權杖及存取安全的 Web API。 請參閱[快速入門：從 Android 應用程式登入使用者並呼叫 Microsoft Graph API](quickstart-v2-android.md) 以開始使用。
