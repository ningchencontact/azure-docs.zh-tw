...
## <a name="azure-ad-provisioning-service"></a>Azure AD 布建服務

Azure AD 布建服務會使用 SCIM, 這是許多身分識別提供者 (Idp) 所支援的通訊協定。 如果除了 Azure AD 之外, 您還想要支援 Idp, 建議您使用 Azure AD 布建服務, 因為任何 SCIM 相容的 IdP 都可以連接到您的 SCIM 端點。
...
* [使用 Microsoft CLI 程式庫建立 SCIM 端點](https://docs.microsoft.com/azure/active-directory/manage-apps/use-scim-to-provision-users-and-groups)
...
* [Microsoft Graph 總管](https://aka.ms/ge) 

* [Microsoft Graph 許可權參考](https://docs.microsoft.com/graph/permissions-reference)

* [使用 Microsoft Graph 的最佳做法](https://docs.microsoft.com/graph/best-practices-concept)

* [Microsoft Graph 的精選案例](https://developer.microsoft.com/graph/examples)
