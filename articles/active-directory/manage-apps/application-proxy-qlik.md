...
- [已安裝應用程式 Proxy 連接器](application-proxy-enable.md#install-and-register-a-connector) 
...
**步驟 #5**：「內部 URL」現在應該是 QlikSense URL 搭配應用程式所使用的驗證連接埠。 HTTPS 的預設值為 **4244**，HTTP 的預設值為 4248。 例如：**https&#58;//demo.qlik.com:4244**</br></br>**步驟 #10：** 請勿設定 SSO，讓**單一登入保持停用**
...
如需有關搭配應用程式 Proxy 發佈 Qlik Sense 的詳細資訊，請參閱 Qlik 社群文章：[將 Azure AD 與使用 Kerberos 限制委派與 Qlik Sense 的整合式 Windows 驗證搭配使用](https://community.qlik.com/docs/DOC-20183)。
