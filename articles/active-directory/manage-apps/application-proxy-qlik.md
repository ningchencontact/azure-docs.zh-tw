...
如需使用 Application Proxy 發佈 Qlik Sense 的詳細資訊，請參閱 Qlik 社群文章： 
- [使用 Qlik Sense 搭配 Kerberos 限制委派來搭配使用 Azure AD 和整合式 Windows 驗證](https://community.qlik.com/docs/DOC-20183)。
