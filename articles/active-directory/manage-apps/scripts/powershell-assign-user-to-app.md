...
description: 指派使用者給 Azure Active Directory （Azure AD）應用程式 Proxy 應用程式的 PowerShell 範例。
...
| Command | 注意 |
|---|---|
| [新增-New-azureaduserapproleassignment](https://docs.microsoft.com/powershell/module/AzureAD/new-azureaduserapproleassignment?view=azureadps-2.0) | 將使用者指派給應用程式角色。 |
