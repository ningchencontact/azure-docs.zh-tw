...
2. 在 [Cloud App Security 功能表列](https://portal.cloudappsecurity.com)中，選取 [探索]，然後 [建立快照集報告]。
  ...
  ![建立新的快照集報告](./media/cloud-app-discovery-create-snapshot-reports/create-snapshot-command.png)
3. 輸入 [報告名稱] 和 [描述]。
    
  ![新的快照集報告](./media/cloud-app-discovery-create-snapshot-reports/create-snapshot-form.png)
4. 選取您要上傳記錄檔的 [資料來源]。
5. 根據您可下載的範例來驗證您的記錄格式，並確定它的格式正確。 按一下 [檢視並確認]，然後按一下 [下載範例記錄]。 然後比較您的記錄與所提供的範例，並確定它是相容的。
  
  ![驗證記錄格式](./media/cloud-app-discovery-create-snapshot-reports/create-snapshot-verify.png)
  >  [!NOTE]
...
8. 選取 [管理快照集報告] 並選取您的快照集報告。
  ...
  ![快照集報告管理](./media/cloud-app-discovery-create-snapshot-reports/create-snapshot-manage.png)

## <a name="next-steps"></a>後續步驟

* [開始使用 Azure AD 中的 Cloud App Discovery](cloud-app-discovery.md)
