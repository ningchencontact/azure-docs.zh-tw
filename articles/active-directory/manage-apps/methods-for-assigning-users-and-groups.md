...
## <a name="configure-the-application-to-require-assignment"></a>將應用程式設定為需要指派

應用程式可以設定為需要指派，才可存取。 若要要求指派：

1. 使用系統管理員帳戶或在**企業應用**程式底下以應用程式的擁有者身分登入 Azure 入口網站。
...
13. **選擇性：** **對於公開角色的應用程式**，如果您想要將自助核准的使用者指派給某個角色，請按一下 [在**此應用程式中應為使用者指派哪個角色？** ] 旁的選取器，以選取要指派給這些使用者的角色。
