...
4. 在搜尋方塊中，輸入 **Zendesk**，從結果面板中選取 [Zendesk]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 Zendesk](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_addfromgallery.png)
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_samlbase.png)

3. 在 [Zendesk 網域與 URL] 區段中，執行下列步驟：

    ![Zendesk 網域與 URL 單一登入資訊](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_url.png)
...
4. 在 [SAML 簽署憑證] 區段上，複製憑證的 [指紋] 值。
    ...
    ![憑證下載連結](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_certificate.png)

5. Zendesk 需要特定格式的 SAML 判斷提示。 沒有任何必要 SAML 屬性，但您可以選擇性依照下列步驟，從 [使用者屬性] 區段新增屬性： 

     ![設定單一登入](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_attributes1.png)

    a. 按一下 [新增屬性] 來開啟 [新增屬性] 對話方塊。

    ![設定單一登入的新增](./media/active-directory-saas-zendesk-tutorial/tutorial_attribute_04.png)

    ![設定單一登入的新增屬性](./media/active-directory-saas-zendesk-tutorial/tutorial_attribute_05.png)
...
6. 按一下 [儲存]  按鈕。
    ...
    ![設定單一登入儲存按鈕](./media/active-directory-saas-zendesk-tutorial/tutorial_general_400.png)

7. 在 [Zendesk 組態] 區段上，按一下 [設定 Zendesk] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL 和 SAML 單一登入服務 URL]。

    ![Zendesk 組態](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_configure.png) 

8. 在不同的 Web 瀏覽器視窗中，以系統管理員身分登入您的 Zendesk 公司網站。

9. 按一下 Admin 。

10. 在左側導覽窗格中按一下 [設定]，然後按一下 [安全性]。
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-zendesk-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-zendesk-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-zendesk-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-zendesk-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [Zendesk]。
    ...
    ![應用程式清單中的 Zendesk 連結](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_app.png)  
