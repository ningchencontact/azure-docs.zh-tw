...
6. 在 [Egnyte 組態] 區段上，按一下 [設定 Egnyte] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [SAML 實體識別碼] 和 [SAML 單一登入服務 URL]。
...
11. 在 [單一登入驗證]  區段中，執行下列步驟：
    ...
    d. 將您從 Azure 入口網站複製的「SAML 實體識別碼」貼到 [識別提供者實體識別碼] 文字方塊中。
