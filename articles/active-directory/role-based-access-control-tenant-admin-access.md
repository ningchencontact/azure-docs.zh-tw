...
![Azure AD 系統管理中心 - 屬性 - 全域管理員可以管理 Azure 訂用帳戶 - 螢幕擷取畫面](./media/role-based-access-control-tenant-admin-access/aad-azure-portal-global-admin-can-manage-azure-subscriptions.png)
