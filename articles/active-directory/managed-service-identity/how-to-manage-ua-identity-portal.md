...
ms.locfileid: "43345015"
---
# <a name="create-list-or-delete-a-user-assigned-managed-identity-using-the-azure-portal"></a>使用 Azure 入口網站建立、列出和刪除使用者指派的受控識別
...
在本文中，您會了解如何使用 Azure P入口網站建立、列出和刪除使用者指派的受控識別。
