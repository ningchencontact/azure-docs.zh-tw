...
ms.locfileid: "33932458"
---
# <a name="use-a-user-assigned-managed-service-identity-msi-on-a-windows-vm-to-access-azure-resource-manager"></a>使用 Windows VM 上使用者指派的受控服務身分識別 (MSI) 來存取 Azure Resource Manager
