...
| SDK             | 程式碼範例 |
| --------------- | ----------- |
| .NET            | [使用受控服務識別從 Windows VM 部署 Azure Resource Manager 範本](https://github.com/Azure-Samples/windowsvm-msi-arm-dotnet) \(英文\) |
| .NET Core       | [使用受控服務識別從 Linux VM 呼叫 Azure 服務](https://github.com/Azure-Samples/linuxvm-msi-keyvault-arm-dotnet/) |
| Node.js         | [使用受控服務識別 (MSI) 來管理資源](https://azure.microsoft.com/resources/samples/resources-node-manage-resources-with-msi/) |
