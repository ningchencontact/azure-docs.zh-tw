...
- [Azure Active Directory 中的條件式存取最佳做法](conditional-access/best-practices.md)，以取得在您的組織中部署條件式存取的一些指引。

- [利用 Azure Active Directory 條件式存取來取得特定應用程式的 MFA](conditional-access/app-based-mfa.md)，以熟悉 Azure 入口網站的使用者介面。
