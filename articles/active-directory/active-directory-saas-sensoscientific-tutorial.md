...
在本節中，您會使用存取面板來測試您的 Azure AD 單一登入設定。 在存取面板中按一下 [SensoScientific Wireless Temperature Monitoring System] 圖格，系統會將您自動登入 SensoScientific Wireless Temperature Monitoring System 應用程式。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://msdn.microsoft.com/library/dn308586)。
