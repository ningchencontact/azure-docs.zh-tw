---
title: 驗證方法使用 & 深入解析-Azure Active Directory
...
1. 流覽至**Azure Active Directory** > **密碼重設** > **使用方式 & 深入**解析。
