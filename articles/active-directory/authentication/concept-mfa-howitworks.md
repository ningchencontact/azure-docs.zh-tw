...
Azure Multi-Factor Authentication 為雲端與伺服器提供可選取的驗證方法。 您可以選擇可供使用者使用的方法：撥打電話、簡訊、應用程式通知或應用程式驗證碼。 如需詳細資訊，請參閱 [可選取的驗證方法](howto-mfa-mfasettings.md#selectable-verification-methods)。
