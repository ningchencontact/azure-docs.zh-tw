...
3. 在下一步 的命令提示字元中輸入 **.\AzureMfaNpsExtnConfigSetup.ps1**，然後選取 Enter。 此指令碼會檢查您是否已安裝 Azure AD PowerShell 模組。 如果尚未安裝此模組，指令碼就會為您安裝。
...
![在 Windows Phone 上的範例 MFA 提示](./media/howto-mfa-nps-extension-vpn/image43.png)
