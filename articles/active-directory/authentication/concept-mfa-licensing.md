...
購買隨附 Azure Multi-Factor Authentication 的授權 (例如 Azure Active Directory Premium 或是 Enterprise Mobility + Security)，並將其指派給您 Azure Active Directory 中的使用者。 
