...
1. 啟用電話登入帳戶。
  ...
  - 如果您還沒有 Microsoft 驗證器應用程式，請根據 [Microsoft 驗證器頁面](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md)上的步驟，安裝並新增您個人的 Microsoft 帳戶。 新增的帳戶會自動啟用，以便您可以大顯身手。
...
如果您有關於應用程式的一般問題，請查看 [Microsoft 驗證器常見問題集](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-faq.md)
