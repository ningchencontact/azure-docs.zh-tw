...
了解如何[管理雙步驟驗證設定](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-manage-settings.md)。

了解如何[開始使用 Microsoft 驗證器應用程式](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md)，如此一來，因此您可以使用通知登入，而不是經由文字訊息和來電。
