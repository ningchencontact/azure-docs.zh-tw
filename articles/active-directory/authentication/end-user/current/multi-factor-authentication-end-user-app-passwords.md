...
- 試用 [Microsoft Authenticator 應用程式](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md)，透過應用程式通知來驗證您的登入，而不是透過文字訊息或電話。
