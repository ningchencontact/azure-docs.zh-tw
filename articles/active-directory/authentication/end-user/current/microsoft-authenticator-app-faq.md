---
title: Microsoft Authenticator 應用程式的說明 - Azure AD | Microsoft Docs
...
如果您是執行已開啟 [自動備份] 的 iOS 裝置，並已在舊裝置上建立帳戶備份；您可以使用該備份在新裝置上復原您的帳戶認證。 如需詳細資訊，請參閱[使用 Microsoft Authenticator 應用程式來備份和復原帳戶認證](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-backup-and-recovery.md)一文。 
