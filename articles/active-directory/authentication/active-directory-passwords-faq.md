...
* **問：我是否可以代表我的使用者定義密碼重設資料？**
  ...
  > **答：** 是，您可以透過 Azure AD Connect、PowerShell、[Azure 入口網站](https://portal.azure.com)或「Office 365 系統管理中心」來進行此操作。 如需詳細資訊，請參閱 [Azure AD 自助式密碼重設所用的資料](howto-sspr-authenticationdata.md)。
  >
  >
