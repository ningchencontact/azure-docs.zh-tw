...
![雲端中的 MFA](./media/howto-mfa-getstarted/mfa_in_cloud.png)
...
如果您沒有上述其中一種授權，或沒有足夠的授權來涵蓋所有的使用者，也沒關係。 您只必須執行額外一個步驟以及在您的目錄中[建立多因素驗證提供者](concept-mfa-authprovider.md)。
