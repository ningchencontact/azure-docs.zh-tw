---
title: 使用 Azure MFA 和 AD FS-Azure Active Directory 保護雲端資源
...
3. 從**條件式存取-具名位置**刀鋒視窗中，選取**設定 MFA 信任的 Ip**

   ![Azure AD 條件式存取具名位置設定 MFA 信任的 Ip](./media/howto-mfa-adfs/trustedip6.png)
