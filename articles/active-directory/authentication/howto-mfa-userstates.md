...
2. 尋找您想要啟用 Azure MFA 的使用者。 建議您在頂端變更檢視方式。
   ![Select 使用者從 [使用者] 索引標籤變更的狀態 ](./media/howto-mfa-userstates/enable1.png)
3. 勾選其名稱旁的方塊。
4. 在右邊的**快速步驟**下，選擇 [啟用] 或 [停用]。
   按一下 [快速步驟] 功能表上的 [啟用]，![Enable 選取的使用者 ](./media/howto-mfa-userstates/user1.png)
