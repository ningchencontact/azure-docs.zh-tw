---
title: 自助式密碼重設部署-Azure Active Directory
...
Azure Active Directory 是每位使用者授權的意義，每個使用者都必須擁有其所使用功能的適當授權。
...
| 在使用者註冊後，從 Windows 10 Azure AD 加入或混合式 Azure AD 加入裝置鎖定畫面重設使用者密碼 | 使用者可以重設密碼 |
