...
| **驗證方法** | Authentication methods required to register | Always 1 more than required for reset |
...
| **自訂** | Customize helpdesk link | 是 |
|   | Custom helpdesk email or URL | Support site or email address |
| **內部部署整合** | Write back passwords to on-premises AD | 是 |
...
|   | Frequency of download | Target system | 負責方 |
| --- | --- | --- | --- |
| Auditing backup |   |   |   |
| Reporting backup |   |   |   |
...
| :---: | :---: |
| Level 1 Helpdesk | 密碼管理員 |
| Level 2 Helpdesk | 使用者管理員 |
| SSPR Administrator | 全域管理員 |
