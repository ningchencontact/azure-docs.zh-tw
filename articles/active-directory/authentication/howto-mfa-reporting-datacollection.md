---
title: Azure 的 Multi-factor Authentication 使用者資料收集-Azure Active Directory
...
- 搜尋`C:\Program Files\Multi-Factor Authentication Server\Logs\MultiFactorAuthSvc.log`與任何備份"\<使用者名稱 >"（在搜尋中包含引號） 來尋找新增或變更的使用者記錄的所有執行個體。
