...
4. 在搜尋方塊中，輸入 **KnowledgeOwl**，從結果面板中選取 [KnowledgeOwl]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 KnowledgeOwl](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_knowledgeowl_addfromgallery.png)
...
3. **[建立 KnowledgeOwl 測試使用者](#create-a-knowledgeowl-test-user)** - 使 KnowledgeOwl 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_knowledgeowl_samlbase.png)

3. 如果您想要以 **IDP** 起始模式設定應用程式，請在 [KnowledgeOwl 網域及 URL] 區段上執行下列步驟：

    ![KnowledgeOwl 網域及 URL 單一登入資訊](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_knowledgeowl_url.png)
...
4. 如果您想要以 **SP** 起始模式設定應用程式，請勾選 [顯示進階 URL 設定]，然後執行下列步驟：
    ...
    ![KnowledgeOwl 網域及 URL 單一登入資訊](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_knowledgeowl_url1.png)
...
5. KnowledgeOwl 應用程式需要特定格式的 SAML 判斷提示，需要您將自訂屬性對應新增到 SAML 權杖屬性設定。 設定此應用程式的下列宣告。 您可以在應用程式整合頁面的 [使用者屬性] 區段中管理這些屬性的值。

    ![設定單一登入](./media/active-directory-saas-knowledgeowl-tutorial/attribute.png)
...
6. 在 [單一登入] 對話方塊的 [使用者屬性] 區段中，如上圖所示設定 SAML 權杖屬性，然後執行下列步驟：
    ...
    ![設定單一登入](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_attribute_04.png)

    ![設定單一登入](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_attribute_05.png)
...
7. 在 [SAML 簽署憑證] 區段上，按一下 [憑證 (原始)]，然後將憑證檔案儲存在您的電腦上。
    ...
    ![憑證下載連結](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_knowledgeowl_certificate.png) 

8. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_general_400.png)
    
9. 在 [KnowledgeOwl 設定] 區段上，按一下 [設定 KnowledgeOwl] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。

    ![KnowledgeOwl 設定](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_knowledgeowl_configure.png)

10. 在不同的網頁瀏覽器視窗中，以系統管理員身分登入您的 KnowledgeOwl 公司網站。

11. 按一下 [設定]，然後選取 [安全性]。

    ![KnowledgeOwl 設定](./media/active-directory-saas-knowledgeowl-tutorial/configure1.png)

12. 向下捲動至 [SAML SSO 整合]，然後執行下列步驟：
    
    ![KnowledgeOwl 設定](./media/active-directory-saas-knowledgeowl-tutorial/configure2.png)
    ...
    ![KnowledgeOwl 設定](./media/active-directory-saas-knowledgeowl-tutorial/configure3.png)
    ...
    * 按一下 [儲存] 
    ...
    ![KnowledgeOwl 設定](./media/active-directory-saas-knowledgeowl-tutorial/configure4.png)
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-knowledgeowl-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-knowledgeowl-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-knowledgeowl-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-knowledgeowl-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [KnowledgeOwl]。
    ...
    ![應用程式清單中的 KnowledgeOwl 連結](./media/active-directory-saas-knowledgeowl-tutorial/tutorial_knowledgeowl_app.png)  
