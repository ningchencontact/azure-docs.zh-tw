...
4. 在 [診斷設定] 窗格中，執行下列其中一項：
    ...
    * 若要新增設定，請選取 [新增診斷設定]。  
    ...
    ![匯出設定](./media/reporting-azure-monitor-diagnostics-azure-storage-account/ExportSettings.png)
...
11. 選取 [儲存] 以儲存設定。
    ...
    ![診斷設定](./media/reporting-azure-monitor-diagnostics-azure-storage-account/DiagnosticSettings.png)
...
13. 針對 [稽核記錄] 選取 [insights-log-audit]。 針對 [登入記錄] 選取 [insights-logs-signin]。
    ![儲存體帳戶](./media/reporting-azure-monitor-diagnostics-azure-storage-account/StorageAccount.png)
