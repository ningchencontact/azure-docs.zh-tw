...
![同步處理錯誤的診斷步驟](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixSteps.png)
...
![診斷同步處理錯誤孤立物件「使用者是否存在」案例](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![診斷同步處理錯誤孤立物件「相同使用者」案例](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
