...
4. 在搜尋方塊中，輸入 **LINE WORKS**，從結果面板中選取 [LINE WORKS]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 LINE WORKS](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_addfromgallery.png)
...
3. 在 [LINE WORKS 網域及 URL] 區段上，執行下列步驟：
    ...
    ![LINE WORKS 網域及 URL 單一登入資訊](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_url.png)
...
6. 在 [LINE WORKS 設定] 區段上，按一下 [設定 LINE WORKS] 以開啟 [設定登入] 視窗。 從 [快速參考] 區段中複製 [登出 URL、SAML 實體識別碼和 SAML 單一登入服務 URL]。
    ...
    ![LINE WORKS 設定](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_configure.png) 
...
2. 在應用程式清單中，選取 [LINE WORKS]。
    ...
    ![應用程式清單中的 [LINE WORKS] 連結](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_app.png)  
