...
4. 在搜尋方塊中，輸入 **Yodeck**，從結果面板中選取 [Yodeck]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 Yodeck](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_addfromgallery.png)
...
3. **[建立 Yodeck 測試使用者](#create-a-yodeck-test-user)** - 使 Yodeck 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_samlbase.png)

3. 如果您想要以 **IDP** 起始模式設定應用程式，請在 [Yodeck 網域及 URL] 區段上執行下列步驟：

    ![Yodeck 網域及 URL 單一登入資訊](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url.png)

    在 [識別碼 (實體識別碼)] 文字方塊中，輸入 URL：`https://app.yodeck.com/api/v1/account/metadata/`

4. 如果您想要以 **SP** 起始模式設定應用程式，請勾選 [顯示進階 URL 設定]，然後執行下列步驟：

    ![Yodeck 網域及 URL 單一登入資訊](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url1.png)

    在 [登入 URL] 文字方塊中，輸入 URL：`https://app.yodeck.com/login`

5. 在 [SAML 簽署憑證] 區段中，按一下「複製」按鈕複製「應用程式同盟中繼資料 URL」，並將它貼到 [記事本]。

    ![憑證下載連結](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_certificate.png)

6. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/active-directory-saas-yodeck-tutorial/tutorial_general_400.png)
    
7. 在不同的網頁瀏覽器視窗中，以系統管理員身分登入您的 Yodeck 公司網站。

8. 按一下頁面右上角的 [使用者設定] 選項，然後選取 [帳戶設定]。

    ![Yodeck 設定](./media/active-directory-saas-yodeck-tutorial/configure1.png)

9. 選取 [SAML] 並執行下列步驟：

    ![Yodeck 設定](./media/active-directory-saas-yodeck-tutorial/configure2.png)
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-yodeck-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-yodeck-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-yodeck-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-yodeck-tutorial/create_aaduser_04.png)
...
2. 按一下頁面右上角的 [使用者設定] 選項，然後選取 [使用者]。
    ...
    ![新增員工](./media/active-directory-saas-yodeck-tutorial/user1.png)

3. 按一下 [+使用者] 以開啟 [使用者詳細資料] 索引標籤。

    ![新增員工](./media/active-directory-saas-yodeck-tutorial/user2.png)

4. 在 [使用者詳細資料]  對話頁面上，執行下列步驟：

    ![新增員工](./media/active-directory-saas-yodeck-tutorial/user3.png)
...
2. 在應用程式清單中，選取 [Yodeck]。
    ...
    ![應用程式清單中的 Yodeck 連結](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_app.png)  
