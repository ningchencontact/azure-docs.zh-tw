...
|角色|說明|
|-----|-----|
|網域或樹系 AD 系統管理員|建立可供 Azure AD Connect 用來執行同步處理服務的網域層級服務帳戶。  如需服務帳戶的詳細資訊，請參閱[帳戶和權限](active-directory-aadconnect-accounts-permissions.md)。
...
- [使用快速設定開始使用 Azure AD Connect](active-directory-aadconnect-get-started-express.md)
- [自訂 Azure AD Connect 安裝](active-directory-aadconnect-get-started-custom.md)
- [使用現有的 ADSync 資料庫安裝 Azure AD Connect](active-directory-aadconnect-existing-database.md)  
