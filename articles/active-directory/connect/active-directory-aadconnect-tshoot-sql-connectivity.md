...
![SQL 錯誤](media/active-directory-aadconnect-tshoot-sql-connectivity/sql1.png)
...
或安裝l [PackageManagement PowerShell Modules Preview - 2016 年 3 月 (適用於PowerShell 3.0/4.0)](https://www.microsoft.com/en-us/download/details.aspx?id=51451) 
