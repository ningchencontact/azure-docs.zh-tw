...
ms.locfileid: "34350231"
---
# <a name="tutorial-azure-active-directory-integration-with-mobileiron"></a>教學課程：Azure Active Directory 與 MobileIron 整合

在本教學課程中，您將了解如何整合 MobileIron 與 Azure Active Directory (Azure AD)。

MobileIron 與 Azure AD 整合提供下列優點：

- 您可以在 Azure AD 中控制可存取 MobileIron 的人員。
- 您可以讓使用者使用他們的 Azure AD 帳戶自動登入 MobileIron (單一登入)。
...
4. 在搜尋方塊中，輸入 **MobileIron**，從結果面板中選取 [MobileIron]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 MobileIron](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>設定和測試 Azure AD 單一登入

在本節中，您會以名為 "Britta Simon" 的測試使用者身分，設定及測試與 MobileIron 搭配運作的 Azure AD 單一登入。

若要讓單一登入能夠運作，Azure AD 必須知道 MobileIron 與 Azure AD 中互相對應的使用者。 換句話說，必須建立 Azure AD 使用者和 MobileIron 中相關使用者之間的連結關聯性。

在 MobileIron 中，將 Azure AD 中**使用者名稱**的值，指派為 [使用者名稱] 的值，以建立連結關聯性。
...
在本節中，您會在 Azure 入口網站中啟用 Azure AD 單一登入，然後在您的 MobileIron 應用程式中設定單一登入。

**若要設定與 MobileIron 搭配運作的 Azure AD 單一登入，請執行下列步驟：**

1. 在 Azure 入口網站的 [MobileIron] 應用程式整合頁面上，按一下 [單一登入]。

    ![設定單一登入連結][4]

2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
 
    ![單一登入對話方塊](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_samlbase.png)

3. 如果您想要以 **IDP** 起始模式設定應用程式，請在 [MobileIron 網域及 URL] 區段上執行下列步驟：

    ![MobileIron 網域及 URL 單一登入資訊](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_url.png)
...
4. 如果您想要以 **SP** 起始模式設定應用程式，請勾選 [顯示進階 URL 設定]，然後執行下列步驟：
    ...
    ![MobileIron 網域及 URL 單一登入](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_url1.png)
...
5. 在 [SAML 簽署憑證] 區段上，按一下 [中繼資料 XML]，然後將中繼資料檔案儲存在您的電腦上。
    ...
    ![憑證下載連結](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_certificate.png) 

6. 按一下 [儲存]  按鈕。

    ![設定單一登入儲存按鈕](./media/active-directory-saas-mobileiron-tutorial/tutorial_general_400.png)
...
8. 移至 [管理員] > [身分識別]。
   ...
   * 在 [雲端 IDP 設定的相關資訊] 欄位中，選取 [AAD] 選項。
    ...
    ![設定單一登入管理員按鈕](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_admin.png)

9. 複製 [金鑰] 和 [主機] 的值，並貼到 Azure 入口網站的 [MobileIron 網域及 URL] 區段中來補齊 URL。

    ![設定單一登入管理員按鈕](./media/active-directory-saas-mobileiron-tutorial/key.png)

10. 在 [從 AAD 匯出中繼資料檔案並匯入至 MobileIron 雲端] 欄位中，按一下 [選擇檔案]，上傳從 Azure 入口網站下載的中繼資料。 上傳之後，按一下 [完成]。
 
    ![設定單一登入管理員中繼資料按鈕](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_adminmetadata.png)
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-mobileiron-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-mobileiron-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-mobileiron-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-mobileiron-tutorial/create_aaduser_04.png)
...
2. 移至 [使用者]，然後按一下 [新增] > [單一使用者]。
    ...
    ![設定單一登入使用者按鈕](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_user.png)

3. 在 [使用者] 對話方塊頁面上，執行下列步驟：

    ![設定單一登入使用者新增按鈕](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_useradd.png)
...
2. 在應用程式清單中，選取 [MobileIron]。
    ...
    ![應用程式清單中的 MobileIron 連結](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_app.png)  
