...
![建立原則](./media/active-directory-conditional-access-tou/5555.png)
...
5. 在 [Azure Active Directory] 頁面的 [管理] 區段中，按一下 [條件式存取]。
    ...
    ![條件式存取](./media/active-directory-conditional-access-tou/03.png) 

6. 在 [管理] 區段中，按一下 [使用規定]。

    ![使用規定](./media/active-directory-conditional-access-tou/04.png) 

7. 在頂端的功能表中，按一下 [新增條款]。

    ![使用規定](./media/active-directory-conditional-access-tou/05.png) 

8. 在 [新增使用規定] 頁面上：

    ![使用規定](./media/active-directory-conditional-access-tou/112.png) 
...
![建立原則](./media/active-directory-conditional-access-tou/1234.png)
...
2. 在 [指派] 區段中，按一下 [使用者和群組]。
    ...
    ![使用者和群組](./media/active-directory-conditional-access-tou/06.png)

3. 在 [使用者和群組] 頁面上：

    ![使用者和群組](./media/active-directory-conditional-access-tou/24.png)
...
4. 按一下 [雲端應用程式]。
    ...
    ![雲端應用程式](./media/active-directory-conditional-access-tou/08.png)

5. 在 [雲端應用程式] 頁面上：

    ![選取雲端應用程式](./media/active-directory-conditional-access-tou/26.png)
...
6. 在 [存取控制] 區段中，按一下 [授與]。
    ...
    ![存取控制](./media/active-directory-conditional-access-tou/10.png)

7. 在 [授與] 頁面上：

    ![授與](./media/active-directory-conditional-access-tou/111.png)
...
8. 在 [啟用原則] 區段中，按一下 [開啟]。
    ...
    ![啟用原則](./media/active-directory-conditional-access-tou/18.png)
...
![What If 原則工具](./media/active-directory-conditional-access-tou/79.png)
...
2. 按一下 **使用者**，選取 **Isabella Simonsen**，然後按一下 **選取**。
    ...
    ![使用者](./media/active-directory-conditional-access-tou/15.png)

2. 若要選取雲端應用程式：

    ![雲端應用程式](./media/active-directory-conditional-access-tou/16.png)
...
![使用規定](./media/active-directory-conditional-access-tou/57.png)
...
> [特定應用程式必須使用 MFA](./active-directory-conditional-access-app-based-mfa.md)
