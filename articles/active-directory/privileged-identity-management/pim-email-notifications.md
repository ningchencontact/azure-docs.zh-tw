...
| 使用者 | 角色啟用正在等待核准 | 角色啟用要求已完成 | 角色已指派為合格 | RDP 已啟用 |
| --- | --- | --- | --- | --- |
| 特殊權限角色管理員</br>(已啟用/合格) | 是</br>(唯有未指定任何明確核准者時) | 是* | 是 | 是 |
| 安全性系統管理員</br>(已啟用/合格) | 否 | 是* | 是 | 是 |
| 全域管理員</br>(已啟用/合格) | 否 | 是* | 是 | 是 |
