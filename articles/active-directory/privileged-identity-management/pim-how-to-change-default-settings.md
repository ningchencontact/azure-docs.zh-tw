---
title: 在 PIM 中設定 Azure AD 角色設定-Azure Active Directory |Microsoft Docs
...
ms.locfileid: "70804434"
---
# <a name="configure-azure-ad-role-settings-in-pim"></a>在 PIM 中設定 Azure AD 角色設定

特殊許可權角色管理員可以自訂其組織中的 Azure Active Directory （Azure AD） Privileged Identity Management （PIM），包括變更啟用合格角色指派之使用者的體驗。
