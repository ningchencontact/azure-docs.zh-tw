---
title: 在 PIM 中設定 Azure 資源角色設定-Azure Active Directory |Microsoft Docs
...
1. 按一下 [選取核准者] 以開啟 [選取成員或群組] 窗格。
    ...
    ![選取成員或群組窗格以選取核准者](./media/pim-resource-roles-configure-role-settings/resources-role-settings-select-approvers.png)
