---
title: 在 PIM 中核准或拒絕 Azure 資源角色的要求-Azure Active Directory |Microsoft Docs
...
1. 尋求並按一下您想要核准的要求。 [核准] 或 [拒絕] 窗格隨即出現。
...
1. 尋求並按一下您想要拒絕的要求。 [核准] 或 [拒絕] 窗格隨即出現。
