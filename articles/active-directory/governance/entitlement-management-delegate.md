...
若要在目錄中委派管理目錄或存取封裝，您可以將使用者新增至目錄擁有者或存取套件管理員角色。 建立目錄的人員會成為第一個目錄擁有者。 

指派的目錄擁有者或存取套件管理員必須熟悉專案。 目錄建立者應該在專案的日常作業中包含存取套件，而且他們知道下列資訊：
- 需要哪些資源
- 需要存取權的人員
- 誰需要核准存取權
- 專案會持續多久

目錄建立者應該將此工作委派給專案負責人，而該主管會在專案的「日常作業」中加入並管理存取封裝。 請遵循下列步驟，將使用者指派給目錄擁有者或存取套件管理員角色：
