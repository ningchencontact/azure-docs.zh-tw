...
1. 按一下核取記號以選取 存取套件。
    ...
    ![我存取入口網站-存取套件](./media/entitlement-management-shared/my-access-access-packages.png)
...
1. 如有必要，指定開始日期和結束日期。
    ...
    ![我存取入口網站-要求存取權](./media/entitlement-management-shared/my-access-request-access.png)
