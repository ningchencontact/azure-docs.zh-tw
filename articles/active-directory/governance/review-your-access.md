---
title: 檢閱您的存取權 | Microsoft Docs
description: 使用 Azure Active Directory 檢閱您的存取權
...
![檢閱存取權電子郵件](./media/review-your-access/new-ar-email.png)
...
當您從清單中選取存取權檢閱時，會看到自己的存取權。 選取資料列，然後選擇要核准或拒絕您的持續存取權需求。

檢閱者可能會要求您提供理由來核准持續存取權。

## <a name="next-steps"></a>後續步驟

拒絕的存取權不會立即移除。 如果您想要變更您的答案並核准，請重設回應，然後選取新的回應。 您可以執行這個步驟，直到存取權檢閱完成為止。
