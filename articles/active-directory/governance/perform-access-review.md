---
title: 使用 Azure AD 存取權檢閱開始存取權檢閱 | Microsoft Docs
description: 了解如何使用 Azure Active Directory 存取權檢閱來開始存取權檢閱。
...
ms.locfileid: "52263412"
---
# <a name="start-an-access-review-with-azure-ad-access-reviews"></a>使用 Azure AD 存取權檢閱開始存取權檢閱
