---
title: 如何安裝及使用 log analytics 檢視 Azure Active directory |Microsoft Docs
description: 了解如何安裝及使用 log analytics 檢視 Azure Active directory
