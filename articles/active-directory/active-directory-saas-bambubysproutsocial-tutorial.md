...
當您在「存取面板」中按一下 [Bambu by Sprout Social] 圖格時，應該會自動登入您的 Bambu by Sprout Social 應用程式。 如需 [存取面板] 的詳細資訊，請參閱 [存取面板簡介](https://msdn.microsoft.com/library/dn308586)。 
