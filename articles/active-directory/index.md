                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>什麼是 Azure AD？</h3>
                                <p>深入了解 Azure Active Directory，包括可用的授權類型和相關聯的功能類型。</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>新增公司商標</h3>
                                <p>了解如何將貴組織的標誌和色彩配置新增至您的 Azure AD 登入頁面。</p>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="manage-apps/user-provisioning.md">自動佈建使用者</a><br>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            <a href="governance/entitlement-management-overview.md">什麼是權利管理？</a><br>
                                                            <a href="governance/access-reviews-overview.md">什麼是存取權檢閱？</a><br>
                                                            <a href="conditional-access/terms-of-use.md">需要使用規定</a><br>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="privileged-identity-management/pim-how-to-add-role-to-user.md">指派目錄角色</a><br>
                                                            <a href="privileged-identity-management/index.yml"><i>更多資訊 &gt;</i></a>
                                                        </p>
                                                        <br><br>
                                                        <h3><a href="reports-monitoring/index.yml">報告和監視</a></h3>
                                                        <p>
                                                            <a href="reports-monitoring/concept-audit-logs.md">稽核記錄</a><br>
                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>Microsoft 365</h3>
                                <p>探索 Microsoft 365，包括 Azure AD 的完整解決方案。</p>
                            </div>
                        </div>
                    </div>
                </div>
