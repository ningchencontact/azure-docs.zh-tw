...
![建立原則](./media/active-directory-conditional-access-app-based-mfa/32.png)
...
![建立原則](./media/active-directory-conditional-access-app-based-mfa/31.png)
...
3. 在 [Azure Active Directory] 頁面的 [管理] 區段中，按一下 [條件式存取]。
    ...
    ![條件式存取](./media/active-directory-conditional-access-app-based-mfa/03.png)
 
4. 在 [條件式存取] 頁面頂端的工具列中，按一下 [新增]。

    ![加](./media/active-directory-conditional-access-app-based-mfa/04.png)
...
6. 在 [指派] 區段中，按一下 [使用者和群組]。
    ...
    ![使用者和群組](./media/active-directory-conditional-access-app-based-mfa/06.png)

7. 在 [使用者和群組] 頁面上，執行下列步驟︰

    ![使用者和群組](./media/active-directory-conditional-access-app-based-mfa/24.png)
...
8. 按一下 [雲端應用程式]。
    ...
    ![雲端應用程式](./media/active-directory-conditional-access-app-based-mfa/08.png)

9. 在 [雲端應用程式] 頁面上，執行下列步驟︰

    ![選取雲端應用程式](./media/active-directory-conditional-access-app-based-mfa/26.png)
...
10. 在 [存取控制] 區段中，按一下 [授與]。
    ...
    ![存取控制](./media/active-directory-conditional-access-app-based-mfa/10.png)

11. 在 [授與] 頁面上，執行下列步驟︰

    ![授與](./media/active-directory-conditional-access-app-based-mfa/11.png)
...
12. 在 [啟用原則] 區段中，按一下 [開啟]。
    ...
    ![啟用原則](./media/active-directory-conditional-access-app-based-mfa/18.png)
...
![What If 原則工具](./media/active-directory-conditional-access-app-based-mfa/23.png)
...
2. 若要選取雲端應用程式，請執行下列步驟：
    ...
    ![雲端應用程式](./media/active-directory-conditional-access-app-based-mfa/16.png)
