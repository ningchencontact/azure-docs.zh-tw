...
|  <ul><li>ClassificationDescriptions<li>類型：字串<li>預設值：“” | 分類說明的以逗號分隔清單。 ClassificationDescriptions 的值只能採用下列格式：<br>$setting ["ClassificationDescriptions"] = "分類：描述，分類：描述"<br>其中分類會符合 ClassificationList 中的字串。|
...
|  <ul><li>AllowAddGuests<li>型別：布林值<li>預設值：True | 布林值表示是否允許將來賓新增至此目錄。|
