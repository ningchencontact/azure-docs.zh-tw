 ...
 * **[Kaizala 系統管理員](#kaizala-administrator)** :具備此角色的使用者具有全域權限管理設定 Microsoft Kaizala，當服務已存在，並能管理支援票證及監控服務健全狀況。
此外，使用者可以存取與採用和使用方式 Kaizala 相關的組織成員和商務報表使用 Kaizala 動作產生的報告。 
...
* **[訊息中心隱私權讀取器](#message-center-privacy-reader)** :此角色中的使用者可以監視訊息中心，包括資料隱私權訊息中的所有通知。 訊息中心隱私權讀者將包括這些相關的資料隱私權的電子郵件通知，他們可以取消訂閱使用訊息中心喜好設定。 只有全域管理員和訊息中心隱私權讀取器可以讀取的資料隱私權訊息。 此外，這個角色包含檢視群組、 網域和訂用帳戶的能力。 這個角色具有檢視、 建立或管理服務要求沒有權限。
...
* **[搜尋系統管理員](#search-administrator)** :此角色中的使用者會在 Microsoft 365 系統管理中心中的完整存取所有的 Microsoft Search 管理功能。 搜尋系統管理員可以委派搜尋系統管理員和搜尋編輯器角色給使用者，以及建立和管理內容，例如書籤、 Q & 和位置。 此外，這些使用者可以檢視訊息中心、 監控服務健全狀況，並建立服務要求。

* **[搜尋編輯器](#search-editor)** :此角色中的使用者可以建立、 管理及刪除 Microsoft 搜尋在 Microsoft 365 系統管理中心，包括書籤、 Q &，和位置的內容。
...
* **[使用者管理員](#user-administrator)** :這個角色可以具有的使用者建立使用者，並管理使用者的所有層面，但有一些限制 （請參閱下文），而且可以更新密碼到期原則。 此外，具有此角色的使用者可以建立與管理所有群組。 此角色也包含建立和管理使用者檢視、管理支援票證，以及監視服務健康情況的能力。
...
### <a name="message-center-privacy-reader"></a>訊息中心隱私權讀取器
可以讀取訊息中心文章、 資料隱私權訊息、 群組、 網域和訂用帳戶。
...
可以建立及管理期刊的內容，例如書籤、 Q 以及、 位置、 floorplan。
...
目錄同步處理帳戶 | 目錄同步作業帳戶 | d29b2b05-8046-44ba-8758-1e26182fcf32
...
訊息中心隱私權讀取器 | 訊息中心隱私權讀取器 | ac16e43d-7b2d-40e0-ac05-243ff356ab5b
訊息中心讀取者 | 訊息中心讀取器 | 790c1fb9-7f7d-4f88-86a1-ef1f95c05c1b
