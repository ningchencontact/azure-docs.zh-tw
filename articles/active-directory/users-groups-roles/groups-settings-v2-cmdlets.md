...
當群組建立時，某些端點允許終端使用者指定 mailNickname 或別名，以作為群組電子郵件地址的一部分。 Groups with the following highly privileged email aliases can only be created by an Azure AD global administrator. 
