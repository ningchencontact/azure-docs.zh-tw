...
4. 在搜尋方塊中，輸入 **SignalFx**，從結果面板中選取 [SignalFx]，然後按一下 [新增] 按鈕以新增應用程式。
    ...
    ![結果清單中的 SignalFx](./media/active-directory-saas-signalfx-tutorial/tutorial_signalfx_addfromgallery.png)
...
3. **[建立 SignalFx 測試使用者](#create-a-signalfx-test-user)** - 使 SignalFx 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-signalfx-tutorial/tutorial_signalfx_samlbase.png)

3. 在 [SignalFx 網域與 URL] 區段上，執行下列步驟：

    ![SignalFx 網域與 URL 單一登入資訊](./media/active-directory-saas-signalfx-tutorial/tutorial_signalfx_url.png)
...
4. SignalFx 應用程式需要特定格式的 SAML 判斷提示。 設定此應用程式的下列宣告。 您可以在應用程式整合頁面的 [使用者屬性] 區段中，管理這些屬性的值。 以下螢幕擷取畫面顯示上述的範例。   

    ![設定單一登入](./media/active-directory-saas-signalfx-tutorial/tutorial_signalfx_attribute.png)
...
5. 在 [單一登入] 對話方塊的 [使用者屬性] 區段中，如圖所示設定 SAML 權杖屬性，然後執行下列步驟：
    ...
    ![設定單一登入的新增](./media/active-directory-saas-signalfx-tutorial/tutorial_attribute_04.png)

    ![設定單一登入的新增屬性](./media/active-directory-saas-signalfx-tutorial/tutorial_attribute_05.png)
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-signalfx-tutorial/create_aaduser_01.png)

2. 若要顯示使用者清單，請移至 [使用者和群組]，然後按一下 [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-signalfx-tutorial/create_aaduser_02.png)

3. 若要開啟 [使用者] 對話方塊，按一下 [所有使用者] 對話方塊頂端的 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-signalfx-tutorial/create_aaduser_03.png)

4. 在 [使用者] 對話方塊中，執行下列步驟：

    ![[使用者] 對話方塊](./media/active-directory-saas-signalfx-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [SignalFx]。
    ...
    ![應用程式清單中的 SignalFx 連結](./media/active-directory-saas-signalfx-tutorial/tutorial_signalfx_app.png)  
