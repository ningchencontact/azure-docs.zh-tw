...
在 Box 中，將 Azure AD 中**使用者名稱**的值，指派為 **Username** 的值，以建立連結關聯性。
...
2. 在 [單一登入] 對話方塊上，於 [模式] 選取 [SAML 登入]，以啟用單一登入。
    ...
    ![單一登入對話方塊](./media/active-directory-saas-box-tutorial/tutorial_box_samlbase.png)

3. 在 [Box 網域與 URL] 區段中，執行下列步驟：

    ![Box 網域與 URL 單一登入資訊](./media/active-directory-saas-box-tutorial/url3.png)
...
1. 在 Azure 入口網站的左窗格中，按一下 [Azure Active Directory] 按鈕。
    ...
    ![Azure Active Directory 按鈕](./media/active-directory-saas-box-tutorial/create_aaduser_01.png)
...
4. 在 [使用者] 對話方塊中，執行下列步驟：
    ...
    ![[使用者] 對話方塊](./media/active-directory-saas-box-tutorial/create_aaduser_04.png)
...
2. 在應用程式清單中，選取 [Box]。
    ...
    ![應用程式清單中的 Box 連結](./media/active-directory-saas-box-tutorial/tutorial_box_app.png)  
