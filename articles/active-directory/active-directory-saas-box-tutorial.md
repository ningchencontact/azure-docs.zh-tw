---
title: 教學課程：整合 Azure Active Directory 與 Box | Microsoft Docs
...
4. 在搜尋方塊中輸入 **Box**，從結果清單中選取 [Box]，然後選取 [新增]。
    ...
    ![結果清單中的 Box](./media/active-directory-saas-box-tutorial/tutorial_box_search.png)
...
2. 在 [單一登入] 視窗的 [單一登入模式] 方塊中，選取 [SAML 登入]。
    ...
    ![單一登入視窗](./media/active-directory-saas-box-tutorial/tutorial_box_samlbase.png)

3. 在 [Box 網域及 URL] 下，執行下列操作：

    ![「Box 網域及 URL」單一登入資訊](./media/active-directory-saas-box-tutorial/url3.png)
...
1. 在 Azure 入口網站的左側窗格中，選取 [Azure Active Directory]。
    ...
    ![Azure Active Directory 連結](./media/active-directory-saas-box-tutorial/create_aaduser_01.png)

2. 若要顯示目前使用者清單，請選取 [使用者和群組]  >  [所有使用者]。

    ![[使用者和群組] 與 [所有使用者] 連結](./media/active-directory-saas-box-tutorial/create_aaduser_02.png)

3. 在 [所有使用者] 視窗頂端，選取 [新增]。

    ![[新增] 按鈕](./media/active-directory-saas-box-tutorial/create_aaduser_03.png)

    [使用者] 視窗隨即開啟。

4. 在 [使用者] 視窗中，執行下列操作：

    ![[使用者] 視窗](./media/active-directory-saas-box-tutorial/create_aaduser_04.png)
...
2. 在 [應用程式] 清單中，選取 [Box]。
    ...
    ![Box 連結](./media/active-directory-saas-box-tutorial/tutorial_box_app.png)  
