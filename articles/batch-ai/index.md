---
title: Batch AI 文件 (預覽)
description: Azure Batch AI 可協助您使用任何架構實驗您的 AI 模型，然後在跨 GPU 和 CPU 叢集間進行大規模定型。 了解如何透過快速入門和範例使用 Batch AI。
services: batch-ai
author: czeumault
manager: carolz
layout: LandingPage
...
ms.locfileid: "30149911"
---
# <a name="batch-ai-documentation-preview"></a>Batch AI 文件 (預覽)

Azure Batch AI 可協助您使用任何架構實驗您的 AI 模型，然後在跨 GPU 和 CPU 叢集間進行大規模定型。 了解如何透過快速入門和範例使用 Batch AI。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/batchai">REST API 參考</a></p>
                    </div>
                </div>
            </div>
        </div>
