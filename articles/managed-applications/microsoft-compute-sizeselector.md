---
title: "Azure 受控應用程式 SizeSelector UI 元素 | Microsoft Docs"
description: "描述 Azure 受控應用程式的 Microsoft.Compute.SizeSelector UI 元素"
...
選取一個或多個虛擬機器執行個體之大小的控制項。 您可以在[建立 Azure 受控應用程式](publish-service-catalog-app.md)時使用此元素。
