...
如需關聯的詳細資訊，請參閱[Azure 自訂提供者資源](./concepts-custom-providers-resourceonboarding.md)上線
...
![指派內建原則](media/builtin-policy/assign-builtin-policy-customprovider.png)
...
- [概念： Azure 自訂提供者資源上線](./concepts-custom-providers-resourceonboarding.md)
