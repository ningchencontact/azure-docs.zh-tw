---
title: "Azure 受控應用程式 Section UI 元素 | Microsoft Docs"
description: "描述 Azure 受控應用程式的 Microsoft.Common.Section UI 元素"
...
將標題下方一個或多個元素進行群組的控制項。 您可以在[建立 Azure 受控應用程式](publish-service-catalog-app.md)時使用此元素。
