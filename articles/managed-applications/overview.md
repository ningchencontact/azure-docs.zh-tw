...
受控應用程式會降低取用者使用您解決方案的障礙。 他們不需要具備雲端基礎結構的專業知識，就可以使用您的解決方案。 取用者具有有限的重要資源存取權。 他們不需要擔心會在管理時犯錯。 
...
服務類別目錄是組織中使用者適用的已核准解決方案的內部目錄。 您會使用目錄來確保符合特定組織標準，同時為其組織提供一些解決方案。 員工會使用目錄輕鬆探索其 IT 部門所建議和核准的應用程式。 他們會看到組織中的其他人所共用的受控應用程式。
