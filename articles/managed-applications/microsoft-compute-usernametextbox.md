---
title: "Azure 受控應用程式 UserNameTextBox UI 元素 | Microsoft Docs"
description: "描述 Azure 受控應用程式的 Microsoft.Compute.UserNameTextBox UI 元素"
...
使用 Windows 和 Linux 使用者名稱內建驗證的文字方塊控制項。 您可以在[建立 Azure 受控應用程式](publish-service-catalog-app.md)時使用此元素。
