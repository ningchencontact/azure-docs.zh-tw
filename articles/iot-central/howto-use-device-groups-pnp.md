...
[裝置群組] 中的 [分析] 與左側導覽功能表中的 [主要分析] 索引標籤相同。 您可以在關於[如何建立分析](howto-use-device-groups-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)的文章中深入了解分析。
