---
title: 教學課程：在 Azure IoT Central 中自訂操作員的檢視
description: 教學課程：身為建置者，您可以在 Azure IoT Central 應用程式中自訂操作員的檢視。
author: sandeeppujar
ms.author: sandeepu
ms.date: 11/13/2019
ms.topic: tutorial
...
1. 若要編輯**聯網空調**裝置範本，請選擇左側窗格上的 [裝置範本]  ：
