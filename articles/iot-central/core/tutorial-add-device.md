---
title: 教學課程：將實際裝置新增至 Azure IoT Central 應用程式
description: 教學課程：了解如何在 Azure IoT Central 應用程式中新增和設定實際裝置。 您也可以了解實際裝置中的程式碼。
author: sandeeppujar
ms.author: sandeepu
ms.date: 11/13/2019
ms.topic: tutorial
