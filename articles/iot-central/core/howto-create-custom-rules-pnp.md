...
現在您已瞭解如何建立自訂規則和通知，建議的下一個步驟是瞭解如何[使用自訂分析來擴充 Azure IoT Central](howto-create-custom-analytics-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)。
