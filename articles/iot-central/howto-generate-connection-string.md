...
1. 使用在開發電腦[Node.js](https://nodejs.org/) 8.0.0 版或更新版本安裝。 您可以在命令列執行 `node --version` 來檢查版本。 Node.js 適用於多種作業系統。

## <a name="get-connection-information"></a>取得連線資訊

下列步驟說明如何取得您需要產生裝置的 SAS 連接字串的資訊：

1. 在 **總管**，尋找您想要連接到您的應用程式的真實裝置：
...
## <a name="generate-the-connection-string"></a>產生的連接字串
