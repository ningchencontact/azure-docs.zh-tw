...
description: 選擇如何使用 Azure IoT 中心、IoT 套件或 IoT 中樞實作 Azure IoT 解決方案。
...
* [Azure IoT 套件](https://docs.microsoft.com/azure/iot-suite/)是[預先設定解決方案](https://docs.microsoft.com/azure/iot-suite/iot-suite-what-are-preconfigured-solutions)的企業級集合，其建置於 Azure 平台即服務 (PaaS) 上，可讓您加速開發自訂的 IoT 解決方案。
...
## <a name="compare-azure-iot-central-and-azure-iot-suite"></a>比較 Azure IoT 中心和 Azure IoT 套件

選擇 Azure IoT 產品是規劃您 IoT 解決方案的重要部分。 IoT 中樞是獨立的 Azure 服務，本身不會提供端對端的 IoT 解決方案。 IoT 中樞可以做為任何 IoT 解決方案的起點，而且不需要透過 Azure IoT 套件或 Azure IoT 中心就可使用。 IoT 套件和 Azure IoT 中心都會使用 IoT 中樞與其他 Azure 服務。 下表彙總了 IoT 套件和 Azure IoT 中心之間的主要差異，協助您根據需求做出正確的選擇：

|     | Azure IoT 中心 | Azure IoT 套件 |
| --- | ----------- | --------- |
...
* **IoT 套件**：[什麼是 Azure IoT 預先設定的解決方案？](https://docs.microsoft.com/azure/iot-suite/iot-suite-what-are-preconfigured-solutions)
