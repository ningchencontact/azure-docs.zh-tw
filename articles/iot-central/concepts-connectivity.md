...
當您要試驗 IoT Central 或測試裝置時, 這個方法很有用。 您可以使用 IoT Central 應用程式中的裝置連線資訊, 來產生裝置的連接字串。 如需詳細步驟, 請參閱[如何產生裝置連接字串以連接至 Azure IoT Central 應用程式](howto-generate-connection-string.md)。
