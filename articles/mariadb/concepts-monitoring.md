...
您可以使用 [預定的**維護**] 事件種類來查看適用於 MariaDB 的 Azure 資料庫的排程維護事件。 若要瞭解如何建立**服務健康狀態警示**，請造訪[在服務通知上建立活動記錄警示](../service-health/alerts-activity-log-service-notifications.md)一文。
