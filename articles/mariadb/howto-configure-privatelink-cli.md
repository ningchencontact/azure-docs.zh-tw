...
請注意，適用于 mariadb 伺服器識別碼類似于您將在下一個步驟中使用適用于 mariadb 伺服器識別碼的 ```/subscriptions/subscriptionId/resourceGroups/myResourceGroup/providers/Microsoft.DBforMariaDB/servers/servername.```。 
...
2. 輸入  `nslookup mydemoserver.mariadb.privatelink.database.azure.com`。 
