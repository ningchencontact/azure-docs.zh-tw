...
目前不支援主要和次要版本升級。 例如，不支援從適用于 mariadb 10.2 升級至適用于 mariadb 10.3。 如果您想要從10.2 升級至10.3，請使用傾印並將它[還原](./howto-migrate-dump-restore.md)至使用新引擎版本所建立的伺服器。
