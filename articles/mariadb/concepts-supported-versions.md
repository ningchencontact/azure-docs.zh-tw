...
請參閱[適用于 mariadb 檔](https://mariadb.com/kb/en/library/mariadb-10223-release-notes/), 以深入瞭解適用于 mariadb 10.2.23 中的增強功能和修正。

## <a name="mariadb-version-103"></a>適用于 mariadb 版本10。3

修補程式版本:10.3.14

請參閱[適用于 mariadb 檔](https://mariadb.com/kb/en/library/mariadb-10314-release-notes/), 以深入瞭解適用于 mariadb 10.3.14 中的增強功能和修正。

## <a name="managing-updates-and-upgrades"></a>管理更新和升級
服務會自動管理修補程式更新的升級。 例如, 10.2.21 至10.2.23。  

目前不支援主要和次要版本升級。 例如, 不支援從適用于 mariadb 10.2 升級至適用于 mariadb 10.3。 如果您想要從10.2 升級至 10.3, 請使用傾印並將它[還原](./howto-migrate-dump-restore.md)至使用新引擎版本所建立的伺服器。
