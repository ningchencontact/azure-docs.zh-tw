...
![Application Insights 中所報告的效能計數器](./media/app-insights-performance-counters/performance-counters.png)
...
## <a name="alerts"></a>警示
與其他計量一樣，您可以[設定警示](app-insights-alerts.md)，在效能計數器超出您指定的界限時提出警告。 開啟 [警示] 窗格，然後按一下 [新增警示]。
