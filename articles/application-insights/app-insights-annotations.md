...
> [!NOTE]
> 本文反映已被取代的**傳統計量體驗**。 註解目前僅適用於傳統經驗和**[活頁簿](app-insights-usage-workbooks.md)** 中。 若要深入了解目前的計量體驗，您可以查閱[這篇文章](../azure-monitor/platform/metrics-charts.md)。
