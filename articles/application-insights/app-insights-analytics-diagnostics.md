...
「智慧型診斷」使用以 [DiffPatterns](app-insights-analytics-reference.md) 作業為基礎、不受監督的進階機器學習演算法。 它會尋找可能解釋資料變更原因的候選模式。 它會分析每個候選項目對計量的影響，並顯示與該變更最具相互關聯性的模式。
