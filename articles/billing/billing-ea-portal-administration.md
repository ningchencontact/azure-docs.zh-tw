...
帳戶轉移最遠可以追溯到目標註冊的開始日期或帳戶開始日期，視何者的開始日期較晚而定。 帳戶轉移之後，在有效轉移日期之前，帳戶中的所有使用量資訊都會保留在轉移的來源註冊中。 轉移日期之後的使用量資訊將會移至目標註冊。
...
- 帳戶轉移生效日期最遠可以追溯到目標註冊的開始日期或帳戶開始日期，視何者的開始日期較晚而定
...
轉移最遠可以追溯到目標註冊的開始日期。 提供所選的轉移日期，並不會影響已發出之超額發票的使用量。
