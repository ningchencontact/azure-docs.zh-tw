---
title: 了解 Azure 中的 Microsoft 合作夥伴合約發票
description: 學習如何閱讀並了解 Azure 中的 Microsoft 合作夥伴合約帳單
author: bandersmsft
manager: jureid
tags: billing
...
ms.locfileid: "74226061"
---
# <a name="terms-in-your-microsoft-partner-agreement-invoice"></a>您 Microsoft 合作夥伴合約發票中的詞彙

本文適用於 Microsoft 合作夥伴合約的 Azure 計費帳戶。 [檢查您是否有 Microsoft 合作夥伴合約的存取權](#check-access-to-a-microsoft-partner-agreement)。
...
| 付款條件 |您支付 Microsoft 帳單的方式。 *月結 60 天*表示您會在發票日期的 60 天內付費。 |
...
[各產品的計費詳細資料]  區段會列出與此帳單設定檔相關聯之每個產品的總費用。 您可以在 Azure 使用量和費用 CSV 中，查看每個產品的每日費用明細。 若要了解如何使用 Azure 使用量和費用 CSV 來調節發票 pdf，請參閱[了解您的 Microsoft 合作夥伴合約帳單](billing-mpa-understand-your-bill.md)。

## <a name="how-to-pay"></a>支付方式

發票底部會顯示支付帳單的指示。 您可以在發票日期的 60 天內經由支票或電匯付費。
