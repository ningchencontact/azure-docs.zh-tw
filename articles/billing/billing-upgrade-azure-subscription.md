...
如果您有[免費試用](https://azure.microsoft.com/free/)，您可以升級至[隨用隨付](https://azure.microsoft.com/offers/ms-azr-0003p/)在 Azure 入口網站中的訂用帳戶。 如果您有[Azure 學生入門版](https://azure.microsoft.com/offers/ms-azr-0144p/)訂用帳戶，您可以升級至[隨用隨付](https://azure.microsoft.com/offers/ms-azr-0003p/)Azure 帳戶中心內。
...
1. 搜尋**成本管理 + 計費。**
    ...
    ![顯示搜尋螢幕擷取畫面](./media/billing-upgrade-azure-subscription/search.png)
...
1. 底下**訂用帳戶狀態**，按一下**立即升級**。

    ![顯示升級適用於學生的螢幕擷取畫面](./media/billing-upgrade-azure-subscription/student-upgrade-button.png)
