...
> * 您切換至發票付款後，即無法再換回信用卡或轉帳卡付款。

## <a name="request-to-pay-by-invoice"></a>若要依發票付款的要求

1. 登入 [Azure 入口網站](https://portal.azure.com/)。 選取 [說明+支援] > [新增支援要求]。

    ![說明及支援按鈕](./media/billing-how-to-pay-by-invoice/help-and-support.png)

2. 依序選取 [計費] 作為問題類型、您想要依發票付款的 [訂用帳戶]、支援計劃，然後選取 [下一步]。

3. 在 [問題類型] 方塊中選取 [按發票付款] 選項。
