...
建議您使用[免費服務頁面](https://go.microsoft.com/fwlink/?linkid=859151)來建立新服務。 或者您可以登入[Azure 入口網站](https://portal.azure.com)，選取**所有服務**，然後搜尋**免費服務**。
...
## <a name="create-multiple-service-instances-in-allowed-limits"></a>建立多個服務執行個體中允許的限制
...
- 了解如何[避免產生費用的 Azure 免費帳戶](billing-avoid-charges-free-account.md)。
