---
title: 檢視適用於貴企業的 Azure 價格 | Microsoft Docs
description: 了解如何檢視和下載 Enterprise 合約的定價或估計成本。
services: ''
documentationcenter: ''
author: adpick
manager: dougeby
...
ms.locfileid: "53090851"
---
# <a name="view-your-organizations-azure-enterprise-agreement-pricing"></a>檢視貴組織的 Azure Enterprise 合約價格 

具有 Enterprise 合約 (EA) 的 Azure 客戶可從 Azure 入口網站檢視及下載其 EA 價格。 您也可以利用 Azure 價格計算機，使用貴組織的 EA 價格來預估成本。
...
## <a name="estimate-costs-with-ea-pricing"></a>使用 EA 價格預估成本
...
- [了解 Azure Enterprise 合約客戶的帳單](billing-understand-your-bill-ea.md)
