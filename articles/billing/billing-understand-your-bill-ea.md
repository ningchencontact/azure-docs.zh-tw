...
若在計費週期內發生下列其中一種情況，您就會收到 Azure 發票：
...
- **Marketplace 費用**：Azure Marketplace 的購買和使用量並未涵蓋於貴組織的點數內。 因此，無論您的點數餘額為何，您都會收到 Marketplace 費用的發票。 在企業版入口網站中，企業系統管理員可以啟用和停用 Marketplace 購買。
...
- **個別計費的費用**：信用額度未涵蓋貴組織所使用的服務。 不論您的信用額度餘額為何，都會收到下列服務的發票：
    ...
    - Visual Studio Professional (每月)
    - Visual Studio Professional (每年)
- **Marketplace 費用**：Azure Marketplace 的購買和使用量並未涵蓋在貴組織的信用額度內，會個別計費。 在企業版入口網站中，企業系統管理員可以啟用和停用 Marketplace 購買。
