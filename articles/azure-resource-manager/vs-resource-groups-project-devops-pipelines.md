...
- `subscriptionName`：提供目標訂用帳戶識別碼。 此屬性僅適用于資源群組部署範圍和訂用帳戶部署內幕。
...
如需有關使用 Azure Pipelines 搭配 Resource Manager 範本的逐步程式，請參閱[教學課程：使用 Azure Pipelines 持續整合 Azure Resource Manager 範本](resource-manager-tutorial-use-azure-pipelines.md)。
