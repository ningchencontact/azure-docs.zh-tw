...
首先，藉由執行 `Install-Module Az.Subscription -AllowPrerelease`來安裝此預覽模組。 若要確認 `-AllowPrerelease` 是否可運作，請從[取得 PowerShellGet 模組](/powershell/scripting/gallery/installing-psget)安裝最新版的 PowerShellGet。
