...
## 描述
**Get-AzureRmFrontDoorFireWallPolicy** cmdletGet 會取得目前訂用帳戶下資源群組中的 WAF 原則

## 範例

### 範例 1：取得 $resourceGroup 中稱為 $Name 的 WAF 原則
```powershell
...
取得 $resourceGroup 中稱為 $Name 的 WAF 原則

### 範例 2：取得 $resourceGroup 中的所有 WAF 原則
```powershell
