...
## 描述
**Set-AzureRmFrontDoor** Cmdlet 會更新現有的 WAF 原則。 如果未提供輸入參數，將使用來自現有 WAF 原則的舊參數。
...
### 範例 4︰更新 $resourceGroup 中的所有 WAF 原則
```powershell
...
### -Mode
描述在原則層級，其是否處於偵測模式或防止模式。
可能值包括：'Prevention'、'Detection'
