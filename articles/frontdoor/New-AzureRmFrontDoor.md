...
## 描述
**New-AzureRmFrontDoor** Cmdlet 會在目前訂用帳戶下指定的資源群組內建立新 Azure Front Door 負載平衡器

## 範例

### 範例 1：根據指定參數建立 Front Door。
```powershell
...
### -EnabledState
Front Door 負載平衡器的 EnabledState。
預設值為 Enabled
