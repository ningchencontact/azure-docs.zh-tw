...
## 描述
**Get-AzureRmFrontDoor** CmdletGet 可取得目前訂用帳戶中符合所提供資訊的所有現有 Front Door。

## 範例

### 範例 1：取得目前訂用帳戶中的所有 FrontDoor。
```powershell
...
取得目前訂用帳戶中的所有 FrontDoor。

### 範例 2：取得目前訂用帳戶之資源群組 "rg1" 中的所有 FrontDoor。
```powershell
...
取得目前訂用帳戶之資源群組 "rg1" 中的所有 FrontDoor。

### 範例 3：取得目前訂用帳戶之資源群組 "rg1" 中具有 "frontDoor1" 名稱的所有 FrontDoor。
```powershell
...
取得目前訂用帳戶之資源群組 "rg1" 中具有 "frontDoor1" 名稱的所有 FrontDoor。
