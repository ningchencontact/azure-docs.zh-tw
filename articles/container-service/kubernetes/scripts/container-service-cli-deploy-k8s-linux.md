---
title: Azure CLI 指令碼範例 - 建立 ACS Linux Kubernetes 叢集
...
ms.locfileid: "76270686"
---
# <a name="deprecated-create-an-azure-container-service-kubernetes-linux-cluster"></a>(已被取代) 建立 Azure Container Service Kubernetes Linux 叢集
