...
description: 使用 Azure 事件方格來訂閱 Azure SignalR Service 事件。 這些事件可以觸發其他下游服務。
...
> 嘗試與 Azure SignalR Service
> [有關事件方格](../event-grid/overview.md)的[範例事件方格整合](./signalr-howto-event-grid-integration.md)
