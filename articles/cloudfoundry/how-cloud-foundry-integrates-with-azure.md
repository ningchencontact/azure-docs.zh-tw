...
有 [6 個 Cloud Foundry 的子系統](https://docs.cloudfoundry.org/concepts/architecture/) \(英文\)，可有彈性地線上調整，包括：路由、驗證、應用程式生命週期管理、服務管理、訊息和監視。 針對每個子系統，您可以設定 Cloud Foundry 來使用對應的 Azure 服務。 
