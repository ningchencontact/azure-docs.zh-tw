...
> [!IMPORTANT]
> 若要在[Azure Batch 延伸模組範本](https://github.com/Azure/batch-extension-templates)外執行具有 Maya 的 V-Ray，請先啟動 `vrayses.exe` 再執行轉譯。 若要在範本外啟動 vrayses，您可以使用下列命令 `%MAYA_2017%\vray\bin\vrayses.exe"`。
>
