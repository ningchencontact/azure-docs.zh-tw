...
執行 **[az mysql server delete](/cli/azure/mysql/server#az_mysql_server_delete)** 命令，即可刪除讀取複本伺服器。
...
若要刪除主要伺服器，您可以執行 **[az mysql server delete](/cli/azure/mysql/server#az_mysql_server_delete)** 命令。
