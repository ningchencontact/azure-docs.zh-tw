...
例如，假設您執行的是一個一般用途、第5代– 32 vCore MySQL 資料庫，以及兩個經記憶體優化的第5代– 16 vCore MySQL 資料庫。 此外，假設您計畫在下個月內部署另一個一般用途第5代– 32 vCore 彈性集區，以及一個記憶體優化、第5代– 16 vCore 資料庫伺服器。 假設您知道您至少需要一年的這些資源。 在此情況下，您應該購買64（2x32）虛擬核心，單一資料庫一般目的-第5代和48（2x16 + 16） vCore 1 年保留，適用于單一資料庫記憶體優化-第5代
