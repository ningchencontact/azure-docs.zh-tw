...
![診斷設定選項的螢幕擷取畫面](./media/howto-configure-server-logs-in-portal/configure-diagnostic-setting.png)

1. 設定資料接收以管道傳送緩慢查詢記錄檔之後，請選取 [**儲存**]。
![診斷設定選項的螢幕擷取畫面，並反白顯示 [儲存]](./media/howto-configure-server-logs-in-portal/save-diagnostic-setting.png)
