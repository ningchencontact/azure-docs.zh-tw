---
title: 適用於 MySQL 的 Azure 資料庫預存程式
description: 本文介紹適用於 MySQL 的 Azure 資料庫特定的預存程式。
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "71156172"
---
# <a name="azure-database-for-mysql-stored-procedures"></a>適用於 MySQL 的 Azure 資料庫預存程式
