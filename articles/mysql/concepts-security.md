---
title: 適用於 MySQL 的 Azure 資料庫中的安全性-單一伺服器
description: 概述適用於 MySQL 的 Azure 資料庫單一伺服器中的安全性功能。
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
---
# <a name="security-in-azure-database-for-mysql---single-server"></a>適用於 MySQL 的 Azure 資料庫中的安全性-單一伺服器
