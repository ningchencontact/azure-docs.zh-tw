...
&emsp;&emsp;6. 在 [通知設定] 類別中選取 [Google] \(GCM\)，輸入 GCM 專案的 [API 金鑰]，然後按一下 [儲存]。

&emsp;&emsp;&emsp;&emsp;![Azure 通知中樞 - Google (GCM)](media/notification-hubs-chrome-get-started/configure-gcm-api-key.png)
...
> [!NOTE]
> 您可以透過公用 [REST 介面](https://msdn.microsoft.com/library/windowsazure/dn223264.aspx)，使用通知中樞從任何後端傳送推播通知。 如需其他跨平台範例，請查看[說明文件入口網站](https://azure.microsoft.com/documentation/services/notification-hubs/)。
