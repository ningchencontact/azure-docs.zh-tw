---
title: 使用 Azure Active Directory B2C 授權開發人員帳戶
...
12. 指定登入**租**使用者中 Azure Active Directory B2C 租使用者的功能變數名稱。

13. [**授權**單位] 欄位可讓您控制要使用的 Azure AD B2C 登入 URL。 將值設定為 **< your_b2c_tenant_name >. .b2clogin.com .com**。
