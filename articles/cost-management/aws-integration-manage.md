...
| 資源類型 | 產品/instanceType | 全部 | 如果 product/instanceType 為 null，則會使用 lineItem/UsageType。 |
| ResourceGuid | N/A | 全部 | Azure 計量 GUID。 |
| 服務名稱 | 產品/ProductName | 全部 | 如果 product/ProductName 是 null，則會使用 lineItem/ProductCode。 |
| 服務層 |   |   |   |
