---
title: 教學課程 - 使用 Terraform 在 Azure 中建立輪輻網路
...
ms.locfileid: "72969355"
---
# <a name="tutorial-create-a-spoke-network-in-azure-using-terraform"></a>教學課程：使用 Terraform 在 Azure 中建立輪輻網路
