---
title: 從資料集建立報表-Power BI 的工作區集合
...
![檔案功能表 - 另存新檔](media/create-report-from-dataset/save-new-report.png)
