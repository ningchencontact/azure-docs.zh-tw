---
title: 使用 PagerDuty 使用 webhook 傳送 Azure 服務健康情況警示
...
ms.locfileid: "67067141"
---
# <a name="send-azure-service-health-alerts-with-pagerduty-using-webhooks"></a>使用 PagerDuty 使用 webhook 傳送 Azure 服務健康情況警示
