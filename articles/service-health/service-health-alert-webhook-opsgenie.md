---
title: 傳送與 OpsGenie 使用 webhook 搭配運作的 Azure 服務健康情況警示
...
ms.locfileid: "67067173"
---
# <a name="send-azure-service-health-alerts-with-opsgenie-using-webhooks"></a>傳送與 OpsGenie 使用 webhook 搭配運作的 Azure 服務健康情況警示
