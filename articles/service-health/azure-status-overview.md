...
[Azure 狀態](https://azure.microsoft.com/en-us/status/)提供您 Azure 服務健康情況的全域檢視。 您可以使用 Azure 狀態取得服務可用性的最新資訊。 每個人都可存取 Azure 狀態，而且可以檢視回報其服務健康情況的所有服務。 
...
因為 [Azure 狀態] 頁面一律會顯示最新的健康情況資訊，您可以使用 [Azure 狀態歷程記錄頁面](https://azure.microsoft.com/en-us/status/history/)檢視較舊的事件。
