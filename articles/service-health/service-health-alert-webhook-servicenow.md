---
title: 使用 ServiceNow 使用 webhook 傳送 Azure 服務健康情況警示
...
ms.locfileid: "67067111"
---
# <a name="send-azure-service-health-alerts-with-servicenow-using-webhooks"></a>使用 ServiceNow 使用 webhook 傳送 Azure 服務健康情況警示
