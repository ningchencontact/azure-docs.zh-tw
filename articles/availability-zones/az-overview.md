...
- 區域**服務**–您可以將資源釘選到特定區域（例如虛擬機器、受控磁片、標準 IP 位址），或
...
- [建立 Azure Active Directory Domain Services 實例](../active-directory-domain-services/tutorial-create-instance.md)
