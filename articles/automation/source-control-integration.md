...
您可以按一下 [**同步處理工作**] 索引標籤，以查看目前同步處理作業或先前的狀態。在 [**原始檔控制**] 下拉式選單上，選取原始檔控制。
...
* 透過[REST Api](https://docs.microsoft.com/rest/api/automation/sourcecontrol/update)。
