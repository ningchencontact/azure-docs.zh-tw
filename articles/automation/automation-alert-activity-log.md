---
title: 使用活動記錄警示來監視 Azure 自動化 Runbook
description: 本文將逐步說明如何使用活動記錄監視 Azure 自動化 Runbook
services: automation
...
ms.locfileid: "34356938"
---
# <a name="monitoring-runbooks-with-azure-activity-log-alerts"></a>使用 Azure 活動記錄警示來監視 Runbook
