...
> 如果您的自動化帳戶不是透過服務主體建立，您可以使用[使用適用於 Python 的 Azure 管理程式庫](/azure/python/python-sdk-azure-authenticate)所述的方法來進行驗證。
...
- 若要深入了解 Azure with Python 的開發，請參閱 [適用於 Python 開發人員的 Azure](/azure/python/)
