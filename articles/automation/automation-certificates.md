...
若要使用憑證，請使用 **Get-AutomationCertificate** 活動。 您不能使用 [Get-AzureRmAutomationCertificate](https://docs.microsoft.com/powershell/module/azurerm.automation/get-azurermautomationcertificate) Cmdlet，因為它會傳回憑證資產的相關資訊，而不是憑證本身。
