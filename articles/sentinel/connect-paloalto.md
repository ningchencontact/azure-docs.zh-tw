...
您需要在專用的 Linux 機器（VM 或內部部署）上部署代理程式，以支援 Palo Alto 網路與 Azure Sentinel 之間的通訊。 下圖說明 Azure 中 Linux VM 的事件設定。
...
## <a name="step-2-forward-palo-alto-networks-logs-to-the-syslog-agent"></a>步驟2：將 Palo Alto 網路記錄轉送到 Syslog 代理程式
