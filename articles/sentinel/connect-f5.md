...
您需要在專用的 Linux 機器（VM 或內部部署）上部署代理程式，以支援 F5 和 Azure Sentinel 之間的通訊。 下圖說明 Azure 中 Linux VM 的事件設定。
...
## <a name="step-2-configure-your-f5-to-send-cef-messages"></a>步驟2：設定 F5 以傳送 CEF 訊息
