...
description: 本文提供 Azure Front 服務上的 Web 應用程式防火牆常見問題的解答
...
## <a name="what-is-waf-on-azure-front-door-service"></a>Azure Front 服務的 WAF 是什麼？ 
...
Front 開門服務提供 SSL 卸載。 WAF 原本就與前門整合，而且可以在要求解密後加以檢查。
