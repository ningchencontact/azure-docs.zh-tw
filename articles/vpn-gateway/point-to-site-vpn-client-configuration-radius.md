...
### <a name="workflow"></a>工作流程
  ...
  3. (本文) - 取得所選驗證選項適用的 VPN 用戶端設定，並使用它在 Windows 裝置上設定 VPN 用戶端。 這可讓您透過 P2S 連線來連線至 Azure VNet。
...
### <a name="admaccli"></a>Mac (OSX) VPN 用戶端設定
...
### <a name="certmaccli"></a>Mac (OSX) VPN 用戶端設定
