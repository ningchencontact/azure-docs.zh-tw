...
ms.locfileid: "73517393"
---
# <a name="create-an-azure-active-directory-tenant-for-p2s-open-vpn-connections-that-use-azure-ad-authentication"></a>為使用 Azure AD authentication 的 P2S Open VPN 連線建立 Azure Active Directory 租使用者
