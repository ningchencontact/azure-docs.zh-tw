...
若要建立使用可用性區域的 AKS 叢集，您需要*AKS-preview* CLI 擴充功能版本0.4.1 （或更高）。 使用[az extension add][az-extension-add]命令來安裝*aks-preview* Azure CLI 擴充功能，然後使用[az extension update][az-extension-update]命令檢查是否有任何可用的更新：
