...
> [!NOTE]
> Azure Load Balancer 有兩種 SKU -「基本」和「標準」。 如需詳細資訊，請參閱 [Azure 負載平衡器 SKU 比較][azure-lb-comparison]。 AKS 目前支援「基本」SKU。 如果您想要使用「標準」SKU，可以使用上游 [aKs-engine][aks-engine]。
