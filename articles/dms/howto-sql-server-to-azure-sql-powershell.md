...
- Azure 資源群組名稱。 如先前所示，您可以使用[remove-azresourcegroup](https://docs.microsoft.com/powershell/module/az.resources/new-azresourcegroup)命令來建立 Azure 資源群組，並提供其名稱作為參數。
