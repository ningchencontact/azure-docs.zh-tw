...
| **Source** | **目標** | **探索 /**<br/>**清查** | **目標和 SKU**<br/>**建議** | **TCO/投資報酬率和**<br/>**商業案例** |
| --- | --- | --- | --- | --- |
...
| **Source** | **目標** | **應用程式資料存取**<br/>**層級評估** | **[資料庫備份]**<br/>**評量** | **效能**<br/>**評量** |
| --- | --- | --- | --- | --- |
...
| **Source** | **目標** | **結構描述** | **資料**<br/>**(離線)** | **資料**<br/>**(線上)** |
| --- | --- | --- | --- | --- |
