---
title: 使用 Web 應用程式防火牆來限制網路流量 - Azure CLI
...
---
# <a name="tutorial-restrict-web-traffic-with-a-web-application-firewall-using-the-azure-cli"></a>教學課程：使用 Azure CLI 以 Web 應用程式防火牆來限制網路流量
