...
在此範例中，您會建立兩個新規則，並刪除之前所建立的預設規則。  您可以使用 [az network application-gateway rule create](/cli/azure/application-gateway#az-network_application_gateway_rule_create) 來新增規則。
