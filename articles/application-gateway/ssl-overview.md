...
請檢查[應用程式閘道限制](https://docs.microsoft.com/azure/azure-resource-manager/management/azure-subscription-service-limits#application-gateway-limits)一節，以瞭解支援的 SSL 憑證大小上限。
...
> [!NOTE] 
>
> 新增至後端**HTTP 設定**以驗證後端伺服器的憑證，可以與在應用程式網**關上針對 SSL 終止所新增**的憑證相同，或不同以增強安全性。
