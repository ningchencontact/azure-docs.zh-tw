...
是的。 在應用程式閘道中, 系統會在計量上設定警示。 如需詳細資訊, 請參閱[應用程式閘道計量](https://docs.microsoft.com/azure/application-gateway/application-gateway-diagnostics#metrics)和[接收警示通知](../monitoring-and-diagnostics/insights-receive-alert-notifications.md)。
