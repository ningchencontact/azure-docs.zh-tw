...
## <a name="use-devops-projects-to-create-an-aspnet-core-app-and-deploy-it-to-service-fabricc"></a>使用 DevOps Projects 建立 ASP.NET Core 應用程式，並將應用程式部署至 Service Fabric
