...
## <a name="aks-clusters-with-different-virtual-network-or-subnet-configurations"></a>具有不同虛擬網路或子網設定的 AKS 叢集
...
## <a name="using-azure-container-networking-with-azure-dev-spaces"></a>搭配 Azure Dev Spaces 使用 Azure 容器網路功能
...
## <a name="using-api-server-authorized-ip-ranges-with-azure-dev-spaces"></a>搭配 Azure Dev Spaces 使用 API 伺服器授權的 IP 範圍
...
## <a name="using-aks-private-clusters-with-azure-dev-spaces"></a>搭配 Azure Dev Spaces 使用 AKS 私用叢集

目前， [AKS 私人][aks-private-clusters]叢集不支援 Azure Dev Spaces。

## <a name="azure-dev-spaces-client-requirements"></a>Azure Dev Spaces 用戶端需求
