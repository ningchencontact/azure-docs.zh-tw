---
title: 使用 Java 和 VS Code 在雲端建立 Kubernetes 開發人員空間 | Microsoft Docs
...
在命令提示字元中，建立資源群組。 使用目前支援的其中一個區域 (EastUS、EastUS2、CentralUS、WestUS2、WestEurope、SoutheastAsia、CanadaCentral 或 CanadaEast)。
