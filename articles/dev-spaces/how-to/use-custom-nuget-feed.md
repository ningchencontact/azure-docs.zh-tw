...
若要設定 NuGet 摘要：
1. 在 `PackageReference` 節點底下的 `*.csproj` 檔案中新增[套件參考](https://docs.microsoft.com/en-us/nuget/consume-packages/package-references-in-project-files)。
