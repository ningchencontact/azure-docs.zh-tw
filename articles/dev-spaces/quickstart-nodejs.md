...
- Visual Studio Code，您可以從[這裡](https://code.visualstudio.com/download)下載。
...
1. 下載 VS Code 的 [Azure Dev Spaces 擴充功能](https://aka.ms/get-azds-code)。 在擴充功能的 Marketplace 頁面上按一下 [安裝]，然後在 VS Code 再按一次。
