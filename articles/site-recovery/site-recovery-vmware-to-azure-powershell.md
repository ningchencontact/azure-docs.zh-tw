---
title: "使用Azure Site Recovery PowerShell 將 VMware 虛擬機器複寫並容錯移轉到 Azure | Microsoft Docs"
description: "使用Azure Site Recovery PowerShell 將 VMware 虛擬機器複寫並容錯移轉到 Azure"
...
---
# <a name="replicate-and-failover-vmware-virtual-machines-to-azure-using-azure-site-recovery-powershell"></a>使用Azure Site Recovery PowerShell 將 VMware 虛擬機器複寫並容錯移轉到 Azure
