...
1. 在 [Azure 入口網站](https://portal.azure.com)功能表中，按一下 [建立資源] > [儲存體] > [儲存體帳戶]。
...
1. 在 [Azure 入口網站](https://portal.azure.com)的左側導覽中，按一下 [所有服務]，然後搜尋並選取 [復原服務保存庫]。
...
1. 在 [Azure 入口網站](https://portal.azure.com)中，按一下 [建立資源]****>[網路]****>
   [虛擬網路]****。
