...
> [!NOTE]
> 「Azure 虛擬機器的災害復原」案例的 Azure Site Recovery PowerShell 支援目前為預覽版。 可透過入口網站使用的案例功能，並非都能透過 Azure PowerShell 來使用。 目前不支援透過 Azure PowerShell 來使用的部分案例功能包括：
