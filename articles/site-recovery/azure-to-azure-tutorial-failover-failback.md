...
ms.locfileid: "57729046"
---
# <a name="fail-over-and-reprotect-azure-vms-between-azure-regions"></a>在 Azure 區域之間容錯移轉及重新保護 Azure VM
...
- 請參閱[如何容錯回復](azure-to-azure-tutorial-failback.md)。
