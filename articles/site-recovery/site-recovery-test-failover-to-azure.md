---
title: 使用 Azure Site Recovery 執行 Azure 的嚴重損壞修復演練
...
![測試容錯移轉](./media/site-recovery-test-failover-to-azure/TestFailover.png)
...
![測試容錯移轉](./media/site-recovery-test-failover-to-azure/TestFailoverJob.png)
