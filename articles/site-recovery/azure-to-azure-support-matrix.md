...
>[!NOTE]
>
> - 對於**巴西南部區域**，您可以複寫並容錯移轉至下列其中一個：美國中南部、美國中西部、美國東部、美國東部 2、美國西部、美國西部 2 和美國中北部區域。 請注意，Site Recovery 只啟用巴西南部做為可保護虛擬機器的來源區域。 這不會做為任何 Azure 區域 (例如美國中南部) 的**目標 DR 區域**。 原因是因地理距離而觀察到的延遲，建議選取巴西南部以外的其他任何美洲區域。
>
...
**版本** | **行動服務版本** | **核心版本** |
--- | --- | --- |
Debian 7 | 9.19,9.20,9.21,9.22 | 3.2.0-4-amd64 至 3.2.0-6-amd64、3.16.0-0.bpo.4-amd64 |
|||
...
暫存磁碟 | 不支援 | 暫存磁碟一律排除在複寫之外。<br/><br/> 請不要將任何永續性資料儲存於暫存磁碟上。 [深入了解](../virtual-machines/windows/about-disks-and-vhds.md#temporary-disk)。
資料磁碟的大小上限 | 4095 GB |
