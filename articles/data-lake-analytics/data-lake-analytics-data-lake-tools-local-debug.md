---
title: 在本機為 Azure Data Lake Analytics 程式碼偵錯 | Microsoft Docs
...
ms.locfileid: "37890708"
---
# <a name="debug-azure-data-lake-analytics-code-locally"></a>在本機為 Azure Data Lake Analytics 程式碼偵錯

您可以使用 Azure Data Lake Tools for Visual Studio 在工作站上執行 Azure Data Lake Analytics 程式碼並偵錯，如同在 Azure Data Lake 服務中一般。
