...
- **診斷記錄：** [診斷記錄](../../azure-monitor/platform/resource-logs-overview.md)是每個資源發出的所有記錄。 這些記錄包含 Windows 事件系統記錄、Azure 儲存體記錄、Key Vault 稽核記錄，以及應用程式閘道存取和防火牆記錄。
