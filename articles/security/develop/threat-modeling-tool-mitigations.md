...
請造訪 **[威脅模型化工具](threat-modeling-tool.md)** 立即開始使用！
...
| **[授權](threat-modeling-tool-authorization.md)** | 您該怎麼辦？ 授權是應用程式針對資源和作業提供存取控制的方式 |
...
請造訪 **[威脅模型化工具威脅](threat-modeling-tool-threats.md)** 以深入了解工具用來產生可能設計威脅的威脅類別。