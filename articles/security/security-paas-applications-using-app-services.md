...
對於 Windows 上的 App Service, 您也可以藉由設定 web.config 來動態限制 IP 位址。如需詳細資訊, 請參閱[動態 IP 安全性](https://docs.microsoft.com/iis/configuration/system.webServer/security/dynamicIpSecurity/)。
