...
description: 本文包含適用于 Azure 公用和 Azure Government 的資料表, 說明 FedRAMP (適中與高) 和 DoD SRG (影響層級2、4或 5) 已達到指定服務的 audit 範圍。
author: Jain-Garima
ms.author: gjain
ms.date: 5/17/2019
ms.topic: article
...
本文提供跨 Azure 的範圍內雲端服務的詳細清單, 以及 FedRAMP 和 DoD CC SRG 合規性供應專案的 Azure Government。
...
| [Azure 資料總管](https://azure.microsoft.com/en-us/services/data-explorer/) | |  |  | :heavy_check_mark: |
...
| [Azure Data Lake 儲存體](https://azure.microsoft.com/en-us/services/storage/data-lake-storage/) |  |  |  | :heavy_check_mark: |
...
| [Azure 受控應用程式](https://azure.microsoft.com/en-us/services/managed-applications/) | |  |  | :heavy_check_mark: |
...
| [Defender Advanced 威脅防護](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) |  | :heavy_check_mark: | :heavy_check_mark: |  |
...
## <a name="azure-government-services-by-audit-scope"></a>依 audit 範圍的 Azure 政府機構服務
| _上次更新日期:2019年7月_ |
...
| [Azure 藍圖](https://azure.microsoft.com/en-us/services/blueprints/)  |  |  |  |  | :heavy_check_mark:
...
| [適用于適用于 mariadb 的 Azure DB](https://azure.microsoft.com/services/mariadb/)  |  |  |  |  | :heavy_check_mark:
...
| [Microsoft Defender Advanced 威脅防護](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)  |  |  |  |  | :heavy_check_mark:
