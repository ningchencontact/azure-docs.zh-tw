        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">了解 Azure 資訊安全</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">我正考慮在公司中使用 Azure。 Azure 提供哪些安全性？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="https://aka.ms/sharedresponsibility">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Microsoft 如何與我的組織共享安全性責任？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-infrastructure">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Microsoft 如何保障 Azure 基礎結構的安全性？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-storage-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">儲存體安全性概觀</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-network-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">網路安全性概觀</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-azure-encryption-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">資料加密概觀</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-log-audit">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 提供哪些監視和記錄選項？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-encryption-atrest">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 如何保護待用資料？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">如何加密 Azure 虛擬機器</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="https://aka.ms/SecurityResponsepaper">雲端的 Azure 安全性回應</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-threat-detection">Azure 進階威脅偵測</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/abstract-azure-network-security">Azure 網路安全性</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/abstract-develop-secure-apps">在 Azure 上開發安全的應用程式</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="https://azure.microsoft.com/resources/security-best-practices-for-azure-solutions/">Azure 的安全性最佳做法</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-security-network-security-best-practices">網路安全性</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-security-data-encryption-best-practices">資料安全性</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-security-best-practices-vms">虛擬機器安全性</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-security-identity-management-best-practices">身分識別與存取</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-security-iaas">IaaS 安全性</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-service-fabric-security-best-practices">Service Fabric 安全性</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-security-global-admin">保護 Azure 管理帳戶</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="cardPadding">
            <div class="card">
                <div class="cardText">
                     ...
                     <ul class="noBullet">
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-database-security-checklist">保護資料庫</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-operational-security-checklist">作業安全性</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-service-fabric-security-checklist">Service Fabric 安全性</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <a href="/azure/security/blueprints/uk-official-three-tier-applications-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">英國官方 (UK-OFFICIAL)</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">資源與服務</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps?search=security&page=1">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 安全性合作夥伴</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-cyber-services">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">網路安全性諮詢</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-pen-testing">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">滲透測試</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security-center/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 資訊安全中心</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/key-vault/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 金鑰保存庫</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">磁碟加密</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/information-protection/what-is-information-protection">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 資訊保護</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/multi-factor-authentication/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">多重要素驗證 (MFA)</p>
                        </div>
                    </div>
                </div>
            </div>
