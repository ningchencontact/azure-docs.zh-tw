...
![防火牆規則](./media/database-best-practices/azure-database-security-best-practices-Fig1.png)
...
- 使用 [RBAC 角色](/azure/role-based-access-control/overview)來使用 Azure AD 驗證。
...
若要深入了解資料庫稽核以及如何啟用它，請參閱[開始使用 SQL Database 稽核](/azure/sql-database/sql-database-auditing)。
