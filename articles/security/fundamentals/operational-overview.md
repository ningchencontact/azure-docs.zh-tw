...
資訊安全中心會使用[角色型存取控制 (RBAC)](/azure/role-based-access-control/role-assignments-portal)。 RBAC 會提供[內建角色](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles)，可指派給 Azure 中的使用者、群組與服務。
