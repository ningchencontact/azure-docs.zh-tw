...
|[Azure 網路安全性](azure-network-security.md)|介紹您可設定來增強您在 Azure 中所部署解決方案之安全性的一系列網路控制措施。 焦點放在客戶面向的網路安全性控制措施。|
...
|[Azure 作業安全性](azure-operational-security.md)|提供 Azure 隨附之客戶面向操作安全性技術與服務的完整說明。|
