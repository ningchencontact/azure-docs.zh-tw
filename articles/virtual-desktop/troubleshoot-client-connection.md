...
3. 清除瀏覽器快取。 See [clear browser cache for your browser](https://binged.it/2RKyfdU).
...
4. 清除瀏覽器快取。 See [Clear browser cache for your browser](https://binged.it/2RKyfdU).
