---
title: 使用 Azure Resource Manager 範本建立 Windows 虛擬桌面預覽主機集區-Azure
description: 如何使用 Azure Resource Manager 範本在 Windows 虛擬桌面 Preview 中建立主機集區。
...
3. 緊接在 "https://portal.azure.com/ " 之後, 在主題標籤 (#) 前面輸入 @ 符號, 後面接著租使用者功能變數名稱。 以下是您應該使用的格式範例: https://portal.azure.com/@Contoso.onmicrosoft.com#create/ 。
