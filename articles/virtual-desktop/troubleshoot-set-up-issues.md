...
若要使用 Windows 10 企業版的多會話映射，請移至 Azure Marketplace，選取 [**開始**使用] > **Microsoft Windows 10** > 和[Windows 10 企業版（適用于虛擬桌面，版本1809）](https://azuremarketplace.microsoft.com/marketplace/apps/microsoftwindowsdesktop.windows-10?tab=PlansAndPrice)。
