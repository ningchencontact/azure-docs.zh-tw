...
當 HP 探討了在開發過程中所提供的業界趨勢、客戶挑戰和解決方案虛擬化時，他們就可以使用四個要件的價值主張來預測理想的雲端端點：設計、管理性、安全性，以及多功能. 每個 HP 瘦用戶端都是由 IT 決策者所打造的。 HP 瘦用戶端長期持續、安全、容易部署和管理，而且功能強大，因此您可以輕鬆地轉換到 VDI 或雲端運算。 HP 的多用途組合可讓您自由選擇最適合您的現代化端點解決方案。
