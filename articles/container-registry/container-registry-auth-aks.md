...
在某些情況下，您可能無法將所需角色指派給自動產生的 AKS 服務主體，授與其存取 ACR 的權限。 例如，由於貴組織的安全性模型，Azure AD 目錄中可能沒有足夠權限為 AKS 產生的服務主體指派角色。 在此情況下，您可以建立新的服務主體，然後使用 Kubernetes 映像提取密碼，授與其容器登錄的存取權。
