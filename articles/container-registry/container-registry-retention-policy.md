...
1. Select a number of days between 0 and 365 to retain the untagged manifests. 選取 [儲存]。
...
1. Navigate to your Azure container registry. Under **Policies**, select **Retention** (Preview).
1. In **Status**, select **Disabled**. 選取 [儲存]。
