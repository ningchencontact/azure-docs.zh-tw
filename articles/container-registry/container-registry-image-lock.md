...
若要查看目前的儲存機制的屬性，請執行下列[az acr 存放庫 show] [ az-acr-repository-show]命令：
...
### <a name="show-the-current-image-attributes"></a>顯示目前的映像屬性
若要查看目前的標記屬性，請執行下列[az acr 存放庫 show] [ az-acr-repository-show]命令：
