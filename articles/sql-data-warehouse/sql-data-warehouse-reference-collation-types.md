---
title: 定序-Azure SQL 資料倉儲 |Microsoft Docs
...
若要檢查資料庫的目前定序, 您可以執行下列 T-sql 程式碼片段:選取 DATABASEPROPERTYEX (DB_NAME (), ' 定序 ') 做為定序;當傳遞 ' 定序 ' 做為屬性參數時, DatabasePropertyEx 函數會傳回所指定資料庫的目前定序。 您可以在 MSDN 上深入瞭解 DatabasePropertyEx 函數。
