...
## <a name="copy-your-data-warehouse-with-user-defined-restore-points"></a>透過使用者定義的還原點來複製資料倉儲
...
4. 建立用來立即複製資料庫的還原點
5. 將您的資料庫重新命名為暫時的名稱。
5. 透過指定的 RestorePointLabel 擷取最新還原點。
6. 取得資料庫的資源識別碼以起始還原作業
6. 將資料庫還原到想要的還原點。
7. 確認還原的資料庫在線上。
...
## <a name="create-a-user-defined-restore-point"></a>建立使用者定義的還原點
