...
## <a name="create-theceo-user-in-mysampledatawarehouse"></a>在 mySampleDataWarehouse 中建立 TheCEO 使用者
...
## <a name="create-a-workload-classifier-for-theceo-with-high-importance"></a>為 TheCEO 建立具有高重要性的工作負載分類器
