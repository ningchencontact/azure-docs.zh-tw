...
* [建立工作負載分類器](/sql/t-sql/statements/create-workload-classifier-transact-sql)（預覽）
...
* [卸除工作負載分類](/sql/t-sql/statements/drop-workload-classifier-transact-sql)（預覽）
