...
ms.locfileid: "30198406"
---
# <a name="reference-topics-for-sql-data-warehouse"></a>SQL 資料倉儲的參考主題
這些文章包含 SQL 資料倉儲的參考資訊。

* [Transact-SQL 語言元素][Transact-SQL language elements]
* [Transact-SQL 陳述式][Transact-SQL statements]
* [Transact-SQL 系統檢視][Transact-SQL system views]
* [PowerShell Cmdlet][PowerShell cmdlets]

## <a name="next-steps"></a>後續步驟
如需開發資訊，請參閱[開發概觀][development overview]。
