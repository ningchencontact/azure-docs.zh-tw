...
| 區段 | 工作 |
| ------- | ----- |
| **驗證** | <ol><li>Define a service principal.</li><li>Download publishing profile.</li><li>Create a GitHub secret.</li></ol>|
| **建置** | <ol><li>Set up the environment.</li><li>建置函式應用程式。</li></ol> |
