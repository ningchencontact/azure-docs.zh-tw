...
- 選擇性：僅在啟動時註冊 HttpClient 時才需要[Http](https://www.nuget.org/packages/Microsoft.Extensions.Http/)
...
如果您想要利用相依性插入，就不應該使用函式插入功能。 針對 cosmos 用戶端，請參閱[此](https://github.com/Azure/azure-cosmos-dotnet-v3/blob/master/Microsoft.Azure.Cosmos.Samples/CodeSamples/AzureFunctions/AzureFunctionsCosmosClient.cs)。
