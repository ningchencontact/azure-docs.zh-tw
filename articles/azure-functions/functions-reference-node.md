...
|---|---|
| 1.x | 6.11.2 (由執行階段鎖定) |
| 2.x  | _作用中 LTS_ 和偶數的 _目前_ Node.js 版本 (建議使用 8.11.1 和 10.6.0)。 使用 WEBSITE_NODE_DEFAULT_VERSION [應用程式設定](functions-how-to-use-azure-function-app-settings.md#settings)來設定版本。|
