...
在 .NET 語言中，這項資訊是以 [ClaimsPrincipal](https://docs.microsoft.com/en-us/dotnet/api/system.security.claims.claimsprincipal?view=netstandard-2.0) 形式提供。 ClaimsPrincipal 可作為要求內容的一部分提供，如下列範例所示：
