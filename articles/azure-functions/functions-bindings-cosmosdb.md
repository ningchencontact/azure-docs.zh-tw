...
| 繫結 | 參考 |
|---|---|
| CosmosDB | [CosmosDB 錯誤碼](https://docs.microsoft.com/en-us/rest/api/cosmos-db/http-status-codes-for-cosmosdb) |
