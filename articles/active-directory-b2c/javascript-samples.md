---
title: 適用於 Azure Active Directory B2C 中的 JavaScript 範例 | Microsoft Docs
...
在程式碼中，請將 `terms-of-use-url` 取代為您使用規定合約的連結。 針對您的目錄，請建立稱為 **termsOfUse** 的新使用者屬性，然後將 **termsOfUse** 包含為您使用者流程的使用者屬性。
