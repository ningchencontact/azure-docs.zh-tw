...
- 設定主動式監控，並監視生產環境的回應能力。 如需與 Application Insights 整合的詳細資訊，請參閱[Azure Active Directory B2C：收集記錄](active-directory-b2c-custom-guide-eventlogger-appins.md)。
