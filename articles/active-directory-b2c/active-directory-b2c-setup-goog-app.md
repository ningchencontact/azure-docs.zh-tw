...
若要在 Azure Active Directory B2C （Azure AD B2C）中使用 Google 帳戶做為[識別提供者](active-directory-b2c-reference-oauth-code.md)，您必須在 Google 開發人員主控台中建立應用程式。 如果您還沒有 Google 帳戶，您可以在[https://accounts.google.com/SignUp](https://accounts.google.com/SignUp)註冊。
