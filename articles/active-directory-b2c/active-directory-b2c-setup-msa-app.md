...
若要使用 Microsoft 帳戶做為 Azure Active Directory (Azure AD) B2C 中的身分[識別提供者](active-directory-b2c-reference-oidc.md), 您需要在 Azure AD 租使用者中建立應用程式。 此 Azure AD 租用戶與您的 Azure AD B2C 租用戶不同。 如果您還沒有 Microsoft 帳戶, 您可以在上[https://www.live.com/](https://www.live.com/)取得一個。
