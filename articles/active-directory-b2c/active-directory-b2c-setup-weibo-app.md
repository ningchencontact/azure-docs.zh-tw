...
若要在 Azure Active Directory (Azure AD) B2C 中使用微博帳戶做為識別提供者，您需要在代表該帳戶的租用戶中建立應用程式。 如果您還沒有 Weibo 帳戶, 可以在[https://weibo.com/signup/signup.php?lang=en-us](https://weibo.com/signup/signup.php?lang=en-us)註冊。
