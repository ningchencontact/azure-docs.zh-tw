...
Azure AD B2C 目前僅支援傳遞 [OAuth 2.0](active-directory-b2c-reference-oauth-code.md) 識別提供者的存取權杖，其中包括 Facebook 和 [Google](active-directory-b2c-custom-setup-goog-idp.md)。 對於所有其他識別提供者，宣告會傳回空白。
