...
1. 安裝及設定最新的 [Azure CLI 2.0](/cli/azure/install-az-cli2)，並使用 [az login](/cli/azure/#az_login) 來登入 Azure 帳戶。

2. 使用 [az group create](/cli/azure/group#az_group_create) 命令搭配 `--name` 和 `--location` 引數來為您的 VNet 建立資源群組：
