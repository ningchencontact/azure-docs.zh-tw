...
1. 在 [Azure 入口網站](https://portal.azure.com)中，按一下 [+ 新增] > [計算] > [Windows Server 2016 Datacenter]。
2. 按一下頁面底部的 [新增] 。
...
1. 在 [Azure 入口網站](https://portal.azure.com)中，按一下 [所有服務]。
2. 在其中有 [篩選條件] 字詞的方塊中輸入 [資源群組]。 當您在篩選清單中看見它時，按一下 [資源群組]。
