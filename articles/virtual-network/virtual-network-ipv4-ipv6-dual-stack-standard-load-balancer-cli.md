...
使用[az network lb create](https://docs.microsoft.com/cli/azure/network/lb?view=azure-cli-latest)建立名為**dsLB**的 Standard Load Balancer，其中包含名為**dsLbFrontEnd_v4**的前端集區、名為**dsLbBackEndPool_v4**的後端集區，與 IPv4 公用 IP 位址**相關聯**您在上一個步驟中建立的 dsPublicIP_v4。 
