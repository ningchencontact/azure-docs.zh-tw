---
title: 建立虛擬網路 | Azure Resource Manager 範本 | Microsoft Docs
description: 了解如何使用 Azure Resource Manager 範本建立虛擬網路。
...
1. 完成[如何安裝並設定 Azure PowerShell](/powershell/azure/overview) 中的下列步驟來安裝和設定 Azure PowerShell。
2. 執行下列命令以建立新的資源群組：
