---
title: 建立具有多個 NIC 的 VM - Azure Resource Manager 範本 | Microsoft Docs
...
若要使用 PowerShell 來部署您下載的範本，請完成[安裝和設定 PowerShell](/powershell/azure/overview) 文章中的步驟來安裝和設定 PowerShell，然後完成下列步驟︰
