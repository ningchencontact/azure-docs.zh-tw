...
若要使用 Azure Resource Manager 範本在 Azure 虛擬網路中部署 IPv6 雙重堆疊應用程式, 請在[這裡](https://azure.microsoft.com/resources/templates/ipv6-in-vnet/)查看範例範本。
