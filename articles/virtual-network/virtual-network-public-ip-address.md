...
|PowerShell|[取得 AzPublicIpAddress](/powershell/module/az.network/get-azpublicipaddress)擷取的公用 IP 位址物件，並檢視其設定中，[組 AzPublicIpAddress](/powershell/module/az.network/set-azpublicipaddress)更新設定;[移除 AzPublicIpAddress](/powershell/module/az.network/remove-azpublicipaddress)刪除|
