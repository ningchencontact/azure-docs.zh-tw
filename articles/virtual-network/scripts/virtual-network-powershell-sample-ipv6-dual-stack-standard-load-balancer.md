---
title: Azure PowerShell 腳本範例-使用 Standard Load Balancer 設定 IPv6 虛擬網路端點 (預覽)
...
ms.locfileid: "68269698"
---
# <a name="configure-ipv6-endpoints-in-virtual-network-script-sample-with-standard-load-balancerpreview"></a>使用 Standard Load Balancer (預覽) 設定虛擬網路中的 IPv6 端點腳本範例
