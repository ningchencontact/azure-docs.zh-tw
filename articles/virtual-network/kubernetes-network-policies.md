...
ACS-Engine 是一種工具，產生在 Azure 中部署 Kubernetes 叢集的 Azure Resource Manager 範本。 叢集設定是在 JSON 檔案中設定，產生範本時會將該檔案傳遞到工具。 若要深入了解支援叢集設定及其描述的完整清單，請參閱＜Microsoft Azure Container Service 引擎 - 叢集定義＞。
