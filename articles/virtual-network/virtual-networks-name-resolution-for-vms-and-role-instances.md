...
> [!NOTE]
> 如果是 Web 和背景工作角色，您也可以使用 Azure 服務管理 REST API，根據角色名稱與執行個體數目，存取角色執行個體的內部 IP 位址。 如需詳細資訊，請參閱 [服務管理 REST API 參考](https://msdn.microsoft.com/library/azure/ee460799.aspx)。
> 
> 
...
使用傳統部署模型時，可以在入口網站或[網路組態檔案](https://msdn.microsoft.com/library/azure/jj157100)中指定虛擬網路的 DNS 伺服器。  針對雲端服務，則是透過[服務組態](https://msdn.microsoft.com/library/azure/ee758710)檔案或在 PowerShell ([New-AzureVM](https://msdn.microsoft.com/library/azure/dn495254.aspx)) 中指定 DNS 伺服器。
