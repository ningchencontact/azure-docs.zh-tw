...
> [!NOTE]
> A**注意保護**為您的自訂網域表示它尚未繫結到 SSL 憑證，且將會收到任何瀏覽器從您的自訂網域的 HTTPS 要求和錯誤或警告，視瀏覽器的標籤。 若要設定 SSL 繫結，請參閱[購買並設定 Azure App Service 的 SSL 憑證](web-sites-purchase-ssl-web-site.md)。
>
