...
> [!NOTE]
> 「App Service 環境」有兩個版本：ASEv1 和 ASEv2。 在 ASEv1 中，您必須先管理資源，才可加以使用。 若要瞭解如何設定和管理 ASEv1, 請參閱[設定 App Service 環境 v1][ConfigureASEv1]。 本文的其餘部分著重於 ASEv2。
>
>
