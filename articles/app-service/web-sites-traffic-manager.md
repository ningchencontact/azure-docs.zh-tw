---
title: 使用流量管理員來控制流量 - Azure App Service
...
若要設定以控制 App Service 應用程式流量，方法，您可以建立 Azure 流量管理員中，使用四個負載平衡方法先前所述的設定檔，然後再新增您想要控制流量的端點 （在此案例中，App Service）設定檔。 系統會定期與設定檔溝通您的應用程式狀態 (執行中、已停止或已刪除)，讓 Azure 流量管理員可相應地導向流量。
