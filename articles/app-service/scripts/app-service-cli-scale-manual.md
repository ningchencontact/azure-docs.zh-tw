...
此範例指令碼會建立資源群組、App Service 方案和 Web 應用程式。 然後將 App Service 方案從單一執行個體調整為多個執行個體。
...
| [`az appservice plan update`](/cli/azure/appservice/plan?view=azure-cli-latest#az_appservice_plan_update) | 更新 App Service 方案的屬性。 |
