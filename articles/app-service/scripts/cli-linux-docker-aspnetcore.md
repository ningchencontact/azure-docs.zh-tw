---
title: CLI：從 Docker 建立 ASP.NET Core 應用程式
description: 了解如何使用 Azure CLI 將 App Service 應用程式的部署和管理自動化。 此範例說明如何從 Docker Hub 建立 ASP.NET Core 應用程式。
