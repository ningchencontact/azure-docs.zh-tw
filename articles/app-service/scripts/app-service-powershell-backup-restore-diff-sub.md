---
title: Azure PowerShell 指令碼範例 - 從另一個訂用帳戶中的備份還原 Web 應用程式 | Microsoft Docs
...
ms.locfileid: "52291553"
---
# <a name="restore-a-web-app-from-a-backup-in-another-subscription"></a>從另一個訂用帳戶中的備份還原 Web 應用程式
