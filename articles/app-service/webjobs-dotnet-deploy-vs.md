...
本主題說明如何使用 Visual Studio 將主控台應用程式專案部署為 [App Service](overview.md)中之 Web 應用程式的 [Azure WebJob](https://go.microsoft.com/fwlink/?LinkId=390226)。 如需如何使用 [Azure 入口網站](https://portal.azure.com)部署 WebJob 的相關資訊，請參閱[使用 WebJob 執行背景工作](webjobs-create.md)。
