---
title: Linux 上搭配 SQL Database 的 ASP.NET Core 應用程式 - Azure App Service | Microsoft Docs
description: 了解如何讓 ASP.NET Core 應用程式在 Linux 上的 Azure App Service 中運作，並連線至 SQL Database。
