---
title: 教學課程：使用 MongoDB 的 Linux Node.js 應用程式
description: 了解如何藉由連線至 Azure 中的 MongoDB 資料庫 (Cosmos DB)，讓 Linux Node.js 應用程式在 Azure App Service 中運作。 此教學課程中將使用 MEAN.js。
