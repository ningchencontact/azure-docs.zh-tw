...
> [!NOTE]
> 目前只有 Azure AD v1.0 才支援 Azure App Service 和 Azure Functions。 [Microsoft 身分識別平臺](https://docs.microsoft.com/azure/active-directory/develop/v2-overview)v2.0 不支援這些版本，其中包含 microsoft 驗證程式庫（MSAL）。
...
1. 在左窗格的 [**設定**] 底下，選取 [**驗證/授權**]，並確定**App Service 驗證**已**開啟**。
1. 選取 [ **Azure Active Directory**]，然後在 [**管理模式]** 下選取 [**快速**]。
...
### <a name="secrets"></a>將 Azure Active Directory 資訊新增至您的 App Service 應用程式
