...
> [!NOTE]
> 這篇文章會將應用程式部署至 Windows 上的應用程式服務。 若要將部署到應用程式服務在_Linux_，請參閱[Linux 上建置的 Node.js 及 MongoDB web 應用程式設定 Azure App Service 中](./containers/tutorial-nodejs-mongodb-app.md)。
>
...
1. [安裝 Bower](https://bower.io/) (依[MEAN.js](http://meanjs.org/docs/0.5.x/#getting-started))
