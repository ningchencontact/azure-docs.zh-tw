...
1. 在 [發佈]  摘要頁面中，選取 [發佈]  。
   ...
   ![Visual Studio 的發佈摘要頁面](./media/app-service-web-get-started-dotnet-framework/publish-summary-page-framework-vs2019.png)
