...
| 屬性 | Type | 描述 |
| --------- | ---- | ----------- |
|名稱|string|必要。 背景工作角色的名稱。 角色的名稱必須是唯一的。|
...
| 屬性 | Type | 描述 |
| --------- | ---- | ----------- |
|分|int|必要。 範圍內的最小連接埠。 可能的值範圍介於 1 到 65535 (含) (Azure SDK 1.7 版或更高版本)。|
...
| 屬性 | Type | 描述 |
| --------- | ---- | ----------- |
|名稱|string|必要。 此憑證的名稱，當與 HTTPS `InputEndpoint` 元素相關聯時，會用來參考它。|
