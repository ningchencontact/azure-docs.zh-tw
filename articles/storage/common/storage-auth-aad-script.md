...
如需有關容器或佇列上每個 Azure 儲存體作業所需許可權的詳細資訊, 請參閱[使用 OAuth 權杖呼叫儲存體作業](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-azure-active-directory#call-storage-operations-with-oauth-tokens)。  
