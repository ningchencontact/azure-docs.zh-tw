...
- [使用 Azure CLI 以 RBAC 授與 Azure blob 和佇列資料的存取權](storage-auth-aad-rbac-cli.md)
- [使用 PowerShell 以 RBAC 授與 Azure blob 和佇列資料的存取權](storage-auth-aad-rbac-powershell.md)
