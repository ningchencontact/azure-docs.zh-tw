...
2. 提供送回的寄件地址和貨運公司客戶編號，以便將磁碟機送回給您。
3. 將磁碟機運送到建立作業期間所提供的運送地址。
4. 在匯入工作詳細資料中更新貨件追蹤號碼，並提交匯入工作。
5. Azure 資料中心收到磁碟機並進行處理。
6. 使用您的貨運業者帳戶，將磁碟機送到匯入作業中提供的寄件地址。
