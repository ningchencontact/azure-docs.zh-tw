...
1. 安裝 [Azure PowerShell](/powershell/azure/install-azurerm-ps) 並[登入](/powershell/azure/authenticate-azureps)。
...
|Azure Event Grid|Microsoft.EventGrid|啟用 Blob 儲存體事件發佈。 [深入了解](/azure/event-grid/overview)。|
