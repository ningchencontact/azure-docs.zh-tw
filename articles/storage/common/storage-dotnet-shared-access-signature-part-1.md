...
* [Azure Storage Client Library for .NET](https://www.nuget.org/packages/WindowsAzure.Storage)，版本 6.x 或更高版本 (以使用 帳戶 SAS)。
* [Azure 資源管理員](https://www.nuget.org/packages/Microsoft.Azure.ConfigurationManager)
