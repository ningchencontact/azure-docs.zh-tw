---
title: 使用 Azure 入口網站來管理對容器與 RBAC-Azure 儲存體佇列的 Azure AD 存取權限 |Microsoft Docs
...
ms.locfileid: "58368233"
---
# <a name="grant-access-to-azure-containers-and-queues-with-rbac-in-the-azure-portal"></a>Azure 容器和佇列使用 RBAC 在 Azure 入口網站中的授與存取權
...
1. 指派適當的 Azure 儲存體的 RBAC 角色，授與容器或佇列的存取權。 讀取權限，指派**Blob 資料讀者**或是**佇列資料讀者**角色。 讀取、 寫入和刪除權限，指派**Blob 資料參與者**或是**佇列資料參與者**角色。 您也可以指派自訂角色。
