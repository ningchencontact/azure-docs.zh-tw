...
使用 [New-AzureRmStorageAccount](/powershell/module/azurerm.storage/New-AzureRmStorageAccount) 建立可用於全部四種服務的一般用途儲存體帳戶。 將儲存體帳戶命名為 *contosomvcstandard*，並將它設定為啟用「本地備援儲存體」和 Blob 加密。
