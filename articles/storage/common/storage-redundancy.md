...
您可以使用，以變更您的儲存體帳戶的複寫策略[Azure 入口網站](https://portal.azure.com/)， [Azure Powershell](storage-powershell-guide-full.md)， [Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest)，或其中一個[Azure 用戶端程式庫](https://docs.microsoft.com/azure/index?view=azure-dotnet#pivot=sdkstools)。 變更儲存體帳戶的複寫類型並不會造成停機。
