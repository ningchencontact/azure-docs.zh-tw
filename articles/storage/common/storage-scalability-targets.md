...
> 如需啟用這些較大檔案共用大小的限制、區域資訊和指示清單，請參閱 Azure 檔案儲存體規劃指南的上[架至較大的檔案共用（標準層）](../files/storage-files-planning.md#onboard-to-larger-file-shares-standard-tier)一節。
