...
| [Get-AzStorageContainer](/powershell/module/azure.storage/get-AzStoragecontainer) | 列出與儲存體帳戶關聯的儲存體容器。 |
| [Remove-AzStorageContainer](/powershell/module/azure.storage/remove-AzStoragecontainer) | 移除指定的儲存體容器。 |
