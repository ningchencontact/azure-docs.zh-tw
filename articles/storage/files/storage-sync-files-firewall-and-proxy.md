...
|--------|--------|----------------------|---------------|---------------|
| 公開 |澳洲東部 | HTTPs：\//kailani-aue.one.microsoft.com | 澳洲東南部 | HTTPs：\//tm-kailani-aue.one.microsoft.com |
| 公開 |澳洲東南部 | HTTPs：\//kailani-aus.one.microsoft.com | 澳洲東部 | HTTPs：\//tm-kailani-aus.one.microsoft.com |
