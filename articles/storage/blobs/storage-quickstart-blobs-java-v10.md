...
* 從命令列運作的 [Maven](https://maven.apache.org/download.cgi)，或您偏好的任何 Java 整合式開發環境。
...
> [API 參考](https://docs.microsoft.com/java/api/overview/azure/storage)
