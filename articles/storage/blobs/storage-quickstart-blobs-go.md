...
* [Go 1.8 或更新版本](https://golang.org/dl/)
* 使用下列命令，安裝 [Azure Storage Blob SDK for Go](https://github.com/azure/azure-storage-blob-go/)：
    ...
    > [!NOTE]
    > 務必將 URL 中的 `Azure` 變成大寫，以避免在使用 SDK 時發生與大小寫相關的匯入問題。 此外，將您匯入陳述式中的 `Azure` 變成大寫。
