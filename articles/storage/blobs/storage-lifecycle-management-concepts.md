...
若要註冊公開預覽版，您必須提交要求向您的訂用帳戶註冊這項功能。 要求通常會在兩週內核准。 一經核准，在以下區域內的所有現有和新的 GPv2 或 Blob 儲存體帳戶均會加進該功能：美國西部 2、美國中西部、美國東部 2 和西歐。 預覽僅支援區塊 Blob。 如同大部分預覽，請不要在這項功能正式運作之前，將之用於生產的工作負載上。
