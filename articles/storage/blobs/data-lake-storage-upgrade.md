---
title: 將 Azure Data Lake Storage 從 Gen1 升級至 Gen2
description: 將 Azure Data Lake Storage 從 Gen1 升級至 Gen2。
author: normesta
ms.topic: conceptual
ms.author: normesta
ms.date: 11/19/2019
...
ms.locfileid: "74894227"
---
# <a name="upgrade-azure-data-lake-storage-from-gen1-to-gen2"></a>將 Azure Data Lake Storage 從 Gen1 升級至 Gen2
...
| 伺服器端 API| [WebHDFS 相容的 REST API](https://msdn.microsoft.com/library/azure/mt693424.aspx) | Azure Blob 服務 REST API [Data Lake Storage Gen2 REST API](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2) | Data Lake Storage Gen2 REST API – *現已推出* <br><br> Azure Blob 服務 REST API –*現已推出*       |
...
| 資料作業 - 記錄  | 是 | 是 | *現已推出*（預覽）。 請參閱[已知問題](data-lake-storage-known-issues.md)。<br><br> Azure 的監視整合 – *尚無法使用* |
...
| 開發人員 SDK | .NET、Java、Python、Node.js  | .NET、JAVA、Python、Node.js、C++、Ruby、PHP、Go、Android、iOS| Blob SDK-*現已推出*。 [AZURE DATA LAKE STORAGE GEN2 SDK](https://azure.microsoft.com/blog/extended-filesystem-programming-capabilities-in-azure-data-lake-storage/)- *現已推出-.net、JAVA、Python （公開預覽）*  |
...
| 資料管理                             | 檔案到期                                                                                                                                        | 生命週期原則                                                                                                                                                                                                                                                                                                                                                                                                          | *立即可用*的生命週期原則（預覽）。 請參閱[已知問題](data-lake-storage-known-issues.md)。                                                                                                                     |

### <a name="programming-interfaces"></a>程式設計介面

下表說明有哪些 API 集合可供您的自訂應用程式使用。 尚不支援 ACL 和目錄層級作業的 SDK 支援。
...
|                     | Qubole       |                      | [連結](https://www.qubole.com/blog/big-data-analytics-microsoft-azure-data-lake-store-qubole/)                                                                                            | [連結](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4c-configure-azure-data-lake-gen-2-storage-with-keys)                                                                                                  | [連結](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4d-configure-azure-data-lake-gen-2-storage-with-tokens)                                                                                                 |
...
| 診斷記錄                                                                                        | [連結](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *現已推出*（預覽）。 請參閱[已知問題](data-lake-storage-known-issues.md)。 <br>Azure 監視整合-尚未*提供* |
