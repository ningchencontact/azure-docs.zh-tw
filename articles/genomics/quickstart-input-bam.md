---
title: 快速入門：使用 BAM 檔案輸入來提交工作流程 | Microsoft Docs
titleSuffix: Azure
...
ms.locfileid: "26684512"
---
# <a name="submit-a-workflow-using-a-bam-file-input"></a>使用 BAM 檔案輸入提交工作流程

本快速入門示範如何在您的輸入檔案是單一的 BAM 檔案時，將工作流程提交至 Microsoft Genomics 服務。 本主題假設您已安裝並執行 `msgen` 用戶端，且熟悉如何使用 Azure 儲存體。 如果您已使用提供的範例資料成功地提交工作流程，即準備好繼續進行本快速入門。 
