...
**問題**：我可以壓縮文字檔來上傳更大的文字檔嗎？ 

**答**：不可以，目前僅允許未壓縮的文字檔。

**問題**：資料報告指出有失敗的語句。 這算是問題嗎？
...
**問題**：我可以使用自訂語言模型對自訂原音模型執行離線測試嗎？

**答**：可以，只要在設定離線測試時，從下拉式清單中選取自訂語言模型即可

**問題**：我可以使用自訂原音模型對自訂語言模型執行離線測試嗎？
...
**問題**：現在我已知道自訂模型的測試結果，此數字是好還是不好呢？

**答**：結果會顯示基準模型與自訂模型之間的比較。
您應該將目標放在勝過基準模型，自訂才有價值

**問題**：如何找出基本模型的 WER，讓我可以查看是否有所改善？ 
