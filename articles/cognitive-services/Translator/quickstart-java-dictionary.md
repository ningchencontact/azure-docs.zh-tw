---
title: 快速入門：尋找替代的翻譯 (Java) - 翻譯工具文字 API
...
ms.locfileid: "50416651"
---
# <a name="quickstart-find-alternate-translations-with-the-translator-text-rest-api-java"></a>快速入門：使用翻譯工具文字 REST API (Java) 尋找替代的翻譯
