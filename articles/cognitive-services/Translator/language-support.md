...
|阿拉伯文|    `ar`    |可使用類神經|  神經網路|
|孟加拉文|    `bn`    |可使用類神經|  神經網路|
|波士尼亞文 (拉丁文)|   `bs`    |可使用類神經|  神經網路|
|保加利亞文| `bg`    |可使用類神經|  神經網路|
|粵語 (繁體中文)|   `yue`   |僅限統計|  統計|
|卡達隆尼亞文|   `ca`    |僅限統計|  統計|
|簡體中文|    `zh-Hans`   |類神經預設值 |神經網路|
|繁體中文|   `zh-Hant`   |類神經預設值 |神經網路|
|克羅埃西亞文|  `hr`    |可使用類神經|  神經網路|
|捷克文| `cs`    |可使用類神經|  神經網路|
|丹麥文|    `da`    |可使用類神經   |神經網路|
|荷蘭文| `nl`    |可使用類神經|  神經網路|
|繁體中文|   `en`    |可使用類神經|  神經網路|
|愛沙尼亞文|  `et`    |可使用類神經|  神經網路|
|斐濟文|    `fj`    |僅限統計|  統計|
|菲律賓文|  `fil`   |僅限統計|  統計|
|芬蘭文|   `fi`    |可使用類神經|  神經網路|
|法文|    `fr`    |可使用類神經|  神經網路|
...
|羅馬尼亞文|  `ro`    |可使用類神經|  神經網路|
|俄文|   `ru`    |可使用類神經|  神經網路|
|薩摩亞文|    `sm`    |僅限統計|  統計|
|塞爾維亞文 (斯拉夫)|    `sr-Cyrl`   |僅限統計|  統計|
|塞爾維亞文 (拉丁)|   `sr-Latn`   |僅限統計   |統計|
|斯洛伐克文|    `sk`    |可使用類神經|  神經網路|
|斯洛維尼亞文| `sl`    |可使用類神經|  神經網路|
|西班牙文|   `es`    |可使用類神經|  神經網路|
|瑞典文|   `sv`    |可使用類神經   |神經網路|
|大溪地文|  `ty`    |僅限統計|  統計|
|坦米爾文| `ta`    |僅限統計|  統計|
