---
title: 快速入門：在雙語字典中查詢單字 (Node.js) - 翻譯工具文字 API
...
ms.locfileid: "56729707"
---
# <a name="quickstart-look-up-words-with-bilingual-dictionary-using-nodejs"></a>快速入門：使用 Node.js 在雙語字典中查詢單字
