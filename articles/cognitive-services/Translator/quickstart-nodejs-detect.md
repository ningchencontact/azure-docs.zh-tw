---
title: 快速入門：從文字識別語言 (Node.js) - 翻譯工具文字 API
titleSuffix: Azure Cognitive Services
description: 在此快速入門中，您將使用翻譯工具文字 API 搭配 Node.js 識別來源文字的語言。
...
ms.locfileid: "49644669"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-nodejs"></a>快速入門：使用翻譯工具文字 REST API (Node.js) 從文字識別語言
