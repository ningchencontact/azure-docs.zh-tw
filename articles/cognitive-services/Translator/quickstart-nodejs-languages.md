---
title: 快速入門：取得支援的語言 (Node.js) - 翻譯工具文字 API
...
ms.locfileid: "49646403"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-nodejs"></a>快速入門：使用翻譯工具文字 REST API (Node.js) 取得支援的語言
