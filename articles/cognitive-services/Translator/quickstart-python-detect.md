---
title: 快速入門：偵測文字語言 (Python) - 翻譯工具文字 API
titleSuffix: Azure Cognitive Services
description: 在此快速入門中，您將了解如何搭配使用 Python 與翻譯工具文字 REST API 來識別所提供文字的語言。
...
在此快速入門中，您將了解如何搭配使用 Python 與翻譯工具文字 REST API 來偵測所提供文字的語言。
