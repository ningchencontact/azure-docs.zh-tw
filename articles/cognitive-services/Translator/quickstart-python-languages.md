---
title: 快速入門：取得支援的語言清單 (Python) - 翻譯工具文字 API
...
ms.locfileid: "50246553"
---
# <a name="quickstart-use-the-translator-text-api-to-get-a-list-of-supported-languages-using-python"></a>快速入門：搭配使用翻譯工具文字 API 和 Python 取得支援的語言清單
...
目前有一個端點可供翻譯工具文字使用，且該端點設定為 `base_url`。 `path` 會設定 `languages` 路由，並指出我們要叫用第 3 版的 API。
