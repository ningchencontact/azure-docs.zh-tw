---
title: 快速入門：取得支援的語言 (PHP) - 翻譯工具文字 API
...
ms.locfileid: "55206828"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-php"></a>快速入門：使用翻譯工具文字 REST API (PHP) 取得支援的語言
