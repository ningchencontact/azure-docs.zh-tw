---
title: 適用於 Microsoft Academic Graph 的學術知識 API | Microsoft Docs
description: 使用學術知識 API 來解譯使用者查詢，以及從 Microsoft 認知服務的 Academic Graph 中擷取豐富資訊。
