---
title: 適用於 Azure 認知服務、文字分析 API 的 Node.js 快速入門 | Microsoft Docs
...
---
# <a name="quickstart-for-text-analytics-api-with-nodejs"></a>含 Node.js 之文字分析 API 快速入門 
<a name="HOLTop"></a>
