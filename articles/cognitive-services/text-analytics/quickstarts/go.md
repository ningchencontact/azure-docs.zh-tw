---
title: 適用於 Azure 認知服務、文字分析 API 的 Go 快速入門 | Microsoft Docs
...
ms.locfileid: "43750274"
---
# <a name="quickstart-for-text-analytics-api-with-go"></a>文字分析 API 搭配 Go 的快速入門 
<a name="HOLTop"></a>
...
情感分析 API 會使用 [Sentiment 方法](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/56f30ceeeda5650db055a3c9) (英文)，偵測一組文字記錄中的情緒態度。 下列範例會為兩份文件進行評分，一份是英文，另一份則是西班牙文。
...
## <a name="identify-linked-entities-request"></a>Identify linked entities 要求
...
## <a name="identify-linked-entities-response"></a>Identify linked entities 回應
