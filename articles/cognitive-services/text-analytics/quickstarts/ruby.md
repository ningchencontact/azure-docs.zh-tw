---
title: 適用於 Azure 認知服務、文字分析 API 的 Ruby 快速入門 | Microsoft Docs
...
ms.locfileid: "43841723"
---
# <a name="quickstart-for-text-analytics-api-with-ruby"></a>文字分析 API 與 Ruby 的快速入門 
<a name="HOLTop"></a>
