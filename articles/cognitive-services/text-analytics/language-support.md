...
## <a name="sentiment-analysis-key-phrase-extraction-and-entity-recognition"></a>情感分析、關鍵片語擷取和實體辨識
...
\*\* 西班牙文的實體擷取僅於 [(2.1-preview 版)](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics-V2-1-Preview/operations/5ac4251d5b4ccd1554da7634) \(英文\) 中提供
