---
title: 文字分析 API 概觀 - Azure 認知服務 | Microsoft Docs
description: Microsoft 認知服務中的文字分析 API 包含情感分析、關鍵片語擷取和語言偵測等功能。
...
---
# <a name="what-is-text-analytics-api-version-20"></a>什麼是文字分析 API 2.0 版？
...
|[**實體連結 (預覽版)**](how-tos/text-analytics-how-to-entity-linking.md) | 在您的文字中識別已知的實體，並連結至網路上的其他資訊。 實體連結可辨識並釐清某個字詞何時會作為可個別區分的一個實體、動詞和其他文字形式。 | [REST](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/5ac4251d5b4ccd1554da7634) | 
