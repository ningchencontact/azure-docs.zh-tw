...
|Language Understanding[訂][pricing]用帳戶-F0-免費層 |無效|1 萬個/月，5 個/秒|查詢 LUIS 端點|
|Language Understanding[訂][pricing]用帳戶-S0-基本層|無效|50 個/秒|查詢 LUIS 端點|
|認知服務[訂][pricing]用帳戶-S0-標準層|無效|50 個/秒|查詢 LUIS 端點|
|[情感分析整合](luis-how-to-publish-app.md#enable-sentiment-analysis)|無效|不收費|新增情感資訊，包括關鍵片語資料擷取 |
|[語音整合](../speech-service/how-to-recognize-intents-from-speech-csharp.md)|無效|$5.50 美元/1 千個端點要求|將口語語句轉換成文字語句並傳回 LUIS 結果|
