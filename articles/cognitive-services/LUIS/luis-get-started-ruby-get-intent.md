---
title: 教學課程：了解如何使用 Ruby 呼叫 Language Understanding Intelligent Services (LUIS) 應用程式 | Microsoft Docs
...
ms.locfileid: "36265104"
---
# <a name="tutorial-call-a-luis-endpoint-using-ruby"></a>教學課程：使用 Ruby 呼叫 LUIS 端點
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-ruby"></a>使用端點 API 搭配 Ruby 來取用 LUIS 結果 
...
2. 以您的訂用帳戶金鑰取代這一行程式碼中的 `"YOUR-SUBSCRIPTION-KEY"`：`subscriptionKey = "YOUR-SUBSCRIPTION-KEY"`

3. 執行 Ruby 應用程式。 它會顯示您稍早在瀏覽器視窗中看到的相同 JSON。
...
> [新增語句](luis-get-started-ruby-add-utterance.md)
