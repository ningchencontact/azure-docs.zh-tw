...
1. 將 **number** 實體新增到應用程式，然後將應用程式[定型](interactive-test.md)和[發佈](PublishApp.md)。
...
1. 將 **datetimeV2** 實體新增到應用程式，然後將應用程式[定型](interactive-test.md)和[發佈](PublishApp.md)。
2. 按一下 [發佈應用程式] 頁面中的端點 URL，以在網頁瀏覽器中開啟 LUIS 端點。 
