---
title: 使用 PHP 呼叫 Language Understanding Intelligent Services (LUIS) 應用程式 | Microsoft Docs
...
ms.locfileid: "36265121"
---
# <a name="tutorial-call-a-luis-endpoint-using-php"></a>教學課程：使用 PHP 呼叫 LUIS 端點
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-php"></a>使用端點 API 搭配 PHP 來取用 LUIS 結果 
...
3. 執行 PHP 應用程式。 它會顯示您稍早在瀏覽器視窗中看到的相同 JSON。
...
> [新增語句](luis-get-started-php-add-utterance.md)
