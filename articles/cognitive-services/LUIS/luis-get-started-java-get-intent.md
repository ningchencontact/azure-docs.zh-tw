---
title: 使用 Java 來分析 Language Understanding (LUIS) 中的自然語言文字 - 認知服務 - Azure 認知服務 | Microsoft Docs
...
ms.locfileid: "43750322"
---
# <a name="quickstart-analyze-text-using-java"></a>快速入門：使用 Java 來分析文字
...
## <a name="analyze-text-with-java"></a>使用 Java 來分析文字 
