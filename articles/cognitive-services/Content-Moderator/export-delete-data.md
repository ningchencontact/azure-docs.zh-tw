...
| 資料 | 匯出作業 | 刪除作業 |
| ---- | ---------------- | ---------------- |
| 帳戶資訊 (訂用帳戶金鑰) | N/A | 使用 Azure 入口網站刪除 (Azure 訂用帳戶)。 或者，使用 **Review UI** Team 設定頁面中的 [刪除小組][](https://contentmoderator.cognitive.microsoft.com/) 按鈕。 |
...
| 標籤 | N/A | 使用 [Review UI Tag] \(Review UI 標籤\) 設定頁面中每個標籤可用的**刪除**圖示。 或者，使用 **Review UI** Team 設定頁面中的 [刪除小組][](https://contentmoderator.cognitive.microsoft.com/) 按鈕。 |
| 評論 | 呼叫[取得檢閱 API](https://westus.dev.cognitive.microsoft.com/docs/services/580519463f9b070e5c591178/operations/580519483f9b0709fc47f9c2) \(英文\) | 使用 **Review UI** 小組設定頁面中的 [刪除小組][](https://contentmoderator.cognitive.microsoft.com/) 按鈕。
| 使用者 | N/A | 使用 **Review UI** 小組設定頁面中每個使用者可用的[刪除](https://contentmoderator.cognitive.microsoft.com/)圖示。 或者，使用 **Review UI** Team 設定頁面中的 [刪除小組][](https://contentmoderator.cognitive.microsoft.com/) 按鈕。 |
