---
title: Azure Content Moderator SDK for .NET 協助程式方法 | Microsoft Docs
...
ms.locfileid: "35367899"
---
# <a name="helper-code-to-return-a-content-moderator-client"></a>用於傳回 Content Moderator 用戶端的協助程式程式碼
