---
title: 在 Content Moderator API 中管理小組和子小組 - Content Moderator
...
ms.locfileid: "54266224"
---
# <a name="manage-review-teams-and-subteams"></a>管理審查小組和子小組
...
### <a name="name-your-subteam"></a>為您的子小組命名
在對話方塊中輸入您的子小組名稱，然後按一下 [儲存]。

![子小組名稱](images/1-Teams-2.PNG)

### <a name="assign-members-from-your-default-team"></a>指派預設小組中的成員。
