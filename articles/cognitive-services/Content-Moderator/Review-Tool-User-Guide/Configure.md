---
title: 設定 Content Moderator 的審查工具設定 - Content Moderator
titlesuffix: Azure Cognitive Services
description: 設定或取出您的小組、標記、連接器、工作流程及認證。
...
ms.locfileid: "54262943"
---
# <a name="configure-review-tool-settings"></a>設定審查工具設定

使用 [審查] 工具儀表板上的 [設定] 索引標籤，可以輕鬆地定義和變更許多元件。
