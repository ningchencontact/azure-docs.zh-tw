...
- **team**：您設定[審核工具](https://contentmoderator.cognitive.microsoft.com/)帳戶時所建立的小組識別碼（可在審核工具的 [認證] 畫面上的 [**識別碼**] 欄位中找到）。
...
1. 編輯 [**要求**本文] 方塊以輸入 JSON 要求，其中包含**描述**和**類型**的詳細資料（`Image` 或 `Text`）。
