...
| **文字審核 API**<br /><br />掃描文字內容。 會傳回不雅內容條款和個人資料。 <br /><br />使用此資訊，在審核後的工作流程中發佈、拒絕或審查內容。<br /><br /> | [文字審核 API 參考](https://westus.dev.cognitive.microsoft.com/docs/services/57cf753a3f9b070c105bd2c1/operations/57cf753a3f9b070868a1f66f "文字審核 API 參考")   |
