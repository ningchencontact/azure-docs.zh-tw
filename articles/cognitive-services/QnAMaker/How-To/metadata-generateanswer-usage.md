...
[回應](https://docs.microsoft.com/rest/api/cognitiveservices/qnamakerruntime/runtime/generateanswer#successful_query)是 JSON 物件，包括所有交談，開啟您要顯示答案和下一個所需資訊，如果有的話。
