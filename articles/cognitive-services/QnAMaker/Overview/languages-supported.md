---
title: 支援的語言 - QnA Maker - Azure 認知服務 | Microsoft Docs
description: 了解 QnA Maker 支援哪些語言。
...
QnA Maker 需要 Azure 搜尋服務中的[語言分析器](https://docs.microsoft.com/en-us/rest/api/searchservice/language-support)才能提供結果。 特殊的重新排名功能適用於 En-* 語言，可改善相關性。
