---
title: 快速入門：Go 發佈知識庫 - QnA Maker
titleSuffix: Azure Cognitive Services
description: 如何使用 Go 發佈 QnA Maker 的知識庫。
...
ms.locfileid: "48883528"
---
# <a name="quickstart-publish-a-knowledge-base-in-go"></a>快速入門：使用 Go 發佈知識庫
