---
title: 更新知識庫 - Go 快速入門 - Azure 認知服務 | Microsoft Docs
description: 如何使用 Go 更新 QnA Maker 的知識庫。
...
## <a name="the-update-knowledge-base-response"></a>更新知識庫的回應
