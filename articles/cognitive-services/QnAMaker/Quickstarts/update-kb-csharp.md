...
一旦更新您的知識庫，您可以在 QnA Maker 入口網站的[我的知識庫](https://www.qnamaker.ai/Home/MyServices) (英文) 頁面中檢視。 請注意，您的知識庫名稱已變更，例如 QnA Maker 常見問題集 ( 或您既有的知識庫名稱) 現在是新的知識庫名稱。

若要修改知識庫的其他元素，請參閱 QnA Maker [JSON 結構描述](https://westus.dev.cognitive.microsoft.com/docs/services/5a93fcf85b4ccd136866eb37/operations/5ac266295b4ccd1554da7600) (英文)，並且修改 `new_kb` 字串。
