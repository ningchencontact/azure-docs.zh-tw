---
title: 更新知識庫，Java 快速入門 - Azure 認知服務 | Microsoft Docs
...
1. 您需要 [apache httpclient](http://hc.apache.org/downloads.cgi) (英文) 程式庫。 例如，下載二進位 HttpClient 4.x.x.tar.gz，以尋找需要匯入至專案的所有 jar 檔案。
