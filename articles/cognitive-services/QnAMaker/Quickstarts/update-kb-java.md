---
title: 快速入門：更新知識庫 - REST (Java) - QnA Maker
...
ms.locfileid: "51614713"
---
# <a name="quickstart-update-a-knowledge-base-in-qna-maker-using-java"></a>快速入門：使用 Java 更新 QnA Maker 中的知識庫
