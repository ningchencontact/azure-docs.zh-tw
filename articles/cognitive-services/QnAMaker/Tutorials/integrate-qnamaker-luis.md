...
![QnA Maker 與 Language Understanding 架構](../media/qnamaker-tutorials-qna-luis/qnamaker-luis-architecture.PNG)
...
1. [建立 「 基本 」 的 Web 應用程式 bot](https://docs.microsoft.com/azure/bot-service/bot-service-quickstart?view=azure-bot-service-4.0)自動包含 LUIS 應用程式。 選取的 4.x SDK 和C#程式設計語言。
