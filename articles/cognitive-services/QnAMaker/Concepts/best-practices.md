...
[主動式學習](../How-to/improve-knowledge-base.md)具有各種品質和數量的使用者查詢時，其在建議替代問題方面的表現最好。 務必讓用戶端應用程式的使用者查詢參與主動式回饋迴圈，而不需要審查。 一旦 QnA Maker 入口網站中，所建議的問題，您可以 **[篩選-依建議](../How-To/improve-knowledge-base.md)** 然後檢閱並接受或拒絕這些建議。 
