...
[語音辨識](quickstart-csharp-dotnet-windows.md)和[語音翻譯](quickstart-translate-speech-dotnetframework-windows.md)也提供快速入門。
...
1. 輸入英文片語或句子。 應用程式會將您的文字傳送到語音服務，文字會轉換為合成語音並傳送回應用程式，以在喇叭上播放。
   ...
   ![語音合成使用者介面](media/sdk/qs-tts-csharp-dotnet-windows-console-output.png)
