...
ms.locfileid: "71803852"
---
# <a name="quickstart-synthesize-speech-with-the-speech-sdk-for-python"></a>快速入門：使用適用於 Python 的語音 SDK 來合成語音

另備有[語音辨識](quickstart-python.md)的快速入門。

本文說明如何透過適用於 Python 的語音 SDK 來使用語音服務。 其中說明如何從文字合成語音，並使用預設的音訊輸出加以播放。
...
1. 若要執行範例程式碼，請在編輯器內任意地方按一下滑鼠右鍵。 選取 [在終端機中執行 Python 檔案]  。
   ...
   ![執行範例](media/sdk/qs-python-vscode-python-run-tts.png)
