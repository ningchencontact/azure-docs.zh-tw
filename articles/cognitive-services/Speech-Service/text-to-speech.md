...
|------------|----------|---------------|
| [C#.NET framework](quickstart-text-to-speech-dotnet-windows.md) |  Windows | [瀏覽](https://aka.ms/csspeech/csharpref) |
| [C++](quickstart-text-to-speech-cpp-windows.md) |  Windows | [瀏覽](https://aka.ms/csspeech/cppref) |
| [C++](quickstart-text-to-speech-cpp-linux.md) |  Linux | [瀏覽](https://aka.ms/csspeech/cppref) |

### <a name="rest-quickstarts"></a>REST 快速入門

| 快速入門 (REST) | 平台 | API 參考資料 |
|------------|----------|---------------|
| [C#, .NET Core](quickstart-dotnet-text-to-speech.md) | Windows、 macOS、 Linux | [瀏覽](https://docs.microsoft.com/azure/cognitive-services/speech-service/rest-apis) |
| [Node.js](quickstart-nodejs-text-to-speech.md) | 視窗、 macOS、 Linux | [瀏覽](https://docs.microsoft.com/azure/cognitive-services/speech-service/rest-apis) |
| [Python](quickstart-python-text-to-speech.md) | 視窗、 macOS、 Linux | [瀏覽](https://docs.microsoft.com/azure/cognitive-services/speech-service/rest-apis) |
...
* [建立自訂的語音字型](how-to-customize-voice-font.md)
