...
應用程式以語音 SDK Maven 套件 1.5.1 版和 Android Studio 3.3 為基礎。
...
1. 在出現的視窗中，輸入適用於 Android 之語音 SDK 的名稱和版本 `com.microsoft.cognitiveservices.speech:client-sdk:1.5.1`。 然後選取 [確定]  。
