...
您的配音員則是另一個重要因素。 他們必須能夠以一致的速率、音量、音調和音調來說話。 發音清晰是必備條件。 人才也必須能夠嚴格控制其音調變化、情緒影響和語音舉止。
...
|政府&nbsp;著作|美國政府所建立的作品在美國境內並不受著作權，不過政府可能會在其他國家/地區領取著作權。|
...
使用 studio 的錄音工程師討論您的專案，並聆聽其建議。 錄音的動態範圍壓縮率應該很低或完全沒有 (最多為 4:1)。 音訊具有一致的音量和高信噪比至關重要，同時沒有不必要的聲音。
...
為避免浪費錄音室時間，請在錄音工作之前，與配音員一起瀏覽腳本。 當配音人員熟悉文字時，可以澄清任何不熟悉單字的發音。

> [!NOTE]
> 大多數的錄音室都會在錄音室中提供電子版的腳本。 在此情況下，請直接在腳本的文件中輸入您的筆記大綱。 但是，您仍然希望在錄音工作期間使用紙本副本做筆記。 大多數的工程師也會想要有紙本副本。 此外，您仍然需要為配音員準備另一份紙本副本備用，以防電腦當機。

您的配音員可能會詢問您在一個語句中想要強調哪個詞 (也就是「關鍵詞」)。 告訴他們您想要自然閱讀，而不需要特別強調。 合成語音時可以加入強調，但這不應該是原始錄音的一部分。
...
> [!TIP]
> 如果您使用大量語句，單一語句可能不會對所產生的自訂語音產生明顯的影響。 只要記下有問題的任何語句、將它們從資料集中排除，然後查看自訂語音的結果，可能會比較方便。您隨時可以返回 studio 並記錄遺漏的範例。

請記下腳本上每個語句的錄音段落編號或時間代碼。 要求工程師也在錄音的中繼資料或提示表中標記每個語句。

請定期休息並提供飲料，以協助您的配音人員將語音保持在良好的形狀。
