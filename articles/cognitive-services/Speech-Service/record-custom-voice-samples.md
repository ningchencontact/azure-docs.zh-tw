...
您的配音員則是另一個重要因素。 他們必須能夠與一致的頻率、 磁碟區層級、 音調、 和音。 發音清晰是必備條件。 若要能夠嚴格控制其音高變化、 情感的影響，以及語音 mannerisms 也需要人才。
...
與 studio 錄製工程師討論您的專案，並聆聽其建議。 錄音的動態範圍壓縮率應該很低或完全沒有 (最多為 4:1)。 音訊具有一致的音量和高信噪比至關重要，同時沒有不必要的聲音。
...
為避免浪費錄音室時間，請在錄音工作之前，與配音員一起瀏覽腳本。 雖然語音人才就能熟悉使用的文字，它們可以釐清任何不熟悉的字詞的發音。

> [!NOTE]
> 大多數的錄音室都會在錄音室中提供電子版的腳本。 在此情況下，請直接在腳本的文件中輸入您的筆記大綱。 但是，您仍然希望在錄音工作期間使用紙本副本做筆記。 大多數的工程師也會想要有紙本副本。 此外，您仍然需要為配音員準備另一份紙本副本備用，以防電腦當機。

您的配音員可能會詢問您在一個語句中想要強調哪個詞 (也就是「關鍵詞」)。 告訴他們您想要任何特別強調的自然讀取。 合成語音時可以加入強調，但這不應該是原始錄音的一部分。
...
取得規則的符號，並提供以協助您保持在良好狀態的語音的語音聰明才智飲料。
