...
您可以使用自訂語音入口網站來建立自訂模型之後，才需要語音服務的訂用帳戶。 請遵循這些指示來建立標準的語音服務訂用帳戶：[建立語音訂閱](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/get-started#new-azure-account)。
