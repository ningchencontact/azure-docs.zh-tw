...
| 地區設定 | 語言 | 性別 | 服務名稱對應|
|--------|----------|--------|---------------------|
| de-DE | 德文 (德國) | 女性 | 「 Microsoft Server 語音文字轉換語音語音 (DE-DE KatjaNeural) 」 |
...
| it-IT | 義大利文 (義大利) | 女性 | 「 Microsoft Server 語音文字轉換語音語音 (IT-IT，ElsaNeural) 」 |
...
> [!IMPORTANT]
> Microsoft Server 語音文字轉換語音語音 (DE-DE KatjaNeural) 和 Microsoft Server 語音文字轉換語音語音 (IT-IT，ElsaNeural) 只可透過西歐端點： https://westeurope.tts.speech.microsoft.com/cognitiveservices/v1。
...
> [!NOTE]
> 法文、 德文和義大利文的語氣訓練課程開始談話 2,000 個以上的資料集。 中文-英文雙語模型也支援使用有 2,000 個以上語句的初始資料集。
