        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="start">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>從 Blob 進行非同步辨識</h3>
                                                    <p>使用我們的 REST 服務，以非同步方式辨識來自 Azure Blob 儲存體中所儲存檔案的語音。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>閱讀文件</h3>
                                                    <p>了解如何將語音辨識新增至您的應用程式、工具和產品。 包括概念、教學課程、API 參考和版本資訊。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>語音合成標記語言</h3>
                                                    <p>使用語音合成標記語言來微調音訊輸出的音調、韻律和說話速度。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>閱讀文件</h3>
                                                    <p>了解如何將語音合成新增至您的應用程式、工具和產品。 包括概念、教學課程、API 參考和版本資訊。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#intentrecognition">意圖辨識</a>
                    ...
                    <li>
                        <a href="#speechtranslation">語音翻譯</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>從麥克風進行語音轉換文字的翻譯</h3>
                                                    <p>使用語音 SDK 從麥克風進行語音轉換文字的翻譯。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>閱讀文件</h3>
                                                    <p>了解如何將語音翻譯新增至您的應用程式、工具和產品。 包括概念、教學課程、API 參考和版本資訊。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>與 Bot Framework 整合</h3>
                                                    <p>深入了解 Bot Framework、Direct Line 語音通道等等。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>GitHub 問題</h3>
                                                    <p>瀏覽未解決的問題及/或在 GitHub 上建立語音 SDK 的新問題。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>堆疊溢位</h3>
                                                    <p>在 Stack Overflow 上提出問題，並取得語音服務社群的協助。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#customization">自訂</a>
                <ul id="customization">
                    <li>
                        <a href="#speech-to-text-customization">語音轉換文字</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>以租用戶模型提高精確度</h3>
                                                    <p>使用 Office 365 資料產生自訂模型，為組織專屬的詞彙最佳化語音辨識精確度。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>以自訂語音提高精確度</h3>
                                                    <p>一組線上工具，可讓您針對應用程式、工具和產品評估及提高 Microsoft 的語音轉換文字準確度。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#text-to-speech-customization">文字轉換語音</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 SSML 改善合成</h3>
                                                    <p>使用語音合成標記語言來微調音訊輸出的音調、韻律和說話速度。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用自訂語音改善合成</h3>
                                                    <p>使用您的談話資料，為您的文字轉語音應用程式建置可辨識且獨一無二的語音。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>取得自訂神經語音的存取權</h3>
                                                    <p>這是可讓您建立自訂神經語音的閘門守護式功能。 深入了解存取和限制。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
