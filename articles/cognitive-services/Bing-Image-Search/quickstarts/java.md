---
title: 快速入門：針對 Bing 影像搜尋 API 和 Java 使用 REST API 來傳送搜尋查詢
description: 在本快速入門中，您可以使用 Java 傳送搜尋查詢給 Bing 搜尋 API，以取得相關影像清單。
...
ms.locfileid: "42093868"
---
# <a name="quickstart-send-search-queries-using-the-rest-api-and-java"></a>快速入門：使用 REST API 和 Java 傳送搜尋查詢
