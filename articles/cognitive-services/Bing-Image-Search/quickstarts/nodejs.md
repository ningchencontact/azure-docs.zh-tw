---
title: 呼叫和回應 - Azure 認知服務 Bing 影像搜尋 API 的 Node.js 快速入門 | Microsoft Docs
...
ms.locfileid: "35369930"
---
# <a name="call-and-response-your-first-bing-image-search-query-for-nodejs"></a>呼叫和回應：第一次使用適用於 Node.js 的 Bing 影像搜尋查詢
