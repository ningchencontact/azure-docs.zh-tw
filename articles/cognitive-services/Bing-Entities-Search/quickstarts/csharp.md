---
title: Azure 認知服務 Bing 實體搜尋 API 的 C# 快速入門 | Microsoft Docs
...
---
# <a name="quickstart-for-microsoft-bing-entity-search-api-with-c"></a>搭配使用 Microsoft Bing 實體搜尋 API 與 C# 的快速入門 
<a name="HOLTop"></a>

本文說明如何搭配使用 [Bing 實體搜尋 API](https://docs.microsoft.com/azure/cognitive-services/bing-entities-search/search-the-web) 與 C#。
