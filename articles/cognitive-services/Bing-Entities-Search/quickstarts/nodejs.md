---
title: Azure 認知服務 Bing 實體搜尋 API 的 Node.JS 快速入門 | Microsoft Docs
...
ms.locfileid: "35370154"
---
# <a name="quickstart-for-microsoft-bing-entity-search-api-with-nodejs"></a>搭配使用 Microsoft Bing 實體搜尋 API 與 Node.JS 的快速入門 
<a name="HOLTop"></a>

本文說明如何搭配使用 [Bing 實體搜尋 API](https://docs.microsoft.com/azure/cognitive-services/bing-entities-search/search-the-web) 與 Node.JS。
