---
title: Azure 認知服務，Bing 新聞搜尋 API 的 C# 快速入門 | Microsoft Docs
...
ms.locfileid: "35370158"
---
# <a name="quickstart-for-bing-news-search-api-with-c"></a>Bing 新聞搜尋 API 的 C# 快速入門
...
1. 將 `accessKey` 值取代為對您的訂用帳戶有效的存取金鑰。
1. 執行程式。
