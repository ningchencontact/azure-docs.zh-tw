...
- 已將 `video` 欄位新增至 [NewsArticle](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-news-api-v7-reference#newsarticle) 物件。 `video` 欄位包含與新聞文章相關的影片。 影片是可以內嵌的 \<iframe\>，或是動態縮圖。
