...
![專案遮擋曲線](media/wwise-occlusion-curve.png)
...
![專案障礙物曲線](media/wwise-obstruction-curve.png)
...
![聲場專案混音器外掛程式選項](media/mixer-plugin-global-settings.png)
...
![每一音效混音器設定](media/per-sound-mixer-settings.png)
...
![語音設計指引](media/voice-design-guidelines.png)
...
* **繪製統計資料：** UE 的 `stat Acoustics` 可以提供您 CPU 資訊，此狀態畫面則會在畫面左上角顯示目前載入的地圖、RAM 使用量，以及其他狀態資訊。
...
![音訊元件控制項](media/audio-component-controls.png)
...
![B P 串流](media/blueprint-streaming.png)
...
![串流設定](media/streaming-setup.png)
