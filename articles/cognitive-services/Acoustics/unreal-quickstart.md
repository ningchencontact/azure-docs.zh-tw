...
下載[聲場專案 Unreal + Wwise 範例套件](http://www.microsoft.com/downloads/details.aspx?FamilyID=f03dff5a-5780-462e-87ef-e6d039d0748d) \(英文\)。 範例套件包含 Unreal Engine 專案、適用於該 Unreal 專案的 Wwise 專案，以及聲場專案 Wwise 外掛程式。
...
![Wwise 聲場遊戲 Unreal 專案](media/wwise-acoustics-game-project.png)
