---
title: 表情 API C# 教學課程 | Microsoft Docs
description: 探索使用認知服務表情 API 來辨識影像中臉部表情的基本 Windows 應用程式。
...
ms.locfileid: "35368562"
---
# <a name="emotion-api-in-c35-tutorial"></a>C&#35; 中的表情 API 教學課程
