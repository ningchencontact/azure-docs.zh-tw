...
ms.locfileid: "52160491"
---
# <a name="quickstart-bing-video-search-api-with-c"></a>快速入門：使用 C# 的 Bing 影片搜尋 API

本文說明如何使用屬於 Azure 認知服務的 Bing 影片搜尋 API。 雖然本文是以 C# 部署，但 API 是一種與任何程式語言相容的 RESTful Web 服務，可產生 HTTP 要求，並剖析 JSON。 
