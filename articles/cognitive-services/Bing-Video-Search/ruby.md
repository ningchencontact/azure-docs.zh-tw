...
ms.locfileid: "52165708"
---
# <a name="quickstart-bing-video-search-api-with-ruby"></a>快速入門：使用 Ruby 的 Bing 影片搜尋 API

本文說明如何在 Azure 上使用屬於 Microsoft 認知服務的 Bing 影片搜尋 API。 雖然本文是以 Ruby 部署，但 API 是一種與任何程式語言相容的 RESTful Web 服務，可產生 HTTP 要求，並剖析 JSON。 
