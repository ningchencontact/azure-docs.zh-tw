---
title: Azure 認知服務，Bing 影片搜尋 API 的 Ruby 快速入門 | Microsoft Docs
...
ms.locfileid: "35369946"
---
# <a name="quickstart-for-bing-video-search-api-with-ruby"></a>Bing 影片搜尋 API 的 Ruby 快速入門

本文示範如何在 Azure 上使用屬於 Microsoft 認知服務的 Bing 影片搜尋 API。 雖然本文是以 Ruby 部署，但 API 是一種與任何程式語言相容的 RESTful Web 服務，可產生 HTTP 要求，並剖析 JSON。 

程式碼範例已撰寫為可在 Ruby 2.4 下執行。
