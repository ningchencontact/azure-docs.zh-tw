...
翻譯工具文字 API 是一個 Azure 服務，是由雲端中機器學習和 AI 演算法所組成之 [Azure 認知服務 API 集合](https://docs.microsoft.com/azure/)的一部分，隨時可供在您的開發專案中取用。
...
NMT 提供的翻譯比 SMT 更好的原因，不僅僅是從原始翻譯品質計分的觀點來看，也因為其翻譯聽起來更流暢、更人性化。
這個流暢性的主要原因在於 NMT 使用句子的完整內容來翻譯單字。 SMT 則只採用每個字前後幾個字的緊鄰內容。
...
- [認知服務文件頁面](https://docs.microsoft.com/azure/)
