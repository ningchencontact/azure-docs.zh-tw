...
description: 在本快速入門中，您會在認知服務中使用電腦視覺與 Java，擷取影像中的手寫文字。
...
ms.locfileid: "43750349"
---
# <a name="quickstart-extract-handwritten-text---rest-java"></a>快速入門：擷取手寫文字 - REST、Java
...
成功的回應會以 JSON 的形式傳回。 手寫辨識結果會包含偵測到的區域、線條和字組的文字、週框方塊。
