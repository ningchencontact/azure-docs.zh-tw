---
title: 電腦視覺 API Go 快速入門分析影像 | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: 在本快速入門中，您會在認知服務中使用電腦視覺與 Go，分析影像。
...
ms.locfileid: "43750620"
---
# <a name="quickstart-analyze-a-remote-image---rest-go"></a>快速入門：分析遠端影像 - REST、Go
...
1. 建置檔案，例如：`go build analyze-image.go`。
1. 執行檔案，例如：`analyze-image`。
