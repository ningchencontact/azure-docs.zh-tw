---
title: 電腦視覺 API PHP 快速入門分析影像 | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: 在本快速入門中，您會在認知服務中使用電腦視覺與 PHP，分析影像。
...
ms.locfileid: "43750348"
---
# <a name="quickstart-analyze-a-remote-image---rest-php"></a>快速入門：分析遠端影像 - REST、PHP
...
這個範例會使用 PHP5 [HTTP_Request2](http://pear.php.net/package/HTTP_Request2) 套件。
