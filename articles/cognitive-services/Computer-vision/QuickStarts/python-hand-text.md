---
title: 電腦視覺 Python 快速入門手寫文字 | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: 在本快速入門中，您會在認知服務中使用電腦視覺與 Python，擷取影像中的手寫文字。
...
ms.locfileid: "43750350"
---
# <a name="quickstart-extract-handwritten-text---rest-python"></a>快速入門：擷取手寫文字 - REST、Python
...
## <a name="extract-handwritten-text"></a>擷取手寫的文字
...
下列程式碼會使用 Python `requests` 程式庫，來呼叫電腦視覺分析影像 API。 它會以 JSON 物件的形式傳回結果。 API 金鑰會透過 `headers` 字典傳入。
