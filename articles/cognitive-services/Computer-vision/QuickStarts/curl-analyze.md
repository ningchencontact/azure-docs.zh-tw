---
title: 快速入門：分析遠端影像 - REST、cURL - 電腦視覺
...
ms.locfileid: "45633481"
---
# <a name="quickstart-analyze-a-remote-image-using-the-rest-api-and-curl-in-computer-vision"></a>快速入門：在電腦視覺中使用 REST API 和 cURL 分析遠端影像
