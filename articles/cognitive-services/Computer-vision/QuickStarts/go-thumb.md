...
ms.locfileid: "45629538"
---
# <a name="quickstart-generate-a-thumbnail-using-the-rest-api-and-go-in-computer-vision"></a>快速入門：使用電腦視覺中的 REST API 和 Go 產生縮圖
...
1. 出現提示時，執行已編譯過套件。 例如： `get-thumbnail`。
