...
使用 Maven 或您最愛的組建自動化工具，建立新的 Java 專案。 假設您使用 Maven，請將下列幾行新增至您的[專案物件模型 (POM)](https://maven.apache.org/guides/introduction/introduction-to-the-pom.html) 檔案。 以您的應用程式取代 `mainClass` 的所有執行個體。
