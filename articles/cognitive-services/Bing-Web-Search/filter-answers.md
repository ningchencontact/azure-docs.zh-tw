...
```
您可以使用 [responseFilter](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-web-api-v7-reference#responsefilter) \(英文\) 查詢參數，來篩選將收到的內容類型 (例如影像、影片和新聞)。 如果 Bing 找到指定答案的相關內容，就會傳回它。 回應篩選是以逗號分隔的答案清單。 
