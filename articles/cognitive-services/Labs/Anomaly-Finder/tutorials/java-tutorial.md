---
title: 異常偵測 Java 應用程式 - Microsoft 認知服務 | Microsoft Docs
description: 探索在 Microsoft 認知服務中使用異常偵測 API 的 Java 應用程式。 將原始資料點傳送到 API，並取得預期的值和異常點。
...
ms.locfileid: "38597943"
---
# <a name="anomaly-detection-java-application"></a>異常偵測 Java 應用程式
