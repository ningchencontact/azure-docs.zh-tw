...
[![教學課程 13 預覽](https://aka.ms/cl-tutorial-13-preview)](https://aka.ms/blis-tutorial-13)
...
> [!NOTE]
> 問題輸入，以及按鈕 1 和 2。 這些是卡中的範本參考，您會在其中輸入問題和個別答案。 您也可以參考並使用實體，或參考並使用文字和實體的混合。
