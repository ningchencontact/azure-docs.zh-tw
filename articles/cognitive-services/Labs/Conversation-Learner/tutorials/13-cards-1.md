---
title: 如何搭配對話學習模組應用程式使用卡，第 1 部份 - Microsoft 認知服務 | Microsoft Docs
titleSuffix: Azure
...
請注意，對話學習模組預期您的卡定義檔案位於稱為「cards」的目錄，也就是聊天機器人開始位置的目錄。
...
在 Web UI 的應用程式清單中，按一下 [Tutorial-13-Cards-1]。 

### <a name="the-card"></a>卡

卡的定義位於下列位置：C:\<installedpath\>\src\cards\prompt.json。
...
請注意問題輸入，以及按鈕 1 和 2。 這些是卡中的範本參考，您會在其中輸入問題和個別答案。 您也可以參考並使用實體，或參考並使用文字和實體的混合。
