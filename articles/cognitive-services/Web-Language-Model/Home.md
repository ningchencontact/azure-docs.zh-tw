...
3. 執行 SDK 程式碼範例。
4. 請參閱 [API 參考](http://web.archive.org/web/20170503191852/ https://westus.dev.cognitive.microsoft.com/docs/services/55de9ca4e597ed1fd4e2f104/operations/55de9ca4e597ed19b0de8a51)以取得端點的完整詳細資料，包括各種語言的程式碼片段。
