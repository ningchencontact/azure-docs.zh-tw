...
當您的裝置正在傳送[註冊裝置呼叫](https://docs.microsoft.com/rest/api/iot-dps/runtimeregistration/registerdevice)至 DPS 時。 您可以增強註冊呼叫以接受本文中的其他欄位。 本文看起來如下所示： 
   ```
   { 
