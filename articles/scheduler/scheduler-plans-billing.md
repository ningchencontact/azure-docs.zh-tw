...
如果有 1 到 10 個標準工作集合，則需支付一個標準計費單位。 如果有 11 到 20 個標準工作集合，則需支付兩個標準計費單位。 如果有 21 到 30 個標準工作集合，則需支付三個標準計費單位，依此類推。
...
如果有 1 到 10,000 個進階工作集合，則您將支付一個 P10 進階計費單位。 如果有 10,001 到 20,000 個進階工作集合，則您將支付 2 個 P10 進階計費單位，依此類推。
...
工作集合會永遠作用中，除非您整個訂用帳戶由於計費問題而進入部分暫時停用狀態。 確保作業集合不計費的唯一方法，就是刪除作業集合。
