...
3. 在 [Azure Databricks 服務] 底下，提供值以建立 Databricks 工作區。
    ...
    |定價層     |  選擇 [標準] 或 [進階]。 本教學課程不適用免費試用版的訂用帳戶，因為有配額增加的限制。 如需這些定價層的詳細資訊，請參閱 [Databricks 定價頁面](https://azure.microsoft.com/pricing/details/databricks/)。       |
