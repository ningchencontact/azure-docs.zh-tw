...
當您使用此範本時，不需要執行任何手動允許清單的子網路流量。

### <a name="network-security-groups"></a>網路安全性群組

若要使用現有虛擬網路的必要規則來建立網路安全性群組，請使用[適用於 Databricks VNet Injection 的網路全性群組範本](https://azure.microsoft.com/resources/templates/101-databricks-all-in-one-template-for-vnet-injection/)。
