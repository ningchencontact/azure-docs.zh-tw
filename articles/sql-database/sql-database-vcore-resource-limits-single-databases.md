...
ms.locfileid: "36311152"
---
# <a name="azure-sql-database-vcore-based-purchasing-model-limits-for-a-single-database-preview"></a>適用於單一資料庫的 Azure SQL Database 以虛擬核心為基礎的購買模型限制 (預覽)
