...
擷取自動調整建議的 PowerShell 指令碼會使用[Get AzResource](https://docs.microsoft.com/powershell/module/az.Resources/Get-azResource)並[Get AzSqlDatabaseRecommendedAction](https://docs.microsoft.com/powershell/module/az.Sql/Get-azSqlDatabaseRecommendedAction)命令的 Azure 模組第 4 版及更新版本所需。
