...
- 若要使用 Azure PowerShell 在無伺服器電腦中建立單一資料庫，請參閱[使用 PowerShell 建立無伺服器資料庫](sql-database-serverless.md#create-new-database-in-serverless-compute-tier-using-powershell)