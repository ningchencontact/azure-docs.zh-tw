...
|效能等級|GP_Gen4_1|GP_Gen4_2|GP_Gen4_4|GP_Gen4_8|GP_Gen4_16|
|:--- | --: |--: |--: |--: |--: |
|H/W 產生|4|4|4|4|4|
|虛擬核心|1|2|4|8|16|
|記憶體 (GB)|7|14|28|56|112|
|資料行存放區支援|yes|yes|yes|yes|yes|
|OLTP 記憶體內部儲存體 (GB)|N/A|N/A|N/A|N/A|N/A|
|儲存體類型|進階 (遠端) 儲存體|進階 (遠端) 儲存體|進階 (遠端) 儲存體|進階 (遠端) 儲存體|進階 (遠端) 儲存體|
...
|記錄大小上限|307|307|461|922|1229|
|TempDB 大小 (DB)|32|64|128|256|384|
|目標 IOPS|320|640|1280|2560|5120|
|IO 延遲 (大約)|5-7 毫秒 (寫入)
|並行背景工作 (要求) 數上限|200|400|800|1600|3200|
|並行登入數上限|200|400|800|1600|3200|
|允許的工作階段數上限|3000|3000|3000|3000|3000|
|複本數目|1|1|1|1|1|
...
|記憶體 (GB)|7|14|28|56|112|
|資料行存放區支援|yes|yes|yes|yes|yes|
|OLTP 記憶體內部儲存體 (GB)|1|2|4|8|20|
|儲存體類型|已連結 SSD|已連結 SSD|已連結 SSD|已連結 SSD|已連結 SSD|
|資料大小上限 (GB)|1024|1024|1024|1024|1024|
|記錄大小上限|307|307|307|307|307|
|TempDB 大小 (DB)|32|64|128|256|384|
|目標 IOPS|5000|10000|20000|40000|80000|
...
|允許的工作階段數上限|3000|3000|3000|3000|3000|
|複本數目|3|3|3|3|3|
|多重 AZ|yes|yes|yes|yes|yes|
|讀取向外延展|yes|yes|yes|yes|yes|
|內含備份儲存體|1X DB 大小|1X DB 大小|1X DB 大小|1X DB 大小|1X DB 大小|
|||
...
|OLTP 記憶體內部儲存體 (GB)|N/A|N/A|N/A|N/A|N/A|
|儲存體類型|進階 (遠端) 儲存體|進階 (遠端) 儲存體|進階 (遠端) 儲存體|進階 (遠端) 儲存體|進階 (遠端) 儲存體|
|資料大小上限 (GB)|512|756|1536|2048|3584|
|記錄大小上限|154|227|461|614|1075|
|TempDB 大小 (DB)|32|64|128|256|384|
|目標 IOPS|320|640|1280|2560|5120|
|IO 延遲 (大約)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|
|並行背景工作 (要求) 數上限|210|420|840|1680|3360|
|並行登入數上限|210|420|840|1680|3360|
|允許的工作階段數上限|3000|3000|3000|3000|3000|
|集區密度上限|100|200|500|500|500|
|最小/最大彈性集區點擊停止|0, 0.25, 0.5, 1|0, 0.25, 0.5, 1, 2|0, 0.25, 0.5, 1, 2, 4|0, 0.25, 0.5, 1, 2, 4, 8|0, 0.25, 0.5, 1, 2, 4, 8, 16|
|複本數目|1|1|1|1|1|
|多重 AZ|N/A|N/A|N/A|N/A|N/A|
|讀取向外延展|N/A|N/A|N/A|N/A|N/A|
|內含備份儲存體|1X DB 大小|1X DB 大小|1X DB 大小|1X DB 大小|1X DB 大小|
...
| 每個資料庫的儲存體上限 |使用者為集區中資料庫所設定的資料庫大小上限。 集區資料庫會共用集區儲存體，所以資料庫可以觸達的大小受限於較小的剩餘集區儲存體和資料庫大小。 資料庫大小上限是指資料檔案的大小上限，並不包含記錄檔所使用的空間。 |
|||
