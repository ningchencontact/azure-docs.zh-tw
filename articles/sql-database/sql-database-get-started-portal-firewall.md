...
ms.locfileid: "50913082"
---
# <a name="quickstart-create-a-server-level-firewall-rule-for-your-sql-database-using-the-azure-portal"></a>快速入門：使用 Azure 入口網站建立 SQL Database 的伺服器層級防火牆規則
