---
title: '已編制索引的影片，Azure SaaS SQL 應用程式 '
...
影片詳述以下書面文件中的資訊： 
- *概念：* [多租使用者 SaaS 資料庫租用模式][saas-concept-design-patterns-563e]
...
- [2017的 Blog 文章，5月22日][resource-blog-saas-patterns-app-dev-sql-db-768h]
