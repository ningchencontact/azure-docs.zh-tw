...
|每個集區的並行背景工作角色 (要求) 數上限 *|1680|1890|2100 個|2520|3360|4200|8400|
...
|目標 IOPS (64 KB)|10000|15000|20000|25000|30000|
|對數速率限制（MBps）|20|30|40|50|60|
|每個集區的並行背景工作角色 (要求) 數上限 *|420|630|840|1050|1260|
...
|虛擬核心|4|6|8|10|12|14|
|記憶體 (GB)|20.4|30.6|40.8|51|61.2|71.4|
|每個集區的最大 DB 數|100|100|100|100|100|100|
|資料行存放區支援|是|是|是|是|是|是|
|OLTP 記憶體內部儲存體 (GB)|3.142|4.713|6.284|8.655|11.026|13.397|
|資料大小上限 (GB)|1024|1536|1536|1536|3072|3072|
|記錄大小上限 (GB)|307|307|461|461|922|922|
|TempDB 大小 (GB)|128|192|256|320|384|384|
|儲存體類型|本機 SSD|本機 SSD|本機 SSD|本機 SSD|本機 SSD|本機 SSD|
|IO 延遲 (大約)|1-2 毫秒 (寫入)<br>1-2 毫秒 (讀取)|1-2 毫秒 (寫入)<br>1-2 毫秒 (讀取)|1-2 毫秒 (寫入)<br>1-2 毫秒 (讀取)|1-2 毫秒 (寫入)<br>1-2 毫秒 (讀取)|1-2 毫秒 (寫入)<br>1-2 毫秒 (讀取)|1-2 毫秒 (寫入)<br>1-2 毫秒 (讀取)|
|目標 IOPS (64 KB)|10000|15000|20000|25000|30000|35000|
|對數速率限制（MBps）|30|45|60|75|90|105|
|每個集區的並行背景工作角色 (要求) 數上限 *|420|630|840|1050|1260|1470|
