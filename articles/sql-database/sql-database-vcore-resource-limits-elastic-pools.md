...
|每個集區的最大並行登入 * |210|420|630|840|1050|1260|
...
|記錄檔的速率限制 (MBps)|2.5|5.6|7.5|10|12.5|15|17.5|
|每個集區的並行背景工作角色 (要求) 數上限 *|210|420|630|840|1050|1260|1470|
|每個集區 （要求） 的最大並行登入 *|210|420|630|840|1050|1260|1470|
...
|每個集區 （要求） 的最大並行登入 *|1680|1890|2100|2520|33600|4200|8400|
...
|記錄檔的速率限制 (MBps)|7.5|15|22.5|30|37.5|45|
|每個集區的並行背景工作角色 (要求) 數上限 *|210|420|630|840|1050|1260|
|每個集區 （要求） 的最大並行登入 *|210|420|630|840|1050|1260|
|允許的工作階段數上限|30000|30000|30000|30000|30000|30000|
...
|記錄檔的速率限制 (MBps)|52.5|60|67.5|75|80|80|
|每個集區的並行背景工作角色 (要求) 數上限 *|1470|1680|1890|2100|3360|5040|
|每個集區 （要求） 的最大並行登入 *|1470|1680|1890|2100|3360|5040|
|允許的工作階段數上限|30000|30000|30000|30000|30000|30000|
...
|記錄檔的速率限制 (MBps)|7.5|15|22.5|30|37.5|45|52.5|
|每個集區的並行背景工作角色 (要求) 數上限 *|210|420|630|840|1050|1260|1470|
|每個集區 （要求） 的最大並行登入 *|210|420|630|840|1050|1260|1470|
|允許的工作階段數上限|30000|30000|30000|30000|30000|30000|30000|
...
|記錄檔的速率限制 (MBps)|60|67.5|75|90|120|120|120|
|每個集區的並行背景工作角色 (要求) 數上限 *|1680|1890|2100|2520|3360|4200|8400|
|每個集區 （要求） 的最大並行登入 *|1680|1890|2100|2520|3360|4200|8400|
|允許的工作階段數上限|30000|30000|30000|30000|30000|30000|30000|
