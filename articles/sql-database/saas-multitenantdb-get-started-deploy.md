...
任何人都可以C#從[GitHub 存放庫][link-github-wingtip-multitenantdb-55g]下載 Wingtip 票證的和 PowerShell 原始程式碼。
...
1. 按一下以下藍色的 [部署至 Azure] 按鈕。
   - 它會開啟 Azure 入口網站以及 Wingtip Tickets SaaS 部署範本。
     ...
     [![按鈕以部署至 Azure。][image-deploy-to-azure-blue-48d]][link-aka-ms-deploywtp-mtapp-52k]
