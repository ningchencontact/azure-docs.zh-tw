...
* [搜尋 Microsoft Azure 相關文件](https://azure.microsoft.com/search/documentation/)
* [檢視 Azure SQL Database 服務的最新更新](https://azure.microsoft.com/updates/?service=sql-database)
