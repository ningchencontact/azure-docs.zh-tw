---
title: 業務關鍵層-Azure SQL Database 服務
...
-   大量更新–插入、更新和刪除作業會修改記憶體中的資料頁（中途分頁），而這些頁面必須以 `CHECKPOINT` 作業的方式儲存到資料檔案中。 可能是資料庫引擎進程損毀，或具有大量中途分頁的資料庫容錯移轉，可能會增加一般用途層的復原時間。 如果您的工作負載會導致許多記憶體中的變更，請使用「業務關鍵層」。 
