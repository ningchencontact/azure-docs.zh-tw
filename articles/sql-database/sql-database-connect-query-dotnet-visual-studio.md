...
ms.locfileid: "50911756"
---
# <a name="quickstart-use-net-c-with-visual-studio-to-connect-and-query-an-azure-sql-database"></a>快速入門：使用 .NET (C#) 搭配 Visual Studio 連線及查詢 Azure SQL Database
