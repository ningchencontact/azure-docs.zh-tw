...
使用 Azure PowerShell，在現有 Azure SQL Server 與 Azure 區域的新空白 Azure SQL Server 之間建立[容錯移轉群組](sql-database-auto-failover-group.md)，然後將範例資料庫新增到容錯移轉群組。
