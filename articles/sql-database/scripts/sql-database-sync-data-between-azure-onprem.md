---
title: PowerShell 範例 - 在內部部署的 SQL Database 和 SQL Server 之間進行同步處理 | Microsoft Docs
...
| [New-AzSqlSyncMember](/powershell/module/az.sql/New-azSqlSyncMember) |  在同步群組中新增成員 |
...
-   更新同步結構描述
    ...
    -   使用 PowerShell - [使用 PowerShell 更新現有同步群組中的同步結構描述](sql-database-sync-update-schema.md)
