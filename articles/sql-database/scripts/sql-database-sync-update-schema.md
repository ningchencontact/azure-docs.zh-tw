---
title: PowerShell 範例 - 更新 SQL 資料同步的同步結構描述
...
您可以在 [Azure SQL 資料庫 PowerShell 指令碼](../sql-database-powershell-samples.md)中找到其他 SQL 資料庫 PowerShell 指令碼範例。
