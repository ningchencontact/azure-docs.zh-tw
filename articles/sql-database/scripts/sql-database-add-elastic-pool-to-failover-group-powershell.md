---
title: PowerShell 範例 - 容錯移轉群組 - Azure SQL Database 彈性集區
description: Azure PowerShell 範例指令碼，用以建立 Azure SQL Database 彈性集區、將其新增至容錯移轉群組，以及測試容錯移轉。
...
ms.locfileid: "73691799"
---
# <a name="use-powershell-to-add-an-azure-sql-database-elastic-pool-to-a-failover-group"></a>使用 PowerShell 將 Azure SQL Database 彈性集區新增至容錯移轉群組 

此 PowerShell 指令碼範例會建立單一資料庫、將其新增至彈性集區、建立容錯移轉群組，以及測試容錯移轉。 
