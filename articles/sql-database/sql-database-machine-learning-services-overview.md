...
除了預先安裝的套件，您可以[安裝其他套件](sql-database-machine-learning-services-add-r-packages.md)。
...
- 請參閱[的主要差異，從 SQL Server Machine Learning 服務](sql-database-machine-learning-services-differences.md)。
