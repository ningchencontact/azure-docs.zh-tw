...
- [我看到下列錯誤訊息：“无法在列 \<column> 中插入 NULL 值。資料行不允許 Null。」這是什麼意思，該如何修正？](#sync-nulls)
...
### <a name="sync-nulls"></a> 我看到下列錯誤訊息：“无法在列 \<column> 中插入 NULL 值。 資料行不允許 Null。」 這是什麼意思，該如何修正？ 
