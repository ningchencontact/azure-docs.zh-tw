...
| [彈性集區](sql-database-elastic-pool.md) | yes | 內建 - 單一「受控執行個體」可以有共用相同資源集區的多個資料庫 |
...
| [透明資料加密 (TDE)](https://docs.microsoft.com/sql/relational-databases/security/encryption/transparent-data-encryption-tde) | yes | 部分，僅限於服務管理加密 |
