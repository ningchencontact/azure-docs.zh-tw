...
ms.locfileid: "39257560"
---
# <a name="create-an-azure-dns-private-zone-using-azure-cli"></a>使用 Azure CLI 建立 Azure DNS 私人區域

本教學課程將逐步引導您使用 Azure CLI 來建立第一個私人 DNS 區域和第一筆記錄。
