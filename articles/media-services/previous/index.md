---
title: Azure 媒體服務文件 - 教學課程和 API 參考 | Microsoft Docs
...
ms.locfileid: "55979661"
---
# <a name="media-services-documentation-legacy"></a>媒體服務文件 (舊版)
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>利用 Azure 入口網站開始使用 Azure 媒體服務</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Azure 入口網站建立 Azure 媒體服務帳戶</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>命令列</h3>
                        <p><a href="https://docs.microsoft.com/azure/azure-resource-manager/powershell-azure-resource-manager">PowerShell (資源管理員)</a></p>
                        <p><a href="https://docs.microsoft.com/powershell/azure/servicemanagement/install-azure-ps?view=azuresmps-4.0.0">PowerShell (服務管理)</a></p>
                    </div>
                </div>
            </div>
        </div>
