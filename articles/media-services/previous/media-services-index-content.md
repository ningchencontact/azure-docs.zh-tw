...
會產生 (與成功工作) 相同的輸出。 您可以參閱輸出資訊清單檔，根據 Error 欄位值找出哪些輸入檔案失敗。 對於失敗的輸入檔，將不會產生產生的 TTML、WebVTT 及關鍵字檔案。
...
| 3000 |無法解碼媒體檔案 |不支援的媒體轉碼器 <br/>或<br/> 損毀的媒體檔案 <br/>或<br/> 輸入媒體中沒有音訊串流。 |
