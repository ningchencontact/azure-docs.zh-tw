...
| Name | 類型 | 說明 |
| --- | --- | --- |
| **Id**<br/><br/> minInclusive ="0"<br/><br/> 必要 |**xs:int** |此視訊播放軌之以零為起始的索引。**附註：** 此**識別碼**不一定是用於 MP4 檔案中的 TrackID。 |
...
| Name | 類型 | 說明 |
| --- | --- | --- |
| **Id**<br/><br/> minInclusive ="0"<br/><br/> 必要 |**xs:int** |此音訊播放軌之以零為起始的索引。**附註：** 這不一定是用於 MP4 檔案中的 TrackID。 |
