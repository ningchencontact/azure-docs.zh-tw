...
description: 本主題概述 Azure 媒體服務媒體索引子的工作預設值。
...
|功能<br/><br/>在 1.2 版中新增。 目前唯一支援的功能是語音辨識 ("ASR")。|false|語音辨識功能具有下列設定索引鍵︰<br/><br/>Language:<br/>- 要在多媒體檔案中辨識的自然語言。<br/>- 英文、西班牙文<br/><br/>CaptionFormats：<br/>- 所需輸出字幕格式的分號分隔清單 (如果有的話)<br/>-ttml; webvtt<br/><br/><br/>GenerateKeywords：<br/>- 布林值旗標，用於指定是否需要關鍵字 XML 檔案。<br/>- True 或 False。|
