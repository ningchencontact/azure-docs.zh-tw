...
| timescale          | Number         | 選用      | 必須是父代播放軌的時幅。                                                                                                                                                                                                                      |
...
| **屬性名稱** | **類型**                | **必要？** | **說明**                                                                                                                                                                                                                                                                                   |
|--------------------|-------------------------|---------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| scheme_id_uri      | 字串                  | 必要項      | 識別訊息的配置。 配置是設定為即時伺服器資訊清單方塊中 Scheme 屬性的值。 值應該是可識別訊息配置的 URN 或 URL；例如 “urn:scte:scte35:2013a:bin”。                                                                |
...
| Event 元素值 | 字串                  | 必要項      | 以 base64 字串表示的事件訊息，如 [IETF RFC 4648](https://tools.ietf.org/html/rfc4648) 中所述。                                                                                                                   |
...
| **欄位名稱**          | **欄位類型**          | **必要？** | **說明**                                                                                                                                                                                                                                                                                                                                                    |
|-------------------------|-------------------------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| scheme_id_uri           | 字串                  | 必要項      | 識別訊息的配置。 配置是設定為即時伺服器資訊清單方塊中 Scheme 屬性的值。 該值應該是可識別訊息配置的 URN 或 URL。 針對 [SCTE-35] 訊息，這會接受特殊值 “urn:scte:scte35:2013a:bin”，雖然 [SCTE-67] 建議其他項目。 |
| 值                   | 字串                  | 必要項      | 由配置擁有者用來自訂訊息語意的額外字串值。 若要區分具有相同配置的多個事件串流，值必須設定為事件串流的名稱 (適用於 Smooth 內嵌的 trackName，或適用於 RTMP 內嵌的 AMF 訊息名稱)。                                                                  |
| Timescale               | 32 位元不帶正負號的整數 | 必要項      | ‘emsg’ 方塊內時間與持續時間的時幅 (以每秒滴答數表示)。                                                                                                                                                                                                                                                                        |
