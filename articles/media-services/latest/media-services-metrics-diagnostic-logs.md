...
如需詳細概觀，請參閱[Azure 監視器計量](../../azure-monitor/platform/data-collection.md)並[Azure 監視器診斷記錄](../../azure-monitor/platform/diagnostic-logs-overview.md)。
