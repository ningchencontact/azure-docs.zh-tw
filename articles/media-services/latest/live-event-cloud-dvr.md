---
title: 使用 Azure 媒體服務時間轉移和即時至 VOD （隨選影片） |Microsoft Docs
...
ms.locfileid: "71338849"
---
# <a name="using-time-shifting-and-live-to-vod-video-on-demand"></a>使用時間轉移和即時至 VOD （隨選影片）
