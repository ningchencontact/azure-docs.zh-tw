...
ms.locfileid: "61466743"
---
# <a name="transforms-and-jobs"></a>轉換與工作

本主題提供有關的詳細資料[轉換](https://docs.microsoft.com/rest/api/media/transforms)並[作業](https://docs.microsoft.com/rest/api/media/jobs)，並說明這些實體之間的關聯性。 下列圖表顯示轉換/作業工作流程。
