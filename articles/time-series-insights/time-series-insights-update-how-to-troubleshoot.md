...
ms.locfileid: "68883326"
---
# <a name="diagnose-and-troubleshoot"></a>診斷和疑難排解

本文摘要說明使用 Azure 時間序列深入解析預覽環境時，可能會遇到的幾個常見問題。 文章中也會描述每個問題的可能發生原因和解決方案。

## <a name="problem-i-cant-find-my-environment-in-the-preview-explorer"></a>問題：在預覽 explorer 中找不到我的環境
...
- 事件來源索引鍵遺漏必要的權限。
  ...
  * 針對事件中樞，您必須提供具有「接聽」權限的索引鍵。
    ...
    [![無權](media/v2-update-diagnose-and-troubleshoot/permissions.png)](media/v2-update-diagnose-and-troubleshoot/permissions.png#lightbox)
