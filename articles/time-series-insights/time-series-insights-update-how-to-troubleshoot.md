...
## <a name="problem-i-cant-find-my-environment-in-the-preview-explorer"></a>問題：我找不到我的環境中 [總管] 中預覽
...
## <a name="problem-no-data-is-seen-in-the-preview-explorer"></a>問題: [總管] 中預覽中，會不看到任何資料
...
- 事件來源可能沒有接收資料。
    ...
    [![儀表板深入解析](media/v2-update-diagnose-and-troubleshoot/dashboard-insights.png)](media/v2-update-diagnose-and-troubleshoot/dashboard-insights.png#lightbox)
...
## <a name="problem-some-data-shows-but-some-is-missing"></a>問題： 某些資料顯示，但有部分已遺失
...
## <a name="problem-my-event-sources-timestamp-property-name-doesnt-work"></a>問題： 我的事件來源時間戳記屬性名稱無法運作
...
## <a name="problem-i-cant-view-or-edit-my-time-series-model"></a>問題：我無法檢視或編輯我的時間序列模型
...
## <a name="problem-all-my-instances-in-the-preview-explorer-lack-a-parent"></a>問題： 我在預覽檔案總管 中的所有執行個體沒有父代
