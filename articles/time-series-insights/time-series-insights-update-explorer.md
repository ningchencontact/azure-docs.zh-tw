...
這會顯示實例欄位, 以及與所選時間序列深入解析實例相關聯的其他中繼資料。 藉由選取右側的核取方塊, 您可以隱藏或顯示目前圖表中的特定實例。 您也可以選取專案左側的紅色 [**刪除**] (垃圾桶) 控制項, 從目前的資料中移除特定的資料元素。
  ...
  [![預覽良好](media/v2-update-explorer/explorer-five.png)](media/v2-update-explorer/explorer-five.png#lightbox)
...
1. **Web 控制項的日期範圍**:有了這個 web 控制項, 您就可以輕鬆地選取您想要的日期和時間範圍。 您也可以使用控制項切換不同的時區。 將變更套用至目前的工作區之後, 請選取 [**儲存**]。
   ...
   [![從選取面板到和](media/v2-update-explorer/explorer-thirteen.png)](media/v2-update-explorer/explorer-thirteen.png#lightbox)
...
若要選取新的主題, 請選取位於右上角的設定檔圖示。 然後, 選取 [**變更主題**]。
  ...
  [![主題選取專案](media/v2-update-explorer/theme-selection.png)](media/v2-update-explorer/theme-selection.png#lightbox)
