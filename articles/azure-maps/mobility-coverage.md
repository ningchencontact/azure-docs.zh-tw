---
title: Azure 地圖服務中的流動性涵蓋範圍 |Microsoft Docs
description: 深入了解 Azure 地圖服務中的流動性涵蓋範圍
author: walsehgal
ms.author: v-musehg
ms.date: 06/05/2019
ms.topic: conceptual
...
Azure 地圖服務[行動服務](https://aka.ms/AzureMapsMobilityService)為公用的傳輸、 自行車共用，以及路由與 multimodal scooter 共用的車程計劃的選項，可讓功能。 公開傳輸，此服務會提供搜尋附近的站台，就會停止，和程式行，並提供資訊，例如排定和即時的公用傳輸抵達的停駐點和路由指南，以及詳細的多樣式逐步路線清單和服務會發出警示。 行動服務也會傳回即時和汽車靜態的可用性資訊共用和共用的自行車與 scooters。

Azure 地圖服務並沒有相同的層級資訊 」 和 「 所有城市和國家/地區的精確度。 呼叫傳輸資料的能力取決於縣 （市） 以及資料可能不包含所有公用的傳輸選項和機關做縣 （市）。

下表提供 Azure Maps 行動服務的涵蓋範圍資訊。
...
| 國家/區域 |  城市 （Metro 區域） |
|----------------|---------|
| 阿根廷       | <p>Bahía 蘭加灣、 布宜諾斯艾利斯，橄欖灣、 Chivilcoy、 Comodoro Rivadavia、 科多巴、 Corrientes、 一般 Pico、 La Rioja、 Mar del Plata，門多薩、 Miramar、 Neuquén、 Oberá、 Olavarría、 Paraná、 Posadas、 Rio Tercero、 Rosario、 Salta、 San Carlos de Bariloche、 San LuisSan Pedro，聖塔非、 Tandil、 Ushuaia，維多利亞，比 María</p>|
| 巴貝多       |  巴貝多 * |
| 巴西         | <p>Angra dos Reis Anápolis、 Apucarana、 Aracaju、 Araraquara、 Araxa、 Araçatuba、 Bage、 Barretos、 Bauru、 貝倫、 好景、 Blumenau、 博阿維斯、 東北部、 Caldas Novas、 Campina 大杯摩卡咖啡，Campinas、 campo 的相關資訊的下列、 格蘭德營、 Caraguatatuba、 Cascavel、 Cataguases，Leopoldina e Região，Catalão，Caxias 索、 Chapecó、 Cianorte、 Conselheiro Lafaiete、 Corumbá、 Criciúma，克魯薩多執行索、 Cuiabá、 Curitiba、 Curitibanos、 Curvelo、 Diamantina、 Divinópolis、 Dourados、 Estrela、 Fernando 諾羅尼亞、 Florianópolis、 福塔力沙，Foz Iguaçu、 通用語言、 Garanhuns、 Goiania、 Governador Valadares、 Guarapuava、 Imperatriz、 Ipatinga、 Irati、 Itabira、 Itabuna、 Itajaí、 Ituiutaba，Jaraguá 執行索、 菲 Pessoa、 Joinville、 Juazeiro do Norte、 Juiz de Fora、 Jundiaí、 Lages、 Londrina、 Macapa、 Macaé，Maceió，Mafra e Rio Negro 瑪瑙斯，Manhuacu、 Maringá、 Marília、 Monte Carmelo、 Montes Claros、 Mossoró、 Natal、 Osorio、 Ourinhos、 Ouro Preto、 Palmas、 Paracatu、 Parnaíba、 Passo Fundo，Passos，Patos de 米、 Patrocínio、 Pelotas、 Piracicaba、 Poco de Caldas、 蓬塔格羅薩、 韋 Alegre、 韋 Ferreira、 韋 Seguro、 韋柳港，Praia 大杯摩卡咖啡、 累西腓、 Ribeirão Preto、 Rio 里, 約布蘭科、 Rondonópolis、 Salinas、 薩爾瓦多、 克魯茲執行索，聖馬利亞、 Santa Rita 執行 Sapucaí，Santarem、 環境、 聖保羅 Gabriel 執行 Oeste，聖多美菲 del ReiTiradentes e Regiao、 聖保羅 Jose 執行 Rio Preto、 聖保羅 Mateus、 聖保羅、 Sorocaba，聖多美 Carlos、 聖多美 Francisco 執行索，聖多美 José dos Campos、 聖多美 Lourenço、 聖多美 Luís、 Taubaté、 Telemaco Borba、 Teofilo Otoni、 Teresina、 托、 Três Lagoas、 Tucurui、 Ubatuba，Uberaba，Uberlândia、 Ubá、 Uruguaiana、 Varginha、 Vicosa、 Videira & Fraiburgo、 Vitória、 Vitória da Conquista、 Volta Redonda、 Votuporanga </p>|
| 加拿大 | Banff (AB)、 Brandon (MB)、 Calgary (AB)、 Comox Valley (BC)、 Cowichan Valley (BC)、 艾德蒙頓 (AB)、 Fort St.John、 Fredericton) (NB)、 大於 Sudbury (ON)、 大於溫哥華 (BC)、 哈利法克斯 (NS)、 坎路普斯 (BC)、 Kelowna (BC)、 Kingston (ON)、 （開啟），倫敦 Moncton (NB)，蒙特婁 (QC)、 Nanaimo (BC)、 渥太華 (ON)、 Prince George (BC)、 Québec 縣 （市） (QC)、 紅色鹿 (AB)、 雷吉納 (SK)、 Rimouski (QC)，薩克屯 (SK)、 Sherbrooke (QC)、 Squamish (BC)、 聖約翰 (NL)、 黃金海岸、 雷槽 (ON)、 多倫多 （開啟），維多利亞 (BC)、 惠斯勒 (BC)，(ON) Windsor、 Woodstock 溫尼柏 (MB)</p>|
| 智利  | <p>Antofagasta、 Arica、 Aysén、 Chillán、 Concepción、 Constitución、 Copiapó、 Curicó、 Iquique、 La Serena y Coquimbo、 Linares、 Los Angeles （智利）、 Los 拉哥斯，蓬塔阿雷納斯、 Rancagua、 聖地牙哥、 Talca、 Temuco、 Valdivia、 瓦爾帕萊索，Viña del Mar</p>|
| 哥倫比亞 | <p>巴蘭幾亞、 Bogot、 Bucaramanga、 Cali、 Cartagena、 Ibagué、 Medellín、 Pasto、 Popayán、 聖馬塔、 Sincelejo、 Valledupar</p>|  
| 哥斯大黎加 | San José|
| 厄瓜多 | Cuenca，圭亞基爾，Manta|
| 墨西哥 | Aguascalientes，墨西哥城，Guadalajara、 Lion、 Merida，蒙特利、 普埃布拉，奎雷塔洛，聖路易斯波|
| 尼加拉瓜 | 馬納瓜 | 
| Panamá | Panamá *| 
| 祕魯 | Cusco 利馬 |
| 波多黎各 | 聖胡安 |
...
| 國家/區域 |  城市 （Metro 區域） |
|--------|---------|
| 澳大利亞      | <p>阿得雷德，Alice Springs、 Bowen、 布里斯本、 Bundaberg QLD、 Burnie、 Cairns、 坎培拉、 達爾文、 Gladstone、 荷巴特、 Innisfail、 Launceston、 Mackay、 磁性島、 Maryborough Hervey 槽、 墨爾本、 新南威爾斯、 伯斯、 RockHampton、 中南部東部昆士蘭，雪梨、 Toowoomba、 Townsville，維多利亞，Warwick、 Yeppoon</p> |
| 中國 | <p> Changchun、 Changsha、 Chengdu，重慶，Dalian、 Datong、 Dongguan、 Hangzhou、 Jiangyin、 Jinan、 南京、 Nantong、 Ningbo、 Pingdingshan、 Qingdao、 Shenyang、 Suzhou、 Tangshan、 Tianjin、 Weifang、 Wuhan、 Wuxi、 Yantai、 Yixing、 Zhuhai、 上海、 北京，Guangzhou，Shenzhen，Zhengzhou</P>| 
| 香港特別行政區 | 香港特別行政區 *|
| 澳門 | 澳門特別行政區 *|
| 印度 | Ahmedabad, Bengaluru, Delhi, Mumbai, Mysuru|
| 印尼 | 萬隆、 Banyuwangi、 巴丹島、 鄧、 雅加達、 Kediri、 Malang、 Palembang、 Semarang、 Surabaya、 Surakarta、 Yogyakarta |
| 日本 | Shizuoka 縣、 東京、 Wakkanai Yamanashi 府 |
...
| 比利時        | 比利時 * |
| 玻利維亞        | La Paz, Santa Cruz de la Sierra | 
| 波士尼亞赫塞哥維納 | 塞拉耶佛 | 
| 保加利亞       | <p>Balchik、 Blagoevgrad、 Burgas、 Dobrich、 Gabrovo、 Haskovo、 Kardzhali、 Lovech、 Nessebar、 Pazardzhik、 Pleven、 Plovdiv、 詭計、 Shumen、 Sliven、 Stara Zagora、 Vratsa、 Yambol、 Varna、 Veliko、 索菲亞</P> |
| 克羅埃西亞 | Crikvenica Dubrovnik、 Rijeka、 Slovanski Brod 札格雷布 | 
| 賽浦路斯 | Larnaca，Limassol，尼古西亞 | 
| 捷克共和國 | Brno、 Jablonec Karlovy 不盡相同，Liberec，Ostrava 布拉格 | 
| 丹麥   | 丹麥 * |
| 愛沙尼亞   | 愛沙尼亞 * |   
