...
| Icon Number |圖示| 天 | Night | 文字 |
|-------------|:----:|-----|-------|------|
| 1           |![](./media/weather-services-concepts/sunny-i.png)                      | 是 |  否    | 晴朗|
| 2           |![](./media/weather-services-concepts/mostly-sunny.png)                | 是 |  否    | Mostly Sunny|
| 3           |![](./media/weather-services-concepts/partly-sunny.png)                | 是 |  否    | Partly Sunny|
| 4           |![](./media/weather-services-concepts/intermittent-clouds.png)         | 是 |  否    | Intermittent Clouds|
| 5           |![](./media/weather-services-concepts/hazy-sunshine.png)               | 是 |  否    | Hazy Sunshine |
| 6           |![](./media/weather-services-concepts/mostly-cloudy.png)               | 是 |  否    | Mostly Cloudy|
| 7           |![](./media/weather-services-concepts/cloudy-i.png)                     | 是 |  是   | Cloudy |
| 8           |![](./media/weather-services-concepts/dreary-overcast.png)             | 是 |  是   | Dreary (Overcast)|
| 11           |![](./media/weather-services-concepts/fog-i.png)                       | 是 |  是   | Fog|
| 12           |![](./media/weather-services-concepts/showers-i.png)                   | 是 |  是   | Showers|
| 13           |![](./media/weather-services-concepts/mostly-cloudy-showers.png)       | 是 |  否    | Mostly Cloudy with Showers|
| 14           |![](./media/weather-services-concepts/partly-sunny-showers.png)        | 是 |  否    | Partly Sunny with Showers|
| 15           |![](./media/weather-services-concepts/tstorms-i.png)                   | 是 |  是   | Thunderstorms|
| 16           |![](./media/weather-services-concepts/mostly-cloudy-tstorms.png)       | 是 |  否    | Mostly Cloudy with Thunderstorms|
| 17           |![](./media/weather-services-concepts/partly-sunny-tstorms.png)        | 是 |  否    | Partly Sunny with Thunderstorms|
| 18           |![](./media/weather-services-concepts/rain-i.png)                      | 是 |  是   | 雨|
| 19           |![](./media/weather-services-concepts/flurries-i.png)                  | 是 |  是   | Flurries|
| 20           |![](./media/weather-services-concepts/mostly-cloudy-flurries.png)      | 是 |  否    | Mostly Cloudy with Flurries|
| 21           |![](./media/weather-services-concepts/partly-sunny-flurries.png)       | 是 |  否    | Partly Sunny with Flurries|
| 22           |![](./media/weather-services-concepts/snow-i.png)                      | 是 |  是   | Snow|
| 23           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | 是 |  否    | Mostly Cloudy with Snow|
| 24           |![](./media/weather-services-concepts/ice-i.png)                       | 是 |  是   | Ice |
| 25           |![](./media/weather-services-concepts/sleet-i.png)                     | 是 |  是   | Sleet|
| 26           |![](./media/weather-services-concepts/freezing-rain.png)              | 是 |  是   | Freezing Rain|
| 29           |![](./media/weather-services-concepts/rain-snow.png)                  | 是 |  是   | Rain and Snow|
...
| 34           |![](./media/weather-services-concepts/mostly-clear-night.png)          | 否  |  是   | Mostly Clear|
| 35           |![](./media/weather-services-concepts/partly-cloudy-night.png)         | 否  |  是   | Partly Cloudy|
| 36           |![](./media/weather-services-concepts/intermittent-clouds-Night.png)   | 否  |  是   | Intermittent Clouds|
| 37           |![](./media/weather-services-concepts/hazymoon-light.png)             | 否  |  是   | Hazy Moonlight|
| 38           |![](./media/weather-services-concepts/mostly-cloudy-night.png)         | 否  |  是   | Mostly Cloudy|
| 39           |![](./media/weather-services-concepts/partly-cloudy-showers-night.png)  | 否  |  是   | Partly Cloudy with Showers|
| 40           |![](./media/weather-services-concepts/mostly-cloudy-showers-night.png)  | 否  |  是   | Mostly Cloudy with Showers|
| 41           |![](./media/weather-services-concepts/partly-cloudy-tstorms-night.png)  | 否  |  是   | Partly Cloudy with Thunderstorms|
| 42           |![](./media/weather-services-concepts/mostly-cloudy-tstorms-night.png)  | 否  |  是   | Mostly Cloudy with Thunderstorms|
| 43           |![](./media/weather-services-concepts/mostly-cloudy-flurries-night.png) | 否  |  是   | Mostly Cloudy with Flurries|
| 44           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | 否  |  是   | Mostly Cloudy with Snow|
