---
title: 在 Windows VM 上針對 Azure Resource Manager 部署中的儲存體資源刪除錯誤進行疑難排解 | Microsoft Docs
...
Azure VM 中使用的 VHD 是以分頁 Blob 形式儲存在 Azure 標準或進階儲存體帳戶中的 .vhd 檔案。 如需有關 Azure 磁碟的詳細資訊，請參閱[關於 Microsoft Azure Windows VM 的未受控與受控磁碟儲存體](about-disks-and-vhds.md)。 
