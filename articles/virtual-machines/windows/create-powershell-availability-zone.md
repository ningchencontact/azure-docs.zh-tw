---
title: 建立分區的 Windows VM-Azure PowerShell
...
這些資源用來提供虛擬機器的網路連線能力，並可將它連線到網際網路。 在此範例的 2中，在 [可用性] 區域中建立 IP 位址。 在稍後步驟中，您會在用於建立 IP 位址的相同區域中建立 VM。
