...
* 深入了解 [DSC 的安全認證管理](extensions-dsc-credentials.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。
* 取得 [Azure DSC 延伸模組處理常式簡介](extensions-dsc-overview.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。
