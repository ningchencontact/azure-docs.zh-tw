...
### <a name="naming"></a>命名
虛擬機器指派一個[名稱](/azure/architecture/best-practices/resource-naming)給它，而它設定一個電腦名稱作為作業系統的一部分。 VM 的名稱最多可為 15 個字元。
