...
- 本文需要 AzureRM 模組 5.6 版或更新版本。 執行 ` Get-Module -ListAvailable AzureRM.Compute` 來尋找您的版本。 如果您需要升級，請參閱[安裝 Azure PowerShell 模組](/powershell/azure/azurerm/install-azurerm-ps)。
