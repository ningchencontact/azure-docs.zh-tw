...
本文會在[Azure Cloud Shell](https://docs.microsoft.com/azure/cloud-shell/overview)內使用 PowerShell，這會持續更新為最新版本。 若要開啟 Cloud Shell，請選取任何程式碼區塊頂端的 [**試用**]。
