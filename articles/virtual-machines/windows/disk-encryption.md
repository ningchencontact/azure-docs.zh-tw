...
- 支援大小為2080的「[軟」和「硬性」 RSA 金鑰](../../key-vault/about-keys-secrets-and-certificates.md#keys-and-key-types)。

目前，我們也有下列限制：

- **僅適用于美國中西部、美國中南部、美國東部2、美國東部、美國西部2、加拿大中部和北歐。**
...
- 如果您使用 Azure 入口網站來建立磁片加密集，則目前無法使用快照。
