---
title: 建立自訂 Windows 虛擬機器 | Microsoft Docs
description: 了解如何使用傳統的部署模型從 Azure 入口網站建立自訂 Windows 虛擬機器。
...
ms.locfileid: "30918514"
---
# <a name="create-a-custom-virtual-machine-running-windows-using-the-classic-deployment-model"></a>使用傳統部署模型建立執行 Windows 的自訂虛擬機器
> [!IMPORTANT]
...
您也可以[建立執行 Linux 的自訂虛擬機器](../../linux/classic/createportal-classic.md)。
