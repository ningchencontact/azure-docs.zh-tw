...
### <a name="create-a-key-vault-with-azure-cli"></a>使用 Azure CLI 建立金鑰保存庫
...
### <a name="create-a-key-vault-with-a-resource-manager-template"></a>使用 Resource Manager 範本建立金鑰保存庫
...
### <a name="set-up-an-azure-ad-app-and-service-principal-though-the-azure-portal"></a>設定 Azure AD 應用程式和服務主體，但 Azure 入口網站
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-cli"></a>使用 Azure CLI 設定 Azure AD 應用程式的金鑰保存庫存取原則
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-the-portal"></a>使用入口網站設定 Azure AD 應用程式的金鑰保存庫存取原則
...
### <a name="set-key-vault-advanced-access-policies-with-azure-powershell"></a>使用 Azure PowerShell 設定金鑰保存庫的先進存取原則
...
### <a name="set-key-vault-advanced-access-policies-using-the-azure-cli"></a>使用 Azure CLI 來設定金鑰保存庫的先進存取原則
...
### <a name="set-key-vault-advanced-access-policies-through-the-azure-portal"></a>透過 Azure 入口網站設定金鑰保存庫的先進存取原則
...
## <a name="certificate-based-authentication-optional"></a>以憑證為基礎的驗證（選擇性）
...
## <a name="certificate-based-authentication-and-a-kek-optional"></a>以憑證為基礎的驗證和 KEK （選擇性）
