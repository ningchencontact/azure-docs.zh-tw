...
映像版本完成之後，您可以建立一或多個新的 VM。 使用 [New-AzVM](https://docs.microsoft.com/powershell/module/az.compute/new-azvm) Cmdlet 的簡化參數集，您只需提供映像版本的映像識別碼即可。 
