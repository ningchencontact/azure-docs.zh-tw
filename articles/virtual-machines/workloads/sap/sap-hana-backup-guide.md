...
此外, 當您經常使用 blob 快照集時, 必須瞭解其對計費的影響, 如這篇文章中所述:[瞭解快照集如何產生費用](/rest/api/storageservices/understanding-how-snapshots-accrue-charges), 不&#39;像使用 Azure 虛擬磁片一樣明顯。
