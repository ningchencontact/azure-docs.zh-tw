...
在範例組態中，安裝命令等。ASCS 實例是數位 00, ERS 實例是數位 01, 主要應用程式實例 (PAS) 是 02, 而應用程式實例 (.AAS) 是03。 使用 SAP 系統識別碼 QAS。 
...
1. 建立負載平衡器 (內部)  
   ...
   1. 負載平衡規則
      ...
      1. ASCS ERS 的其他連接埠
         * 針對ASCS ERS 的埠 32**01**、33**01**、5**01**13、5**01**14、5 01 16 和 TCP, 重複上述的步驟 "d"
