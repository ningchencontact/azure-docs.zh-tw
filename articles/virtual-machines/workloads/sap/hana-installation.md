...
Azure 上的 SAP Hana （大型實例）的儲存體配置是透過 SAP 建議方針的 Azure `service management` 上的 SAP Hana 來設定。 這些指引列載於 [SAP HANA 儲存體需求](https://go.sap.com/documents/2015/03/74cdb554-5a7c-0010-82c7-eda71af511fa.html)白皮書中。 
