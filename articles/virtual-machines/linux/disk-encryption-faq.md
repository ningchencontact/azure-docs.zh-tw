---
title: Linux Vm 的常見問題-Azure 磁碟加密 |Microsoft Docs
...
是，您可以在 Red Hat Linux VM 上執行 yum 更新。  如需詳細資訊，請參閱[防火牆後方的 Linux 套件管理](disk-encryption-troubleshooting.md#linux-package-management-behind-a-firewall)。
