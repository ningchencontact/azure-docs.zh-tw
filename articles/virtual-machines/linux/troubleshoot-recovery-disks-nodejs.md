...
- [Azure CLI 2.0](../windows/troubleshoot-recovery-disks.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) - 適用於資源管理部署模型的新一代 CLI
...
確定您已安裝[最新的 Azure CLI 1.0](../../cli-install-nodejs.md)，並已登入且使用 Resource Manager 模式：
