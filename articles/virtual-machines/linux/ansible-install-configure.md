...
- **Azure 服務主體**：請遵循[使用 Azure CLI 2.0 建立 Azure 服務主體](/cli/azure/create-an-azure-service-principal-azure-cli?view=azure-cli-latest)一文中**建立服務主體**一節的指示。 記下 **appId**、**displayName**、**密碼**和**租用戶**的值。
