---
title: 使用 Azure 映射產生器搭配適用于 Linux Vm 的映射庫（預覽）
description: 使用 Azure 映射產生器和共用映射資源庫建立 Linux VM 映射。
author: cynthn
ms.author: cynthn
ms.date: 04/20/2019
ms.topic: article
...
若要將映射發佈到共用映射資源庫，範本會使用[sharedImage](image-builder-json.md#distribute-sharedimage)做為範本 `distribute` 區段的值。
