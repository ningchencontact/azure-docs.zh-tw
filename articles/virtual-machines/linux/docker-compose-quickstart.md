...
若要確認容器是否已啟動，請輸入 `sudo docker-compose ps`。 您應該會看到如下的內容：
...
* 嘗試整合 Docker Compose 與 Docker Swarm 叢集。 如需案例，請參閱 [Using Compose with Swarm (搭配使用 Compose 與 Swarm)](https://docs.docker.com/compose/swarm/) 。
