---
title: 針對 Azure 中的 Linux VM 使用基礎結構自動化工具| Microsoft Docs
description: 了解如何使用 Ansible、Chef、Puppet、Terraform 和 Packer 等基礎結構自動化工具，來建立和管理 Azure 中的 Linux 虛擬機器
