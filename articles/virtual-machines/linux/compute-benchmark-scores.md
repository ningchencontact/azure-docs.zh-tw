---
title: Azure Linux VM 的計算基準測試分數 | Microsoft Docs
...
| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | 標準差 | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | 標準差 | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32-核心處理器 | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 32-核心處理器 | 16 | 2 | 125.9 | 154,829 | 3,708 | 2.40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 32-核心處理器 | 32 | 4 | 251.9 | 310,811 | 7,751 | 2.49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 32-核心處理器 | 64 | 8 | 503.9 | 595,140 | 14,572 | 2.45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 32-核心處理器 | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |
...
| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | 標準差 | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v3 | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 6 | 1 | 110.2 | 106,929 | 353 | 0.33% | 49 |
| Standard_NC12s_v3 | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 12 | 1 | 220.4 | 213,585 | 875 | 0.41% | 42 |
| Standard_NC24rs_v3 | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 24 | 2 | 440.9 | 403,554 | 6,705 | 1.66% | 42 |
| Standard_NC24s_v3 | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 24 | 2 | 440.9 | 403,874 | 7,603 | 1.88% | 42 |
...
| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | 標準差 | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v2 | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 6 | 1 | 110.2 | 107,115 | 321 | 0.30% | 63 |
| Standard_NC12s_v2 | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 12 | 1 | 220.4 | 213,814 | 656 | 0.31% | 63 |
| Standard_NC24rs_v2 | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 24 | 2 | 440.9 | 401,728 | 6,995 | 1.74% | 63 |
| Standard_NC24s_v2 | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 24 | 2 | 440.9 | 402,808 | 7923 | 1.97% | 63 |
...
| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | 標準差 | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6 | Intel (R) 強式 (R) CPU E5-2690 v3 @ 2.60 GHz | 6 | 1 | 55.0 | 102,211 | 658 | 0.64% | 259 |
| Standard_NC12 | Intel (R) 強式 (R) CPU E5-2690 v3 @ 2.60 GHz | 12 | 1 | 110.2 | 203,523 | 2,293 | 1.13% | 259 |
| Standard_NC24 | Intel (R) 強式 (R) CPU E5-2690 v3 @ 2.60 GHz | 24 | 2 | 220.4 | 382,897 | 8712 | 2.28% | 259 |
| Standard_NC24r | Intel (R) 強式 (R) CPU E5-2690 v3 @ 2.60 GHz | 24 | 2 | 220.4 | 383,171 | 9,166 | 2.39% | 259 |
...
| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | 標準差 | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_ND6s | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 6 | 1 | 110.2 | 107,095 | 353 | 0.33% | 63 |
| Standard_ND12s | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 12 | 1 | 220.4 | 212,298 | 3,457 | 1.63% | 63 |
| Standard_ND24rs | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 24 | 2 | 440.9 | 402,749 | 7,838 | 1.95% | 56 |
| Standard_ND24s | Intel (R) 強式 (R) CPU E5-2690 v4 @ 2.60 GHz | 24 | 2 | 440.9 | 401,822 | 7,776 | 1.94% | 63 |
...
| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | 標準差 | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NV6 | Intel (R) 強式 (R) CPU E5-2690 v3 @ 2.60 GHz | 6 | 1 | 55.0 | 101,728 | 2,094 | 2.06% | 259 |
| Standard_NV12 | Intel (R) 強式 (R) CPU E5-2690 v3 @ 2.60 GHz | 12 | 1 | 110.2 | 203,903 | 1,724 | 0.85% | 252 |
| Standard_NV24 | Intel (R) 強式 (R) CPU E5-2690 v3 @ 2.60 GHz | 24 | 2 | 220.4 | 379,879 | 8,737 | 2.30% | 259 |
