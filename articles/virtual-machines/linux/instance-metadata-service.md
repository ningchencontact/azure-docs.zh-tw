...
計劃 | VM 在其 Azure Marketplace 映像中的[計劃](https://docs.microsoft.com/rest/api/compute/virtualmachines/createorupdate#plan)，包含名稱、產品和發行者 | 2017-04-02
