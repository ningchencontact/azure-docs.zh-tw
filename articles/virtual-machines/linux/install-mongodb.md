...
接著，使用 [az group deployment create](/cli/azure/group/deployment) 來佈建 MongoDB 範本。 出現提示時，針對 newStorageAccountName  、dnsNameForPublicIP  和管理員使用者名稱與密碼輸入您自己唯一的值：
