---
title: 使用遠端桌面連線到 Azure 虛擬機器時發生內部錯誤 | Microsoft Docs
...
連線至[序列主控台並開啟 PowerShell 執行個體](./serial-console-windows.md#open-cmd-or-powershell-in-serial-console
...
2. 如果無法停止應用程式，或是這個方法不適合您，則請變更 RDP 的連接埠：
    ...
    C. 在 Azure 入口網站的 RDP 連接埠中，[為新的連接埠更新網路安全性群組](../../virtual-network/security-overview.md)。
