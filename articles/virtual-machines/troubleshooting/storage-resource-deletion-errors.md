...
## <a name="step-1-identify-blob-attached-to-a-vm"></a>步驟 1：識別連結 VM 的 Blob

### <a name="scenario-1-deleting-a-blob--identify-attached-vm"></a>案例 1：刪除 Blob - 識別連結的 VM
...
6. 如果 Blob 磁碟類型是 **OSDisk**，請遵循[步驟 2：刪除 VM 以中斷連結作業系統磁碟](#step-2-delete-vm-to-detach-os-disk)。 否則，如果 Blob 磁碟類型是 **DataDisk**，請遵循[步驟 3：中斷連結資料磁碟與 VM](#step-3-detach-data-disk-from-the-vm)。 
...
### <a name="scenario-2-deleting-a-container---identify-all-blobs-within-container-that-are-attached-to-vms"></a>案例 2：刪除容器 - 識別連結 VM 之容器內的所有 Blob
1. 登入 [Azure 入口網站](https://portal.azure.com)。
...
### <a name="scenario-3-deleting-storage-account---identify-all-blobs-within-storage-account-that-are-attached-to-vms"></a>案例 3：刪除儲存體帳戶 - 識別儲存體帳戶內已連結 VM 的所有 Blob
1. 登入 [Azure 入口網站](https://portal.azure.com)。
...
## <a name="step-2-delete-vm-to-detach-os-disk"></a>步驟 2：刪除 VM 以中斷連結作業系統磁碟
...
## <a name="step-3-detach-data-disk-from-the-vm"></a>步驟 3：中斷連結資料磁碟與 VM
