...
## <a name="use-the-serial-console-for-nmi-calls-in-windows-vms"></a>使用序列主控台在 Windows VM 中進行 NMI 呼叫
...
Web 通訊端已關閉或無法開啟。 | 您可能需要將 `*.console.azure.com` 列入白名單。 有一個更詳細但較冗長的方法，就是將 [Microsoft Azure 資料中心 IP 範圍](https://www.microsoft.com/download/details.aspx?id=41653)列入白名單，而此範圍會經常變更。
