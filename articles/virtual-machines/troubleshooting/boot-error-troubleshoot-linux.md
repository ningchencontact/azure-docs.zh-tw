...
This article lists the common boot errors that you may receive when you start a Linux virtual machine (VM) in Microsoft Azure. 如需這些錯誤的詳細資訊，請參閱**開機錯誤和解決方案**一節中的文章。
