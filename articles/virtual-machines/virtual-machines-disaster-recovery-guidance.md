...
## <a name="option-1-initiate-a-failover-by-using-azure-site-recovery"></a>選項 1：使用 Azure Site Recovery 启动故障转移
...
在此情況下，您不需要採取任何動作。 但您要知道，我們正在努力還原服務的可用性。 可在 [Azure 服务运行状况仪表板](https://azure.microsoft.com/status/)上查看当前服务状态。
...
> [!NOTE]
> 請注意，您完全無法控制這個程序，而且它只有在全區域服務中斷時才會發生。 因此，您也必須依賴其他的應用程式特定備份策略，以達到最高層級的可用性。 有关详细信息，请参阅 [Data strategies for disaster recovery](https://docs.microsoft.com/azure/architecture/resiliency/disaster-recovery-azure-applications#data-strategies-for-disaster-recovery)（灾难恢复的数据策略）部分。
>
>
