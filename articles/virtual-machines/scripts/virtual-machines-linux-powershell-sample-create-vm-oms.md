...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | 將 VM 擴充功能新增至虛擬機器。 此案例會使用 Log Analytics 代理程式擴充功能來安裝 Log Analytics 代理程式，並在 Log Analytics 工作區中註冊 VM。 |
