...
對 VM 執行 VM 擴充功能後，請使用 [Get-AzVM ](https://docs.microsoft.com/powershell/module/az.compute/get-azvm) 傳回擴充功能狀態。 *Substatuses[0]* 顯示擴充功能佈建成功，這表示擴充功能已成功部署至 VM，但在 VM 內部執行失敗，而顯示 *Substatuses[1]*。
