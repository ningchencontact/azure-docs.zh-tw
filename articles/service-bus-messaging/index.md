---
title: 服務匯流排傳訊文件
description: 了解如何設定傳訊功能，以連接橫跨內部部署和雲端環境的應用程式和服務。
...
---
# <a name="service-bus-messaging-documentation"></a>服務匯流排傳訊文件
傳訊服務提供做為訊息代理程式或第三方通訊機制的相依資訊傳遞。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/servicebus/">REST API 參考</a></p>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>其他</h3>
                        <p><a href="service-bus-messaging-exceptions.md">例外狀況</a></p>
                        <p><a href="service-bus-quotas.md">配額</a></p>
                        <p><a href="service-bus-messaging-sql-filter.md">SQLFilter 語法</a></p>
                        <p><a href="service-bus-messaging-sql-rule-action.md">SQLRuleAction 語法</a></p>
                   </div>
                </div>
            </div>
        </div>
