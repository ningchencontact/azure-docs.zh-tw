...
description: 了解如何直接從原始程式碼啟動 Azure Spring Cloud 應用程式
author: jpconnock
...
ms.locfileid: "73721283"
---
# <a name="launch-your-spring-cloud-application-from-source-code"></a>從原始程式碼啟動 Spring Cloud 應用程式
