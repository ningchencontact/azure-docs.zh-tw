...
如需有關如何使用 Azure 入口網站擷取帳戶存取金鑰的詳細資訊，請參閱[管理 Azure 入口網站中的儲存體帳戶設定](../articles/storage/common/storage-account-manage.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#access-keys)中的**存取金鑰**。