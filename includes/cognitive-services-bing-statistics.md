...
- **市場**：結果的來源市場。 例如，en-US (英文，美國)。 預設會選取所有市場。 請注意，如果呼叫未指定市場，而且 Bing 無法判斷使用者的市場，Bing 會使用 en-WW 市場。  
...
- **地理分佈**：結果的來源市場。 例如，en-US (英文，美國)。 Bing 使用 `mkt` 查詢參數來判斷市場 (如果指定的話)。 否則，Bing 會使用訊號 (例如呼叫端的 IP 位址) 來判斷市場。
