...
ms.locfileid: "55302186"
---
1. 完成 [Azure Machine Learning Python 快速入門](../articles/machine-learning/service/quickstart-create-workspace-with-python.md)以安裝 SDK 並建立工作區。  您可以視需要放心略過**使用 Notebook** 的部分。
