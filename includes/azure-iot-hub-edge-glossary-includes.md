...
Azure IoT 邊緣能夠雲端驅動部署 Azure 服務和解決方案專用程式碼，以在內部部署裝置。 IoT Edge 裝置可以在其他裝置的資料被傳送至雲端之前，對這些資料進行彙總來執行計算和分析。 如需詳細資訊，請參閱 [Azure IoT Edge](https://docs.microsoft.com/en-us/azure/iot-edge/)。
...
## <a name="iot-edge-priority"></a>IoT 邊緣優先順序
...
## <a name="iot-edge-target-condition"></a>IoT 邊緣目標條件
