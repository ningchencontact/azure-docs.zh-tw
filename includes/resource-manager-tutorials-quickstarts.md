...
- 快速入門
    ...
    |[使用 Visual Studio](../articles/azure-resource-manager/vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)|使用 Visual Studio 來建立、編輯和部署範本。|
