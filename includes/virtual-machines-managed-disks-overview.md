...
**儲存體類型：** 受控磁碟提供 3 個效能層級：[標準 HDD](../articles/virtual-machines/windows/standard-storage.md)、[標準 SSD](../articles/virtual-machines/windows/standard-storage.md) 和[進階](../articles/virtual-machines/windows/premium-storage.md)。 受控磁碟的計費取決於您為磁碟選取的儲存體類型。
...
以下是進階受控磁碟可用的磁碟大小，以星號表示的大小目前處於預覽狀態：

| **進階 SSD 受控<br>磁碟類型** | **P4** | **P6** | **P10** | **P15** | **P20** | **P30** | **P40** | **P50** | **P60*** | **P70*** | **P80*** |
|------------------|---------|---------|--------|--------|--------|----------------|----------------|----------------|----------------|----------------|----------------|
...
以下是標準 SSD 受控磁碟可用的磁碟大小，以星號表示的大小目前處於預覽狀態：

| **標準 SSD 受控<br>磁碟類型** | **E4** | **E6** | **E10** | **E15** | **E20** | **E30** | **E40** | **E50** | **E60*** | **E70*** | **E80*** |
|------------------|---------|---------|--------|--------|--------|----------------|----------------|----------------|----------------|----------------|----------------|
| 磁碟大小        | 32 GiB | 64 GiB | 128 GB | 256 GiB | 512 GB | 1,024 GiB (1 TiB) | 2,048 GiB (2 TiB) | 4,095 GiB (4 TiB) | 8,192 GiB (8 TiB) | 16,384 GiB (16 TiB) | 32,767 GiB (TiB) |

以下是標準 HDD 受控磁碟可用的磁碟大小，以星號表示的大小目前處於預覽狀態：
