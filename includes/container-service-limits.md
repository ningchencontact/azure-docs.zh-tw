...
| Maximum pods per node: [Advanced networking][advanced-networking] with Azure Container Networking Interface | Azure CLI 部署：30<sup>1</sup><br />Azure Resource Manager template: 30<sup>1</sup><br />入口網站部署：30 |
