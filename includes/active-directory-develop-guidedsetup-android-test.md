...
1. 將您的程式碼部署到裝置/模擬器。
2. 當您準備好測試應用程式時，請使用 Microsoft Azure Active Directory 帳戶 (公司或學校帳戶) 或 Microsoft 帳戶 (live.com、outlook.com) 帳戶登入。 
...
登入之後，您應該會看到 Microsoft Graph API 的呼叫所傳回的結果。 呼叫 Microsoft Graph API 的 **me** 端點會傳回使用者設定檔 https://graph.microsoft.com/v1.0/me。 如需常用的 Microsoft Graph 端點清單，請參閱 [Microsoft Graph API 的開發人員文件](https://developer.microsoft.com/graph/docs#common-microsoft-graph-queries)。
