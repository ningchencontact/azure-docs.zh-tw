...
* **發行者**：建立映像的組織。 例如：Canonical、MicrosoftWindowsServer
* **供應項目**：相關映像群組 (由發行者所建立) 的名稱。 例如：UbuntuServer、WindowsServer
* **SKU**：供應項目執行個體，例如發佈的主要版本。 例如：18.04-LTS、2019-Datacenter
* **版本**：映像 SKU 的版本號碼。 
