...
每次进行更改时，必须指定前缀的完整列表，不能仅指定要更改的前缀。 僅指定我們想要保留的首碼。 在此案例中為 10.0.0.0/24 和 20.0.0.0/24
...
每次進行變更時，您都必須指定完整的首碼清單，而不只是指定您想要變更的首碼。 在此示例中，10.0.0.0/24 和 20.0.0.0/24 已存在。 我們會新增首碼 30.0.0.0/24 和 40.0.0.0/24，並且在更新時指定全部 4 個首碼。
