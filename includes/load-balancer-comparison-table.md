...
| [輸出規則](../articles/load-balancer/load-balancer-outbound-rules-overview.md) | 宣告式輸出 NAT 組態，其使用公用 IP 位址或公用 IP 首碼 (或兩者皆使用)、可設定的輸出閒置逾時、自訂的 SNAT 連接埠配置 | 無法使用。 |
