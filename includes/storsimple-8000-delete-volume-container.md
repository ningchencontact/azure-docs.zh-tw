...
如果磁碟區容器有相關聯的磁碟區，請先將那些磁碟區離線。 請遵循 [使磁碟區離線](../articles/storsimple/storsimple-8000-manage-volumes-u2.md#take-a-volume-offline)中的步驟進行。 磁碟機離線後，才可以刪除它們。 當磁碟區容器沒有相關聯的磁碟區時，請將磁碟區容器刪除。 執行下列程序可將磁碟區容器刪除。
