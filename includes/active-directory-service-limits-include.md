...
ms.locfileid: "38755657"
---
以下是 Azure Active Directory 服務的使用條件約束和其他服務限制。

| 類別 | 限制 |
| --- | --- |
| 目錄 |單一使用者最多能與 500 個 Azure Active Directory 目錄相關聯。<br />可能組合的範例︰ <ul> <li>單一使用者建立 500 個目錄。</li><li>單一使用者新增 500 個目錄作為成員。</li><li>單一使用者建立 250 個目錄，之後由其他使用者加入到 250 個不同的目錄。</li></ul> |
