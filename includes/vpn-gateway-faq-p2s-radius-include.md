...
RADIUS 驗證在閘道上所支援的 SSTP 連線數目上限並未變更。 SSTP 的限制數量仍為 128，但取決於 IKEv2 的閘道 SKU。 如需所支援連線數目的詳細資訊，請參閱[閘道 sku](../articles/vpn-gateway/vpn-gateway-about-vpngateways.md#gwsku)。
