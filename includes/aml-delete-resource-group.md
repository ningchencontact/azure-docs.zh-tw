...
1. 在 Azure 入口網站中，選取最左邊的 [資源群組]  。
   ...
   [![在 Azure 入口網站中刪除](./media/aml-delete-resource-group/delete-resources.png)](./media/aml-delete-resource-group/delete-resources-expanded.png)
