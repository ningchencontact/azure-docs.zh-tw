...
1. 在開發人員中心中，於 [App IDs] 下找出您建立的 App ID，並在該列上按一下。
...
1. 返回 <a href="http://go.microsoft.com/fwlink/p/?LinkId=272456" target="_blank">iOS 佈建入口網站</a>，並依序選取 [佈建設定檔] 和 [全部]，然後按一下 **+** 按鈕建立新的設定檔。 您會看見 **Add iOS Provisioning Profile** 精靈
