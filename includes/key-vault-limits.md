...
|金鑰類型|HSM key<br>CREATE key|HSM key<br>所有其他交易|軟體金鑰<br>CREATE key|軟體金鑰<br>所有其他交易|
|:---|---:|---:|---:|---:|
...
| 交易類型 | Maximum transactions allowed in 10 seconds, per vault per region<sup>1</sup> |
| --- | --- |
| 所有交易 |2,000 |
