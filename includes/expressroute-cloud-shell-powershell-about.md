...
如果您不想要使用 Azure Cloud Shell 中，Azure PowerShell 在本機改為安裝。 請務必安裝最新版的 Azure PowerShell Az 模組，以取得最新的功能。 如需詳細資訊，請參閱[安裝 Azure PowerShell](/powershell/azure/overview) (英文)。
