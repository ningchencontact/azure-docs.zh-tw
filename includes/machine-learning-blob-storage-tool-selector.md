...
ms.locfileid: "67174510"
---
<!-- Guidance on technologies used to move data to and/or from Azure Blob storage are linked here:
-->
此功能表會連結至將資料移進和移出 Azure Blob 儲存體所使用的技術：

> [!div class="op_single_selector" title1="Blob 儲存體工具"]
> * [概觀](../articles/machine-learning/team-data-science-process/move-azure-blob.md)
> * [Azure 儲存體總管](../articles/machine-learning/team-data-science-process/move-data-to-azure-blob-using-azure-storage-explorer.md)
