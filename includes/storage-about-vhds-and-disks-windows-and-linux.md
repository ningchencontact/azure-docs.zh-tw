...
標準 SSD 磁碟的設計是為了處理和標準 HDD 磁碟相同類型的工作負載，但可提供比 HDD 還要好的一致效能和可靠性。 標準 SSD 磁碟會合併進階 SSD 磁碟和標準 HDD 磁碟的元素，可針對磁碟上不需要高 IOPS 的網頁伺服器等應用程式，構成最適合的解決方案，且符合成本效益。 情況適合時，標準 SSD 磁碟是大部分工作負載的建議部署選項。 標準 SSD 磁碟僅提供受控磁碟形式，而在預覽狀態時，僅在[選定區域](../articles/virtual-machines/windows/faq-for-disks.md)中提供，且只有本地備援儲存體 (LRS) 復原類型。
...
下表會比較標準 HDD、標準 SSD 和進階 SSD 的非受控磁碟和受控磁碟，以協助您決定要使用何者。

|    | Azure 進階磁碟 |Azure 標準 SSD 磁碟 (預覽)| Azure 標準 HDD 磁碟 
|--- | ------------------ | ------------------------------- | ----------------------- 
...
| 磁碟大小 | P4: 32 GiB (僅限受控磁碟)<br>P6: 64 GiB (僅限受控磁碟)<br>P10: 128 GiB<br>P15: 256 GiB (僅限受控磁碟)<br>P20: 512 GiB<br>P30: 1024 GiB<br>P40: 2048 GiB<br>P50: 4095 GiB |僅限受控磁碟：<br>E10: 128 GiB<br>E15: 256 GiB<br>E20: 512 GiB<br>E30: 1024 GiB<br>E40: 2048 GiB<br>E50: 4095 GiB | 非受控磁碟：1 GiB – 4 TiB (4095 GiB) <br><br>受控磁碟：<br> S4: 32 GiB <br>S6: 64 GiB <br>S10: 128 GiB <br>S15: 256 GiB <br>S20: 512 GiB <br>S30: 1024 GiB <br>S40: 2048 GiB<br>S50: 4095 GiB
| 每一磁碟的輸送量上限 | 250 MiB/秒 | 高達 60 MiB/秒 | 高達 60 MiB/秒 
| 每一磁碟的 IOPS 上限 | 7500 IOPS | 高達 500 IOPS | 高達 500 IOPS 