...
ms.locfileid: "57553485"
---
| 資源 | 免費 | 共用 | 基本 | 標準 | 進階 (v2) | 隔離 </th> |
| --- | --- | --- | --- | --- | --- | --- |
| [Web、 行動或 API 應用程式](https://azure.microsoft.com/services/app-service/)每個[Azure App Service 方案](../articles/app-service/overview-hosting-plans.md)<sup>1</sup> |10 |100 |无限制<sup>2</sup> |無限制<sup>2</sup> |無限制<sup>2</sup> |無限制<sup>2</sup>|
| [App Service 計劃](../articles/app-service/overview-hosting-plans.md) |每個區域 10 個 |每個資源群組 10 個 |每個資源群組 100 個 |每個資源群組 100 個 |每個資源群組 100 個 |每个资源组 100 个|
...
| 應用程式架構 |32 位 |32 位元 |32 位元/64 位元 |32 位元/64 位元 |32 位元/64 位元 |32 位元/64 位元 |
| Web 通訊端，每個執行個體<sup>7</sup> |5 |35 |350 |无限制 |無限 |無限制 |
