...
* Dv2 系列是原始 D 系列的延續，擁有更強大的 CPU。 Dv2 系列 CPU 比 D 系列 CPU 快約 35%。 它是以最新一代的 2.4 GHz Intel 2673® E5-2673 v3 2.4 g h z （Haswell）或 E5-v4 2.3 GHz （Broadwell）處理器為基礎，而且透過 Intel Turbo 加速技術2.0，最高可達 3.1 GHz。 Dv2 系列的記憶體和磁碟組態和 D 系列一樣。
