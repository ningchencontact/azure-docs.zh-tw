...
* [RogueWave CentOS 型 HPC](https://azuremarketplace.microsoft.com/marketplace/apps/RogueWave.CentOSbased74HPC?tab=Overview)
...
* Azure Batch 上的[轉譯應用程式](../articles/batch/batch-rendering-service.md)，包括 Autodesk Maya、3ds Max 和 Arnold、Chaos Group V-Ray 與 Blender
...
使用 [Azure CycleCloud](https://docs.microsoft.com/azure/cyclecloud/overview) 在 Azure VM 上建立 HPC 叢集並予以最佳化，可輕鬆有效地管理常見的工作負載。
...
大規模 Batch 和 HPC 工作負載所需要的資料儲存和存取會超過傳統雲端檔案系統的容量。 

深入了解：

* [Avere vFXT for Azure](../articles/avere-vfxt/avere-vfxt-overview.md) 
* [Azure 上的平行虛擬檔案系統](https://azure.microsoft.com/resources/parallel-virtual-file-systems-on-microsoft-azure/)，包括 [Lustre](http://lustre.org/) 和 [BeeGFS](http://www.beegfs.com/content/)。
...
* 深入了解適用於[高效能運算](https://azure.microsoft.com/solutions/high-performance-computing/)、[轉譯](https://azure.microsoft.com/solutions/big-compute/rendering/)、[銀行與資本市場](https://finance.azure.com/)和[基因體學](https://enterprise.microsoft.com/industries/health/genomics/)的 Azure 解決方案。

* 深入了解 Azure 中的 [Big Compute 解決方案架構](https://azure.microsoft.com/solutions/architecture/?solution=high-performance-computing)。
