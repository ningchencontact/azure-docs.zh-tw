...
| &nbsp; |[Netezza 搶鮮版 (Beta)](../articles/data-factory/connector-netezza.md) |
...
| &nbsp; |[Vertica 搶鮮版 (Beta)](../articles/data-factory/connector-vertica.md) |
...
| **服務和應用程式** |[Amazon Marketplace Web Service 搶鮮版 (Beta)](../articles/data-factory/connector-amazon-marketplace-web-service.md) |
...
| &nbsp; |[Marketo 搶鮮版 (Beta)](../articles/data-factory/connector-marketo.md) |
...
> [!NOTE]
> 任何標示為「搶鮮版 (Beta)」的連接器都表示您可以試用並提供意見反應給我們。 如果您需要依賴解決方案中的 Beta 連接器，請連絡 [Azure 支援](https://azure.microsoft.com/support/)。