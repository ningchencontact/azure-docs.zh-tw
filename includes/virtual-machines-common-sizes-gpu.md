...
NDv2 系列虛擬機器是 GPU 家族的新增項目，專為 HPC、AI 和機器學習工作負載的需求設計而成。 它是由8個 NVIDIA Tesla V100 NVLINK 互連 Gpu 和 40 Intel 最強白金 8168 (Skylake) 核心和 672 GiB 的系統記憶體所提供技術支援。 NDv2 執行個體利用了 Cuda、TensorFlow、Pytorch、Caffe 等架構，為 HPC 和 AI 工作負載提供優異的 FP32 和 FP64 效能。
