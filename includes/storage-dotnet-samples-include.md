...
* [使用增量快照備份 Azure 虛擬機器磁碟](https://github.com/Azure-Samples/storage-blob-dotnet-back-up-with-incremental-snapshots)
* [開始使用 .NET 的 Azure 用戶端加密](https://github.com/Azure-Samples/storage-dotnet-client-side-encryption)
...
* [在 .NET 中開始使用 Azure 表格儲存體](https://github.com/Azure-Samples/storage-table-dotnet-getting-started)
* [開始使用共用存取簽章 (SAS)](https://azure.microsoft.com/resources/samples/storage-dotnet-sas-getting-started/)
* [透過 REST API 匯入匯出作業管理](https://github.com/Azure-Samples/storage-dotnet-import-export-job-management/)
* [MyDriving - Azure IOT 與行動應用程式範例](https://github.com/Azure-Samples/mydriving/)
