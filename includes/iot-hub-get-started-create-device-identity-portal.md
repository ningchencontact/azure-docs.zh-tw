...
1. 選取 [所有資源] 並尋找您的 IoT 中樞資源。

1. 當您的 IoT 中樞資源開啟時，按一下 [IoT 裝置] 工具，然後按一下頂端的 [新增]。 
...
1. 提供新裝置的名稱 (例如 **myDeviceId**)，然後按一下 [儲存]。 此動作會為您的 IoT 中樞建立新的裝置身分識別。
   ...
   ![新增裝置](./media/iot-hub-get-started-create-device-identity-portal/add-device.png)

1. 在裝置清單中，按一下新建立的裝置，並複製 [連接字串---主索引鍵] 以供日後使用。

    ![裝置連接字串](./media/iot-hub-get-started-create-device-identity-portal/device-connection-string.png)
