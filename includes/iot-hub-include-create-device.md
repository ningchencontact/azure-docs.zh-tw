...
ms.locfileid: "69558727"
---
<!-- put the ## header in the file that includes this file -->

在本節中，您會在 IoT 中樞的身分識別登錄中建立裝置身分識別。 裝置無法連線到中樞, 除非它在身分識別登錄中具有專案。 如需詳細資訊, 請參閱[IoT 中樞開發人員指南](../articles/iot-hub/iot-hub-devguide-identity-registry.md)的「身分識別登錄」一節。
